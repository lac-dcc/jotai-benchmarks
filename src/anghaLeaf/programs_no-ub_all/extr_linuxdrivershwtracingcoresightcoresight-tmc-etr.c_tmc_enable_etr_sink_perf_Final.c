...
__attribute__((used)) static int tmc_enable_etr_sink_perf(struct coresight_device *csdev)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_csdev0; _i0++) {
            csdev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = tmc_enable_etr_sink_perf(csdev);
          printf("%d\n", benchRet); 
          free(csdev);
