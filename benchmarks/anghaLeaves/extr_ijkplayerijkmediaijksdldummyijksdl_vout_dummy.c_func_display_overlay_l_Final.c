...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_vout0 = 1;
          int * vout = (int *) malloc(_len_vout0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_vout0; _i0++) {
            vout[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_overlay0 = 1;
          int * overlay = (int *) malloc(_len_overlay0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_overlay0; _i0++) {
            overlay[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = func_display_overlay_l(vout,overlay);
          printf("%d\n", benchRet); 
          free(vout);
          free(overlay);
