...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->stats.rx_over_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.tx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.tx_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.tx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.tx_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_packets = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_stats0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_stats0; _i0++) {
            stats->rx_over_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->rx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->tx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->tx_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->rx_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->tx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->rx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->tx_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->rx_packets = ((-2 * (next_i()%2)) + 1) * next_i();
          }
