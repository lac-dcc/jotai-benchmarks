...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info[_i0].bitdepth = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].palettesize = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].palette = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].colortype = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].key_b = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].key_g = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].key_r = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].key_defined = ((-2 * (next_i()%2)) + 1) * next_i();
          }
