...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hcd0; _i0++) {
            hcd->flags.b.port_over_current_change = ((-2 * (next_i()%2)) + 1) * next_i();
        hcd->flags.b.port_suspend_change = ((-2 * (next_i()%2)) + 1) * next_i();
        hcd->flags.b.port_enable_change = ((-2 * (next_i()%2)) + 1) * next_i();
        hcd->flags.b.port_reset_change = ((-2 * (next_i()%2)) + 1) * next_i();
        hcd->flags.b.port_connect_status_change = ((-2 * (next_i()%2)) + 1) * next_i();
          }
