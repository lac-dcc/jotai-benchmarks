...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rxe0; _i0++) {
            rxe->max_ucontext = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_cqe = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.local_ca_ack_delay = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_pkeys = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_fast_reg_page_list_len = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_srq_sge = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_srq_wr = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_srq = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_map_per_fmr = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_fmr = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_ah = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_total_mcast_qp_attach = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_mcast_qp_attach = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_mcast_grp = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_raw_ethy_qp = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_raw_ipv6_qp = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_mw = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_rdd = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_ee = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.atomic_cap = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_ee_init_rd_atom = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_qp_init_rd_atom = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_res_rd_atom = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_ee_rd_atom = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_qp_rd_atom = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_pd = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_mr = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_cq = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_sge_rd = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.device_cap_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_qp_wr = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_qp = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.hw_ver = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.vendor_part_id = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.vendor_id = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.page_size_cap = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.max_mr_size = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->attr.fw_ver = ((-2 * (next_i()%2)) + 1) * next_i();
        rxe->max_inline_data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
