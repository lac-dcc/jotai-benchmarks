...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_a10; _i0++) {
            a1->type = ((-2 * (next_i()%2)) + 1) * next_i();
        a1->proto = ((-2 * (next_i()%2)) + 1) * next_i();
        a1->u.a4.mask = ((-2 * (next_i()%2)) + 1) * next_i();
        a1->u.a6.pfxlen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_a20 = 1;
          struct qeth_ipaddr * a2 = (struct qeth_ipaddr *) malloc(_len_a20*sizeof(struct qeth_ipaddr));
          for(int _i0 = 0; _i0 < _len_a20; _i0++) {
            a2->type = ((-2 * (next_i()%2)) + 1) * next_i();
        a2->proto = ((-2 * (next_i()%2)) + 1) * next_i();
        a2->u.a4.mask = ((-2 * (next_i()%2)) + 1) * next_i();
        a2->u.a6.pfxlen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
