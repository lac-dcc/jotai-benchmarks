...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_qp0; _i0++) {
            qp->ibqp.qp_type = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->ibqp.srq = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->ibqp.recv_cq = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->ibqp.send_cq = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->ibqp.qp_context = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->ibqp.event_handler = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->sq_sig_type = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rq.max_sge = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rq.max_wr = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->srq = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->sq.max_inline = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->sq.max_sge = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->sq.max_wr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_init0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_init0; _i0++) {
            init->port_num = ((-2 * (next_i()%2)) + 1) * next_i();
        init->qp_type = ((-2 * (next_i()%2)) + 1) * next_i();
        init->sq_sig_type = ((-2 * (next_i()%2)) + 1) * next_i();
        init->cap.max_recv_sge = ((-2 * (next_i()%2)) + 1) * next_i();
        init->cap.max_recv_wr = ((-2 * (next_i()%2)) + 1) * next_i();
        init->cap.max_inline_data = ((-2 * (next_i()%2)) + 1) * next_i();
        init->cap.max_send_sge = ((-2 * (next_i()%2)) + 1) * next_i();
        init->cap.max_send_wr = ((-2 * (next_i()%2)) + 1) * next_i();
        init->srq = ((-2 * (next_i()%2)) + 1) * next_i();
        init->recv_cq = ((-2 * (next_i()%2)) + 1) * next_i();
        init->send_cq = ((-2 * (next_i()%2)) + 1) * next_i();
        init->qp_context = ((-2 * (next_i()%2)) + 1) * next_i();
        init->event_handler = ((-2 * (next_i()%2)) + 1) * next_i();
          }
