...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_args10; _i0++) {
            args1->fwa_divert_rule = ((-2 * (next_i()%2)) + 1) * next_i();
        args1->fwa_pf_rule = ((-2 * (next_i()%2)) + 1) * next_i();
        args1->fwa_ipfw_rule = ((-2 * (next_i()%2)) + 1) * next_i();
        args1->fwa_next_hop = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_args0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_args0; _i0++) {
            args->fwai_divert_rule = ((-2 * (next_i()%2)) + 1) * next_i();
        args->fwai_pf_rule = ((-2 * (next_i()%2)) + 1) * next_i();
        args->fwai_ipfw_rule = ((-2 * (next_i()%2)) + 1) * next_i();
        args->fwai_next_hop = ((-2 * (next_i()%2)) + 1) * next_i();
          }
