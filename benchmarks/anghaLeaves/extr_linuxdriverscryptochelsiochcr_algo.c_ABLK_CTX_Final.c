...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__crypto_ctx0; _j0++) {
              int _len_ctx__i0__crypto_ctx_ablkctx0 = 1;
          ctx[_i0].crypto_ctx->ablkctx = (struct ablk_ctx *) malloc(_len_ctx__i0__crypto_ctx_ablkctx0*sizeof(struct ablk_ctx));
          for(int _j0 = 0; _j0 < _len_ctx__i0__crypto_ctx_ablkctx0; _j0++) {
            ctx[_i0].crypto_ctx->ablkctx->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct ablk_ctx * benchRet = ABLK_CTX(ctx);
          printf("%d\n", (*benchRet).dummy);
