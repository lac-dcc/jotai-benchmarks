...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_udc0 = 1;
          struct fsl_udc * udc = (struct fsl_udc *) malloc(_len_udc0*sizeof(struct fsl_udc));
          for(int _i0 = 0; _i0 < _len_udc0; _i0++) {
            udc->vbus_active = ((-2 * (next_i()%2)) + 1) * next_i();
        udc->softconnect = ((-2 * (next_i()%2)) + 1) * next_i();
        udc->driver = ((-2 * (next_i()%2)) + 1) * next_i();
          }
