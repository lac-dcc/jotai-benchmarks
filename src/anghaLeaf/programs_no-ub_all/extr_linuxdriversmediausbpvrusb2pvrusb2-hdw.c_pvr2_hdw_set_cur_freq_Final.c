...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hdw0; _i0++) {
            hdw->input_val = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->freqSelector = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->freqDirty = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->freqValRadio = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->freqValTelevision = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->freqSlotTelevision = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->freqSlotRadio = ((-2 * (next_i()%2)) + 1) * next_i();
          }
