...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct psb_intel_sdvo_connector * connector = (struct psb_intel_sdvo_connector *) malloc(_len_connector0*sizeof(struct psb_intel_sdvo_connector));
          for(int _i0 = 0; _i0 < _len_connector0; _i0++) {
            connector[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          psb_intel_sdvo_add_hdmi_properties(connector);
          free(connector);
