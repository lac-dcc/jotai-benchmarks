...
__attribute__((used)) static int get_user_dscr(struct task_struct *task, unsigned long *data)
{
	return -EIO;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_task0; _i0++) {
            task->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = get_user_dscr(task,data);
          printf("%d\n", benchRet); 
          free(task);
          free(data);
