...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_clk__i0__core0; _j0++) {
              int _len_clk__i0__core_hw0 = 1;
          clk[_i0].core->hw = (struct clk_hw *) malloc(_len_clk__i0__core_hw0*sizeof(struct clk_hw));
          for(int _j0 = 0; _j0 < _len_clk__i0__core_hw0; _j0++) {
            clk[_i0].core->hw->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct clk_hw * benchRet = __clk_get_hw(clk);
          printf("%d\n", (*benchRet).dummy);
