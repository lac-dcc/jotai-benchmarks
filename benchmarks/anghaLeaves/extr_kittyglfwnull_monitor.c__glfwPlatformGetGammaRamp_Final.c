...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_ramp0 = 1;
          int * ramp = (int *) malloc(_len_ramp0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_ramp0; _i0++) {
            ramp[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = _glfwPlatformGetGammaRamp(monitor,ramp);
          printf("%d\n", benchRet); 
          free(monitor);
          free(ramp);
