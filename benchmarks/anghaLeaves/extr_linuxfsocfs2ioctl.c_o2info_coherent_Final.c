...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_req0 = 1;
          struct ocfs2_info_request * req = (struct ocfs2_info_request *) malloc(_len_req0*sizeof(struct ocfs2_info_request));
          for(int _i0 = 0; _i0 < _len_req0; _i0++) {
            req[_i0].ir_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = o2info_coherent(req);
          printf("%d\n", benchRet); 
          free(req);
