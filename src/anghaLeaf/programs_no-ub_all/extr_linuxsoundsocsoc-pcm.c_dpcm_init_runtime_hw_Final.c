...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_runtime0; _i0++) {
            runtime->hw.formats = ((-2 * (next_i()%2)) + 1) * next_i();
        runtime->hw.rates = ((-2 * (next_i()%2)) + 1) * next_i();
        runtime->hw.channels_max = ((-2 * (next_i()%2)) + 1) * next_i();
        runtime->hw.channels_min = ((-2 * (next_i()%2)) + 1) * next_i();
        runtime->hw.rate_max = ((-2 * (next_i()%2)) + 1) * next_i();
        runtime->hw.rate_min = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_stream0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
            stream->formats = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->rates = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->channels_max = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->channels_min = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->rate_max = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->rate_min = ((-2 * (next_i()%2)) + 1) * next_i();
          }
