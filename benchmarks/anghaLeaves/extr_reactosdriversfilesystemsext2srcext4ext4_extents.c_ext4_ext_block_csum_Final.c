...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_eh0 = 1;
          struct ext4_extent_header * eh = (struct ext4_extent_header *) malloc(_len_eh0*sizeof(struct ext4_extent_header));
          for(int _i0 = 0; _i0 < _len_eh0; _i0++) {
            eh[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ext4_ext_block_csum(inode,eh);
          printf("%d\n", benchRet); 
          free(inode);
          free(eh);
