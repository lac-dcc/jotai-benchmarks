...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ccdc0; _i0++) {
            ccdc->ccdc_cfg.bayer.config_params.alaw.gamma_wd = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.config_params.data_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.win.width = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.win.height = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.win.top = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.win.left = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.frm_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.bayer.pix_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.bt656_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.win.width = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.win.height = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.win.top = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.win.left = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.buf_type = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.pix_order = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.frm_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.ycbcr.pix_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        ccdc->ccdc_cfg.if_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
