...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long peer_number = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int _len_g0 = 1;
          struct TYPE_5__ * g = (struct TYPE_5__ *) malloc(_len_g0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_g0; _i0++) {
              g[_i0].numpeers = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_g__i0__group0 = 1;
          g[_i0].group = (struct TYPE_4__ *) malloc(_len_g__i0__group0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_g__i0__group0; _j0++) {
              g[_i0].group->peer_number = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          int benchRet = get_peer_index(g,peer_number);
          printf("%d\n", benchRet); 
