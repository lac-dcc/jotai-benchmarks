...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_opts0; _i0++) {
            opts->monitor_pixel_aspect = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        opts->force_monitor_aspect = ((-2 * (next_i()%2)) + 1) * next_i();
          }
