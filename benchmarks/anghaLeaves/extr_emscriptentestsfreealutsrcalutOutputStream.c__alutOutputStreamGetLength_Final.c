...
/* Type definitions */
struct TYPE_3__ {size_t current; size_t data; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
            stream[_i0].current = ((-2 * (next_i()%2)) + 1) * next_i();
        stream[_i0].data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = _alutOutputStreamGetLength(stream);
          printf("%lu\n", benchRet); 
          free(stream);
