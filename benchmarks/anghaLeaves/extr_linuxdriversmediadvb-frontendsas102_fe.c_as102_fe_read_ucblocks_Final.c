...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
            fe[_i0].demodulator_priv->demod_stats.bad_frame_count = ((-2 * (next_i()%2)) + 1) * next_i();
        fe[_i0].demodulator_priv->demod_stats.has_started = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          int benchRet = as102_fe_read_ucblocks(fe,ucblocks);
          printf("%d\n", benchRet); 
