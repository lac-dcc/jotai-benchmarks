...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          float znear = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          float zfar = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          ...
          mat_frustum(matrix,left,right,bottom,top,znear,zfar);
          free(matrix);
