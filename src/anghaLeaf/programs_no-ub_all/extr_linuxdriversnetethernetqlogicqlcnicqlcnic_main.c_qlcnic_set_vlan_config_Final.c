...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter->tx_pvid = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->rx_pvid = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_esw_cfg0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_esw_cfg0; _i0++) {
            esw_cfg->vlan_id = ((-2 * (next_i()%2)) + 1) * next_i();
        esw_cfg->discard_tagged = ((-2 * (next_i()%2)) + 1) * next_i();
          }
