...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__crypto_ctx0; _j0++) {
              int _len_ctx__i0__crypto_ctx_hmacctx0 = 1;
          ctx[_i0].crypto_ctx->hmacctx = (struct hmac_ctx *) malloc(_len_ctx__i0__crypto_ctx_hmacctx0*sizeof(struct hmac_ctx));
          for(int _j0 = 0; _j0 < _len_ctx__i0__crypto_ctx_hmacctx0; _j0++) {
            ctx[_i0].crypto_ctx->hmacctx->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct hmac_ctx * benchRet = HMAC_CTX(ctx);
          printf("%d\n", (*benchRet).dummy);
