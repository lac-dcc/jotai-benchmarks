...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_par0; _i0++) {
            par->cursor_heap.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        par->cursor_heap.virtual = ((-2 * (next_i()%2)) + 1) * next_i();
        par->aperture.virtual = ((-2 * (next_i()%2)) + 1) * next_i();
        par->aperture.physical = ((-2 * (next_i()%2)) + 1) * next_i();
        par->iring.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        par->iring.virtual = ((-2 * (next_i()%2)) + 1) * next_i();
        par->iring.physical = ((-2 * (next_i()%2)) + 1) * next_i();
        par->fb.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        par->fb.virtual = ((-2 * (next_i()%2)) + 1) * next_i();
        par->fb.physical = ((-2 * (next_i()%2)) + 1) * next_i();
          }
