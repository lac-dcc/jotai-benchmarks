...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_w10; _i0++) {
            w1[_i0].signum = ((-2 * (next_i()%2)) + 1) * next_i();
        w1[_i0].flags = ((-2 * (next_i()%2)) + 1) * next_i();
        w1[_i0].loop = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_w20 = 1;
          struct TYPE_4__ * w2 = (struct TYPE_4__ *) malloc(_len_w20*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_w20; _i0++) {
            w2[_i0].signum = ((-2 * (next_i()%2)) + 1) * next_i();
        w2[_i0].flags = ((-2 * (next_i()%2)) + 1) * next_i();
        w2[_i0].loop = ((-2 * (next_i()%2)) + 1) * next_i();
          }
