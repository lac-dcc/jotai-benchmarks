...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_llist0; _i0++) {
              int _len_llist__i0__tail0 = 1;
          llist[_i0].tail = (struct TYPE_4__ *) malloc(_len_llist__i0__tail0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_llist__i0__tail0; _j0++) {
            llist[_i0].tail->data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = spl_ptr_llist_last(llist);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_llist0; _aux++) {
          free(llist[_aux].tail);
          }
          free(llist);
