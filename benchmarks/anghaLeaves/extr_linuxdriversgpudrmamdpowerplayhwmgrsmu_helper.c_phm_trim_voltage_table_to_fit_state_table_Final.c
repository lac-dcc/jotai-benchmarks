...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct pp_atomctrl_voltage_table * vol_table = (struct pp_atomctrl_voltage_table *) malloc(_len_vol_table0*sizeof(struct pp_atomctrl_voltage_table));
          ...
          phm_trim_voltage_table_to_fit_state_table(max_vol_steps,vol_table);
