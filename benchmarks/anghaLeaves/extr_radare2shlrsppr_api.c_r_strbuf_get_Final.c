...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sb0; _i0++) {
              int _len_sb__i0__ptr0 = 1;
          sb[_i0].ptr = (char *) malloc(_len_sb__i0__ptr0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_sb__i0__ptr0; _j0++) {
            sb[_i0].ptr[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
