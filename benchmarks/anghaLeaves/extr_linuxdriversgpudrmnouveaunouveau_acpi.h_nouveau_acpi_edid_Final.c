...
__attribute__((used)) static inline void *nouveau_acpi_edid(struct drm_device *dev, struct drm_connector *connector) { return NULL; }
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          void * benchRet = nouveau_acpi_edid(dev,connector);
          free(dev);
          free(connector);
