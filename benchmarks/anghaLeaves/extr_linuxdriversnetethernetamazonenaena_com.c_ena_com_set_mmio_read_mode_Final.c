...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ena_dev0; _i0++) {
              ena_dev[_i0].mmio_read.readless_supported = ((-2 * (next_i()%2)) + 1) * next_i();
    ...
    case 3:
    {
          ...
          int readless_supported = ((-2 * (next_i()%2)) + 1) * next_i();
