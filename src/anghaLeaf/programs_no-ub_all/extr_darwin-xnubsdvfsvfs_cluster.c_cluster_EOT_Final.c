...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cbp_head0; _i0++) {
            cbp_head->b_validend = ((-2 * (next_i()%2)) + 1) * next_i();
        cbp_head->b_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_cbp_tail0; _i0++) {
            cbp_tail->b_validend = ((-2 * (next_i()%2)) + 1) * next_i();
        cbp_tail->b_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
