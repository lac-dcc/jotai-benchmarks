...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_pt0 = 1;
          struct pool_c * pt = (struct pool_c *) malloc(_len_pt0*sizeof(struct pool_c));
          for(int _i0 = 0; _i0 < _len_pt0; _i0++) {
            pt[_i0].adjusted_pf.discard_passdown = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = passdown_enabled(pt);
          printf("%d\n", benchRet); 
          free(pt);
