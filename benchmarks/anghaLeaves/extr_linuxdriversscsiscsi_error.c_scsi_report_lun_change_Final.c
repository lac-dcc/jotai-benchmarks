...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sdev0; _i0++) {
              int _len_sdev__i0__sdev_target0 = 1;
          sdev[_i0].sdev_target = (struct TYPE_2__ *) malloc(_len_sdev__i0__sdev_target0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_sdev__i0__sdev_target0; _j0++) {
            sdev[_i0].sdev_target->expecting_lun_change = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          scsi_report_lun_change(sdev);
          for(int _aux = 0; _aux < _len_sdev0; _aux++) {
          free(sdev[_aux].sdev_target);
          }
          free(sdev);
