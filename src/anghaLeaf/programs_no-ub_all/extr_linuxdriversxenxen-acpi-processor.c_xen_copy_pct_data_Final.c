...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pct0; _i0++) {
            pct->address = ((-2 * (next_i()%2)) + 1) * next_i();
        pct->reserved = ((-2 * (next_i()%2)) + 1) * next_i();
        pct->bit_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        pct->bit_width = ((-2 * (next_i()%2)) + 1) * next_i();
        pct->space_id = ((-2 * (next_i()%2)) + 1) * next_i();
        pct->length = ((-2 * (next_i()%2)) + 1) * next_i();
        pct->descriptor = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dst_pct0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_dst_pct0; _i0++) {
            dst_pct->address = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_pct->reserved = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_pct->bit_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_pct->bit_width = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_pct->space_id = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_pct->length = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_pct->descriptor = ((-2 * (next_i()%2)) + 1) * next_i();
          }
