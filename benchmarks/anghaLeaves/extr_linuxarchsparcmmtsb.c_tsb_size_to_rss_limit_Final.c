...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long new_size = 100;
        
          unsigned long benchRet = tsb_size_to_rss_limit(new_size);
          printf("%lu\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long new_size = ((-2 * (next_i()%2)) + 1) * next_i();
