...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phydev0; _i0++) {
            phydev[_i0].lp_advertising = ((-2 * (next_i()%2)) + 1) * next_i();
        phydev[_i0].advertising = ((-2 * (next_i()%2)) + 1) * next_i();
        phydev[_i0].duplex = ((-2 * (next_i()%2)) + 1) * next_i();
        phydev[_i0].pause = ((-2 * (next_i()%2)) + 1) * next_i();
        phydev[_i0].asym_pause = ((-2 * (next_i()%2)) + 1) * next_i();
          }
