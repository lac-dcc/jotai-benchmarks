...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sc0; _i0++) {
            sc->rx.ampdu_ref = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rs0 = 1;
          struct ath_rx_status * rs = (struct ath_rx_status *) malloc(_len_rs0*sizeof(struct ath_rx_status));
          for(int _i0 = 0; _i0 < _len_rs0; _i0++) {
            rs->rs_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        rs->rs_moreaggr = ((-2 * (next_i()%2)) + 1) * next_i();
        rs->rs_isaggr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rxs0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_rxs0; _i0++) {
            rxs->flag = ((-2 * (next_i()%2)) + 1) * next_i();
        rxs->ampdu_reference = ((-2 * (next_i()%2)) + 1) * next_i();
          }
