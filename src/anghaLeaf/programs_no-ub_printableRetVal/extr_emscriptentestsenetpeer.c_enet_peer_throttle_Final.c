...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_peer0; _i0++) {
            peer->lastRoundTripTime = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->lastRoundTripTimeVariance = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->packetThrottle = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->packetThrottleLimit = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->packetThrottleAcceleration = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->packetThrottleDeceleration = ((-2 * (next_i()%2)) + 1) * next_i();
          }
