...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p0 = 1;
          struct bnx2x_rx_mode_ramrod_params * p = (struct bnx2x_rx_mode_ramrod_params *) malloc(_len_p0*sizeof(struct bnx2x_rx_mode_ramrod_params));
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = bnx2x_empty_rx_mode_wait(bp,p);
          printf("%d\n", benchRet); 
          free(bp);
          free(p);
