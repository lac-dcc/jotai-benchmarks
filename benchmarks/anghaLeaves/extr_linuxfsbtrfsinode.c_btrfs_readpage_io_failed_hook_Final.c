...
__attribute__((used)) __attribute__((const))
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = btrfs_readpage_io_failed_hook(page,failed_mirror);
          printf("%d\n", benchRet); 
          free(page);
    ...
    case 3:
    {
          ...
          int failed_mirror = ((-2 * (next_i()%2)) + 1) * next_i();
