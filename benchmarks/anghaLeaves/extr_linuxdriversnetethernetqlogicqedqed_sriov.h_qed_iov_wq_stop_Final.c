...
__attribute__((used)) static inline void qed_iov_wq_stop(struct qed_dev *cdev, bool schedule_first)
{
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          qed_iov_wq_stop(cdev,schedule_first);
          free(cdev);
