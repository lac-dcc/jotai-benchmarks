...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_minfo0; _i0++) {
            minfo->values.reg.opt = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.opt2 = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.opt3 = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.mctlwtst_core = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.mctlwtst = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.memmisc = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.memrdbk = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.reg.maccess = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.memory.ddr = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.memory.dll = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.memory.emrswen = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.pll.system = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->values.pll.video = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->features.pll.ref_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->limits.video.vcomax = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->limits.video.vcomin = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->limits.system.vcomax = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->limits.system.vcomin = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->limits.pixel.vcomax = ((-2 * (next_i()%2)) + 1) * next_i();
        minfo->limits.pixel.vcomin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          default_pins5(minfo);
          free(minfo);
