...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int clk = 100;
        
          int _len_a0 = 1;
          struct TYPE_3__ * a = (struct TYPE_3__ *) malloc(_len_a0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_a0; _i0++) {
              a[_i0].__attr = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = pthread_condattr_setclock(a,clk);
          printf("%d\n", benchRet); 
          free(a);
    ...
    case 3:
    {
          ...
          unsigned int clk = ((-2 * (next_i()%2)) + 1) * next_i();
