...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_effect0; _i0++) {
            effect->u.ramp.start_level = ((-2 * (next_i()%2)) + 1) * next_i();
        effect->u.ramp.end_level = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_old0 = 1;
          struct ff_effect * old = (struct ff_effect *) malloc(_len_old0*sizeof(struct ff_effect));
          for(int _i0 = 0; _i0 < _len_old0; _i0++) {
            old->u.ramp.start_level = ((-2 * (next_i()%2)) + 1) * next_i();
        old->u.ramp.end_level = ((-2 * (next_i()%2)) + 1) * next_i();
          }
