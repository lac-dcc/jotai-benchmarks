...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_filter0; _i0++) {
            filter->u.ipv4.dst_port = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->u.ipv4.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->u.ipv4.dst_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->u.ipv4.protocol = ((-2 * (next_i()%2)) + 1) * next_i();
