...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_filter0; _i0++) {
            filter->u.usnic.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->u.usnic.proto_version = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->u.usnic.usnic_id = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->u.usnic.ethtype = ((-2 * (next_i()%2)) + 1) * next_i();
        filter->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
