...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_link0 = 1;
          struct qed_mcp_link_state * p_link = (struct qed_mcp_link_state *) malloc(_len_p_link0*sizeof(struct qed_mcp_link_state));
          for(int _i0 = 0; _i0 < _len_p_link0; _i0++) {
            p_link[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
