...
__attribute__((used)) static inline void debugfs_init(struct ser_device *ser, struct tty_struct *tty)
{
}
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ser0 = 1;
          struct ser_device * ser = (struct ser_device *) malloc(_len_ser0*sizeof(struct ser_device));
