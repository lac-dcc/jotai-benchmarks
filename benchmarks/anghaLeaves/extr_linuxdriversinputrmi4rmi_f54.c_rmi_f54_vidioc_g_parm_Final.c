...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_a0 = 65025;
          struct v4l2_streamparm * a = (struct v4l2_streamparm *) malloc(_len_a0*sizeof(struct v4l2_streamparm));
          for(int _i0 = 0; _i0 < _len_a0; _i0++) {
              a[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          a[_i0].parm.capture.readbuffers = ((-2 * (next_i()%2)) + 1) * next_i();
          a[_i0].parm.capture.timeperframe.numerator = ((-2 * (next_i()%2)) + 1) * next_i();
          a[_i0].parm.capture.timeperframe.denominator = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = rmi_f54_vidioc_g_parm(file,fh,a);
          printf("%d\n", benchRet); 
          free(file);
          free(a);
