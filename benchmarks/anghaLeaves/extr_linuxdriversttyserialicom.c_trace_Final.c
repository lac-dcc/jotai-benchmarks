...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_icom_port0; _i0++) {
            icom_port[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_trace_pt0 = 1;
          char * trace_pt = (char *) malloc(_len_trace_pt0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_trace_pt0; _i0++) {
            trace_pt[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          trace(icom_port,trace_pt,trace_data);
          free(icom_port);
          free(trace_pt);
