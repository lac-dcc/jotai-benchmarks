...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned int fw_mod_type = 100;
        
          int benchRet = t4_is_inserted_mod_type(fw_mod_type);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          unsigned int fw_mod_type = ((-2 * (next_i()%2)) + 1) * next_i();
