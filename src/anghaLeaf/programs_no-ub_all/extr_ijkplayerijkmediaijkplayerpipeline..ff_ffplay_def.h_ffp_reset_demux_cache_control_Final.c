...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dcc0; _i0++) {
            dcc->last_high_water_mark_in_ms = ((-2 * (next_i()%2)) + 1) * next_i();
        dcc->next_high_water_mark_in_ms = ((-2 * (next_i()%2)) + 1) * next_i();
        dcc->high_water_mark_in_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        dcc->max_buffer_size = ((-2 * (next_i()%2)) + 1) * next_i();
        dcc->min_frames = ((-2 * (next_i()%2)) + 1) * next_i();
          }
