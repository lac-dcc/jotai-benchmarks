...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_msi0; _i0++) {
              msi[_i0].nr_irqs = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          unsigned long benchRet = hwirq_to_group(msi,hwirq);
          printf("%lu\n", benchRet); 
          free(msi);
    ...
    case 3:
    {
          ...
          unsigned long hwirq = ((-2 * (next_i()%2)) + 1) * next_i();
