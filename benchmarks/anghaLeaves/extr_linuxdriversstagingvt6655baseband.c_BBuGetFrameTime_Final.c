...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          ...
          unsigned char byPreambleType = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned char byPktType = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int cbFrameLength = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned short wRate = ((-2 * (next_i()%2)) + 1) * next_i();
