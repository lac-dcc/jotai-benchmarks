...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_int_pkt0; _i0++) {
            int_pkt->int_desc.vector_count = ((-2 * (next_i()%2)) + 1) * next_i();
        int_pkt->int_desc.cpu_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        int_pkt->int_desc.delivery_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        int_pkt->int_desc.vector = ((-2 * (next_i()%2)) + 1) * next_i();
        int_pkt->wslot.slot = ((-2 * (next_i()%2)) + 1) * next_i();
        int_pkt->message_type.type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_affinity0; _i0++) {
            affinity->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
