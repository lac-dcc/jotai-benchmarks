...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_remote0; _i0++) {
              remote[_i0].configured_in_repo = ((-2 * (next_i()%2)) + 1) * next_i();
          remote[_i0].origin = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = remote_is_configured(remote,in_repo);
          printf("%d\n", benchRet); 
          free(remote);
    ...
    case 3:
    {
          ...
          int in_repo = ((-2 * (next_i()%2)) + 1) * next_i();
