...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
              int _len_c__i0__widget0 = 1;
          c[_i0].widget = (int *) malloc(_len_c__i0__widget0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_c__i0__widget0; _j0++) {
            c[_i0].widget[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = uiprivChildWidget(c);
          printf("%d\n", (*benchRet)); 
