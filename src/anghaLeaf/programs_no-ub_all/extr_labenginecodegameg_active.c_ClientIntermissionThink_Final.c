...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_client0; _i0++) {
            client->oldbuttons = ((-2 * (next_i()%2)) + 1) * next_i();
        client->buttons = ((-2 * (next_i()%2)) + 1) * next_i();
        client->readyToExit = ((-2 * (next_i()%2)) + 1) * next_i();
        client->pers.cmd.buttons = ((-2 * (next_i()%2)) + 1) * next_i();
        client->ps.eFlags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
