...
__attribute__((used)) static int request_key_auth_preparse(struct key_preparsed_payload *prep)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_prep0; _i0++) {
            prep[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = request_key_auth_preparse(prep);
          printf("%d\n", benchRet); 
          free(prep);
