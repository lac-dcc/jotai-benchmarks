...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_data0 = 1;
          struct vsock_transport_send_notify_data * data = (struct vsock_transport_send_notify_data *) malloc(_len_data0*sizeof(struct vsock_transport_send_notify_data));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = virtio_transport_notify_send_post_enqueue(vsk,written,data);
          printf("%d\n", benchRet); 
          free(vsk);
          free(data);
