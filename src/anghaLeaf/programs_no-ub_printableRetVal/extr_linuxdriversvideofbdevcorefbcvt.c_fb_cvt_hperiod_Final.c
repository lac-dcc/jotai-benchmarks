...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cvt0; _i0++) {
            cvt->f_refresh = ((-2 * (next_i()%2)) + 1) * next_i();
        cvt->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        cvt->yres = ((-2 * (next_i()%2)) + 1) * next_i();
        cvt->interlace = ((-2 * (next_i()%2)) + 1) * next_i();
        cvt->v_margin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
