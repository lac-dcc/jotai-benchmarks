...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hash0; _i0++) {
            hash[_i0].cbData = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_hash__i0__pbData0 = 1;
          hash[_i0].pbData = (int *) malloc(_len_hash__i0__pbData0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_hash__i0__pbData0; _j0++) {
            hash[_i0].pbData[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          CRYPT_ReverseBytes(hash);
          for(int _aux = 0; _aux < _len_hash0; _aux++) {
          free(hash[_aux].pbData);
          }
          free(hash);
