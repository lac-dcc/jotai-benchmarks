...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 6483
          // ------------------------------- 
          // static_instructions_O1 : 22
          // dynamic_instructions_O1 : 2752
          // ------------------------------- 
          // static_instructions_O2 : 22
          // dynamic_instructions_O2 : 2752
          // ------------------------------- 
          // static_instructions_O3 : 22
          // dynamic_instructions_O3 : 2752
          // ------------------------------- 
          // static_instructions_Ofast : 22
          // dynamic_instructions_Ofast : 2752
          // ------------------------------- 
          // static_instructions_Os : 20
          // dynamic_instructions_Os : 2528
          // ------------------------------- 
          // static_instructions_Oz : 19
          // dynamic_instructions_Oz : 2783
          // ------------------------------- 

          int nr = 255;
        
          int _len_ref_status0 = 65025;
          int * ref_status = (int *) malloc(_len_ref_status0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_ref_status0; _i0++) {
            ref_status[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int _len_bitmap0 = 65025;
          unsigned int * bitmap = (unsigned int *) malloc(_len_bitmap0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_bitmap0; _i0++) {
            bitmap[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          update_refstatus(ref_status,nr,bitmap);
          free(ref_status);
          free(bitmap);
