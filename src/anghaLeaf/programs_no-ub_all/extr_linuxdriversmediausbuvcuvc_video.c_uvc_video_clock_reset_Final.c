...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
            stream->clock.last_sof = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->clock.sof_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->clock.count = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->clock.head = ((-2 * (next_i()%2)) + 1) * next_i();
          }
