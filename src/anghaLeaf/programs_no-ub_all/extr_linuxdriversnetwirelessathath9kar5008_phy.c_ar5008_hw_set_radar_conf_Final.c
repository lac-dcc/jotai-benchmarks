...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ah0; _i0++) {
            ah->radar_conf.fir_power = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.radar_rssi = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.pulse_height = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.pulse_rssi = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.pulse_inband = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.pulse_maxlen = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.pulse_inband_step = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->radar_conf.radar_inband = ((-2 * (next_i()%2)) + 1) * next_i();
          }
