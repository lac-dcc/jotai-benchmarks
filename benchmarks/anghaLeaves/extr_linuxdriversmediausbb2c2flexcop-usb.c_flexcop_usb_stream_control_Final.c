...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int onoff = 100;
          int _len_fc0 = 1;
          struct flexcop_device * fc = (struct flexcop_device *) malloc(_len_fc0*sizeof(struct flexcop_device));
          for(int _i0 = 0; _i0 < _len_fc0; _i0++) {
            fc[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = flexcop_usb_stream_control(fc,onoff);
          printf("%d\n", benchRet); 
          free(fc);
