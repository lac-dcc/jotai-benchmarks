...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_gspca_dev0; _i0++) {
              gspca_dev[_i0].pixfmt.width = ((-2 * (next_i()%2)) + 1) * next_i();
          gspca_dev[_i0].pixfmt.height = ((-2 * (next_i()%2)) + 1) * next_i();
        
          gspca_dev[_i0].cam.bulk_nurbs = ((-2 * (next_i()%2)) + 1) * next_i();
          gspca_dev[_i0].cam.bulk_size = ((-2 * (next_i()%2)) + 1) * next_i();
