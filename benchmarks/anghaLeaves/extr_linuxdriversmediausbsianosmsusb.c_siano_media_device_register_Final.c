...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int board_id = 100;
          int _len_dev0 = 1;
          struct smsusb_device_t * dev = (struct smsusb_device_t *) malloc(_len_dev0*sizeof(struct smsusb_device_t));
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = siano_media_device_register(dev,board_id);
          free(dev);
