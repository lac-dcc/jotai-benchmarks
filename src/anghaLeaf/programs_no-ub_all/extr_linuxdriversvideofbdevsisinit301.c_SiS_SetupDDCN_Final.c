...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_SiS_Pr0; _i0++) {
            SiS_Pr->SiS_DDC_NData = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_DDC_Data = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_DDC_NClk = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_DDC_Clk = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_DDC_Index = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_SensibleSR11 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
