...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          double completion = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          unsigned int benchRet = convertCompletionToChange(completion);
          printf("%u\n", benchRet); 
