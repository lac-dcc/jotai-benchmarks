...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vif0; _i0++) {
            vif->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_params0 = 1;
          struct ieee80211_ampdu_params * params = (struct ieee80211_ampdu_params *) malloc(_len_params0*sizeof(struct ieee80211_ampdu_params));
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = cw1200_ampdu_action(hw,vif,params);
          printf("%d\n", benchRet); 
          free(hw);
          free(vif);
          free(params);
