...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_s0 = 1;
          struct mxs_auart_port * s = (struct mxs_auart_port *) malloc(_len_s0*sizeof(struct mxs_auart_port));
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s[_i0].devtype = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_asm9260_auart(s);
          printf("%d\n", benchRet); 
          free(s);
