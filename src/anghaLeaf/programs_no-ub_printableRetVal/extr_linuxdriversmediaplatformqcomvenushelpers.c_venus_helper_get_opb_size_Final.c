...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_inst0; _i0++) {
            inst->session_type = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->output_buf_size = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->opb_buftype = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->output2_buf_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
