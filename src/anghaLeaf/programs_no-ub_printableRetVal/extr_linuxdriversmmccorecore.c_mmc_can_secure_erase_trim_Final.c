...
/* Variables and functions */
 ...
 int MMC_QUIRK_SEC_ERASE_TRIM_BROKEN ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
            card->quirks = ((-2 * (next_i()%2)) + 1) * next_i();
        card->ext_csd.sec_feature_support = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = mmc_can_secure_erase_trim(card);
          printf("%d\n", benchRet); 
          free(card);
