...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int size = 100;
          int _len_hw0 = 1;
          struct hermes * hw = (struct hermes *) malloc(_len_hw0*sizeof(struct hermes));
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
            hw[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_fid0 = 1;
          int * fid = (int *) malloc(_len_fid0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_fid0; _i0++) {
            fid[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ezusb_allocate(hw,size,fid);
          printf("%d\n", benchRet); 
          free(hw);
          free(fid);
