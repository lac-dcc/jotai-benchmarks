...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q0; _i0++) {
            q->current_import_jobs_time = ((-2 * (next_i()%2)) + 1) * next_i();
        q->prev_import_jobs_time = ((-2 * (next_i()%2)) + 1) * next_i();
        q->current_import_jobs_count = ((-2 * (next_i()%2)) + 1) * next_i();
        q->prev_import_jobs_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
