...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_asset0; _i0++) {
            asset->asset_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->asset_size = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->extension_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->core_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->core_size = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->xbr_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->xbr_size = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->xxch_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->xxch_size = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->x96_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->x96_size = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->lbr_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->lbr_size = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->xll_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        asset->xll_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
