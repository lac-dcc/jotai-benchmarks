...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_processor0; _i0++) {
            processor->current_perfctl_class = ((-2 * (next_i()%2)) + 1) * next_i();
        processor->current_recommended_pset_type = ((-2 * (next_i()%2)) + 1) * next_i();
        processor->current_sfi_class = ((-2 * (next_i()%2)) + 1) * next_i();
        processor->current_pri = ((-2 * (next_i()%2)) + 1) * next_i();
          }
