...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pb0 = 1;
          struct TYPE_3__ * pb = (struct TYPE_3__ *) malloc(_len_pb0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_pb0; _i0++) {
              pb[_i0].progress_cb = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          void * progress_cb_payload;
        
          int benchRet = git_packbuilder_set_callbacks(pb,progress_cb,progress_cb_payload);
          printf("%d\n", benchRet); 
          free(pb);
    ...
    case 3:
    {
          ...
          int progress_cb = ((-2 * (next_i()%2)) + 1) * next_i();
