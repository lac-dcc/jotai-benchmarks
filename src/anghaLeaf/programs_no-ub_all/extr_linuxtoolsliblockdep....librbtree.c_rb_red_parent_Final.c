...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_red0 = 1;
          struct rb_node * red = (struct rb_node *) malloc(_len_red0*sizeof(struct rb_node));
          for(int _i0 = 0; _i0 < _len_red0; _i0++) {
            red->__rb_parent_color = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct rb_node * benchRet = rb_red_parent(red);
          printf("{{struct}} %p\n", &benchRet); 
          free(red);
