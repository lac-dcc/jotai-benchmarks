...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hbqmb0; _i0++) {
            hbqmb->profiles.profile2.seqlenoff = ((-2 * (next_i()%2)) + 1) * next_i();
        hbqmb->profiles.profile2.maxlen = ((-2 * (next_i()%2)) + 1) * next_i();
        hbqmb->profiles.profile2.seqlenbcnt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_hbq_desc0; _i0++) {
            hbq_desc->seqlenoff = ((-2 * (next_i()%2)) + 1) * next_i();
        hbq_desc->maxlen = ((-2 * (next_i()%2)) + 1) * next_i();
        hbq_desc->seqlenbcnt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
