...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fattr0; _i0++) {
            fattr->cf_cifsattrs = ((-2 * (next_i()%2)) + 1) * next_i();
        fattr->cf_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        fattr->cf_eof = ((-2 * (next_i()%2)) + 1) * next_i();
        fattr->cf_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        fattr->cf_dtype = ((-2 * (next_i()%2)) + 1) * next_i();
        fattr->cf_gid = ((-2 * (next_i()%2)) + 1) * next_i();
        fattr->cf_uid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cifs_sb0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_cifs_sb0; _i0++) {
            cifs_sb->mnt_dir_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        cifs_sb->mnt_file_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        cifs_sb->mnt_cifs_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        cifs_sb->mnt_gid = ((-2 * (next_i()%2)) + 1) * next_i();
        cifs_sb->mnt_uid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
