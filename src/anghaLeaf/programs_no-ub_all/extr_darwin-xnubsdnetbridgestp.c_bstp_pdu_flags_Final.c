...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bp0; _i0++) {
            bp->bp_state = ((-2 * (next_i()%2)) + 1) * next_i();
        bp->bp_role = ((-2 * (next_i()%2)) + 1) * next_i();
        bp->bp_protover = ((-2 * (next_i()%2)) + 1) * next_i();
        bp->bp_tc_ack = ((-2 * (next_i()%2)) + 1) * next_i();
        bp->bp_tc_timer.active = ((-2 * (next_i()%2)) + 1) * next_i();
        bp->bp_agree = ((-2 * (next_i()%2)) + 1) * next_i();
        bp->bp_proposing = ((-2 * (next_i()%2)) + 1) * next_i();
          }
