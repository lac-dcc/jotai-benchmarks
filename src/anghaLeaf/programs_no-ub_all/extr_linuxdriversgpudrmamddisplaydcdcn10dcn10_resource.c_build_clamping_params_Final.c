...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
            stream->timing.pixel_encoding = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->timing.display_color_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->clamping.pixel_encoding = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->clamping.c_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->clamping.clamping_level = ((-2 * (next_i()%2)) + 1) * next_i();
          }
