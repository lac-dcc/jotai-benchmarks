...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_string__i0__str0 = 1;
          string[_i0].str = (long *) malloc(_len_string__i0__str0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_string__i0__str0; _j0++) {
            string[_i0].str[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          simplestring_clear(string);
          for(int _aux = 0; _aux < _len_string0; _aux++) {
          free(string[_aux].str);
          }
          free(string);
