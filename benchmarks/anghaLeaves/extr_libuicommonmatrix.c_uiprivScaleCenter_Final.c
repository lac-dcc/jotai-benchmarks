...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          double xCenter = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          double yCenter = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          int _len_x0 = 1;
          ...
          int _len_y0 = 1;
          double * y = (double *) malloc(_len_y0*sizeof(double));
          ...
          uiprivScaleCenter(xCenter,yCenter,x,y);
          free(x);
          free(y);
