...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long ssize = 100;
          int benchRet = SetSockBufSize(sockfd,rsize,ssize);
          printf("%d\n", benchRet); 
    ...
    {
          int sockfd = 255;
          unsigned long rsize = 255;
          unsigned long ssize = 255;
          int benchRet = SetSockBufSize(sockfd,rsize,ssize);
          printf("%d\n", benchRet); 
    ...
    {
          int sockfd = 10;
          unsigned long rsize = 10;
          unsigned long ssize = 10;
          int benchRet = SetSockBufSize(sockfd,rsize,ssize);
          printf("%d\n", benchRet); 
