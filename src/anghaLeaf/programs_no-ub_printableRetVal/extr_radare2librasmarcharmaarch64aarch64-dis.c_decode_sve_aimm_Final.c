...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->imm.value = ((-2 * (next_i()%2)) + 1) * next_i();
        info->shifter.amount = ((-2 * (next_i()%2)) + 1) * next_i();
        info->shifter.operator_present = ((-2 * (next_i()%2)) + 1) * next_i();
        info->shifter.amount_present = ((-2 * (next_i()%2)) + 1) * next_i();
        info->shifter.kind = ((-2 * (next_i()%2)) + 1) * next_i();
          }
