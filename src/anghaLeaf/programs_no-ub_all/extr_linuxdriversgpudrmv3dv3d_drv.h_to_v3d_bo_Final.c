...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_bo0 = 1;
          struct drm_gem_object * bo = (struct drm_gem_object *) malloc(_len_bo0*sizeof(struct drm_gem_object));
          for(int _i0 = 0; _i0 < _len_bo0; _i0++) {
            bo->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct v3d_bo * benchRet = to_v3d_bo(bo);
          printf("{{struct}} %p\n", &benchRet); 
          free(bo);
