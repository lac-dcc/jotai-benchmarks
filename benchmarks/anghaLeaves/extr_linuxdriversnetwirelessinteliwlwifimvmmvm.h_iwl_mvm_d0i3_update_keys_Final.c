...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_status0 = 1;
          struct iwl_wowlan_status * status = (struct iwl_wowlan_status *) malloc(_len_status0*sizeof(struct iwl_wowlan_status));
          for(int _i0 = 0; _i0 < _len_status0; _i0++) {
            status[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          iwl_mvm_d0i3_update_keys(mvm,vif,status);
          free(mvm);
          free(vif);
          free(status);
