    ...
    case 0:
    {
        ...
        p->btMode = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_vTable0; _i0++) {
            vTable->GetPointerToCurrentPos = ((-2 * (next_i()%2)) + 1) * next_i();
        vTable->GetNumAvailableBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        vTable->GetIndexByte = ((-2 * (next_i()%2)) + 1) * next_i();
        vTable->Init = ((-2 * (next_i()%2)) + 1) * next_i();
          }
