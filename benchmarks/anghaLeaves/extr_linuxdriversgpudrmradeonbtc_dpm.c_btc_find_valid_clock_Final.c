...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          long max_clock = ((-2 * (next_i()%2)) + 1) * next_i();
        
          long requested_clock = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int _len_clocks0 = 1;
          struct radeon_clock_array * clocks = (struct radeon_clock_array *) malloc(_len_clocks0*sizeof(struct radeon_clock_array));
