...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long wParam = 100;
        
          const char * benchRet = SPY_GetVKeyName(wParam);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          ...
          unsigned long wParam = ((-2 * (next_i()%2)) + 1) * next_i();
