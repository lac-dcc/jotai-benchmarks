...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        adapter->num_txd = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->max_jumbo_rxd = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->num_jumbo_rxd = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->max_rxd = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->num_rxd = ((-2 * (next_i()%2)) + 1) * next_i();
          }
