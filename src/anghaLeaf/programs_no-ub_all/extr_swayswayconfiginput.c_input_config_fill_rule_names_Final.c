...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ic0; _i0++) {
            ic->xkb_variant = ((-2 * (next_i()%2)) + 1) * next_i();
        ic->xkb_rules = ((-2 * (next_i()%2)) + 1) * next_i();
        ic->xkb_options = ((-2 * (next_i()%2)) + 1) * next_i();
        ic->xkb_model = ((-2 * (next_i()%2)) + 1) * next_i();
        ic->xkb_layout = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rules0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_rules0; _i0++) {
            rules->variant = ((-2 * (next_i()%2)) + 1) * next_i();
        rules->rules = ((-2 * (next_i()%2)) + 1) * next_i();
        rules->options = ((-2 * (next_i()%2)) + 1) * next_i();
        rules->model = ((-2 * (next_i()%2)) + 1) * next_i();
        rules->layout = ((-2 * (next_i()%2)) + 1) * next_i();
          }
