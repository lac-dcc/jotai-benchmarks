...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ac0; _i0++) {
            ac[_i0].session = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_hdr0 = 1;
          struct apr_hdr * hdr = (struct apr_hdr *) malloc(_len_hdr0*sizeof(struct apr_hdr));
          for(int _i0 = 0; _i0 < _len_hdr0; _i0++) {
            hdr[_i0].src_port = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr[_i0].dest_port = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr[_i0].pkt_size = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr[_i0].token = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr[_i0].hdr_field = ((-2 * (next_i()%2)) + 1) * next_i();
          }
