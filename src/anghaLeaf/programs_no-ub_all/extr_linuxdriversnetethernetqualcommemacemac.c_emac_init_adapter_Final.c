...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adpt0; _i0++) {
            adpt->irq_mod = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->automatic = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->single_pause_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->preamble = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->rfd_burst = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->tpd_burst = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->dmaw_dly_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->dmar_dly_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->dmaw_block = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->dmar_block = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->dma_order = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->rx_desc_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->tx_desc_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->rfd_size = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->tpd_size = ((-2 * (next_i()%2)) + 1) * next_i();
        adpt->rrd_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
