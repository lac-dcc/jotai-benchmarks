...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_packet0 = 1;
          struct arm_spe_pkt * packet = (struct arm_spe_pkt *) malloc(_len_packet0*sizeof(struct arm_spe_pkt));
          for(int _i0 = 0; _i0 < _len_packet0; _i0++) {
            packet->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = arm_spe_get_pad(packet);
          printf("%d\n", benchRet); 
          free(packet);
