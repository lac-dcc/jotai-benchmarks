...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        p->tdes23.tx_rd_des23.tcp_hdr_len = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tdes23.tx_rd_des23.tx_pkt_len.tcp_payload_len = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tdes23.tx_rd_des23.tse_bit = ((-2 * (next_i()%2)) + 1) * next_i();
          }
