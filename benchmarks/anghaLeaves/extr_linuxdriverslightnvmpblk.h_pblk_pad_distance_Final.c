...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_pblk__i0__dev0; _j0++) {
              pblk[_i0].dev->geo.mw_cunits = ((-2 * (next_i()%2)) + 1) * next_i();
          pblk[_i0].dev->geo.all_luns = ((-2 * (next_i()%2)) + 1) * next_i();
          pblk[_i0].dev->geo.ws_opt = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = pblk_pad_distance(pblk);
          printf("%d\n", benchRet); 
