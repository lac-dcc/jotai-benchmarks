...
__attribute__((used)) static int vfb_setcolreg(u_int regno, u_int red, u_int green, u_int blue,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->pseudo_palette = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.bits_per_pixel = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.transp.length = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.transp.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.blue.length = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.blue.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.green.length = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.green.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.red.length = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.red.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        info->var.grayscale = ((-2 * (next_i()%2)) + 1) * next_i();
        info->fix.visual = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = vfb_setcolreg(regno,red,green,blue,transp,info);
          printf("%d\n", benchRet); 
          free(info);
