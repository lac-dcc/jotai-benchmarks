...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_psmouse0; _i0++) {
            psmouse->state = ((-2 * (next_i()%2)) + 1) * next_i();
        psmouse->last = ((-2 * (next_i()%2)) + 1) * next_i();
        psmouse->ps2dev.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        psmouse->out_of_sync_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        psmouse->pktcnt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
