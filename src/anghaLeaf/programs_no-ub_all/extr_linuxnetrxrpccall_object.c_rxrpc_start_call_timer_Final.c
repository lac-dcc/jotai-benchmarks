...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_call0; _i0++) {
            call->ack_at = ((-2 * (next_i()%2)) + 1) * next_i();
        call->ack_lost_at = ((-2 * (next_i()%2)) + 1) * next_i();
        call->resend_at = ((-2 * (next_i()%2)) + 1) * next_i();
        call->ping_at = ((-2 * (next_i()%2)) + 1) * next_i();
        call->expect_rx_by = ((-2 * (next_i()%2)) + 1) * next_i();
        call->expect_req_by = ((-2 * (next_i()%2)) + 1) * next_i();
        call->expect_term_by = ((-2 * (next_i()%2)) + 1) * next_i();
        call->timer.expires = ((-2 * (next_i()%2)) + 1) * next_i();
          }
