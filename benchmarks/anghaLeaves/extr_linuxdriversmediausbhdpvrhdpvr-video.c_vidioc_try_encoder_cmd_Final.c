...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_a0 = 65025;
          struct v4l2_encoder_cmd * a = (struct v4l2_encoder_cmd *) malloc(_len_a0*sizeof(struct v4l2_encoder_cmd));
          for(int _i0 = 0; _i0 < _len_a0; _i0++) {
              a[_i0].cmd = ((-2 * (next_i()%2)) + 1) * next_i();
          a[_i0].flags = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = vidioc_try_encoder_cmd(filp,priv,a);
          printf("%d\n", benchRet); 
          free(filp);
          free(a);
