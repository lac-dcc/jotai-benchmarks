...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_link0; _i0++) {
            link->symmetric_rates = ((-2 * (next_i()%2)) + 1) * next_i();
        link->symmetric_channels = ((-2 * (next_i()%2)) + 1) * next_i();
        link->symmetric_samplebits = ((-2 * (next_i()%2)) + 1) * next_i();
        link->ignore_suspend = ((-2 * (next_i()%2)) + 1) * next_i();
          }
