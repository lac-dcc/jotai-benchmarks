...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ssPtr0; _i0++) {
            ssPtr->longLengthID = ((-2 * (next_i()%2)) + 1) * next_i();
        ssPtr->sequencesStart = ((-2 * (next_i()%2)) + 1) * next_i();
        ssPtr->sequences = ((-2 * (next_i()%2)) + 1) * next_i();
        ssPtr->litStart = ((-2 * (next_i()%2)) + 1) * next_i();
        ssPtr->lit = ((-2 * (next_i()%2)) + 1) * next_i();
          }
