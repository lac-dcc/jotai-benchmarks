...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_column0; _i0++) {
              int _len_column__i0__values0 = 1;
          column[_i0].values = (int *) malloc(_len_column__i0__values0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_column__i0__values0; _j0++) {
            column[_i0].values[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = sqliterkColumnGetValues(column);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_column0; _aux++) {
          free(column[_aux].values);
          }
          free(column);
