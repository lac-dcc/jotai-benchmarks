...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_params0 = 1;
          struct qed_mcp_link_params * params = (struct qed_mcp_link_params *) malloc(_len_params0*sizeof(struct qed_mcp_link_params));
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          qed_vf_get_link_params(p_hwfn,params);
          free(p_hwfn);
          free(params);
