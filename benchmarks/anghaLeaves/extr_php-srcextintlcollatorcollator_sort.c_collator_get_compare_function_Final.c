...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          const int sort_flags = 100;
        
          int benchRet = collator_get_compare_function(sort_flags);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          const int sort_flags = ((-2 * (next_i()%2)) + 1) * next_i();
