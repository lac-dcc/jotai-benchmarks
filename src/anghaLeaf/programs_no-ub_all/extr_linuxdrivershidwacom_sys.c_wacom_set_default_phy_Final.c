...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_features0; _i0++) {
            features->x_resolution = ((-2 * (next_i()%2)) + 1) * next_i();
        features->x_phy = ((-2 * (next_i()%2)) + 1) * next_i();
        features->x_max = ((-2 * (next_i()%2)) + 1) * next_i();
        features->y_phy = ((-2 * (next_i()%2)) + 1) * next_i();
        features->y_max = ((-2 * (next_i()%2)) + 1) * next_i();
        features->y_resolution = ((-2 * (next_i()%2)) + 1) * next_i();
          }
