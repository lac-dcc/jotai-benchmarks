...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          tcdev[_i0].devdata = (struct aspeed_cooling_device *) malloc(_len_tcdev__i0__devdata0*sizeof(struct aspeed_cooling_device));
          for(int _j0 = 0; _j0 < _len_tcdev__i0__devdata0; _j0++) {
            tcdev[_i0].devdata->cur_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_state0 = 1;
          ...
          int benchRet = aspeed_pwm_cz_get_cur_state(tcdev,state);
          printf("%d\n", benchRet); 
