...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
            f->left = ((-2 * (next_i()%2)) + 1) * next_i();
        f->right = ((-2 * (next_i()%2)) + 1) * next_i();
        f->middle = ((-2 * (next_i()%2)) + 1) * next_i();
        f->ts_left = ((-2 * (next_i()%2)) + 1) * next_i();
        f->ts_right = ((-2 * (next_i()%2)) + 1) * next_i();
        f->ts_middle = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_p0 = 65025;
