...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          f[_i0].priv = (struct chain *) malloc(_len_f__i0__priv0*sizeof(struct chain));
          for(int _j0 = 0; _j0 < _len_f__i0__priv0; _j0++) {
            f[_i0].priv->public.ao_needs_update = ((-2 * (next_i()%2)) + 1) * next_i();
        f[_i0].priv->public.got_output_eof = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          reset(f);
