...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        dev->stats.collisions = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_crc_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_length_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_missed_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.rx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->stats.multicast = ((-2 * (next_i()%2)) + 1) * next_i();
