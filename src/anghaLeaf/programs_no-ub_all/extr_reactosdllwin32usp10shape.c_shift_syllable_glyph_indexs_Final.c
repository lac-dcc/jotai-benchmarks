...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_glyph_index0; _i0++) {
            glyph_index->start = ((-2 * (next_i()%2)) + 1) * next_i();
        glyph_index->base = ((-2 * (next_i()%2)) + 1) * next_i();
        glyph_index->end = ((-2 * (next_i()%2)) + 1) * next_i();
        glyph_index->ralf = ((-2 * (next_i()%2)) + 1) * next_i();
        glyph_index->blwf = ((-2 * (next_i()%2)) + 1) * next_i();
        glyph_index->pref = ((-2 * (next_i()%2)) + 1) * next_i();
          }
