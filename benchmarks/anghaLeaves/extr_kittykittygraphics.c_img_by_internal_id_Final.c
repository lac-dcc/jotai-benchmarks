...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
              self[_i0].image_count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_self__i0__images0 = 1;
          self[_i0].images = (struct TYPE_5__ *) malloc(_len_self__i0__images0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_self__i0__images0; _j0++) {
              self[_i0].images->internal_id = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          struct TYPE_5__ * benchRet = img_by_internal_id(self,id);
          printf("%lu\n", (*benchRet).internal_id);
          for(int _aux = 0; _aux < _len_self0; _aux++) {
          free(self[_aux].images);
          }
          free(self);
