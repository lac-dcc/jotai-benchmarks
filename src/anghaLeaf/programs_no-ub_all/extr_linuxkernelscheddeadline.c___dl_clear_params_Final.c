...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->dl.dl_overrun = ((-2 * (next_i()%2)) + 1) * next_i();
        p->dl.dl_non_contending = ((-2 * (next_i()%2)) + 1) * next_i();
        p->dl.dl_yielded = ((-2 * (next_i()%2)) + 1) * next_i();
        p->dl.dl_throttled = ((-2 * (next_i()%2)) + 1) * next_i();
        p->dl.dl_density = ((-2 * (next_i()%2)) + 1) * next_i();
        p->dl.dl_bw = ((-2 * (next_i()%2)) + 1) * next_i();
