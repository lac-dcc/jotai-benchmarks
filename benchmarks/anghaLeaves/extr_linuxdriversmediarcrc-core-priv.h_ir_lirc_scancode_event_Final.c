...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_lsc0 = 1;
          struct lirc_scancode * lsc = (struct lirc_scancode *) malloc(_len_lsc0*sizeof(struct lirc_scancode));
          for(int _i0 = 0; _i0 < _len_lsc0; _i0++) {
            lsc[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
