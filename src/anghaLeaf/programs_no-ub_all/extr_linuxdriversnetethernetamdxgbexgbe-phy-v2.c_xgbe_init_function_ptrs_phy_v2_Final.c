...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phy_if0; _i0++) {
            phy_if->phy_impl.module_eeprom = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_impl.module_info = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_impl.kr_training_post = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_impl.kr_training_pre = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_impl.an_post = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_impl.an_pre = ((-2 * (next_i()%2)) + 1) * next_i();
