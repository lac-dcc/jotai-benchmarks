...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct tda18212_dev *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct tda18212_dev));
          for(int _j0 = 0; _j0 < _len_fe__i0__tuner_priv0; _j0++) {
            fe[_i0].tuner_priv->if_frequency = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          int benchRet = tda18212_get_if_frequency(fe,frequency);
          printf("%d\n", benchRet); 
