...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rgb2rgb0; _i0++) {
            rgb2rgb->out_ofst_r = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->out_ofst_g = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->out_ofst_b = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_bb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_bb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_gb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_gb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_rb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_rb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_bg.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_bg.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_gg.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_gg.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_rg.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_rg.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_br.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_br.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_gr.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_gr.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_rr.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2rgb->coef_rr.integer = ((-2 * (next_i()%2)) + 1) * next_i();
          }
