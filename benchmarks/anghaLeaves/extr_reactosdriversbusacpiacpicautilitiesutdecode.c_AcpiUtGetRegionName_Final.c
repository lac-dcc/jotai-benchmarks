...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long SpaceId = 100;
        
          const char * benchRet = AcpiUtGetRegionName(SpaceId);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          ...
          unsigned long SpaceId = ((-2 * (next_i()%2)) + 1) * next_i();
