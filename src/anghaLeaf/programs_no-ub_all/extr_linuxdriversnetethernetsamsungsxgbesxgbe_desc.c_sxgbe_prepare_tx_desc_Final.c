...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->tdes23.tx_rd_des23.buf1_size = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tdes23.tx_rd_des23.cksum_ctl = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tdes23.tx_rd_des23.tx_pkt_len.pkt_len.total_pkt_len = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tdes23.tx_rd_des23.first_desc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
