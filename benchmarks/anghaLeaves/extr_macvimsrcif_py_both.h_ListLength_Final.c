...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
              int _len_self__i0__list0 = 1;
          self[_i0].list = (struct TYPE_4__ *) malloc(_len_self__i0__list0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_self__i0__list0; _j0++) {
              self[_i0].list->lv_len = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          int benchRet = ListLength(self);
          printf("%d\n", benchRet); 
