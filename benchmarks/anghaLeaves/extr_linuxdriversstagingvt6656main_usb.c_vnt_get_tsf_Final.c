...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          hw[_i0].priv = (struct vnt_private *) malloc(_len_hw__i0__priv0*sizeof(struct vnt_private));
          for(int _j0 = 0; _j0 < _len_hw__i0__priv0; _j0++) {
            hw[_i0].priv->current_tsf = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_vif0 = 1;
          ...
          int benchRet = vnt_get_tsf(hw,vif);
          printf("%d\n", benchRet); 
