...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_the_port0; _i0++) {
            the_port->icount.parity = ((-2 * (next_i()%2)) + 1) * next_i();
        the_port->icount.overrun = ((-2 * (next_i()%2)) + 1) * next_i();
        the_port->icount.frame = ((-2 * (next_i()%2)) + 1) * next_i();
        the_port->icount.brk = ((-2 * (next_i()%2)) + 1) * next_i();
          }
