...
typedef  int /*<<< orphan*/  DirentOndisk ;
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_dirent0 = 1;
          struct TYPE_3__ * dirent = (struct TYPE_3__ *) malloc(_len_dirent0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_dirent0; _i0++) {
            dirent[_i0].name_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ondisk_dirent_size(dirent);
          printf("%d\n", benchRet); 
          free(dirent);
