...
__attribute__((used)) static int sci_request_smp_completion_status_is_tx_rx_suspend(
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = sci_request_smp_completion_status_is_tx_rx_suspend(completion_status);
          printf("%d\n", benchRet); 
