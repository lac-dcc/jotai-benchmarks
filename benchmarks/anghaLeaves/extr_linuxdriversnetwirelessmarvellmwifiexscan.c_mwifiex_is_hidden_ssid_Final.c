...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ssid0 = 1;
          struct cfg80211_ssid * ssid = (struct cfg80211_ssid *) malloc(_len_ssid0*sizeof(struct cfg80211_ssid));
          for(int _i0 = 0; _i0 < _len_ssid0; _i0++) {
            ssid[_i0].ssid_len = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ssid__i0__ssid0 = 1;
          ssid[_i0].ssid = (long *) malloc(_len_ssid__i0__ssid0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_ssid__i0__ssid0; _j0++) {
            ssid[_i0].ssid[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = mwifiex_is_hidden_ssid(ssid);
          printf("%d\n", benchRet); 
