...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->initialized = ((-2 * (next_i()%2)) + 1) * next_i();
        data->old_salt = ((-2 * (next_i()%2)) + 1) * next_i();
        data->saltbits = ((-2 * (next_i()%2)) + 1) * next_i();
        data->old_rawkey1 = ((-2 * (next_i()%2)) + 1) * next_i();
        data->old_rawkey0 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          des_init_local(data);
          free(data);
