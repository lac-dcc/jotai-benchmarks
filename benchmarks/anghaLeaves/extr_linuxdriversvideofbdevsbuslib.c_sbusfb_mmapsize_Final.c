...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long fbsize = 100;
        
          unsigned long benchRet = sbusfb_mmapsize(size,fbsize);
          printf("%lu\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long fbsize = ((-2 * (next_i()%2)) + 1) * next_i();
