...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s->state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_insn0 = 1;
          struct comedi_insn * insn = (struct comedi_insn *) malloc(_len_insn0*sizeof(struct comedi_insn));
          for(int _i0 = 0; _i0 < _len_insn0; _i0++) {
            insn->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = apci1032_cos_insn_bits(dev,s,insn,data);
          printf("%d\n", benchRet); 
          free(dev);
          free(s);
          free(insn);
