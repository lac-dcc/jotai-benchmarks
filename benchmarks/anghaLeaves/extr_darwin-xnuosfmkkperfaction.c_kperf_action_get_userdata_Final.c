...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_userdata_out0 = 1;
          long * userdata_out = (long *) malloc(_len_userdata_out0*sizeof(long));
          for(int _i0 = 0; _i0 < _len_userdata_out0; _i0++) {
            userdata_out[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = kperf_action_get_userdata(actionid,userdata_out);
          printf("%d\n", benchRet); 
          free(userdata_out);
