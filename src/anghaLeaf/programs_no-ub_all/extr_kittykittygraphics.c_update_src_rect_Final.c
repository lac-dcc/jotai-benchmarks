...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ref0; _i0++) {
            ref->src_height = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->src_y = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->src_rect.left = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        ref->src_rect.right = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        ref->src_rect.top = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        ref->src_rect.bottom = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        ref->src_width = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->src_x = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_img0 = 1;
          struct TYPE_8__ * img = (struct TYPE_8__ *) malloc(_len_img0*sizeof(struct TYPE_8__));
          for(int _i0 = 0; _i0 < _len_img0; _i0++) {
            img->height = ((-2 * (next_i()%2)) + 1) * next_i();
        img->width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
