...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dest0; _i0++) {
            dest->ei_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        dest->ei_clusters = ((-2 * (next_i()%2)) + 1) * next_i();
        dest->ei_phys = ((-2 * (next_i()%2)) + 1) * next_i();
        dest->ei_cpos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_src0 = 1;
          struct ocfs2_extent_map_item * src = (struct ocfs2_extent_map_item *) malloc(_len_src0*sizeof(struct ocfs2_extent_map_item));
          for(int _i0 = 0; _i0 < _len_src0; _i0++) {
            src->ei_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        src->ei_clusters = ((-2 * (next_i()%2)) + 1) * next_i();
        src->ei_phys = ((-2 * (next_i()%2)) + 1) * next_i();
        src->ei_cpos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
