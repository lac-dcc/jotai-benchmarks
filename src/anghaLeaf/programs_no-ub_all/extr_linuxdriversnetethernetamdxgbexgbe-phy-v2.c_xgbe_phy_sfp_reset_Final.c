...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phy_data0; _i0++) {
            phy_data->sfp_mod_absent = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_data->sfp_speed = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_data->sfp_cable = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_data->sfp_base = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_data->sfp_tx_fault = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_data->sfp_rx_los = ((-2 * (next_i()%2)) + 1) * next_i();
          }
