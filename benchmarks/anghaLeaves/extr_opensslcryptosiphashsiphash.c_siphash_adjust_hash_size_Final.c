...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long hash_size = 100;
        
          unsigned long benchRet = siphash_adjust_hash_size(hash_size);
          printf("%lu\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long hash_size = ((-2 * (next_i()%2)) + 1) * next_i();
