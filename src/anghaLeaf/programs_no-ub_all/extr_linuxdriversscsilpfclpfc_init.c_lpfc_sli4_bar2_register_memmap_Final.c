...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phba0; _i0++) {
            phba->sli4_hba.drbl_regs_memmap_p = ((-2 * (next_i()%2)) + 1) * next_i();
        phba->sli4_hba.BMBXregaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        phba->sli4_hba.MQDBregaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        phba->sli4_hba.CQDBregaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        phba->sli4_hba.EQDBregaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        phba->sli4_hba.WQDBregaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        phba->sli4_hba.RQDBregaddr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
