...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_in_serv_queue0 = 1;
          struct bfq_queue * in_serv_queue = (struct bfq_queue *) malloc(_len_in_serv_queue0*sizeof(struct bfq_queue));
          for(int _i0 = 0; _i0 < _len_in_serv_queue0; _i0++) {
            in_serv_queue[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          bfq_update_dispatch_stats(q,rq,in_serv_queue,idle_timer_disabled);
          free(q);
          free(rq);
          free(in_serv_queue);
