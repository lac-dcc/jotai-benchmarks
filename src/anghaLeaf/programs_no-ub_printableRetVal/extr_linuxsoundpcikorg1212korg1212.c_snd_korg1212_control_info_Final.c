...
/* Variables and functions */
 ...
 int /*<<< orphan*/  k1212MaxADCSens ; 
 int /*<<< orphan*/  k1212MinADCSens ; 

__attribute__((used)) static int snd_korg1212_control_info(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        uinfo->type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = snd_korg1212_control_info(kcontrol,uinfo);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(uinfo);
