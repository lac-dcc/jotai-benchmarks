...
__attribute__((used)) static long _rtl8822be_phy_txpwr_idx_to_dbm(struct ieee80211_hw *hw,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long benchRet = _rtl8822be_phy_txpwr_idx_to_dbm(hw,wirelessmode,txpwridx);
          printf("%ld\n", benchRet); 
          free(hw);
    ...
    case 3:
    {
          ...
          int txpwridx = ((-2 * (next_i()%2)) + 1) * next_i();
