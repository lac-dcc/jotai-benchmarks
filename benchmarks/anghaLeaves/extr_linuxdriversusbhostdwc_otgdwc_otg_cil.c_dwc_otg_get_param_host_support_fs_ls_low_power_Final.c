...
struct TYPE_4__ {int /*<<< orphan*/  host_support_fs_ls_low_power; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_core_if__i0__core_params0; _j0++) {
            core_if[_i0].core_params->host_support_fs_ls_low_power = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = dwc_otg_get_param_host_support_fs_ls_low_power(core_if);
          printf("%d\n", benchRet); 
