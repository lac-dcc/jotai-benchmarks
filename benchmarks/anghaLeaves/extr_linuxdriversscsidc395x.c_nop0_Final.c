...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_srb0; _i0++) {
            srb[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pscsi_status0 = 1;
          int * pscsi_status = (int *) malloc(_len_pscsi_status0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pscsi_status0; _i0++) {
            pscsi_status[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          nop0(acb,srb,pscsi_status);
          free(acb);
          free(srb);
          free(pscsi_status);
