...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_padsh0; _i0++) {
            padsh->pbPreparedSrc = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->pbSrc = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->cbPreparedSrcLength = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->cbSrcLength = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->pbPreparedDst = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->pbDst = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->cbPreparedDstLength = ((-2 * (next_i()%2)) + 1) * next_i();
        padsh->cbDstLength = ((-2 * (next_i()%2)) + 1) * next_i();
          }
