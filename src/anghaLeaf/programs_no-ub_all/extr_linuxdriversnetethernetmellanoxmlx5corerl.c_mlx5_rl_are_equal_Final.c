...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rl_00; _i0++) {
            rl_0->rate = ((-2 * (next_i()%2)) + 1) * next_i();
        rl_0->max_burst_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        rl_0->typical_pkt_sz = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rl_10 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_rl_10; _i0++) {
            rl_1->rate = ((-2 * (next_i()%2)) + 1) * next_i();
        rl_1->max_burst_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        rl_1->typical_pkt_sz = ((-2 * (next_i()%2)) + 1) * next_i();
          }
