...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pg00; _i0++) {
              pg0[_i0].Flags = ((-2 * (next_i()%2)) + 1) * next_i();
          pg0[_i0].Protocol = ((-2 * (next_i()%2)) + 1) * next_i();
          pg0[_i0].PortIdentifier = ((-2 * (next_i()%2)) + 1) * next_i();
          pg0[_i0].WWPN.Low = ((-2 * (next_i()%2)) + 1) * next_i();
          pg0[_i0].WWPN.High = ((-2 * (next_i()%2)) + 1) * next_i();
        
          pg0[_i0].WWNN.Low = ((-2 * (next_i()%2)) + 1) * next_i();
          pg0[_i0].WWNN.High = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_rid0; _i0++) {
              rid[_i0].node_name = ((-2 * (next_i()%2)) + 1) * next_i();
          rid[_i0].port_name = ((-2 * (next_i()%2)) + 1) * next_i();
          rid[_i0].roles = ((-2 * (next_i()%2)) + 1) * next_i();
          rid[_i0].port_id = ((-2 * (next_i()%2)) + 1) * next_i();
