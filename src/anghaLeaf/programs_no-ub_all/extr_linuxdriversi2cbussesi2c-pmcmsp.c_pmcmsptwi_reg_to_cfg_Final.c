...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cfg0; _i0++) {
            cfg->arbf = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->nak = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->add10 = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->mst_code = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->arb = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->highspeed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
