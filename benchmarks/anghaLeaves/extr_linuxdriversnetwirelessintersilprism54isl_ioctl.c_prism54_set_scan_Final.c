...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_vwrq0 = 1;
          struct iw_param * vwrq = (struct iw_param *) malloc(_len_vwrq0*sizeof(struct iw_param));
          for(int _i0 = 0; _i0 < _len_vwrq0; _i0++) {
            vwrq[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_extra0 = 1;
          ...
          int benchRet = prism54_set_scan(dev,info,vwrq,extra);
          printf("%d\n", benchRet); 
          free(dev);
          free(info);
          free(vwrq);
