...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_dsp0 = 1;
          struct TYPE_3__ * dsp = (struct TYPE_3__ *) malloc(_len_dsp0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_dsp0; _i0++) {
              dsp[_i0].sad = ((-2 * (next_i()%2)) + 1) * next_i();
          dsp[_i0].convolution_y = ((-2 * (next_i()%2)) + 1) * next_i();
          dsp[_i0].convolution_x = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          vmafmotiondsp_init(dsp,bpp);
          free(dsp);
