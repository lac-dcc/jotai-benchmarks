...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_var0; _i0++) {
            var->present = ((-2 * (next_i()%2)) + 1) * next_i();
        var->type = ((-2 * (next_i()%2)) + 1) * next_i();
        var->s = ((-2 * (next_i()%2)) + 1) * next_i();
        var->dpl = ((-2 * (next_i()%2)) + 1) * next_i();
        var->avl = ((-2 * (next_i()%2)) + 1) * next_i();
        var->l = ((-2 * (next_i()%2)) + 1) * next_i();
        var->db = ((-2 * (next_i()%2)) + 1) * next_i();
        var->g = ((-2 * (next_i()%2)) + 1) * next_i();
        var->unusable = ((-2 * (next_i()%2)) + 1) * next_i();
          }
