...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long entry_sz = 100;
        
          unsigned long pos = 100;
        
          int benchRet = s390_cpumsf_reached_trailer(entry_sz,pos);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long entry_sz = ((-2 * (next_i()%2)) + 1) * next_i();
