...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_sa0 = 65025;
          float * sa = (float *) malloc(_len_sa0*sizeof(float));
          for(int _i0 = 0; _i0 < _len_sa0; _i0++) {
            sa[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          ...
          int benchRet = saxpy_(n,sa,sx,incx,sy,incy);
          printf("%d\n", benchRet); 
          free(n);
          free(sa);
          free(sx);
