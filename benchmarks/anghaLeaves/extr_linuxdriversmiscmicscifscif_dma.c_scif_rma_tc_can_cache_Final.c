...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long cur_bytes = 100;
          int _len_ep0 = 1;
          struct scif_endpt * ep = (struct scif_endpt *) malloc(_len_ep0*sizeof(struct scif_endpt));
          for(int _i0 = 0; _i0 < _len_ep0; _i0++) {
            ep[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = scif_rma_tc_can_cache(ep,cur_bytes);
          printf("%d\n", benchRet); 
          free(ep);
