...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adev0; _i0++) {
            adev->enable_virtual_display = ((-2 * (next_i()%2)) + 1) * next_i();
        adev->pg_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        adev->cg_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        adev->mode_info.num_crtc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
