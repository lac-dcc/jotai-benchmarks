...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_comp0; _i0++) {
              int _len_comp__i0__assembly0 = 1;
          comp[_i0].assembly = (struct TYPE_4__ *) malloc(_len_comp__i0__assembly0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_comp__i0__assembly0; _j0++) {
            comp[_i0].assembly->application = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = msi_is_global_assembly(comp);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_comp0; _aux++) {
          free(comp[_aux].assembly);
          }
          free(comp);
