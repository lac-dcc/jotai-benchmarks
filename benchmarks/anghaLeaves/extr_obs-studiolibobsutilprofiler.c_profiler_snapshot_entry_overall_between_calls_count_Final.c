...
struct TYPE_3__ {int /*<<< orphan*/  overall_between_calls_count; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_entry0; _i0++) {
            entry[_i0].overall_between_calls_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = profiler_snapshot_entry_overall_between_calls_count(entry);
          printf("%d\n", benchRet); 
          free(entry);
