...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_inp0; _i0++) {
            inp->inp_depend6.inp6_hops = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_depend6.inp6_cksum = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_depend4.inp4_ip_tos = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_dependladdr.inp6_local = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_dependfaddr.inp6_foreign = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_ip_p = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_ip_ttl = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_vflag = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_flow = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_gencnt = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_lport = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_fport = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_xinp0 = 1;
          struct xinpcb64 * xinp = (struct xinpcb64 *) malloc(_len_xinp0*sizeof(struct xinpcb64));
          for(int _i0 = 0; _i0 < _len_xinp0; _i0++) {
            xinp->inp_depend6.inp6_hops = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_depend6.inp6_ifindex = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_depend6.inp6_cksum = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_depend6.inp6_hlim = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_depend4.inp4_ip_tos = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_dependladdr.inp6_local = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_dependfaddr.inp6_foreign = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_ip_p = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_ip_ttl = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_vflag = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_flow = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_gencnt = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_lport = ((-2 * (next_i()%2)) + 1) * next_i();
        xinp->inp_fport = ((-2 * (next_i()%2)) + 1) * next_i();
          }
