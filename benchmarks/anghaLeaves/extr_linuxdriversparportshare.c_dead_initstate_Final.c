...
__attribute__((used)) static void dead_initstate(struct pardevice *d, struct parport_state *s) { }
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_d0 = 1;
          struct pardevice * d = (struct pardevice *) malloc(_len_d0*sizeof(struct pardevice));
