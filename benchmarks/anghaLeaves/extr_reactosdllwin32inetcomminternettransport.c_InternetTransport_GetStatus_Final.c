...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pCurrentStatus0 = 1;
          int * pCurrentStatus = (int *) malloc(_len_pCurrentStatus0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pCurrentStatus0; _i0++) {
            pCurrentStatus[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = InternetTransport_GetStatus(This,pCurrentStatus);
          printf("%d\n", benchRet); 
          free(This);
          free(pCurrentStatus);
    ...
    case 1:
    {
          ...
          int _len_pCurrentStatus0 = 65025;
          int * pCurrentStatus = (int *) malloc(_len_pCurrentStatus0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pCurrentStatus0; _i0++) {
            pCurrentStatus[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
