...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
            self->bold = ((-2 * (next_i()%2)) + 1) * next_i();
        self->italic = ((-2 * (next_i()%2)) + 1) * next_i();
        self->reverse = ((-2 * (next_i()%2)) + 1) * next_i();
        self->strikethrough = ((-2 * (next_i()%2)) + 1) * next_i();
        self->dim = ((-2 * (next_i()%2)) + 1) * next_i();
        self->decoration = ((-2 * (next_i()%2)) + 1) * next_i();
        self->decoration_fg = ((-2 * (next_i()%2)) + 1) * next_i();
        self->fg = ((-2 * (next_i()%2)) + 1) * next_i();
        self->bg = ((-2 * (next_i()%2)) + 1) * next_i();
          }
