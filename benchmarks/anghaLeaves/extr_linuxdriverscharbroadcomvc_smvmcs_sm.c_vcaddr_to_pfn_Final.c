...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long vc_addr = 100;
        
          unsigned int benchRet = vcaddr_to_pfn(vc_addr);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long vc_addr = ((-2 * (next_i()%2)) + 1) * next_i();
