...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int service_mask = 100;
        
          int benchRet = ucm_validate_listen(service_id,service_mask);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          int service_id = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int service_mask = ((-2 * (next_i()%2)) + 1) * next_i();
