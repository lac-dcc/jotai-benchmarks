...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          mtd[_i0].priv = (struct spi_nor *) malloc(_len_mtd__i0__priv0*sizeof(struct spi_nor));
          for(int _j0 = 0; _j0 < _len_mtd__i0__priv0; _j0++) {
            mtd[_i0].priv->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct spi_nor * benchRet = mtd_to_spi_nor(mtd);
          printf("%d\n", (*benchRet).dummy);
