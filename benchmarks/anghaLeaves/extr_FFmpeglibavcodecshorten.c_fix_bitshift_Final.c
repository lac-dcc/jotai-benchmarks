...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s[_i0].bitshift = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].blocksize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_buffer0 = 1;
          unsigned int * buffer = (unsigned int *) malloc(_len_buffer0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_buffer0; _i0++) {
            buffer[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          fix_bitshift(s,buffer);
          free(s);
          free(buffer);
