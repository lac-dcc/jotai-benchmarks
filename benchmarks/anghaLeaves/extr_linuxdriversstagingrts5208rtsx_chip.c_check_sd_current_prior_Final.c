...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int sd_current_prior = 100;
        
          int benchRet = check_sd_current_prior(sd_current_prior);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int sd_current_prior = ((-2 * (next_i()%2)) + 1) * next_i();
