...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hdmi0; _i0++) {
            hdmi->csp = ((-2 * (next_i()%2)) + 1) * next_i();
        hdmi->aud_param.aud_input_chan_type = ((-2 * (next_i()%2)) + 1) * next_i();
        hdmi->aud_param.aud_mclk = ((-2 * (next_i()%2)) + 1) * next_i();
        hdmi->aud_param.aud_i2s_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        hdmi->aud_param.aud_input_type = ((-2 * (next_i()%2)) + 1) * next_i();
        hdmi->aud_param.aud_sampe_size = ((-2 * (next_i()%2)) + 1) * next_i();
        hdmi->aud_param.aud_codec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
