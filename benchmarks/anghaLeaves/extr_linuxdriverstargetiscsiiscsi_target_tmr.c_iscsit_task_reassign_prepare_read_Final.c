...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_tmr_req0 = 1;
          struct iscsi_tmr_req * tmr_req = (struct iscsi_tmr_req *) malloc(_len_tmr_req0*sizeof(struct iscsi_tmr_req));
          for(int _i0 = 0; _i0 < _len_tmr_req0; _i0++) {
            tmr_req[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_conn0 = 1;
          ...
          int benchRet = iscsit_task_reassign_prepare_read(tmr_req,conn);
          printf("%d\n", benchRet); 
          free(tmr_req);
          free(conn);
