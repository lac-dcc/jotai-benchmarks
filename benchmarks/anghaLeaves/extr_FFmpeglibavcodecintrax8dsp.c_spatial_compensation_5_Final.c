...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 1682
          // ------------------------------- 
          // static_instructions_O1 : 37
          // dynamic_instructions_O1 : 867
          // ------------------------------- 
          // static_instructions_O2 : 97
          // dynamic_instructions_O2 : 525
          // ------------------------------- 
          // static_instructions_O3 : 315
          // dynamic_instructions_O3 : 315
          // ------------------------------- 
          // static_instructions_Ofast : 315
          // dynamic_instructions_Ofast : 315
          // ------------------------------- 
          // static_instructions_Os : 35
          // dynamic_instructions_Os : 858
          // ------------------------------- 
          // static_instructions_Oz : 37
          // dynamic_instructions_Oz : 948
          // ------------------------------- 
          ...
          spatial_compensation_5(src,dst,stride);
          free(src);
          free(dst);
