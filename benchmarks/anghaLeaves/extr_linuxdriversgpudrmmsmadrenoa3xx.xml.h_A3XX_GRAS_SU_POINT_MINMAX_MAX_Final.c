...
/* Variables and functions */
 int A3XX_GRAS_SU_POINT_MINMAX_MAX__MASK ; 
 int A3XX_GRAS_SU_POINT_MINMAX_MAX__SHIFT ; 

__attribute__((used)) static inline uint32_t A3XX_GRAS_SU_POINT_MINMAX_MAX(float val)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = A3XX_GRAS_SU_POINT_MINMAX_MAX(val);
          printf("%d\n", benchRet); 
