...
int main(int argc, char *argv[]) {
    ...
    case 1:
    {
          int rss_default_cpu = 255;
        
          int rss_hash_type = 255;
        
          int rss_hash_bits = 255;
        
          int rss_base_cpu = 255;
        
          int rss_enable = 255;
        
          int tso_ipid_split_en = 255;
        
          int ig_vlan_strip_en = 255;
        
          int _len_nic_cfg0 = 65025;
          int * nic_cfg = (int *) malloc(_len_nic_cfg0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_nic_cfg0; _i0++) {
            nic_cfg[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
    ...
    case 3:
    {
          int rss_default_cpu = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int rss_hash_type = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int rss_hash_bits = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int rss_base_cpu = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int rss_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int tso_ipid_split_en = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int ig_vlan_strip_en = ((-2 * (next_i()%2)) + 1) * next_i();
