...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int rate_power_idx = 100;
        
          int band = 100;
        
          int benchRet = get_min_power_idx(rate_power_idx,band);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int rate_power_idx = ((-2 * (next_i()%2)) + 1) * next_i();
