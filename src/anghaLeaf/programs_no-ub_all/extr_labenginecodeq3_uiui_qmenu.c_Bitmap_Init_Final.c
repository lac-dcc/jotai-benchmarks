...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_b0; _i0++) {
            b->width = ((-2 * (next_i()%2)) + 1) * next_i();
        b->height = ((-2 * (next_i()%2)) + 1) * next_i();
        b->focusshader = ((-2 * (next_i()%2)) + 1) * next_i();
        b->shader = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.x = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.y = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.left = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.right = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.top = ((-2 * (next_i()%2)) + 1) * next_i();
        b->generic.bottom = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          Bitmap_Init(b);
          free(b);
