...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cfg0; _i0++) {
              int _len_cfg__i0__wiphy0 = 1;
          cfg[_i0].wiphy = (struct wiphy *) malloc(_len_cfg__i0__wiphy0*sizeof(struct wiphy));
          for(int _j0 = 0; _j0 < _len_cfg__i0__wiphy0; _j0++) {
            cfg[_i0].wiphy->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct wiphy * benchRet = cfg_to_wiphy(cfg);
          printf("%d\n", (*benchRet).dummy);
