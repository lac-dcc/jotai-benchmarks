...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->reply_tx_stats.unknown = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.sta_color_mismatch = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.fail_hw_drop = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.insuff_cf_poll = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.fifo_flush = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.tid_disable = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.frag_drop = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.sta_invalid = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.bt_retry = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.host_abort = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.dest_ps = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.life_expire = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.rfkill_flush = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.drain_flow = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.fifo_underrun = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.long_limit = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.short_limit = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.int_crossed_retry = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.pp_calc_ttak = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.pp_quiet_period = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.pp_bt_prio = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.pp_few_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_tx_stats.pp_delay = ((-2 * (next_i()%2)) + 1) * next_i();
          }
