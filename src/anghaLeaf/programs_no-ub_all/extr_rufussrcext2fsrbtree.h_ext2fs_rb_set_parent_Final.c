...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rb0; _i0++) {
            rb->rb_parent_color = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_p0 = 1;
          struct rb_node * p = (struct rb_node *) malloc(_len_p0*sizeof(struct rb_node));
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->rb_parent_color = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ext2fs_rb_set_parent(rb,p);
          free(rb);
          free(p);
