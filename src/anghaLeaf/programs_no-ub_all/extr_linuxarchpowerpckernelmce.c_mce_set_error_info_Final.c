...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_mce0; _i0++) {
            mce->error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.link_error.link_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.ra_error.ra_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.user_error.user_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.tlb_error.tlb_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.erat_error.erat_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.slb_error.slb_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce->u.ue_error.ue_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_mce_err0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_mce_err0; _i0++) {
            mce_err->error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.link_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.ra_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.user_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.tlb_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.erat_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.slb_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
        mce_err->u.ue_error_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
