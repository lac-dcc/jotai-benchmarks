...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter->eth_dump.len = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->eth_dump.version = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->eth_dump.flag = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->params.fw_vers = ((-2 * (next_i()%2)) + 1) * next_i();
          }
