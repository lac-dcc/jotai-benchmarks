...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ah0; _i0++) {
            ah->nf_5g.nominal = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->nf_5g.min = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->nf_5g.max = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->nf_2g.nominal = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->nf_2g.min = ((-2 * (next_i()%2)) + 1) * next_i();
        ah->nf_2g.max = ((-2 * (next_i()%2)) + 1) * next_i();
          }
