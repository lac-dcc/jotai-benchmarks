...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_b10; _i0++) {
            b1->root_id = ((-2 * (next_i()%2)) + 1) * next_i();
        b1->inum = ((-2 * (next_i()%2)) + 1) * next_i();
        b1->file_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_b20 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_b20; _i0++) {
            b2->root_id = ((-2 * (next_i()%2)) + 1) * next_i();
        b2->inum = ((-2 * (next_i()%2)) + 1) * next_i();
        b2->file_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
