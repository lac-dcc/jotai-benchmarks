...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cap0; _i0++) {
            cap->events_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        cap->events_mask_len = ((-2 * (next_i()%2)) + 1) * next_i();
        cap->bit_width_fixed = ((-2 * (next_i()%2)) + 1) * next_i();
        cap->bit_width_gp = ((-2 * (next_i()%2)) + 1) * next_i();
        cap->num_counters_fixed = ((-2 * (next_i()%2)) + 1) * next_i();
        cap->num_counters_gp = ((-2 * (next_i()%2)) + 1) * next_i();
        cap->version = ((-2 * (next_i()%2)) + 1) * next_i();
          }
