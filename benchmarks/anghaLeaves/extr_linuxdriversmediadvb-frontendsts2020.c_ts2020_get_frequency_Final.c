...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct ts2020_priv *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct ts2020_priv));
          for(int _j0 = 0; _j0 < _len_fe__i0__tuner_priv0; _j0++) {
            fe[_i0].tuner_priv->frequency_khz = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          int benchRet = ts2020_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
