...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ benchRet = BMK_setValid_runTime(runTime);
          printf("%d\n", benchRet.internal_never_ever_use_directly);
          printf("%ld\n", benchRet.error_tag_never_ever_use_directly);
    ...
    case 3:
    {
          ...
          int runTime = ((-2 * (next_i()%2)) + 1) * next_i();
