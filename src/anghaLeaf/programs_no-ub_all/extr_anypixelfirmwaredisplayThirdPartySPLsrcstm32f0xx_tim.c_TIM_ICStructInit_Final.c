...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_TIM_ICInitStruct0; _i0++) {
            TIM_ICInitStruct->TIM_ICFilter = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_ICInitStruct->TIM_ICPrescaler = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_ICInitStruct->TIM_ICSelection = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_ICInitStruct->TIM_ICPolarity = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_ICInitStruct->TIM_Channel = ((-2 * (next_i()%2)) + 1) * next_i();
          }
