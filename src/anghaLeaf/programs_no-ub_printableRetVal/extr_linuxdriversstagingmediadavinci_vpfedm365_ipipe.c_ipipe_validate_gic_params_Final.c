...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_gic0; _i0++) {
            gic->en = ((-2 * (next_i()%2)) + 1) * next_i();
        gic->gain = ((-2 * (next_i()%2)) + 1) * next_i();
        gic->thr = ((-2 * (next_i()%2)) + 1) * next_i();
        gic->slope = ((-2 * (next_i()%2)) + 1) * next_i();
        gic->apply_lsc_gain = ((-2 * (next_i()%2)) + 1) * next_i();
        gic->nf2_thr_gain.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        gic->nf2_thr_gain.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
          }
