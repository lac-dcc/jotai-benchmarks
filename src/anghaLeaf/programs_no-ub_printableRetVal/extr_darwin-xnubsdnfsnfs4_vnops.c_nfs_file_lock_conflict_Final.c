...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nflp10; _i0++) {
            nflp1->nfl_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp1->nfl_owner = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp1->nfl_type = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp1->nfl_start = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp1->nfl_end = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_nflp20 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_nflp20; _i0++) {
            nflp2->nfl_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp2->nfl_owner = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp2->nfl_type = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp2->nfl_start = ((-2 * (next_i()%2)) + 1) * next_i();
        nflp2->nfl_end = ((-2 * (next_i()%2)) + 1) * next_i();
          }
