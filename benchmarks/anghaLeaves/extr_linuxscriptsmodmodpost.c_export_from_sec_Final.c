...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_elf0 = 1;
          struct elf_info * elf = (struct elf_info *) malloc(_len_elf0*sizeof(struct elf_info));
          for(int _i0 = 0; _i0 < _len_elf0; _i0++) {
            elf[_i0].export_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf[_i0].export_unused_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf[_i0].export_gpl_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf[_i0].export_unused_gpl_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf[_i0].export_gpl_future_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          enum export benchRet = export_from_sec(elf,sec);
          printf("{{other_type}} %p\n", &benchRet); 
          free(elf);
