...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_item0 = 1;
          struct TYPE_3__ * item = (struct TYPE_3__ *) malloc(_len_item0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_item0; _i0++) {
            item[_i0].nRefs = ((-2 * (next_i()%2)) + 1) * next_i();
        item[_i0].nAge = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          release_font_cache(item);
          free(item);
