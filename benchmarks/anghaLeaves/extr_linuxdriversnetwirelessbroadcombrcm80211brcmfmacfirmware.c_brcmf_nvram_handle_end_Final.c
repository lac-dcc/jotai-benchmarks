...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_nvp0 = 1;
          struct nvram_parser * nvp = (struct nvram_parser *) malloc(_len_nvp0*sizeof(struct nvram_parser));
          for(int _i0 = 0; _i0 < _len_nvp0; _i0++) {
            nvp[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          enum nvram_parser_state benchRet = brcmf_nvram_handle_end(nvp);
          free(nvp);
