...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        ops->enable_timing = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->get_status = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->setup_prg_fetch = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->setup_timing_gen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
