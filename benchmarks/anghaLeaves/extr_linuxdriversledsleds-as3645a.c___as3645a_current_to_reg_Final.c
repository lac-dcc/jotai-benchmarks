...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int benchRet = __as3645a_current_to_reg(min,max,step,val);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int max = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int step = ((-2 * (next_i()%2)) + 1) * next_i();
