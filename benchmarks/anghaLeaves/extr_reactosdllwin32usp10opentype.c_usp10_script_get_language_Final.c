...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_script0; _i0++) {
              script[_i0].language_count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_script__i0__languages0 = 1;
          script[_i0].languages = (struct TYPE_6__ *) malloc(_len_script__i0__languages0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_script__i0__languages0; _j0++) {
              script[_i0].languages->tag = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          struct TYPE_6__ * benchRet = usp10_script_get_language(script,tag);
          printf("%ld\n", (*benchRet).tag);
          for(int _aux = 0; _aux < _len_script0; _aux++) {
          free(script[_aux].languages);
          }
          free(script);
