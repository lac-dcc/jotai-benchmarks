...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_data0 = 1;
          struct hdc100x_data * data = (struct hdc100x_data *) malloc(_len_data0*sizeof(struct hdc100x_data));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->config = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = hdc100x_get_heater_status(data);
          printf("%d\n", benchRet); 
          free(data);
