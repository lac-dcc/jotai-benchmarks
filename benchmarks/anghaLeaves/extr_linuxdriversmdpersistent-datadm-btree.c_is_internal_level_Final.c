...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info[_i0].levels = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_f0 = 1;
          struct frame * f = (struct frame *) malloc(_len_f0*sizeof(struct frame));
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
            f[_i0].level = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_internal_level(info,f);
          printf("%d\n", benchRet); 
          free(info);
          free(f);
