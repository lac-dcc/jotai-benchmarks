...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          module_ctx[_i0].module_kernel_threads_min = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_kernel_threads_max = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_kernel_loops_min = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_kernel_loops_max = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_kernel_accel_min = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_kernel_accel_max = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_jit_cache_disable = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          module_ctx[_i0].module_extra_tmp_size = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_extra_buffer_size = ((-2 * (next_i()%2)) + 1) * next_i();
