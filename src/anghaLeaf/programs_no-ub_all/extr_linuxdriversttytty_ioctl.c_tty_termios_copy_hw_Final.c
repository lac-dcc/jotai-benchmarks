...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_new0; _i0++) {
            new->c_cflag = ((-2 * (next_i()%2)) + 1) * next_i();
        new->c_ospeed = ((-2 * (next_i()%2)) + 1) * next_i();
        new->c_ispeed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_old0 = 1;
          struct ktermios * old = (struct ktermios *) malloc(_len_old0*sizeof(struct ktermios));
          for(int _i0 = 0; _i0 < _len_old0; _i0++) {
            old->c_cflag = ((-2 * (next_i()%2)) + 1) * next_i();
        old->c_ospeed = ((-2 * (next_i()%2)) + 1) * next_i();
        old->c_ispeed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
