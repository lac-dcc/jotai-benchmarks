...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c_seg_dst0; _i0++) {
            c_seg_dst->c_bytes_used = ((-2 * (next_i()%2)) + 1) * next_i();
        c_seg_dst->c_nextoffset = ((-2 * (next_i()%2)) + 1) * next_i();
        c_seg_dst->c_nextslot = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_c_seg_src0; _i0++) {
            c_seg_src->c_bytes_used = ((-2 * (next_i()%2)) + 1) * next_i();
        c_seg_src->c_nextoffset = ((-2 * (next_i()%2)) + 1) * next_i();
        c_seg_src->c_nextslot = ((-2 * (next_i()%2)) + 1) * next_i();
          }
