...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_backend0 = 1;
          struct TYPE_3__ * backend = (struct TYPE_3__ *) malloc(_len_backend0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_backend0; _i0++) {
            backend[_i0].object_zlib_level = ((-2 * (next_i()%2)) + 1) * next_i();
        backend[_i0].fsync_object_files = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = filebuf_flags(backend);
          printf("%d\n", benchRet); 
          free(backend);
