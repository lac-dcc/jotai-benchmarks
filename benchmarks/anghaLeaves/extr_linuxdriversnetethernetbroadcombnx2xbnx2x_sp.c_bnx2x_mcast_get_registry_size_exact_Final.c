...
__attribute__((used)) static int bnx2x_mcast_get_registry_size_exact(struct bnx2x_mcast_obj *o)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_o0; _i0++) {
            o[_i0].registry.exact_match.num_macs_set = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = bnx2x_mcast_get_registry_size_exact(o);
          printf("%d\n", benchRet); 
          free(o);
