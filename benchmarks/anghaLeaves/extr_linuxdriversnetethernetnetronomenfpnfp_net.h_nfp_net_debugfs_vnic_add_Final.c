...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_ddir0 = 1;
          struct dentry * ddir = (struct dentry *) malloc(_len_ddir0*sizeof(struct dentry));
          for(int _i0 = 0; _i0 < _len_ddir0; _i0++) {
            ddir[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          nfp_net_debugfs_vnic_add(nn,ddir);
          free(nn);
          free(ddir);
