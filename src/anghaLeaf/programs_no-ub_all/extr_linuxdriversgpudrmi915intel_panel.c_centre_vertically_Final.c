...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adjusted_mode0; _i0++) {
            adjusted_mode->crtc_vsync_end = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_vsync_start = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_vblank_end = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_vblank_start = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_vdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
          }
