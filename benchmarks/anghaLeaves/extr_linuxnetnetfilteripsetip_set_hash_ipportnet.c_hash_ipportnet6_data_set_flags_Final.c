...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int flags = 100;
          int _len_elem0 = 1;
          struct hash_ipportnet6_elem * elem = (struct hash_ipportnet6_elem *) malloc(_len_elem0*sizeof(struct hash_ipportnet6_elem));
          for(int _i0 = 0; _i0 < _len_elem0; _i0++) {
            elem[_i0].nomatch = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          hash_ipportnet6_data_set_flags(elem,flags);
          free(elem);
