...
__attribute__((used)) static int cx25821_vidioc_g_output(struct file *file, void *priv, unsigned int *o)
{
	*o = 0;
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          void * priv;
          int _len_o0 = 1;
          unsigned int * o = (unsigned int *) malloc(_len_o0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_o0; _i0++) {
            o[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = cx25821_vidioc_g_output(file,priv,o);
          printf("%d\n", benchRet); 
          free(file);
          free(o);
