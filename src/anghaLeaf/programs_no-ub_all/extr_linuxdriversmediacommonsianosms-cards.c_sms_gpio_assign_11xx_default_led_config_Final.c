...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p_gpio_config0; _i0++) {
            p_gpio_config->pullupdown = ((-2 * (next_i()%2)) + 1) * next_i();
        p_gpio_config->outputslewrate = ((-2 * (next_i()%2)) + 1) * next_i();
        p_gpio_config->outputdriving = ((-2 * (next_i()%2)) + 1) * next_i();
        p_gpio_config->inputcharacteristics = ((-2 * (next_i()%2)) + 1) * next_i();
        p_gpio_config->direction = ((-2 * (next_i()%2)) + 1) * next_i();
          }
