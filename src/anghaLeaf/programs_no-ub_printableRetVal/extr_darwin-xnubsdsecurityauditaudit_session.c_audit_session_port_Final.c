...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int p = 255;
          int _len_uap0 = 1;
          struct audit_session_port_args * uap = (struct audit_session_port_args *) malloc(_len_uap0*sizeof(struct audit_session_port_args));
          ...
          int benchRet = audit_session_port(p,uap,retval);
          printf("%d\n", benchRet); 
          free(uap);
          free(retval);
