...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_csa0; _i0++) {
            csa[_i0].prob.pu_mb_R = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _j0 = 0; _j0 < _len_csa__i0__lscsa0; _j0++) {
              int _len_csa__i0__lscsa_ppu_mb_slot0 = 1;
          csa[_i0].lscsa->ppu_mb.slot = (int *) malloc(_len_csa__i0__lscsa_ppu_mb_slot0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_csa__i0__lscsa_ppu_mb_slot0; _j0++) {
            csa[_i0].lscsa->ppu_mb.slot[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_spu0 = 1;
