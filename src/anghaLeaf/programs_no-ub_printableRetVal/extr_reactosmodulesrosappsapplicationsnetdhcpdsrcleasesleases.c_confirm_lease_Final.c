...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dhcpl0; _i0++) {
            dhcpl->siaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        dhcpl->lease = ((-2 * (next_i()%2)) + 1) * next_i();
        dhcpl->mask = ((-2 * (next_i()%2)) + 1) * next_i();
        dhcpl->router = ((-2 * (next_i()%2)) + 1) * next_i();
        dhcpl->ip = ((-2 * (next_i()%2)) + 1) * next_i();
          }
