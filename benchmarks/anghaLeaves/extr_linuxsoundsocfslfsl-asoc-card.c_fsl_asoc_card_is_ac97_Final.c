...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_priv0 = 1;
          struct fsl_asoc_card_priv * priv = (struct fsl_asoc_card_priv *) malloc(_len_priv0*sizeof(struct fsl_asoc_card_priv));
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv[_i0].dai_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = fsl_asoc_card_is_ac97(priv);
          printf("%d\n", benchRet); 
          free(priv);
