...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long base_status = 100;
        
          long addl_status = 100;
        
          int benchRet = be_skip_err_log(opcode,base_status,addl_status);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          ...
          long base_status = 255;
        
          long addl_status = 255;
    ...
    case 3:
    {
          ...
          long base_status = ((-2 * (next_i()%2)) + 1) * next_i();
        
          long addl_status = ((-2 * (next_i()%2)) + 1) * next_i();
