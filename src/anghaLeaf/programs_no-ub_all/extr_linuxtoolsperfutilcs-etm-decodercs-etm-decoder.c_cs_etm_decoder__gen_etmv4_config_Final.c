...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params->etmv4.reg_idr8 = ((-2 * (next_i()%2)) + 1) * next_i();
        params->etmv4.reg_idr2 = ((-2 * (next_i()%2)) + 1) * next_i();
        params->etmv4.reg_idr1 = ((-2 * (next_i()%2)) + 1) * next_i();
        params->etmv4.reg_idr0 = ((-2 * (next_i()%2)) + 1) * next_i();
        params->etmv4.reg_traceidr = ((-2 * (next_i()%2)) + 1) * next_i();
        params->etmv4.reg_configr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_config0 = 1;
          struct TYPE_5__ * config = (struct TYPE_5__ *) malloc(_len_config0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_config0; _i0++) {
            config->core_prof = ((-2 * (next_i()%2)) + 1) * next_i();
        config->arch_ver = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr13 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr12 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr11 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr10 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr9 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr8 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr2 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr1 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_idr0 = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_traceidr = ((-2 * (next_i()%2)) + 1) * next_i();
        config->reg_configr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
