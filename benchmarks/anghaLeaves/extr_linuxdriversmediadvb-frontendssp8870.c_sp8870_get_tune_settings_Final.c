...
__attribute__((used)) static int sp8870_get_tune_settings(struct dvb_frontend* fe, struct dvb_frontend_tune_settings* fesettings)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        fesettings[_i0].step_size = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = sp8870_get_tune_settings(fe,fesettings);
          printf("%d\n", benchRet); 
          free(fe);
          free(fesettings);
