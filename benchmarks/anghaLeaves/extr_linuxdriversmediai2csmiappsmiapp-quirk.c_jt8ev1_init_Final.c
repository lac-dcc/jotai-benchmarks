...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_sensor0 = 1;
          struct smiapp_sensor * sensor = (struct smiapp_sensor *) malloc(_len_sensor0*sizeof(struct smiapp_sensor));
          for(int _i0 = 0; _i0 < _len_sensor0; _i0++) {
            sensor[_i0].pll.flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = jt8ev1_init(sensor);
          printf("%d\n", benchRet); 
          free(sensor);
