...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_za0 = 65025;
          struct TYPE_4__ * za = (struct TYPE_4__ *) malloc(_len_za0*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_za0; _i0++) {
              za[_i0].r = ((-2 * (next_i()%2)) + 1) * next_i();
          za[_i0].i = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = zscal_(n,za,zx,incx);
          printf("%d\n", benchRet); 
          free(n);
          free(za);
          free(zx);
