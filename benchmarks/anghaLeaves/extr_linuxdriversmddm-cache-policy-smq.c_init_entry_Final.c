...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_e0; _i0++) {
              e[_i0].level = ((-2 * (next_i()%2)) + 1) * next_i();
          e[_i0].dirty = ((-2 * (next_i()%2)) + 1) * next_i();
          e[_i0].allocated = ((-2 * (next_i()%2)) + 1) * next_i();
          e[_i0].sentinel = ((-2 * (next_i()%2)) + 1) * next_i();
          e[_i0].pending_work = ((-2 * (next_i()%2)) + 1) * next_i();
