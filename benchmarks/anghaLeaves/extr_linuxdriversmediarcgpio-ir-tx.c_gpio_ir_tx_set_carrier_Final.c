...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].priv = (struct gpio_ir *) malloc(_len_dev__i0__priv0*sizeof(struct gpio_ir));
          for(int _j0 = 0; _j0 < _len_dev__i0__priv0; _j0++) {
              dev[_i0].priv->carrier = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          int benchRet = gpio_ir_tx_set_carrier(dev,carrier);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          long carrier = ((-2 * (next_i()%2)) + 1) * next_i();
