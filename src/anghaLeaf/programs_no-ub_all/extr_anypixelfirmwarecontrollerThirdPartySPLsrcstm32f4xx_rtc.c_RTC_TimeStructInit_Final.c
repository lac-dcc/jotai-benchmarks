...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_RTC_TimeStruct0; _i0++) {
            RTC_TimeStruct->RTC_Seconds = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_TimeStruct->RTC_Minutes = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_TimeStruct->RTC_Hours = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_TimeStruct->RTC_H12 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
