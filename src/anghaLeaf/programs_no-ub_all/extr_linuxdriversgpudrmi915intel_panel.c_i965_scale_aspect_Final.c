...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pipe_config0; _i0++) {
            pipe_config->pipe_src_h = ((-2 * (next_i()%2)) + 1) * next_i();
        pipe_config->pipe_src_w = ((-2 * (next_i()%2)) + 1) * next_i();
        pipe_config->base.adjusted_mode.crtc_hdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
        pipe_config->base.adjusted_mode.crtc_vdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
          }
