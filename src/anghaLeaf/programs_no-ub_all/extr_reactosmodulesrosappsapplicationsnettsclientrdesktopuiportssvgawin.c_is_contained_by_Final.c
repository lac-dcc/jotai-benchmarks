...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_r10; _i0++) {
            r1->x = ((-2 * (next_i()%2)) + 1) * next_i();
        r1->y = ((-2 * (next_i()%2)) + 1) * next_i();
        r1->cx = ((-2 * (next_i()%2)) + 1) * next_i();
        r1->cy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_r20 = 1;
          struct TYPE_4__ * r2 = (struct TYPE_4__ *) malloc(_len_r20*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_r20; _i0++) {
            r2->x = ((-2 * (next_i()%2)) + 1) * next_i();
        r2->y = ((-2 * (next_i()%2)) + 1) * next_i();
        r2->cx = ((-2 * (next_i()%2)) + 1) * next_i();
        r2->cy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
