...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_t0; _i0++) {
            t->last_file_pid = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.size = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.file_type = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.file_path_s = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.file_path_d = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.action.code = ((-2 * (next_i()%2)) + 1) * next_i();
        t->r_ctx.file_suffix = ((-2 * (next_i()%2)) + 1) * next_i();
        t->file.left_length = ((-2 * (next_i()%2)) + 1) * next_i();
        t->file.file_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        t->last_file_type = ((-2 * (next_i()%2)) + 1) * next_i();
        t->last_file_path = ((-2 * (next_i()%2)) + 1) * next_i();
        t->file_name = ((-2 * (next_i()%2)) + 1) * next_i();
          }
