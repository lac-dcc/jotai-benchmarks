...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int local_orig = 100;
          int _len_mdst0 = 1;
          struct net_bridge_mdb_entry * mdst = (struct net_bridge_mdb_entry *) malloc(_len_mdst0*sizeof(struct net_bridge_mdb_entry));
          for(int _i0 = 0; _i0 < _len_mdst0; _i0++) {
            mdst[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_skb0 = 1;
          ...
          br_multicast_flood(mdst,skb,local_rcv,local_orig);
          free(mdst);
          free(skb);
