...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_d10; _i0++) {
            d1->type = ((-2 * (next_i()%2)) + 1) * next_i();
        d1->ft = ((-2 * (next_i()%2)) + 1) * next_i();
        d1->tir_num = ((-2 * (next_i()%2)) + 1) * next_i();
        d1->ft_num = ((-2 * (next_i()%2)) + 1) * next_i();
        d1->vport.num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_d20 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_d20; _i0++) {
            d2->type = ((-2 * (next_i()%2)) + 1) * next_i();
        d2->ft = ((-2 * (next_i()%2)) + 1) * next_i();
        d2->tir_num = ((-2 * (next_i()%2)) + 1) * next_i();
        d2->ft_num = ((-2 * (next_i()%2)) + 1) * next_i();
        d2->vport.num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
