...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_grp0; _i0++) {
            grp->s_64 = ((-2 * (next_i()%2)) + 1) * next_i();
        grp->s_65_127 = ((-2 * (next_i()%2)) + 1) * next_i();
        grp->s_128_255 = ((-2 * (next_i()%2)) + 1) * next_i();
        grp->s_256_511 = ((-2 * (next_i()%2)) + 1) * next_i();
        grp->s_512_1023 = ((-2 * (next_i()%2)) + 1) * next_i();
        grp->s_1024_1518 = ((-2 * (next_i()%2)) + 1) * next_i();
        grp->s_1519_max = ((-2 * (next_i()%2)) + 1) * next_i();
          }
