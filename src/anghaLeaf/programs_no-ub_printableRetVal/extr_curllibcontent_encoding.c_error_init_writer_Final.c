...
__attribute__((used)) static CURLcode error_init_writer(struct connectdata *conn,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_writer0; _i0++) {
            writer->downstream = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = error_init_writer(conn,writer);
          printf("%d\n", benchRet); 
          free(conn);
          free(writer);
