...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_qp0; _i0++) {
            qp->link_is_up = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->active = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_async = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_memcpy = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_err_no_buf = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_ring_full = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_async = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_memcpy = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_err_ver = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_err_oflow = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_err_no_buf = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_ring_empty = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->rx_index = ((-2 * (next_i()%2)) + 1) * next_i();
        qp->tx_index = ((-2 * (next_i()%2)) + 1) * next_i();
          }
