...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
            f->rend = ((-2 * (next_i()%2)) + 1) * next_i();
        f->shend = ((-2 * (next_i()%2)) + 1) * next_i();
        f->rpos = ((-2 * (next_i()%2)) + 1) * next_i();
        f->buf = ((-2 * (next_i()%2)) + 1) * next_i();
        f->shcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        f->shlim = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ffshlim(f,lim);
          free(f);
