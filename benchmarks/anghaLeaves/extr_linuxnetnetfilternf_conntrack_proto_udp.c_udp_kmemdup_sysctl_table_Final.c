...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_un0 = 1;
          struct nf_udp_net * un = (struct nf_udp_net *) malloc(_len_un0*sizeof(struct nf_udp_net));
          for(int _i0 = 0; _i0 < _len_un0; _i0++) {
            un[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = udp_kmemdup_sysctl_table(pn,un);
          printf("%d\n", benchRet); 
          free(pn);
          free(un);
