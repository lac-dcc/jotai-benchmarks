...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_glypharr0 = 65025;
          int * glypharr = (int *) malloc(_len_glypharr0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_glypharr0; _i0++) {
            glypharr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          RedrawBlip(glypharr,blippos);
          free(glypharr);
