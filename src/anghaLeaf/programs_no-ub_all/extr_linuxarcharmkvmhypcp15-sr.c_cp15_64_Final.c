...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int idx = 255;
          int _len_ctxt0 = 1;
          struct kvm_cpu_context * ctxt = (struct kvm_cpu_context *) malloc(_len_ctxt0*sizeof(struct kvm_cpu_context));
          for(int _i0 = 0; _i0 < _len_ctxt0; _i0++) {
            ctxt->cp15 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = cp15_64(ctxt,idx);
          printf("{{other_type}} %p\n", &benchRet); 
          free(ctxt);
