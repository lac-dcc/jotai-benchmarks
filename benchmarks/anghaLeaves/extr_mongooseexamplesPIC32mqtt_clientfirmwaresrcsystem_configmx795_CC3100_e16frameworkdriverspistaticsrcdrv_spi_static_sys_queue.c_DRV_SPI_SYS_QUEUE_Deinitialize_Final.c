...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          long queueManager = 100;
        
          int benchRet = DRV_SPI_SYS_QUEUE_Deinitialize(queueManager);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          long queueManager = ((-2 * (next_i()%2)) + 1) * next_i();
