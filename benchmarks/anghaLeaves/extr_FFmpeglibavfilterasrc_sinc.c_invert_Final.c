...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 4103
          // ------------------------------- 
          // static_instructions_O1 : 27
          // dynamic_instructions_O1 : 1551
          // ------------------------------- 
          // static_instructions_O2 : 67
          // dynamic_instructions_O2 : 313
          // ------------------------------- 
          // static_instructions_O3 : 67
          // dynamic_instructions_O3 : 313
          // ------------------------------- 
          // static_instructions_Ofast : 67
          // dynamic_instructions_Ofast : 313
          // ------------------------------- 
          // static_instructions_Os : 25
          // dynamic_instructions_Os : 1549
          // ------------------------------- 
          // static_instructions_Oz : 25
          // dynamic_instructions_Oz : 1805
          // ------------------------------- 
