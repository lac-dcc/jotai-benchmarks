...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_twl40300; _i0++) {
            twl4030->hsr_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        twl4030->hsl_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        twl4030->carkitr_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        twl4030->carkitl_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        twl4030->predriver_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        twl4030->predrivel_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        twl4030->earpiece_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
