...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          long wParam = 100;
          int lParam = 100;
          int _len_pChildWnd0 = 1;
          int * pChildWnd = (int *) malloc(_len_pChildWnd0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pChildWnd0; _i0++) {
            pChildWnd[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
