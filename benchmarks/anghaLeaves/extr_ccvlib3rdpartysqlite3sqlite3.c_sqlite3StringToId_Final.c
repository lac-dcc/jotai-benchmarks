...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              p[_i0].op = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_p__i0__pLeft0 = 1;
          p[_i0].pLeft = (struct TYPE_4__ *) malloc(_len_p__i0__pLeft0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_p__i0__pLeft0; _j0++) {
              p[_i0].pLeft->op = ((-2 * (next_i()%2)) + 1) * next_i();
