...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_range10; _i0++) {
            range1->logical_sector = ((-2 * (next_i()%2)) + 1) * next_i();
        range1->n_sectors = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_range20 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_range20; _i0++) {
            range2->logical_sector = ((-2 * (next_i()%2)) + 1) * next_i();
        range2->n_sectors = ((-2 * (next_i()%2)) + 1) * next_i();
          }
