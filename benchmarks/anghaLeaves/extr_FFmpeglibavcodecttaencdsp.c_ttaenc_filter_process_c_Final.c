...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          // static_instructions_O0 : 204
          // dynamic_instructions_O0 : 204
          // ------------------------------- 
          // static_instructions_O1 : 101
          // dynamic_instructions_O1 : 101
          // ------------------------------- 
          // static_instructions_O2 : 107
          // dynamic_instructions_O2 : 107
          // ------------------------------- 
          // static_instructions_O3 : 107
          // dynamic_instructions_O3 : 107
          // ------------------------------- 
          // static_instructions_Ofast : 107
          // dynamic_instructions_Ofast : 107
          // ------------------------------- 
          // static_instructions_Os : 107
          // dynamic_instructions_Os : 107
          // ------------------------------- 
          // static_instructions_Oz : 107
          ...
          int _len_qm0 = 100;
          int * qm = (int *) malloc(_len_qm0*sizeof(int));
          ...
          int _len_dl0 = 100;
          int * dl = (int *) malloc(_len_dl0*sizeof(int));
          ...
          ttaenc_filter_process_c(qm,dx,dl,error,in,shift,round);
          free(qm);
          free(dx);
          free(dl);
          free(error);
