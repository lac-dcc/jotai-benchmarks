...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int _len_uv_req0 = 65025;
          int * uv_req = (int *) malloc(_len_uv_req0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_uv_req0; _i0++) {
            uv_req[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          req_free(uv_req);
          free(uv_req);
