...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_lq0 = 1;
          struct iwl_link_quality_cmd * lq = (struct iwl_link_quality_cmd *) malloc(_len_lq0*sizeof(struct iwl_link_quality_cmd));
          for(int _i0 = 0; _i0 < _len_lq0; _i0++) {
            lq[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
