...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int filters = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int spatial = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_mean0 = 1;
          float * mean = (float *) malloc(_len_mean0*sizeof(float));
          for(int _i0 = 0; _i0 < _len_mean0; _i0++) {
            mean[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
