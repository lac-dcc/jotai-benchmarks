...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_first0; _i0++) {
            first->operation = ((-2 * (next_i()%2)) + 1) * next_i();
        first->u.rw.nr_segments = ((-2 * (next_i()%2)) + 1) * next_i();
        first->u.rw.handle = ((-2 * (next_i()%2)) + 1) * next_i();
        first->u.rw.sector_number = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_second0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_second0; _i0++) {
            second->operation = ((-2 * (next_i()%2)) + 1) * next_i();
        second->u.rw.nr_segments = ((-2 * (next_i()%2)) + 1) * next_i();
        second->u.rw.handle = ((-2 * (next_i()%2)) + 1) * next_i();
        second->u.rw.sector_number = ((-2 * (next_i()%2)) + 1) * next_i();
          }
