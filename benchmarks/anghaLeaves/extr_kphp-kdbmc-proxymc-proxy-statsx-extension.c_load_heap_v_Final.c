...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_H0; _i0++) {
              int _len_H__i0__cur0 = 1;
          H[_i0].cur = (int *) malloc(_len_H__i0__cur0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_H__i0__cur0; _j0++) {
            H[_i0].cur[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        H[_i0].value64 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          load_heap_v(H);
