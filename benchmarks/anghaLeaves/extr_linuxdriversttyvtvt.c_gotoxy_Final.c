...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int new_x = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int new_y = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          vc[_i0].vc_top = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_bottom = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_rows = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_y = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_size_row = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_need_wrap = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_origin = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          vc[_i0].vc_decom = ((-2 * (next_i()%2)) + 1) * next_i();
