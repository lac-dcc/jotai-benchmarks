...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_intc0 = 1;
          struct bcm6345_l1_chip * intc = (struct bcm6345_l1_chip *) malloc(_len_intc0*sizeof(struct bcm6345_l1_chip));
          for(int _i0 = 0; _i0 < _len_intc0; _i0++) {
            intc->n_words = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned int benchRet = reg_enable(intc,word);
          printf("%u\n", benchRet); 
          free(intc);
