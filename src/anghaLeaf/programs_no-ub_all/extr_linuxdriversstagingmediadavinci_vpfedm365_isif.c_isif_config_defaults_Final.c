...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_isif0; _i0++) {
            isif->isif_cfg.data_pack = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.bayer.data_msb = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.bayer.cfa_pat = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.bayer.frm_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.bayer.pix_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.bayer.v4l2_pix_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.ycbcr.buf_type = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.ycbcr.pix_order = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.ycbcr.frm_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.ycbcr.pix_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        isif->isif_cfg.ycbcr.v4l2_pix_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
