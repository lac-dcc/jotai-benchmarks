...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int protocol_family = 100;
        
          int benchRet = proto_hash_value(protocol_family);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          int protocol_family = ((-2 * (next_i()%2)) + 1) * next_i();
