...
/* Type definitions */
struct ib_smp {scalar_t__ mgmt_class; int /*<<< orphan*/  status; int /*<<< orphan*/  method; } ;
...
__attribute__((used)) static int reply(struct ib_smp *smp)
{
	/*
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_smp0; _i0++) {
            smp->mgmt_class = ((-2 * (next_i()%2)) + 1) * next_i();
        smp->status = ((-2 * (next_i()%2)) + 1) * next_i();
        smp->method = ((-2 * (next_i()%2)) + 1) * next_i();
          }
