...
/* Variables and functions */
 int /*<<< orphan*/  LOWPAN_NHC_ROUTING_ID_0 ; 
 int /*<<< orphan*/  LOWPAN_NHC_ROUTING_MASK_0 ; 

__attribute__((used)) static void routing_nhid_setup(struct lowpan_nhc *nhc)
{
