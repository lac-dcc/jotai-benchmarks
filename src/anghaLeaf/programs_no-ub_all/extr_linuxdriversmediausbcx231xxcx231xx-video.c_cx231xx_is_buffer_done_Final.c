...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dma_q0; _i0++) {
            dma_q->current_field = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_q->lines_completed = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_q->lines_per_field = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_q->field1_done = ((-2 * (next_i()%2)) + 1) * next_i();
          }
