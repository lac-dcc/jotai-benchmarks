...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_decoder0; _i0++) {
            decoder->cbr_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->cbr = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->cbr_cyc_to_tsc = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->max_non_turbo_ratio_fp = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->packet.payload = ((-2 * (next_i()%2)) + 1) * next_i();
          }
