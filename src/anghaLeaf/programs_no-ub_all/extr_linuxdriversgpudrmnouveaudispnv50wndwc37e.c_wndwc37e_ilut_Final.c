...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_asyw0; _i0++) {
            asyw->xlut.i.mode = ((-2 * (next_i()%2)) + 1) * next_i();
        asyw->xlut.i.output_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        asyw->xlut.i.range = ((-2 * (next_i()%2)) + 1) * next_i();
        asyw->xlut.i.size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
