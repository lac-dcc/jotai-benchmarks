...
__attribute__((used)) static inline unsigned long soc_tplg_get_hdr_offset(struct soc_tplg *tplg)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        tplg[_i0].hdr_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = soc_tplg_get_hdr_offset(tplg);
          printf("%lu\n", benchRet); 
