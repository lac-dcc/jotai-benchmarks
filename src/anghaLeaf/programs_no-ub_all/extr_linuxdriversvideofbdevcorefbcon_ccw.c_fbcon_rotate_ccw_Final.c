...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ops0; _i0++) {
            ops->update_start = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->cursor = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->clear_margins = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->putcs = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->clear = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->bmove = ((-2 * (next_i()%2)) + 1) * next_i();
          }
