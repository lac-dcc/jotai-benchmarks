...
/* Variables and functions */
 ...
 int /*<<< orphan*/  module_benchmark_esalt ; 
 int /*<<< orphan*/  module_benchmark_salt ; 
 ...
 int /*<<< orphan*/  module_kern_type_dynamic ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O3 : 98
          // ------------------------------- 
          // static_instructions_Ofast : 98
          // dynamic_instructions_Ofast : 98
          // ------------------------------- 
          // static_instructions_Os : 98
          // dynamic_instructions_Os : 98
          // ------------------------------- 
          // static_instructions_Oz : 98
          ...
          module_ctx[_i0].module_potfile_disable = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_outfile_check_disable = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_opts_type = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_opti_type = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_kern_type_dynamic = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          module_ctx[_i0].module_hash_binary_parse = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_binary_count = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          module_ctx[_i0].module_benchmark_salt = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_benchmark_esalt = ((-2 * (next_i()%2)) + 1) * next_i();
