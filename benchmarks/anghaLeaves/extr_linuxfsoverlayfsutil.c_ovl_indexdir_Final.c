...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_sb__i0__s_fs_info0; _j0++) {
              int _len_sb__i0__s_fs_info_indexdir0 = 1;
          sb[_i0].s_fs_info->indexdir = (struct dentry *) malloc(_len_sb__i0__s_fs_info_indexdir0*sizeof(struct dentry));
          for(int _j0 = 0; _j0 < _len_sb__i0__s_fs_info_indexdir0; _j0++) {
            sb[_i0].s_fs_info->indexdir->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct dentry * benchRet = ovl_indexdir(sb);
          printf("%d\n", (*benchRet).dummy);
