...
struct TYPE_5__ {TYPE_1__ sctp; } ;
struct TYPE_6__ {TYPE_2__ nf_ct_proto; } ;
struct net {TYPE_3__ ct; } ;

/* Variables and functions */

__attribute__((used)) static struct nf_proto_net *sctp_get_net_proto(struct net *net)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_net0; _i0++) {
            net[_i0].ct.nf_ct_proto.sctp.pn.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct nf_proto_net * benchRet = sctp_get_net_proto(net);
          printf("%d\n", (*benchRet).dummy);
          free(net);
