...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_gus0; _i0++) {
            gus->gf1.pcm_alloc_voices = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pvoice0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_pvoice0; _i0++) {
            pvoice->use = ((-2 * (next_i()%2)) + 1) * next_i();
        pvoice->pcm = ((-2 * (next_i()%2)) + 1) * next_i();
        pvoice->synth = ((-2 * (next_i()%2)) + 1) * next_i();
        pvoice->client = ((-2 * (next_i()%2)) + 1) * next_i();
        pvoice->port = ((-2 * (next_i()%2)) + 1) * next_i();
        pvoice->midi = ((-2 * (next_i()%2)) + 1) * next_i();
          }
