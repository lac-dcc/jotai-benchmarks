...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ls0; _i0++) {
            ls->ls_stub_lkb.lkb_remid = ((-2 * (next_i()%2)) + 1) * next_i();
        ls->ls_stub_lkb.lkb_nodeid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ms0 = 1;
          struct dlm_message * ms = (struct dlm_message *) malloc(_len_ms0*sizeof(struct dlm_message));
          for(int _i0 = 0; _i0 < _len_ms0; _i0++) {
            ms->m_lkid = ((-2 * (next_i()%2)) + 1) * next_i();
        ms->m_header.h_nodeid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
