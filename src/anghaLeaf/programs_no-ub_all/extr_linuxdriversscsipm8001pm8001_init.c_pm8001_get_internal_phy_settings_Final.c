...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pm8001_ha0; _i0++) {
            pm8001_ha->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_phycfg0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_phycfg0; _i0++) {
            phycfg->LaneLosCfg = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePgaCfg1 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePisoCfg1 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePisoCfg2 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePisoCfg3 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePisoCfg4 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePisoCfg5 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LanePisoCfg6 = ((-2 * (next_i()%2)) + 1) * next_i();
        phycfg->LaneBctCtrl = ((-2 * (next_i()%2)) + 1) * next_i();
          }
