...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_mp0; _i0++) {
            mp->mnt_ioscale = ((-2 * (next_i()%2)) + 1) * next_i();
        mp->mnt_ioqueue_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        mp->mnt_maxreadcnt = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_mnt_fields0; _i0++) {
            mnt_fields->mnt_ioscale = ((-2 * (next_i()%2)) + 1) * next_i();
        mnt_fields->mnt_ioqueue_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        mnt_fields->mnt_segwritecnt = ((-2 * (next_i()%2)) + 1) * next_i();
        mnt_fields->mnt_segreadcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        mnt_fields->mnt_maxwritecnt = ((-2 * (next_i()%2)) + 1) * next_i();
        mnt_fields->mnt_maxreadcnt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
