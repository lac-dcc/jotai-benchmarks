...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cval0; _i0++) {
              cval[_i0].min = ((-2 * (next_i()%2)) + 1) * next_i();
          cval[_i0].res = ((-2 * (next_i()%2)) + 1) * next_i();
          cval[_i0].max = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = get_abs_value(cval,val);
          printf("%d\n", benchRet); 
          free(cval);
