...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          cdev[_i0].devdata = (struct devfreq_cooling_device *) malloc(_len_cdev__i0__devdata0*sizeof(struct devfreq_cooling_device));
          for(int _j0 = 0; _j0 < _len_cdev__i0__devdata0; _j0++) {
            cdev[_i0].devdata->freq_table_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_state0 = 1;
          ...
          int benchRet = devfreq_cooling_get_max_state(cdev,state);
          printf("%d\n", benchRet); 
