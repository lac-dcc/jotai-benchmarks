...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->irq_start = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->irq_end = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->remote_irq = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->local_irq = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
