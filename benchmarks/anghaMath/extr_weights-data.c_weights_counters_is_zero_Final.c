...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_C0; _i0++) {
              int _len_C__i0__values0 = 1;
          C[_i0].values = (int *) malloc(_len_C__i0__values0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_C__i0__values0; _j0++) {
            C[_i0].values[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = weights_counters_is_zero(C);
          printf("%d\n", benchRet); 
