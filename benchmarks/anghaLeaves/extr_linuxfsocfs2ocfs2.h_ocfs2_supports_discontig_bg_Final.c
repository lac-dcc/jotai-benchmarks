...
/* Variables and functions */
 int OCFS2_FEATURE_INCOMPAT_DISCONTIG_BG ; 

__attribute__((used)) static inline int ocfs2_supports_discontig_bg(struct ocfs2_super *osb)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_osb0; _i0++) {
            osb[_i0].s_feature_incompat = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ocfs2_supports_discontig_bg(osb);
          printf("%d\n", benchRet); 
          free(osb);
