...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cam0; _i0++) {
            cam->pixelformat = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.camera_state.stream_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        cam->num_frames = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->frame_size = ((-2 * (next_i()%2)) + 1) * next_i();
