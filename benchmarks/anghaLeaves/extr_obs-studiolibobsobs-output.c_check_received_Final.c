...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_output0; _i0++) {
            output[_i0].received_video = ((-2 * (next_i()%2)) + 1) * next_i();
        output[_i0].received_audio = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_out0 = 1;
          struct encoder_packet * out = (struct encoder_packet *) malloc(_len_out0*sizeof(struct encoder_packet));
          for(int _i0 = 0; _i0 < _len_out0; _i0++) {
            out[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          check_received(output,out);
          free(output);
          free(out);
