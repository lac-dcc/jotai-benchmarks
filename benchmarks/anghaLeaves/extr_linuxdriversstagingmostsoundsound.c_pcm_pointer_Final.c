...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          substream[_i0].private_data = (struct channel *) malloc(_len_substream__i0__private_data0*sizeof(struct channel));
          for(int _j0 = 0; _j0 < _len_substream__i0__private_data0; _j0++) {
            substream[_i0].private_data->buffer_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = pcm_pointer(substream);
          printf("%d\n", benchRet); 
