...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dst0; _i0++) {
            dst->Send.UnicastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Send.UnicastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Send.BroadcastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Send.BroadcastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Recv.UnicastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Recv.UnicastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Recv.BroadcastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->Recv.BroadcastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_diff0 = 1;
          struct TYPE_8__ * diff = (struct TYPE_8__ *) malloc(_len_diff0*sizeof(struct TYPE_8__));
          for(int _i0 = 0; _i0 < _len_diff0; _i0++) {
            diff->Send.UnicastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Send.UnicastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Send.BroadcastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Send.BroadcastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Recv.UnicastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Recv.UnicastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Recv.BroadcastCount = ((-2 * (next_i()%2)) + 1) * next_i();
        diff->Recv.BroadcastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          AddTraffic(dst,diff);
          free(dst);
          free(diff);
