...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_old0 = 1;
          struct rb_node * old = (struct rb_node *) malloc(_len_old0*sizeof(struct rb_node));
          for(int _i0 = 0; _i0 < _len_old0; _i0++) {
            old[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_new0 = 1;
          struct rb_node * new = (struct rb_node *) malloc(_len_new0*sizeof(struct rb_node));
          for(int _i0 = 0; _i0 < _len_new0; _i0++) {
            new[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          dummy_rotate(old,new);
          free(old);
          free(new);
