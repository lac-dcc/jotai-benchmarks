...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cyapa0; _i0++) {
            cyapa->gen = ((-2 * (next_i()%2)) + 1) * next_i();
        cyapa->platform_ver = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_image_head0; _i0++) {
            image_head->head_size = ((-2 * (next_i()%2)) + 1) * next_i();
        image_head->family_id = ((-2 * (next_i()%2)) + 1) * next_i();
        image_head->silicon_id_hi = ((-2 * (next_i()%2)) + 1) * next_i();
          }
