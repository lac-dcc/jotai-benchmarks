...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_my_aiocbp0; _i0++) {
            my_aiocbp[_i0].aio_sigevent.sigev_notify_attributes = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_sigevent.sigev_notify_function = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_sigevent.sigev_value.size_equivalent.sival_int = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_sigevent.sigev_signo = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_sigevent.sigev_notify = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_lio_opcode = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_reqprio = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_nbytes = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_buf = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        my_aiocbp[_i0].aio_fildes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_the_user_aiocbp0; _i0++) {
            the_user_aiocbp[_i0].aio_sigevent.sigev_notify_attributes = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_sigevent.sigev_notify_function = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_sigevent.sigev_value.size_equivalent.sival_int = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_sigevent.sigev_signo = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_sigevent.sigev_notify = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_lio_opcode = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_reqprio = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_nbytes = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_buf = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_fildes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
    ...
    case 1:
    {
        ...
        my_aiocbp[_i0].aio_fildes = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_the_user_aiocbp0 = 65025;
          struct user_aiocb * the_user_aiocbp = (struct user_aiocb *) malloc(_len_the_user_aiocbp0*sizeof(struct user_aiocb));
          for(int _i0 = 0; _i0 < _len_the_user_aiocbp0; _i0++) {
            the_user_aiocbp[_i0].aio_sigevent.sigev_notify_attributes = ((-2 * (next_i()%2)) + 1) * next_i();
        the_user_aiocbp[_i0].aio_sigevent.sigev_notify_function = ((-2 * (next_i()%2)) + 1) * next_i();
