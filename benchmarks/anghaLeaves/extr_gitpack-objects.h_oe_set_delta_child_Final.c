...
__attribute__((used)) static inline void oe_set_delta_child(struct packing_data *pack,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_delta0; _i0++) {
            delta[_i0].delta_child_idx = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          oe_set_delta_child(pack,e,delta);
