...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c->high = ((-2 * (next_i()%2)) + 1) * next_i();
        c->low = ((-2 * (next_i()%2)) + 1) * next_i();
        c->value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_probs0 = 65025;
          int * probs = (int *) malloc(_len_probs0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_probs0; _i0++) {
            probs[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = arith_get_prob(c,probs);
          printf("%d\n", benchRet); 
          free(c);
          free(probs);
