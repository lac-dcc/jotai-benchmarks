...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
              int _len_ctx__i0__group0 = 1;
          ctx[_i0].group = (struct TYPE_6__ *) malloc(_len_ctx__i0__group0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_ctx__i0__group0; _j0++) {
            ctx[_i0].group->num_ch = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct TYPE_6__ * benchRet = ff_psy_find_group(ctx,channel);
          printf("%ld\n", (*benchRet).num_ch);
