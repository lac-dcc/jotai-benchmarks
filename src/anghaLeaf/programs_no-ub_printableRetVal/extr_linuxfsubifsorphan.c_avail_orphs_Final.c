...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c->orph_lebs = ((-2 * (next_i()%2)) + 1) * next_i();
        c->ohead_lnum = ((-2 * (next_i()%2)) + 1) * next_i();
        c->orph_first = ((-2 * (next_i()%2)) + 1) * next_i();
        c->leb_size = ((-2 * (next_i()%2)) + 1) * next_i();
        c->ohead_offs = ((-2 * (next_i()%2)) + 1) * next_i();
          }
