...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_trace0 = 1;
          struct tracer_stat * trace = (struct tracer_stat *) malloc(_len_trace0*sizeof(struct tracer_stat));
          for(int _i0 = 0; _i0 < _len_trace0; _i0++) {
            trace[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = annotated_branch_stat_start(trace);
          free(trace);
