...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_statep0 = 65025;
          int * statep = (int *) malloc(_len_statep0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_statep0; _i0++) {
            statep[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          get_sockev_state(so,statep);
          free(so);
          free(statep);
