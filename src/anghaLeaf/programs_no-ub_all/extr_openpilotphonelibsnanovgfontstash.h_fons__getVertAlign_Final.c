...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stash0; _i0++) {
            stash->params.flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_font0 = 1;
          struct TYPE_7__ * font = (struct TYPE_7__ *) malloc(_len_font0*sizeof(struct TYPE_7__));
          for(int _i0 = 0; _i0 < _len_font0; _i0++) {
            font->ascender = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        font->descender = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
