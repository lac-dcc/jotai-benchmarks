...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_filter_cmd0 = 1;
          struct qed_filter_mcast * p_filter_cmd = (struct qed_filter_mcast *) malloc(_len_p_filter_cmd0*sizeof(struct qed_filter_mcast));
          for(int _i0 = 0; _i0 < _len_p_filter_cmd0; _i0++) {
            p_filter_cmd[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
