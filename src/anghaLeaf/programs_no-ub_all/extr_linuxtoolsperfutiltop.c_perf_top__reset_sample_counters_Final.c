...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_top0; _i0++) {
            top->guest_us_samples = ((-2 * (next_i()%2)) + 1) * next_i();
        top->guest_kernel_samples = ((-2 * (next_i()%2)) + 1) * next_i();
        top->exact_samples = ((-2 * (next_i()%2)) + 1) * next_i();
        top->kernel_samples = ((-2 * (next_i()%2)) + 1) * next_i();
        top->us_samples = ((-2 * (next_i()%2)) + 1) * next_i();
        top->samples = ((-2 * (next_i()%2)) + 1) * next_i();
          }
