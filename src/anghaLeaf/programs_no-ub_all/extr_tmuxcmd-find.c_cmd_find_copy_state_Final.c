...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dst0; _i0++) {
            dst->wp = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->w = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->idx = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->wl = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->s = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_src0 = 1;
          struct cmd_find_state * src = (struct cmd_find_state *) malloc(_len_src0*sizeof(struct cmd_find_state));
          for(int _i0 = 0; _i0 < _len_src0; _i0++) {
            src->wp = ((-2 * (next_i()%2)) + 1) * next_i();
        src->w = ((-2 * (next_i()%2)) + 1) * next_i();
        src->idx = ((-2 * (next_i()%2)) + 1) * next_i();
        src->wl = ((-2 * (next_i()%2)) + 1) * next_i();
        src->s = ((-2 * (next_i()%2)) + 1) * next_i();
          }
