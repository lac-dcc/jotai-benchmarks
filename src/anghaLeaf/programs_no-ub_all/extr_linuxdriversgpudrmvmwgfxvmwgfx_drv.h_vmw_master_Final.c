...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_master0 = 1;
          struct drm_master * master = (struct drm_master *) malloc(_len_master0*sizeof(struct drm_master));
          for(int _i0 = 0; _i0 < _len_master0; _i0++) {
            master->driver_priv = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct vmw_master * benchRet = vmw_master(master);
          printf("{{struct}} %p\n", &benchRet); 
          free(master);
