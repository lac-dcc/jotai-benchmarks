...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_cdc0 = 1;
          struct TYPE_3__ * cdc = (struct TYPE_3__ *) malloc(_len_cdc0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_cdc0; _i0++) {
            cdc[_i0].connect_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = usbd_cdc_is_connected(cdc);
          printf("%d\n", benchRet); 
          free(cdc);
