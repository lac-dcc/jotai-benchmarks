...
__attribute__((used)) static void si_trim_voltage_table_to_fit_state_table(struct amdgpu_device *adev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int max_voltage_steps = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          si_trim_voltage_table_to_fit_state_table(adev,max_voltage_steps,voltage_table);
          free(adev);
