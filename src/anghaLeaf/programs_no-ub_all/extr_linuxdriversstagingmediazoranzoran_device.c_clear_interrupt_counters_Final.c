...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_zr0; _i0++) {
            zr->JPEG_min_missed = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->JPEG_max_missed = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->JPEG_missed = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->END_event_missed = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->JPEG_1 = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->JPEG_0 = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->JPEG_out = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->JPEG_in = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->IRQ1_out = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->IRQ1_in = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->field_counter = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->intr_counter_JPEGRepIRQ = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->intr_counter_CodRepIRQ = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->intr_counter_GIRQ0 = ((-2 * (next_i()%2)) + 1) * next_i();
        zr->intr_counter_GIRQ1 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
