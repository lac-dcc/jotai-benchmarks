...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_parm0; _i0++) {
              parm[_i0].parm.capture.timeperframe.numerator = ((-2 * (next_i()%2)) + 1) * next_i();
          parm[_i0].parm.capture.timeperframe.denominator = ((-2 * (next_i()%2)) + 1) * next_i();
