...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_wq0; _i0++) {
            wq->wq_constrained_queue.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
        wq->wq_overcommit_queue.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
        wq->wq_special_queue.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_req0 = 1;
          struct TYPE_3__ * req = (struct TYPE_3__ *) malloc(_len_req0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_req0; _i0++) {
            req->tr_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
