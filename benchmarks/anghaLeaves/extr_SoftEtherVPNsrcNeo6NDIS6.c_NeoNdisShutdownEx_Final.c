...
/* Type definitions */
typedef  int /*<<< orphan*/  NDIS_SHUTDOWN_ACTION ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int ShutdownAction = 100;
          NeoNdisShutdownEx(MiniportAdapterContext,ShutdownAction);
