...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_type_info0; _i0++) {
            type_info->leaf_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_print_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_mlist = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_index = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_arglist = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_this_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_class_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_return_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_utype = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_vshape = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_derived = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_base_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_index_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_element_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_arg_type = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_members = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_name_len = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_val = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_name = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->free_ = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->is_fwdref = ((-2 * (next_i()%2)) + 1) * next_i();
        type_info->get_modified_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
