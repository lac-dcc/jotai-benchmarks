...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_a0; _i0++) {
            a->left = ((-2 * (next_i()%2)) + 1) * next_i();
        a->top = ((-2 * (next_i()%2)) + 1) * next_i();
        a->width = ((-2 * (next_i()%2)) + 1) * next_i();
        a->height = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_b0 = 1;
          struct v4l2_rect * b = (struct v4l2_rect *) malloc(_len_b0*sizeof(struct v4l2_rect));
          for(int _i0 = 0; _i0 < _len_b0; _i0++) {
            b->left = ((-2 * (next_i()%2)) + 1) * next_i();
        b->top = ((-2 * (next_i()%2)) + 1) * next_i();
        b->width = ((-2 * (next_i()%2)) + 1) * next_i();
        b->height = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_rectangle_enclosed(a,b);
          printf("%d\n", benchRet); 
          free(a);
          free(b);
