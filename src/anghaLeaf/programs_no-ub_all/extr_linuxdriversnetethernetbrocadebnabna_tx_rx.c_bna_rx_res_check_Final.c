...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rx_mod0; _i0++) {
            rx_mod->rx_free_count = ((-2 * (next_i()%2)) + 1) * next_i();
        rx_mod->rxp_free_count = ((-2 * (next_i()%2)) + 1) * next_i();
        rx_mod->rxq_free_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rx_cfg0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_rx_cfg0; _i0++) {
            rx_cfg->rxp_type = ((-2 * (next_i()%2)) + 1) * next_i();
        rx_cfg->num_paths = ((-2 * (next_i()%2)) + 1) * next_i();
          }
