...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cfa0; _i0++) {
            cfa->hpf_thr_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->hpf_slp_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->hp_mix_thr_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->hp_mix_slope_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->dir_thr_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->dir_slope_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->nd_wt_2dir = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->hue_fract_daa = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->edge_thr_daa = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->thr_min_daa = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->thr_slope_daa = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->slope_min_daa = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->slope_slope_daa = ((-2 * (next_i()%2)) + 1) * next_i();
        cfa->lp_wt_daa = ((-2 * (next_i()%2)) + 1) * next_i();
          }
