...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_req0; _i0++) {
            req->upgrade_request = ((-2 * (next_i()%2)) + 1) * next_i();
        req->upgrade = ((-2 * (next_i()%2)) + 1) * next_i();
        req->done_processing = ((-2 * (next_i()%2)) + 1) * next_i();
        req->connect_port = ((-2 * (next_i()%2)) + 1) * next_i();
        req->callcount = ((-2 * (next_i()%2)) + 1) * next_i();
        req->prot_version = ((-2 * (next_i()%2)) + 1) * next_i();
        req->rcmd = ((-2 * (next_i()%2)) + 1) * next_i();
        req->writedelay = ((-2 * (next_i()%2)) + 1) * next_i();
        req->skip = ((-2 * (next_i()%2)) + 1) * next_i();
        req->cl = ((-2 * (next_i()%2)) + 1) * next_i();
        req->open = ((-2 * (next_i()%2)) + 1) * next_i();
        req->partno = ((-2 * (next_i()%2)) + 1) * next_i();
        req->testno = ((-2 * (next_i()%2)) + 1) * next_i();
        req->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        req->checkindex = ((-2 * (next_i()%2)) + 1) * next_i();
          }
