...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->handle.ops.clk_ops.get_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.set_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.get_best_match_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.get_num_parents = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.get_parent = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.set_parent = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.is_off = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.is_on = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.is_auto = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.put_clock = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.idle_clock = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.clk_ops.get_clock = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.get_device_resets = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.set_device_resets = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.is_transitioning = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.is_on = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.is_stop = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.is_idle = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.get_context_loss_count = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.is_valid = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.put_device = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.idle_device = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.dev_ops.get_device = ((-2 * (next_i()%2)) + 1) * next_i();
        info->handle.ops.core_ops.reboot_device = ((-2 * (next_i()%2)) + 1) * next_i();
          }
