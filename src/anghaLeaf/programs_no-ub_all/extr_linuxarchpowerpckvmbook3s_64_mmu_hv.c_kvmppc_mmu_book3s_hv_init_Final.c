...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vcpu0; _i0++) {
            vcpu->arch.slb_nr = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->arch.hflags = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->arch.mmu.reset_msr = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->arch.mmu.xlate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
