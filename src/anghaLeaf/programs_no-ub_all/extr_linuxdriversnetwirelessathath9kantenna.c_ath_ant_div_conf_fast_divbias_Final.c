...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ant_conf0; _i0++) {
            ant_conf->div_group = ((-2 * (next_i()%2)) + 1) * next_i();
        ant_conf->main_lna_conf = ((-2 * (next_i()%2)) + 1) * next_i();
        ant_conf->alt_lna_conf = ((-2 * (next_i()%2)) + 1) * next_i();
        ant_conf->fast_div_bias = ((-2 * (next_i()%2)) + 1) * next_i();
        ant_conf->alt_gaintb = ((-2 * (next_i()%2)) + 1) * next_i();
        ant_conf->main_gaintb = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_antcomb0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_antcomb0; _i0++) {
            antcomb->ant_ratio = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->fast_div_bias = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->scan = ((-2 * (next_i()%2)) + 1) * next_i();
          }
