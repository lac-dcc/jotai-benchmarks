...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_identify0; _i0++) {
            identify->device_type = ((-2 * (next_i()%2)) + 1) * next_i();
        identify->target_port_protocols = ((-2 * (next_i()%2)) + 1) * next_i();
        identify->initiator_port_protocols = ((-2 * (next_i()%2)) + 1) * next_i();
        identify->phy_identifier = ((-2 * (next_i()%2)) + 1) * next_i();
        identify->sas_address = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_device_info0; _i0++) {
            device_info->device_info = ((-2 * (next_i()%2)) + 1) * next_i();
        device_info->phy_id = ((-2 * (next_i()%2)) + 1) * next_i();
        device_info->sas_address = ((-2 * (next_i()%2)) + 1) * next_i();
          }
