...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stat0; _i0++) {
            stat->icp6errs_unknown = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_redirect = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_paramprob_option = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_paramprob_nextheader = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_paramprob_header = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_time_exceed_reassembly = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_time_exceed_transit = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_packet_too_big = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_dst_unreach_noport = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_dst_unreach_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_dst_unreach_beyondscope = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_dst_unreach_admin = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->icp6errs_dst_unreach_noroute = ((-2 * (next_i()%2)) + 1) * next_i();
          }
