...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_mpio0 = 1;
          struct dm_mpath_io * mpio = (struct dm_mpath_io *) malloc(_len_mpio0*sizeof(struct dm_mpath_io));
          for(int _i0 = 0; _i0 < _len_mpio0; _i0++) {
            mpio[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct dm_bio_details * benchRet = get_bio_details_from_mpio(mpio);
          free(mpio);
