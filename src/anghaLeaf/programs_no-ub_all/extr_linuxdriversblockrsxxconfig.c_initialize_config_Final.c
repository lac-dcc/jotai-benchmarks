...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cfg0; _i0++) {
            cfg->data.cache_order = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->data.intr_coal.latency = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->data.intr_coal.count = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->data.intr_coal.mode = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->data.vendor_id = ((-2 * (next_i()%2)) + 1) * next_i();
        cfg->hdr.version = ((-2 * (next_i()%2)) + 1) * next_i();
          }
