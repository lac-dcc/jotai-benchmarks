...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s[_i0].stack_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_s__i0__stack0 = 1;
          s[_i0].stack = (char *) malloc(_len_s__i0__stack0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_s__i0__stack0; _j0++) {
            s[_i0].stack[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = webvtt_stack_push(s,c);
          printf("%d\n", benchRet); 
