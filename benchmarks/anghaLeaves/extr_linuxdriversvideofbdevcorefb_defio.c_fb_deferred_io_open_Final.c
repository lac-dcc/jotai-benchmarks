...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_file__i0__f_mapping0; _j0++) {
              int _len_file__i0__f_mapping_a_ops0 = 1;
          file[_i0].f_mapping->a_ops = (int *) malloc(_len_file__i0__f_mapping_a_ops0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_file__i0__f_mapping_a_ops0; _j0++) {
            file[_i0].f_mapping->a_ops[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
