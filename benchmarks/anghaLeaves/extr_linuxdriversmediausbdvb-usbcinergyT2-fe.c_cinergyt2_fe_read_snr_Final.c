...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].demodulator_priv = (struct cinergyt2_fe_state *) malloc(_len_fe__i0__demodulator_priv0*sizeof(struct cinergyt2_fe_state));
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
            fe[_i0].demodulator_priv->status.snr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_snr0 = 1;
          int * snr = (int *) malloc(_len_snr0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_snr0; _i0++) {
            snr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = cinergyt2_fe_read_snr(fe,snr);
          printf("%d\n", benchRet); 
