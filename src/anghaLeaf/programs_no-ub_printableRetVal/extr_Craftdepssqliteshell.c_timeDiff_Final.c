...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pStart0; _i0++) {
            pStart->tv_usec = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        pStart->tv_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pEnd0 = 1;
          struct timeval * pEnd = (struct timeval *) malloc(_len_pEnd0*sizeof(struct timeval));
          for(int _i0 = 0; _i0 < _len_pEnd0; _i0++) {
            pEnd->tv_usec = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        pEnd->tv_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
