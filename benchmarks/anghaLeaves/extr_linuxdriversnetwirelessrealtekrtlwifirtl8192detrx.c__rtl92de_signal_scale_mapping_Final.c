...
__attribute__((used)) static long _rtl92de_signal_scale_mapping(struct ieee80211_hw *hw, long currsig)
{
	long retsig;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long benchRet = _rtl92de_signal_scale_mapping(hw,currsig);
          printf("%ld\n", benchRet); 
          free(hw);
    ...
    case 3:
    {
          ...
          long currsig = ((-2 * (next_i()%2)) + 1) * next_i();
