...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ar0; _i0++) {
            ar->mbox_info.gmbox_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        ar->mbox_info.gmbox_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ar->mbox_info.block_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ar->mbox_info.htc_ext_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        ar->mbox_info.htc_ext_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ar->mbox_info.htc_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
