...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state[_i0].m_SettlingTime = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_IFLevelAnalog = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_IFLevelDigital = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_IFLevelDVBC = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_IFLevelDVBT = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_EP4 = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_EP3_Standby = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_bMaster = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_bFMInput = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_Frequency = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          reset(state);
          free(state);
