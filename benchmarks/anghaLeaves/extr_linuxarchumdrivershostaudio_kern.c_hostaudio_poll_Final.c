...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_wait0 = 1;
          struct poll_table_struct * wait = (struct poll_table_struct *) malloc(_len_wait0*sizeof(struct poll_table_struct));
          for(int _i0 = 0; _i0 < _len_wait0; _i0++) {
            wait[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = hostaudio_poll(file,wait);
          printf("%d\n", benchRet); 
          free(file);
          free(wait);
