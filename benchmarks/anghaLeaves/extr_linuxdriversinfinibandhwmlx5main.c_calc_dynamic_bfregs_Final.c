...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int uars_per_sys_page = 100;
        
          int benchRet = calc_dynamic_bfregs(uars_per_sys_page);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          int uars_per_sys_page = ((-2 * (next_i()%2)) + 1) * next_i();
