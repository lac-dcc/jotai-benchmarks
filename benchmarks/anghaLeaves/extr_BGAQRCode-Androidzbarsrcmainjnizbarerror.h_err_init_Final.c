...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_err0 = 1;
          struct TYPE_3__ * err = (struct TYPE_3__ *) malloc(_len_err0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_err0; _i0++) {
              err[_i0].module = ((-2 * (next_i()%2)) + 1) * next_i();
          err[_i0].magic = ((-2 * (next_i()%2)) + 1) * next_i();
    ...
    case 3:
    {
          int module = ((-2 * (next_i()%2)) + 1) * next_i();
