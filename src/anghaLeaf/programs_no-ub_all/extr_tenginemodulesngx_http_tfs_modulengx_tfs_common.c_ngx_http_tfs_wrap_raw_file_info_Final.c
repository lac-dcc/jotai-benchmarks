...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_file_info0; _i0++) {
            file_info->crc = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->flag = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->create_time = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->modify_time = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->u_size = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->size = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        file_info->id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_file_stat0; _i0++) {
            file_stat->crc = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->flag = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->create_time = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->modify_time = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->u_size = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->size = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        file_stat->id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
