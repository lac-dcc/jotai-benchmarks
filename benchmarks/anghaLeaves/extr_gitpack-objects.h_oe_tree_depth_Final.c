...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pack0; _i0++) {
              int _len_pack__i0__tree_depth0 = 1;
          pack[_i0].tree_depth = (unsigned int *) malloc(_len_pack__i0__tree_depth0*sizeof(unsigned int));
          for(int _j0 = 0; _j0 < _len_pack__i0__tree_depth0; _j0++) {
            pack[_i0].tree_depth[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _j0 = 0; _j0 < _len_pack__i0__objects0; _j0++) {
            pack[_i0].objects->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_e0 = 1;
          ...
          unsigned int benchRet = oe_tree_depth(pack,e);
          printf("%u\n", benchRet); 
          for(int _aux = 0; _aux < _len_pack0; _aux++) {
          free(pack[_aux].tree_depth);
          }
          for(int _aux = 0; _aux < _len_pack0; _aux++) {
