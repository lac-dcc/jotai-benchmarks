...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int pointer = 100;
        
          int _len_priv0 = 1;
          struct ftgmac100 * priv = (struct ftgmac100 *) malloc(_len_priv0*sizeof(struct ftgmac100));
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
              priv[_i0].rx_q_entries = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          unsigned int benchRet = ftgmac100_next_rx_pointer(priv,pointer);
          printf("%u\n", benchRet); 
          free(priv);
    ...
    case 3:
    {
          ...
          unsigned int pointer = ((-2 * (next_i()%2)) + 1) * next_i();
