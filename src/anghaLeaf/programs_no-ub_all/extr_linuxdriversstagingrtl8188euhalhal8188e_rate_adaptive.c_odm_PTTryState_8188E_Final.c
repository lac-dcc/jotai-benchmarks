...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pRaInfo0; _i0++) {
            pRaInfo->PTTryState = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->PTModeSS = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->DecisionRate = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->RssiStaRA = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->PTStage = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->PTStopCount = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->PTPreRssi = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->PTPreRate = ((-2 * (next_i()%2)) + 1) * next_i();
        pRaInfo->RAstage = ((-2 * (next_i()%2)) + 1) * next_i();
          }
