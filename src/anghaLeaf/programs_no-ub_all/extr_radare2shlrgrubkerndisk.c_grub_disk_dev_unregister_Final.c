...
struct TYPE_4__ *_allocate_dev(int length) {
...
void _delete_dev(struct TYPE_4__ * head) {
  if(head->next != NULL) _delete_dev(head->next);
  free(head);
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          struct TYPE_4__ * dev = _allocate_dev(1);
