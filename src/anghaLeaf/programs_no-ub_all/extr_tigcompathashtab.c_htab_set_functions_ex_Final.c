...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_htab0; _i0++) {
            htab->free_with_arg_f = ((-2 * (next_i()%2)) + 1) * next_i();
        htab->alloc_with_arg_f = ((-2 * (next_i()%2)) + 1) * next_i();
        htab->alloc_arg = ((-2 * (next_i()%2)) + 1) * next_i();
        htab->del_f = ((-2 * (next_i()%2)) + 1) * next_i();
        htab->eq_f = ((-2 * (next_i()%2)) + 1) * next_i();
        htab->hash_f = ((-2 * (next_i()%2)) + 1) * next_i();
          }
