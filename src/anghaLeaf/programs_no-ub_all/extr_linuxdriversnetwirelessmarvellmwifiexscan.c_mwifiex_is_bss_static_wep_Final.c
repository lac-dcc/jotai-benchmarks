...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->sec_info.wpa2_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->sec_info.wpa_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->sec_info.wep_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_bss_desc0; _i0++) {
            bss_desc->privacy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
