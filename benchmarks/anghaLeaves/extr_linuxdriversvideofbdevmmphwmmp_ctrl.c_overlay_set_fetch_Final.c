...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_overlay0 = 1;
          struct mmp_overlay * overlay = (struct mmp_overlay *) malloc(_len_overlay0*sizeof(struct mmp_overlay));
          for(int _i0 = 0; _i0 < _len_overlay0; _i0++) {
              overlay[_i0].dmafetch_id = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          overlay_set_fetch(overlay,fetch_id);
          free(overlay);
    ...
    case 3:
    {
          ...
          int fetch_id = ((-2 * (next_i()%2)) + 1) * next_i();
