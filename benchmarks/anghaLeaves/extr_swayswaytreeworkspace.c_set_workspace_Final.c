...
/* Type definitions */
struct sway_container {TYPE_1__* parent; int /*<<< orphan*/  workspace; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_container0; _i0++) {
              int _len_container__i0__parent0 = 1;
          container[_i0].parent = (struct TYPE_2__ *) malloc(_len_container__i0__parent0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_container__i0__parent0; _j0++) {
              container[_i0].parent->workspace = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
          container[_i0].workspace = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          void * data;
        
          set_workspace(container,data);
          for(int _aux = 0; _aux < _len_container0; _aux++) {
          free(container[_aux].parent);
          }
          free(container);
