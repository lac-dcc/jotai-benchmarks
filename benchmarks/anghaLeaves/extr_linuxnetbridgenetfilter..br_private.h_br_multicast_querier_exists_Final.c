...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_eth0 = 1;
          struct ethhdr * eth = (struct ethhdr *) malloc(_len_eth0*sizeof(struct ethhdr));
          for(int _i0 = 0; _i0 < _len_eth0; _i0++) {
            eth[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = br_multicast_querier_exists(br,eth);
          printf("%d\n", benchRet); 
          free(br);
          free(eth);
