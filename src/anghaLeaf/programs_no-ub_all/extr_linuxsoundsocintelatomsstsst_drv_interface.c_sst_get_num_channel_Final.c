...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_str_param0; _i0++) {
            str_param->codec = ((-2 * (next_i()%2)) + 1) * next_i();
        str_param->sparams.uc.aac_params.num_chan = ((-2 * (next_i()%2)) + 1) * next_i();
        str_param->sparams.uc.mp3_params.num_chan = ((-2 * (next_i()%2)) + 1) * next_i();
        str_param->sparams.uc.pcm_params.num_chan = ((-2 * (next_i()%2)) + 1) * next_i();
          }
