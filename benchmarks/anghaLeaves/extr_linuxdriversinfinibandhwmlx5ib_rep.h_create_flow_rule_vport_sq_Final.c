...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_sq0 = 1;
          struct mlx5_ib_sq * sq = (struct mlx5_ib_sq *) malloc(_len_sq0*sizeof(struct mlx5_ib_sq));
          for(int _i0 = 0; _i0 < _len_sq0; _i0++) {
            sq[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = create_flow_rule_vport_sq(dev,sq);
          printf("%d\n", benchRet); 
          free(dev);
          free(sq);
