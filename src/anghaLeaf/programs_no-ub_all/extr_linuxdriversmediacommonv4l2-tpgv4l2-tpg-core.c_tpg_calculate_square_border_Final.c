...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tpg0; _i0++) {
            tpg->src_width = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->src_height = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->vid_aspect = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->pix_aspect = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->border.left = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->border.width = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->border.top = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->border.height = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->square.width = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->square.left = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->square.height = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->square.top = ((-2 * (next_i()%2)) + 1) * next_i();
          }
