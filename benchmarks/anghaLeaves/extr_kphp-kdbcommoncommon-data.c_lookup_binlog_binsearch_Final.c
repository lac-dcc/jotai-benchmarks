...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long long binlog_time = 100;
        
          int a = 100;
        
          int b = 100;
        
          int benchRet = lookup_binlog_binsearch(binlog_time,a,b);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          long long binlog_time = ((-2 * (next_i()%2)) + 1) * next_i();
