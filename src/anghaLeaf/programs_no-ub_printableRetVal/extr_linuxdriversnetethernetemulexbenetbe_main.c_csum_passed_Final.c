...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rxcp0; _i0++) {
            rxcp->err = ((-2 * (next_i()%2)) + 1) * next_i();
        rxcp->ipv6 = ((-2 * (next_i()%2)) + 1) * next_i();
        rxcp->ip_csum = ((-2 * (next_i()%2)) + 1) * next_i();
        rxcp->l4_csum = ((-2 * (next_i()%2)) + 1) * next_i();
        rxcp->udpf = ((-2 * (next_i()%2)) + 1) * next_i();
        rxcp->tcpf = ((-2 * (next_i()%2)) + 1) * next_i();
          }
