...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ndev0; _i0++) {
            ndev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_info0 = 1;
        ...
        info->phc_index = ((-2 * (next_i()%2)) + 1) * next_i();
        info->rx_filters = ((-2 * (next_i()%2)) + 1) * next_i();
        info->tx_types = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = cpsw_get_ts_info(ndev,info);
          printf("%d\n", benchRet); 
          free(ndev);
          free(info);
