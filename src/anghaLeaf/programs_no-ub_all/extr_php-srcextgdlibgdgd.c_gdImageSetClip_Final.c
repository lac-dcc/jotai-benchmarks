...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_im0; _i0++) {
            im->sx = ((-2 * (next_i()%2)) + 1) * next_i();
        im->sy = ((-2 * (next_i()%2)) + 1) * next_i();
        im->cx1 = ((-2 * (next_i()%2)) + 1) * next_i();
        im->cy1 = ((-2 * (next_i()%2)) + 1) * next_i();
        im->cx2 = ((-2 * (next_i()%2)) + 1) * next_i();
        im->cy2 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
