...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ri0; _i0++) {
            ri->ri_child_elapsed_abstime = ((-2 * (next_i()%2)) + 1) * next_i();
        ri->ri_child_pageins = ((-2 * (next_i()%2)) + 1) * next_i();
        ri->ri_child_interrupt_wkups = ((-2 * (next_i()%2)) + 1) * next_i();
        ri->ri_child_pkg_idle_wkups = ((-2 * (next_i()%2)) + 1) * next_i();
        ri->ri_child_system_time = ((-2 * (next_i()%2)) + 1) * next_i();
        ri->ri_child_user_time = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_ri_current0; _i0++) {
            ri_current->ri_child_elapsed_abstime = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_proc_start_abstime = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_proc_exit_abstime = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_child_pageins = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_pageins = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_child_interrupt_wkups = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_interrupt_wkups = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_child_pkg_idle_wkups = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_pkg_idle_wkups = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_child_system_time = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_system_time = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_child_user_time = ((-2 * (next_i()%2)) + 1) * next_i();
        ri_current->ri_user_time = ((-2 * (next_i()%2)) + 1) * next_i();
          }
