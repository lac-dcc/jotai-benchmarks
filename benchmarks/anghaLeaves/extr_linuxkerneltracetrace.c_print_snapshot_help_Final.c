...
__attribute__((used)) static inline void print_snapshot_help(struct seq_file *m, struct trace_iterator *iter) { }
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_iter0 = 1;
          struct trace_iterator * iter = (struct trace_iterator *) malloc(_len_iter0*sizeof(struct trace_iterator));
