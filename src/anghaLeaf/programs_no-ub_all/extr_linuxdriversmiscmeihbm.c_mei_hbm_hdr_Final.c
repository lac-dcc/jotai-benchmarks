...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hdr0; _i0++) {
            hdr->length = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr->msg_complete = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr->internal = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr->reserved = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr->dma_ring = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr->me_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        hdr->host_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
