...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = ifproto_media_ioctl(ifp,protocol,command,argument);
          printf("%d\n", benchRet); 
          free(ifp);
    ...
    case 3:
    {
          ...
          unsigned long command = ((-2 * (next_i()%2)) + 1) * next_i();
