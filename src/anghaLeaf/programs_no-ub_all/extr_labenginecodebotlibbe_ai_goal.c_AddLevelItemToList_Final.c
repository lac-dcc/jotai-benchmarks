...
struct TYPE_4__ *_allocate_li(int length) {
...
void _delete_li(struct TYPE_4__ * head) {
  if(head->next != NULL) _delete_li(head->next);
  if(head->prev != NULL) _delete_li(head->prev);
  free(head);
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          struct TYPE_4__ * li = _allocate_li(1);
