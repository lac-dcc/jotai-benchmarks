...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].dev_private = (struct nouveau_drm *) malloc(_len_dev__i0__dev_private0*sizeof(struct nouveau_drm));
          for(int _j0 = 0; _j0 < _len_dev__i0__dev_private0; _j0++) {
              dev[_i0].dev_private->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          struct nouveau_drm * benchRet = nouveau_drm(dev);
          printf("%d\n", (*benchRet).dummy);
