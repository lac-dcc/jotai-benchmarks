...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_parser0; _i0++) {
            parser[_i0].header_index = ((-2 * (next_i()%2)) + 1) * next_i();
        parser[_i0].on_value = ((-2 * (next_i()%2)) + 1) * next_i();
        parser[_i0].on_field = ((-2 * (next_i()%2)) + 1) * next_i();
        parser[_i0].state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * context;
          query_string_parser_init(parser,context);
          free(parser);
