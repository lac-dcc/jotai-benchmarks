...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = speedlink_input_mapping(hdev,hi,field,usage,bit,max);
          printf("%d\n", benchRet); 
          free(hdev);
          free(hi);
          free(field);
