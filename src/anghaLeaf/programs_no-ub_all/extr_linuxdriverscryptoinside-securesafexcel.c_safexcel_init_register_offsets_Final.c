...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->version = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.pe = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_gen_cfg = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_dse_thr = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_dse = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_dfe_thr = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_dfe = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_aic_xdr = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_aic_r = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_aic_g = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->offsets.hia_aic = ((-2 * (next_i()%2)) + 1) * next_i();
          }
