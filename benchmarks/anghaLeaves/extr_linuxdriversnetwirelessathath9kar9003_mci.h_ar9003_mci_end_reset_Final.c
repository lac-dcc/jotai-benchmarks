...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_caldata0 = 1;
          struct ath9k_hw_cal_data * caldata = (struct ath9k_hw_cal_data *) malloc(_len_caldata0*sizeof(struct ath9k_hw_cal_data));
          for(int _i0 = 0; _i0 < _len_caldata0; _i0++) {
            caldata[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ar9003_mci_end_reset(ah,chan,caldata);
          printf("%d\n", benchRet); 
          free(ah);
          free(chan);
          free(caldata);
