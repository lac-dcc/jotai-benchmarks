...
int main(int argc, char *argv[]) {
    ...
    {
          struct media_frames_per_second fps;
        fps.denominator = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        fps.numerator = ((-2 * (next_i()%2)) + 1) * next_i();
          double benchRet = media_frames_per_second_to_fps(fps);
          printf("%lf\n", benchRet); 
