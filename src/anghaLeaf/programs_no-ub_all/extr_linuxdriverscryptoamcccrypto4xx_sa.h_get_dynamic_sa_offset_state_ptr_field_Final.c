...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cts0; _i0++) {
            cts->sa_contents.bf.key_size = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.inner_size = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.outer_size = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.spi = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.seq_num0 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.seq_num1 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.seq_num_mask0 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.seq_num_mask1 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.seq_num_mask2 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.seq_num_mask3 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.iv0 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.iv1 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.iv2 = ((-2 * (next_i()%2)) + 1) * next_i();
        cts->sa_contents.bf.iv3 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
