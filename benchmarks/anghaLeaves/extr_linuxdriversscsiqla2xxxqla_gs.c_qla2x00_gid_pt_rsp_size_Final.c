...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_vha0 = 1;
          struct TYPE_5__ * vha = (struct TYPE_5__ *) malloc(_len_vha0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_vha0; _i0++) {
              int _len_vha__i0__hw0 = 1;
          vha[_i0].hw = (struct TYPE_4__ *) malloc(_len_vha__i0__hw0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_vha__i0__hw0; _j0++) {
            vha[_i0].hw->max_fibre_devices = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = qla2x00_gid_pt_rsp_size(vha);
          printf("%d\n", benchRet); 
