...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int benchRet = tegra_gpio_compose(bank,port,bit);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int bank = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int port = ((-2 * (next_i()%2)) + 1) * next_i();
