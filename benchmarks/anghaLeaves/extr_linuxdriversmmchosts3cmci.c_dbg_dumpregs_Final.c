...
__attribute__((used)) static void dbg_dumpregs(struct s3cmci_host *host, char *prefix) { }
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_host0 = 1;
          struct s3cmci_host * host = (struct s3cmci_host *) malloc(_len_host0*sizeof(struct s3cmci_host));
