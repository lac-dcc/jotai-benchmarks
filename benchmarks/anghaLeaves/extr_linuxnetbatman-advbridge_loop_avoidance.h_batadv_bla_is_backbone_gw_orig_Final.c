...
__attribute__((used)) static inline bool batadv_bla_is_backbone_gw_orig(struct batadv_priv *bat_priv,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_orig0 = 1;
          int * orig = (int *) malloc(_len_orig0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_orig0; _i0++) {
            orig[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = batadv_bla_is_backbone_gw_orig(bat_priv,orig,vid);
          printf("%d\n", benchRet); 
          free(bat_priv);
          free(orig);
