...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
            hw->mbx.stats.rsts = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.stats.acks = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.stats.reqs = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.stats.msgs_rx = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.stats.msgs_tx = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.unlock = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.check_for_rst = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.check_for_ack = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.check_for_msg = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.write_posted = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.read_posted = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.write = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.ops.read = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.size = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.usec_delay = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mbx.timeout = ((-2 * (next_i()%2)) + 1) * next_i();
          }
