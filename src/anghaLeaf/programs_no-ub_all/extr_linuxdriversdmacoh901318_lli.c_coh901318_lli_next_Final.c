...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_data0 = 1;
          struct coh901318_lli * data = (struct coh901318_lli *) malloc(_len_data0*sizeof(struct coh901318_lli));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->link_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        data->virt_link_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct coh901318_lli * benchRet = coh901318_lli_next(data);
          printf("{{struct}} %p\n", &benchRet); 
          free(data);
