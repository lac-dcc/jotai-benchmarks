...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params->audio_sampling_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        params->capabilities = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_encoding = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_l2_bitrate = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_ac3_bitrate = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_mode_extension = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_emphasis = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_crc = ((-2 * (next_i()%2)) + 1) * next_i();
        params->audio_mute = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_aspect = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_gop_size = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_b_frames = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_gop_closure = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_bitrate_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_bitrate = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_bitrate_peak = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_temporal_decimation = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_mute = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_mute_yuv = ((-2 * (next_i()%2)) + 1) * next_i();
        params->stream_type = ((-2 * (next_i()%2)) + 1) * next_i();
        params->stream_vbi_fmt = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_spatial_filter_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_spatial_filter = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_luma_spatial_filter_type = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_chroma_spatial_filter_type = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_temporal_filter_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_temporal_filter = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_median_filter_type = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_luma_median_filter_top = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_luma_median_filter_bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_chroma_median_filter_top = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_chroma_median_filter_bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        params->stream_insert_nav_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        params->video_encoding = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ctrl0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_ctrl0; _i0++) {
            ctrl->id = ((-2 * (next_i()%2)) + 1) * next_i();
        ctrl->value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
