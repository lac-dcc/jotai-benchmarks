...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ctx[_i0].priv = (struct TYPE_4__ *) malloc(_len_ctx__i0__priv0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_ctx__i0__priv0; _j0++) {
            ctx[_i0].priv->size = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctx__i0__priv_luminance0 = 1;
          ctx[_i0].priv->luminance = (float *) malloc(_len_ctx__i0__priv_luminance0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_ctx__i0__priv_luminance0; _j0++) {
            ctx[_i0].priv->luminance[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          }
          }
          int _len_f0 = 1;
