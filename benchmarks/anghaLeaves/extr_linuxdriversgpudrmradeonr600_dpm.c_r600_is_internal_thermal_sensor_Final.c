...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          enum radeon_int_thermal_type sensor = 100;
        
          int benchRet = r600_is_internal_thermal_sensor(sensor);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          ...
          enum radeon_int_thermal_type sensor = 255;
    ...
    case 2:
    {
          ...
          enum radeon_int_thermal_type sensor = 10;
    ...
    case 3:
    {
          ...
          enum radeon_int_thermal_type sensor = ((-2 * (next_i()%2)) + 1) * next_i();
