...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vcpu0; _i0++) {
            vcpu[_i0].mmio_needed = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_vcpu__i0__run0 = 1;
          vcpu[_i0].run = (struct TYPE_2__ *) malloc(_len_vcpu__i0__run0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_vcpu__i0__run0; _j0++) {
            vcpu[_i0].run->exit_reason = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = handle_triple_fault(vcpu);
          printf("%d\n", benchRet); 
