...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long space_id = 100;
        
          const char * benchRet = acpi_ut_get_region_name(space_id);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          unsigned long space_id = ((-2 * (next_i()%2)) + 1) * next_i();
