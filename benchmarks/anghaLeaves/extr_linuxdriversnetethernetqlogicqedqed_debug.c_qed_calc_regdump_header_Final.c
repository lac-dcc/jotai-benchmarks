...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum debug_print_features feature = 100;
          int engine = 100;
          int feature_size = 100;
          int omit_engine = 100;
          int benchRet = qed_calc_regdump_header(feature,engine,feature_size,omit_engine);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          enum debug_print_features feature = 255;
          int engine = 255;
          int feature_size = 255;
          int omit_engine = 255;
          int benchRet = qed_calc_regdump_header(feature,engine,feature_size,omit_engine);
          printf("%d\n", benchRet); 
    ...
    case 2:
    {
          enum debug_print_features feature = 10;
          int engine = 10;
          int feature_size = 10;
          int omit_engine = 10;
          int benchRet = qed_calc_regdump_header(feature,engine,feature_size,omit_engine);
