...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hr_dev0; _i0++) {
            hr_dev->caps.mtt_hop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hr_dev->caps.cqe_hop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hr_dev->caps.srqc_hop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hr_dev->caps.cqc_hop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hr_dev->caps.mpt_hop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hr_dev->caps.qpc_hop_num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
