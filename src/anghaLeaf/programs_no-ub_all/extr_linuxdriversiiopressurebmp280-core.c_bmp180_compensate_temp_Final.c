...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        data->calib.bmp180.AC6 = ((-2 * (next_i()%2)) + 1) * next_i();
        data->calib.bmp180.AC5 = ((-2 * (next_i()%2)) + 1) * next_i();
        data->calib.bmp180.MC = ((-2 * (next_i()%2)) + 1) * next_i();
        data->calib.bmp180.MD = ((-2 * (next_i()%2)) + 1) * next_i();
          }
