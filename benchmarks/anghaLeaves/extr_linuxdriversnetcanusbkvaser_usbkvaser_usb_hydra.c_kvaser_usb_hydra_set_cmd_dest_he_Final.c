...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_cmd0 = 1;
          struct kvaser_cmd * cmd = (struct kvaser_cmd *) malloc(_len_cmd0*sizeof(struct kvaser_cmd));
          for(int _i0 = 0; _i0 < _len_cmd0; _i0++) {
              cmd[_i0].header.he_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        
        
          }
        
          kvaser_usb_hydra_set_cmd_dest_he(cmd,dest_he);
          free(cmd);
    ...
    case 3:
    {
          ...
          int dest_he = ((-2 * (next_i()%2)) + 1) * next_i();
