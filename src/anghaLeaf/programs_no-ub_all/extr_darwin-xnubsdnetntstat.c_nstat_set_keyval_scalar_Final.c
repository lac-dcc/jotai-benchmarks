...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_kv0; _i0++) {
            kv->nstat_sysinfo_key = ((-2 * (next_i()%2)) + 1) * next_i();
        kv->nstat_sysinfo_valsize = ((-2 * (next_i()%2)) + 1) * next_i();
        kv->u.nstat_sysinfo_scalar = ((-2 * (next_i()%2)) + 1) * next_i();
        kv->nstat_sysinfo_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
