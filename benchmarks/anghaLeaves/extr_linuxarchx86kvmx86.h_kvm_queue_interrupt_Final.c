...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vcpu0; _i0++) {
              vcpu[_i0].arch.interrupt.injected = ((-2 * (next_i()%2)) + 1) * next_i();
          vcpu[_i0].arch.interrupt.soft = ((-2 * (next_i()%2)) + 1) * next_i();
          vcpu[_i0].arch.interrupt.nr = ((-2 * (next_i()%2)) + 1) * next_i();
        
        
        
          }
        
          kvm_queue_interrupt(vcpu,vector,soft);
          free(vcpu);
