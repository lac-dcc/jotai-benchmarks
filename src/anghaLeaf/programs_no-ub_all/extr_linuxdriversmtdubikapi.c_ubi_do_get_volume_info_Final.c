...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ubi0; _i0++) {
            ubi->ubi_num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_vol0 = 1;
          struct ubi_volume * vol = (struct ubi_volume *) malloc(_len_vol0*sizeof(struct ubi_volume));
          for(int _i0 = 0; _i0 < _len_vol0; _i0++) {
            vol->cdev.dev = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->name = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->name_len = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->usable_leb_size = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->alignment = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->upd_marker = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->corrupted = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->vol_type = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->used_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->reserved_pebs = ((-2 * (next_i()%2)) + 1) * next_i();
        vol->vol_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_vi0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_vi0; _i0++) {
            vi->cdev = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->name = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->name_len = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->usable_leb_size = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->alignment = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->upd_marker = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->corrupted = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->vol_type = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->used_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->size = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->ubi_num = ((-2 * (next_i()%2)) + 1) * next_i();
        vi->vol_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
