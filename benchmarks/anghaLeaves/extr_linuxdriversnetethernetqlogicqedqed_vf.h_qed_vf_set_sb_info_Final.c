...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_sb0 = 1;
          struct qed_sb_info * p_sb = (struct qed_sb_info *) malloc(_len_p_sb0*sizeof(struct qed_sb_info));
          for(int _i0 = 0; _i0 < _len_p_sb0; _i0++) {
            p_sb[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          qed_vf_set_sb_info(p_hwfn,sb_id,p_sb);
          free(p_hwfn);
          free(p_sb);
