...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long src_rate = 100;
        
          unsigned long rate = 100;
        
          int benchRet = clock_divider(src_rate,rate);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long src_rate = ((-2 * (next_i()%2)) + 1) * next_i();
