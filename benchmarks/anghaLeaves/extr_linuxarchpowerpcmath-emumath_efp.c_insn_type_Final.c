...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long speinsn = 100;
        
          unsigned long benchRet = insn_type(speinsn);
          printf("%lu\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long speinsn = ((-2 * (next_i()%2)) + 1) * next_i();
