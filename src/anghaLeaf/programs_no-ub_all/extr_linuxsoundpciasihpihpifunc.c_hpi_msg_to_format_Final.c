...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pF0; _i0++) {
            pF->unused = ((-2 * (next_i()%2)) + 1) * next_i();
        pF->mode_legacy = ((-2 * (next_i()%2)) + 1) * next_i();
        pF->format = ((-2 * (next_i()%2)) + 1) * next_i();
        pF->channels = ((-2 * (next_i()%2)) + 1) * next_i();
        pF->attributes = ((-2 * (next_i()%2)) + 1) * next_i();
        pF->bit_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        pF->sample_rate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pMF0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_pMF0; _i0++) {
            pMF->format = ((-2 * (next_i()%2)) + 1) * next_i();
        pMF->channels = ((-2 * (next_i()%2)) + 1) * next_i();
        pMF->attributes = ((-2 * (next_i()%2)) + 1) * next_i();
        pMF->bit_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        pMF->sample_rate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
