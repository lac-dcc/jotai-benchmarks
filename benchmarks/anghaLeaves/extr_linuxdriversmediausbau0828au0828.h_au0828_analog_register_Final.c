...
__attribute__((used)) static inline int au0828_analog_register(struct au0828_dev *dev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_interface0; _i0++) {
            interface[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = au0828_analog_register(dev,interface);
          printf("%d\n", benchRet); 
          free(dev);
          free(interface);
