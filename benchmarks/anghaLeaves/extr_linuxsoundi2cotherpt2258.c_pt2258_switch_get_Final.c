...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          kcontrol[_i0].private_data = (struct snd_pt2258 *) malloc(_len_kcontrol__i0__private_data0*sizeof(struct snd_pt2258));
          for(int _j0 = 0; _j0 < _len_kcontrol__i0__private_data0; _j0++) {
            kcontrol[_i0].private_data->mute = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          int benchRet = pt2258_switch_get(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
