...
__attribute__((used)) static int team_notify_peers_interval_set(struct team *team,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_team0; _i0++) {
            team[_i0].notify_peers.interval = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ctx0 = 1;
          struct team_gsetter_ctx * ctx = (struct team_gsetter_ctx *) malloc(_len_ctx0*sizeof(struct team_gsetter_ctx));
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx[_i0].data.u32_val = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = team_notify_peers_interval_set(team,ctx);
          printf("%d\n", benchRet); 
          free(team);
          free(ctx);
