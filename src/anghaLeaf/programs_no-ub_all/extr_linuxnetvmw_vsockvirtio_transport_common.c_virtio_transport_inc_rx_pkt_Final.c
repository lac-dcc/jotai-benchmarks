...
/* Type definitions */
struct virtio_vsock_sock {int /*<<< orphan*/  rx_bytes; } ;
struct virtio_vsock_pkt {scalar_t__ len; } ;

/* Variables and functions */

__attribute__((used)) static void virtio_transport_inc_rx_pkt(struct virtio_vsock_sock *vvs,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vvs0; _i0++) {
            vvs->rx_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pkt0 = 1;
