...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q0; _i0++) {
            q->rate_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        q->max_netlen = ((-2 * (next_i()%2)) + 1) * next_i();
        q->min_netlen = ((-2 * (next_i()%2)) + 1) * next_i();
        q->rate_mpu = ((-2 * (next_i()%2)) + 1) * next_i();
        q->atm_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        q->max_adjlen = ((-2 * (next_i()%2)) + 1) * next_i();
        q->min_adjlen = ((-2 * (next_i()%2)) + 1) * next_i();
        q->rate_overhead = ((-2 * (next_i()%2)) + 1) * next_i();
          }
