...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_battery0; _i0++) {
            battery->state = ((-2 * (next_i()%2)) + 1) * next_i();
        battery->capacity_now = ((-2 * (next_i()%2)) + 1) * next_i();
        battery->full_charge_capacity = ((-2 * (next_i()%2)) + 1) * next_i();
        battery->design_capacity = ((-2 * (next_i()%2)) + 1) * next_i();
          }
