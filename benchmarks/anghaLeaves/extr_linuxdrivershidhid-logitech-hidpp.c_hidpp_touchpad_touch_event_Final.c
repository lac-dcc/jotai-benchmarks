...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_finger0; _i0++) {
            finger[_i0].x = ((-2 * (next_i()%2)) + 1) * next_i();
        finger[_i0].y = ((-2 * (next_i()%2)) + 1) * next_i();
        finger[_i0].contact_type = ((-2 * (next_i()%2)) + 1) * next_i();
        finger[_i0].contact_status = ((-2 * (next_i()%2)) + 1) * next_i();
        finger[_i0].z = ((-2 * (next_i()%2)) + 1) * next_i();
        finger[_i0].area = ((-2 * (next_i()%2)) + 1) * next_i();
        finger[_i0].finger_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
