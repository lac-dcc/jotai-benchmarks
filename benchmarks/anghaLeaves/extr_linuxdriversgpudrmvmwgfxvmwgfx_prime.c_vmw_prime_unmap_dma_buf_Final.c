...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_sgb0 = 1;
          struct sg_table * sgb = (struct sg_table *) malloc(_len_sgb0*sizeof(struct sg_table));
          for(int _i0 = 0; _i0 < _len_sgb0; _i0++) {
            sgb[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          vmw_prime_unmap_dma_buf(attach,sgb,dir);
          free(attach);
          free(sgb);
