...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hdspm0; _i0++) {
            hdspm->io_type = ((-2 * (next_i()%2)) + 1) * next_i();
        hdspm->settings_register = ((-2 * (next_i()%2)) + 1) * next_i();
        hdspm->control_register = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = hdspm_system_clock_mode(hdspm);
          printf("%d\n", benchRet); 
          free(hdspm);
