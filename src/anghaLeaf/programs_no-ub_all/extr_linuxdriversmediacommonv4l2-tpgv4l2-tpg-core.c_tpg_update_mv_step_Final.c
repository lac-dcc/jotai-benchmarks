...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tpg0; _i0++) {
            tpg->mv_hor_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->mv_hor_step = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->src_width = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->mv_vert_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->mv_vert_step = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->src_height = ((-2 * (next_i()%2)) + 1) * next_i();
        tpg->hflip = ((-2 * (next_i()%2)) + 1) * next_i();
          }
