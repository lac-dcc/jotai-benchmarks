...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_trace0; _i0++) {
            trace->frame.AddrStack.Offset = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->frame.AddrPC.Offset = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->frame.AddrFrame.Offset = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->image_type = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->context.Esp = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->context.Ebp = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->context.Eip = ((-2 * (next_i()%2)) + 1) * next_i();
        trace->instruction_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
