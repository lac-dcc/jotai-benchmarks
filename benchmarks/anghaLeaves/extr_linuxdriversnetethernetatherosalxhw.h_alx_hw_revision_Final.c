...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
              int _len_hw__i0__pdev0 = 1;
          hw[_i0].pdev = (struct TYPE_2__ *) malloc(_len_hw__i0__pdev0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_hw__i0__pdev0; _j0++) {
            hw[_i0].pdev->revision = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = alx_hw_revision(hw);
          printf("%d\n", benchRet); 
