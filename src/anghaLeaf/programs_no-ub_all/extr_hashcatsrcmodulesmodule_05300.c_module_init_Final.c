...
/* Variables and functions */
 ...
 int /*<<< orphan*/  module_hlfmt_disable ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        module_ctx->module_hlfmt_disable = ((-2 * (next_i()%2)) + 1) * next_i();
