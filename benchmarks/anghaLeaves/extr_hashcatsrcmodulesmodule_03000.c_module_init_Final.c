...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          module_ctx[_i0].module_potfile_keep_all_hashes = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          module_ctx[_i0].module_hash_decode_zero_hash = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_dictstat_disable = ((-2 * (next_i()%2)) + 1) * next_i();
