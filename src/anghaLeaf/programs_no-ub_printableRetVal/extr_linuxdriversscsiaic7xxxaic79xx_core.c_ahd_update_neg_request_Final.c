...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ahd0; _i0++) {
            ahd->features = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_devinfo0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_devinfo0; _i0++) {
            devinfo->target_mask = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_tstate0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_tstate0; _i0++) {
            tstate->auto_negotiate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_tinfo0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_tinfo0; _i0++) {
            tinfo->goal.period = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->goal.width = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->goal.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->goal.ppr_options = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->curr.width = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->curr.period = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->curr.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        tinfo->curr.ppr_options = ((-2 * (next_i()%2)) + 1) * next_i();
          }
