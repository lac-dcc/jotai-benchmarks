...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_t0; _i0++) {
            t->tm_year = ((-2 * (next_i()%2)) + 1) * next_i();
        t->tm_mday = ((-2 * (next_i()%2)) + 1) * next_i();
        t->tm_hour = ((-2 * (next_i()%2)) + 1) * next_i();
        t->tm_min = ((-2 * (next_i()%2)) + 1) * next_i();
        t->tm_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        t->tm_mon = ((-2 * (next_i()%2)) + 1) * next_i();
          }
