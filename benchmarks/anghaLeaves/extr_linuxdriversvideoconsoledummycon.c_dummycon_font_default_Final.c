...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_font0 = 1;
          struct console_font * font = (struct console_font *) malloc(_len_font0*sizeof(struct console_font));
          for(int _i0 = 0; _i0 < _len_font0; _i0++) {
            font[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_name0 = 1;
          ...
          int benchRet = dummycon_font_default(vc,font,name);
          printf("%d\n", benchRet); 
          free(vc);
          free(font);
          free(name);
