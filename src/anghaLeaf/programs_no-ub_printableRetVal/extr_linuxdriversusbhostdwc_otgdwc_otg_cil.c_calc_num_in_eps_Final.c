...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_core_if0; _i0++) {
            core_if->hwcfg4.b.num_in_eps = ((-2 * (next_i()%2)) + 1) * next_i();
        core_if->hwcfg4.b.ded_fifo_en = ((-2 * (next_i()%2)) + 1) * next_i();
        core_if->hwcfg1.d32 = ((-2 * (next_i()%2)) + 1) * next_i();
        core_if->hwcfg2.b.num_dev_ep = ((-2 * (next_i()%2)) + 1) * next_i();
          }
