...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 7662
          // ------------------------------- 
          // static_instructions_O1 : 30
          // dynamic_instructions_O1 : 5364
          // ------------------------------- 
          // static_instructions_O2 : 100
          // dynamic_instructions_O2 : 1878
          // ------------------------------- 
          // static_instructions_O3 : 100
          // dynamic_instructions_O3 : 1878
          // ------------------------------- 
          // static_instructions_Ofast : 100
          // dynamic_instructions_Ofast : 1878
          // ------------------------------- 
          // static_instructions_Os : 29
          // dynamic_instructions_Os : 5363
          // ------------------------------- 
          // static_instructions_Oz : 26
          // dynamic_instructions_Oz : 4346
          // ------------------------------- 
          ...
          vertical_decompose97iL0(b0,b1,b2,width);
          free(b0);
          free(b1);
          free(b2);
    ...
    {
          // static_instructions_O0 : 39
          // dynamic_instructions_O0 : 312
          // ------------------------------- 
          // static_instructions_O1 : 30
          // dynamic_instructions_O1 : 219
          // ------------------------------- 
          // static_instructions_O2 : 100
          // dynamic_instructions_O2 : 149
          // ------------------------------- 
          // static_instructions_O3 : 100
          // dynamic_instructions_O3 : 149
          // ------------------------------- 
          // static_instructions_Ofast : 100
          // dynamic_instructions_Ofast : 149
          // ------------------------------- 
          // static_instructions_Os : 29
          // dynamic_instructions_Os : 218
          // ------------------------------- 
          // static_instructions_Oz : 26
          // dynamic_instructions_Oz : 181
          // ------------------------------- 
