...
int main(int argc, char *argv[]) {
    ...
    {
          int rel_vf_id = 100;
          int b_enabled_only = 100;
          int b_non_malicious = 100;
          int _len_p_hwfn0 = 1;
          ...
          int benchRet = qed_iov_is_valid_vfid(p_hwfn,rel_vf_id,b_enabled_only,b_non_malicious);
          printf("%d\n", benchRet); 
          free(p_hwfn);
    ...
    {
          int rel_vf_id = 10;
          int b_enabled_only = 10;
          int b_non_malicious = 10;
