...
__attribute__((used)) static int load_iotlb_entry(struct omap_iommu *obj, struct iotlb_entry *e)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_obj0 = 1;
          struct omap_iommu * obj = (struct omap_iommu *) malloc(_len_obj0*sizeof(struct omap_iommu));
          ...
          int benchRet = load_iotlb_entry(obj,e);
          printf("%d\n", benchRet); 
          free(obj);
          free(e);
