...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_parser0; _i0++) {
            parser->type = ((-2 * (next_i()%2)) + 1) * next_i();
        parser->method = ((-2 * (next_i()%2)) + 1) * next_i();
        parser->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        parser->upgrade = ((-2 * (next_i()%2)) + 1) * next_i();
        parser->nread = ((-2 * (next_i()%2)) + 1) * next_i();
