...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_phy_info__i0__port_details0; _j0++) {
              int _len_phy_info__i0__port_details_port0 = 1;
          phy_info[_i0].port_details->port = (struct sas_port *) malloc(_len_phy_info__i0__port_details_port0*sizeof(struct sas_port));
          for(int _j0 = 0; _j0 < _len_phy_info__i0__port_details_port0; _j0++) {
            phy_info[_i0].port_details->port->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct sas_port * benchRet = mptsas_get_port(phy_info);
          printf("%d\n", (*benchRet).dummy);
