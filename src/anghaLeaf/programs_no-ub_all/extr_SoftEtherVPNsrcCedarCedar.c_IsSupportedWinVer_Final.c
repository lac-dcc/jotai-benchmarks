...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_v0; _i0++) {
            v->IsWindows = ((-2 * (next_i()%2)) + 1) * next_i();
        v->IsNT = ((-2 * (next_i()%2)) + 1) * next_i();
        v->VerMajor = ((-2 * (next_i()%2)) + 1) * next_i();
        v->VerMinor = ((-2 * (next_i()%2)) + 1) * next_i();
        v->ServicePack = ((-2 * (next_i()%2)) + 1) * next_i();
        v->IsBeta = ((-2 * (next_i()%2)) + 1) * next_i();
          }
