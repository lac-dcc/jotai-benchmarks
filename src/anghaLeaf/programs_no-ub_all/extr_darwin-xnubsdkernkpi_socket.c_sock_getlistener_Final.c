...
struct TYPE_4__ *_allocate_sock(int length) {
...
void _delete_sock(struct TYPE_4__ * head) {
  if(head->so_head != NULL) _delete_sock(head->so_head);
  free(head);
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          struct TYPE_4__ * sock = _allocate_sock(1);
