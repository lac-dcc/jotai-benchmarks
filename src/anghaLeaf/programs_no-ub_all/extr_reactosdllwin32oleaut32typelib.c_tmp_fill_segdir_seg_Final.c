...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_segdir0; _i0++) {
            segdir->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        segdir->res08 = ((-2 * (next_i()%2)) + 1) * next_i();
        segdir->res0c = ((-2 * (next_i()%2)) + 1) * next_i();
        segdir->length = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_contents0; _i0++) {
            contents->len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
