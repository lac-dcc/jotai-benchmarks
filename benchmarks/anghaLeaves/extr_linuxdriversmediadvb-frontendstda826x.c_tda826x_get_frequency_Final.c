...
struct tda826x_priv {int /*<<< orphan*/  frequency; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct tda826x_priv *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct tda826x_priv));
          ...
          int benchRet = tda826x_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
