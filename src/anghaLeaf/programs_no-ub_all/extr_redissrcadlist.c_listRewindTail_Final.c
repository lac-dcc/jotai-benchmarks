...
struct TYPE_6__ {int /*<<< orphan*/  tail; } ;
typedef  TYPE_2__ list ;

/* Variables and functions */
 int /*<<< orphan*/  AL_START_TAIL ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_list0; _i0++) {
            list->tail = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_li0 = 1;
          struct TYPE_5__ * li = (struct TYPE_5__ *) malloc(_len_li0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_li0; _i0++) {
            li->direction = ((-2 * (next_i()%2)) + 1) * next_i();
        li->next = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          listRewindTail(list,li);
          free(list);
          free(li);
