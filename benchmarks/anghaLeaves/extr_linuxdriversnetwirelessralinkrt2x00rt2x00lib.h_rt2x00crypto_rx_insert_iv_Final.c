...
__attribute__((used)) static inline void rt2x00crypto_rx_insert_iv(struct sk_buff *skb,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned int header_length = 100;
          int _len_skb0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_rxdesc0; _i0++) {
            rxdesc[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          rt2x00crypto_rx_insert_iv(skb,header_length,rxdesc);
          free(skb);
          free(rxdesc);
