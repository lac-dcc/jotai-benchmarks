...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->monspecs.vfmax = ((-2 * (next_i()%2)) + 1) * next_i();
        info->monspecs.vfmin = ((-2 * (next_i()%2)) + 1) * next_i();
        info->monspecs.hfmin = ((-2 * (next_i()%2)) + 1) * next_i();
        info->monspecs.hfmax = ((-2 * (next_i()%2)) + 1) * next_i();
          }
