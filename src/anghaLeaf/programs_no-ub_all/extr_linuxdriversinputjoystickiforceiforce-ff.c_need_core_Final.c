    ...
    case 0:
    {
        ...
        old->trigger.interval = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_new0; _i0++) {
            new->direction = ((-2 * (next_i()%2)) + 1) * next_i();
        new->replay.length = ((-2 * (next_i()%2)) + 1) * next_i();
        new->replay.delay = ((-2 * (next_i()%2)) + 1) * next_i();
        new->trigger.button = ((-2 * (next_i()%2)) + 1) * next_i();
        new->trigger.interval = ((-2 * (next_i()%2)) + 1) * next_i();
          }
