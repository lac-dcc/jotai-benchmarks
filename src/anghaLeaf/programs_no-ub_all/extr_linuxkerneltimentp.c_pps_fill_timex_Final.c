...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_txc0; _i0++) {
            txc->stbcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->errcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->calcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->jitcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->stabil = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->shift = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->jitter = ((-2 * (next_i()%2)) + 1) * next_i();
        txc->ppsfreq = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          pps_fill_timex(txc);
          free(txc);
