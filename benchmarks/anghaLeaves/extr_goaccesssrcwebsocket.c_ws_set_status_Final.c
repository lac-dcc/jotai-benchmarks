...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int bytes = 100;
          int _len_client0 = 1;
          struct TYPE_3__ * client = (struct TYPE_3__ *) malloc(_len_client0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_client0; _i0++) {
            client[_i0].status = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ws_set_status(client,status,bytes);
          printf("%d\n", benchRet); 
          free(client);
