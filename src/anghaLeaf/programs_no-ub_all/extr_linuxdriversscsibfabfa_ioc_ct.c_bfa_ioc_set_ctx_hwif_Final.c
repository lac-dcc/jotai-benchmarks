...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hwif0; _i0++) {
            hwif->ioc_get_alt_fwstate = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_set_alt_fwstate = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_get_fwstate = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_set_fwstate = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_sync_complete = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_sync_ack = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_sync_leave = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_sync_join = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_sync_start = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_ownership_reset = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_notify_fail = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_firmware_unlock = ((-2 * (next_i()%2)) + 1) * next_i();
        hwif->ioc_firmware_lock = ((-2 * (next_i()%2)) + 1) * next_i();
          }
