...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nk0; _i0++) {
            nk->min_k = ((-2 * (next_i()%2)) + 1) * next_i();
        nk->max_k = ((-2 * (next_i()%2)) + 1) * next_i();
        nk->min_n = ((-2 * (next_i()%2)) + 1) * next_i();
        nk->max_n = ((-2 * (next_i()%2)) + 1) * next_i();
        nk->k = ((-2 * (next_i()%2)) + 1) * next_i();
        nk->n = ((-2 * (next_i()%2)) + 1) * next_i();
          }
