...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int rate_class_index = 100;
        
          int benchRet = wl1271_tx_get_rate_flags(rate_class_index);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int rate_class_index = ((-2 * (next_i()%2)) + 1) * next_i();
