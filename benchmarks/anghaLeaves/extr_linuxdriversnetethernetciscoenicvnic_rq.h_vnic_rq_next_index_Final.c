...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rq0; _i0++) {
              int _len_rq__i0__to_use0 = 1;
          rq[_i0].to_use = (struct TYPE_2__ *) malloc(_len_rq__i0__to_use0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_rq__i0__to_use0; _j0++) {
            rq[_i0].to_use->index = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned int benchRet = vnic_rq_next_index(rq);
          printf("%u\n", benchRet); 
