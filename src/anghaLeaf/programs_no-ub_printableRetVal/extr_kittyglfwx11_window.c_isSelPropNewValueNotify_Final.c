...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_event0; _i0++) {
            event->type = ((-2 * (next_i()%2)) + 1) * next_i();
        event->xselection.requestor = ((-2 * (next_i()%2)) + 1) * next_i();
        event->xselection.property = ((-2 * (next_i()%2)) + 1) * next_i();
        event->xproperty.state = ((-2 * (next_i()%2)) + 1) * next_i();
        event->xproperty.window = ((-2 * (next_i()%2)) + 1) * next_i();
        event->xproperty.atom = ((-2 * (next_i()%2)) + 1) * next_i();
          }
