...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_v0; _i0++) {
            v->ui32 = ((-2 * (next_i()%2)) + 1) * next_i();
        v->si32 = ((-2 * (next_i()%2)) + 1) * next_i();
        v->unused_bits2a = ((-2 * (next_i()%2)) + 1) * next_i();
        v->bits28 = ((-2 * (next_i()%2)) + 1) * next_i();
        v->unused_bits2b = ((-2 * (next_i()%2)) + 1) * next_i();
        v->ui64 = ((-2 * (next_i()%2)) + 1) * next_i();
        v->aenum = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          set_pprint_mapv(v,i);
          free(v);
