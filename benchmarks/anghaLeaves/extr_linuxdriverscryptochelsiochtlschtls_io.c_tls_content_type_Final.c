...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned char content_type = 100;
        
          unsigned char benchRet = tls_content_type(content_type);
          printf("%c\n", (benchRet %26) + 'a'); 
    ...
    case 1:
    {
          ...
          unsigned char content_type = 255;
    ...
    case 3:
    {
          ...
          unsigned char content_type = ((-2 * (next_i()%2)) + 1) * next_i();
