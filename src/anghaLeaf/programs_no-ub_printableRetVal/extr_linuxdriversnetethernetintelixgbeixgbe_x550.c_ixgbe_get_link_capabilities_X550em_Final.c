...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
            hw->device_id = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->phy.type = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->phy.speeds_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->phy.media_type = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->phy.sfp_type = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->phy.nw_mng_if_sel = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->phy.multispeed_fiber = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
