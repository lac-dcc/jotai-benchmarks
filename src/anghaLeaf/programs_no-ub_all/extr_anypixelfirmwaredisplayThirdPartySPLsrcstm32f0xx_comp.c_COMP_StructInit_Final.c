...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_COMP_InitStruct0; _i0++) {
            COMP_InitStruct->COMP_Mode = ((-2 * (next_i()%2)) + 1) * next_i();
        COMP_InitStruct->COMP_Hysteresis = ((-2 * (next_i()%2)) + 1) * next_i();
        COMP_InitStruct->COMP_OutputPol = ((-2 * (next_i()%2)) + 1) * next_i();
        COMP_InitStruct->COMP_Output = ((-2 * (next_i()%2)) + 1) * next_i();
        COMP_InitStruct->COMP_InvertingInput = ((-2 * (next_i()%2)) + 1) * next_i();
          }
