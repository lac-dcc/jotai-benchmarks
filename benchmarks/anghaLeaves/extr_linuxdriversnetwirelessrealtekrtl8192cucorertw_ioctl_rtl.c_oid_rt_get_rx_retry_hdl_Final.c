...
/* Type definitions */
struct oid_par_priv {scalar_t__ type_of_oid; int /*<<< orphan*/  information_buf_len; int /*<<< orphan*/ * bytes_rw; int /*<<< orphan*/  adapter_context; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        poid_par_priv[_i0].adapter_context = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = oid_rt_get_rx_retry_hdl(poid_par_priv);
          printf("%d\n", benchRet); 
