...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cstate0; _i0++) {
            cstate->mode.hdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
        cstate->mode.vdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pstate0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_pstate0; _i0++) {
            pstate->crtc_x = ((-2 * (next_i()%2)) + 1) * next_i();
        pstate->crtc_y = ((-2 * (next_i()%2)) + 1) * next_i();
        pstate->crtc_w = ((-2 * (next_i()%2)) + 1) * next_i();
        pstate->crtc_h = ((-2 * (next_i()%2)) + 1) * next_i();
          }
