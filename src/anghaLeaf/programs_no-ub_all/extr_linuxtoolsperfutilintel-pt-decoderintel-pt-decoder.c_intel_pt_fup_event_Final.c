...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_decoder0; _i0++) {
            decoder->set_fup_tx_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->set_fup_ptw = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->set_fup_mwait = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->set_fup_pwre = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->set_fup_exstop = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.to_ip = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.from_ip = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.type = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.pwre_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.mwait_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->state.ptw_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->ip = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->fup_pwre_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->fup_mwait_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->fup_ptw_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->fup_tx_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        decoder->tx_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
