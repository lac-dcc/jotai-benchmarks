...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_np0; _i0++) {
            np->link_config.advertising = ((-2 * (next_i()%2)) + 1) * next_i();
        np->link_config.autoneg = ((-2 * (next_i()%2)) + 1) * next_i();
        np->link_config.loopback_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        np->link_config.active_duplex = ((-2 * (next_i()%2)) + 1) * next_i();
        np->link_config.duplex = ((-2 * (next_i()%2)) + 1) * next_i();
        np->link_config.active_speed = ((-2 * (next_i()%2)) + 1) * next_i();
        np->link_config.speed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
