...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
            hw->mac.mta_reg_count = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.rar_entry_count = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.set_vfta = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.set_uc_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.read_mac_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.rar_set = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.update_mc_addr_list = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.get_link_up_info = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.check_for_link = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.init_hw = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->mac.ops.reset_hw = ((-2 * (next_i()%2)) + 1) * next_i();
          }
