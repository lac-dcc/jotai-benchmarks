...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pv0; _i0++) {
            pv->pv_root_id = ((-2 * (next_i()%2)) + 1) * next_i();
        pv->pv_cost = ((-2 * (next_i()%2)) + 1) * next_i();
        pv->pv_dbridge_id = ((-2 * (next_i()%2)) + 1) * next_i();
        pv->pv_dport_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cpv0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_cpv0; _i0++) {
            cpv->pv_root_id = ((-2 * (next_i()%2)) + 1) * next_i();
        cpv->pv_cost = ((-2 * (next_i()%2)) + 1) * next_i();
        cpv->pv_dbridge_id = ((-2 * (next_i()%2)) + 1) * next_i();
        cpv->pv_dport_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
