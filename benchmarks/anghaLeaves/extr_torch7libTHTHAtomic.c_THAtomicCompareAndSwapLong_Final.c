...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_a0 = 1;
          volatile long * a = (volatile long *) malloc(_len_a0*sizeof(volatile long));
          for(int _i0 = 0; _i0 < _len_a0; _i0++) {
            a[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          long benchRet = THAtomicCompareAndSwapLong(a,oldvalue,newvalue);
          printf("%ld\n", benchRet); 
          free(a);
    ...
    case 3:
    {
          ...
          long oldvalue = ((-2 * (next_i()%2)) + 1) * next_i();
        
          long newvalue = ((-2 * (next_i()%2)) + 1) * next_i();
