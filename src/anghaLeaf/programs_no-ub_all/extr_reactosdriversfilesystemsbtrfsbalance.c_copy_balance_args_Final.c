...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_opts0; _i0++) {
            opts->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->usage_start = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->stripes_end = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->stripes_start = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->limit_end = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->limit_start = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->convert = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->vrange_end = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->vrange_start = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->drange_end = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->drange_start = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->devid = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->usage_end = ((-2 * (next_i()%2)) + 1) * next_i();
        opts->profiles = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_args0 = 1;
          struct TYPE_6__ * args = (struct TYPE_6__ *) malloc(_len_args0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_args0; _i0++) {
            args->usage_start = ((-2 * (next_i()%2)) + 1) * next_i();
        args->limit_start = ((-2 * (next_i()%2)) + 1) * next_i();
        args->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        args->stripes_end = ((-2 * (next_i()%2)) + 1) * next_i();
        args->stripes_start = ((-2 * (next_i()%2)) + 1) * next_i();
        args->limit = ((-2 * (next_i()%2)) + 1) * next_i();
        args->convert = ((-2 * (next_i()%2)) + 1) * next_i();
        args->vrange_end = ((-2 * (next_i()%2)) + 1) * next_i();
        args->vrange_start = ((-2 * (next_i()%2)) + 1) * next_i();
        args->drange_end = ((-2 * (next_i()%2)) + 1) * next_i();
        args->drange_start = ((-2 * (next_i()%2)) + 1) * next_i();
        args->devid = ((-2 * (next_i()%2)) + 1) * next_i();
        args->usage = ((-2 * (next_i()%2)) + 1) * next_i();
        args->usage_end = ((-2 * (next_i()%2)) + 1) * next_i();
        args->profiles = ((-2 * (next_i()%2)) + 1) * next_i();
          }
