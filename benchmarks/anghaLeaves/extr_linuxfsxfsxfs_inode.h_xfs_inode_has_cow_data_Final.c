...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ip[_i0].i_cowfp = (struct TYPE_2__ *) malloc(_len_ip__i0__i_cowfp0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_ip__i0__i_cowfp0; _j0++) {
            ip[_i0].i_cowfp->if_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = xfs_inode_has_cow_data(ip);
          printf("%d\n", benchRet); 
