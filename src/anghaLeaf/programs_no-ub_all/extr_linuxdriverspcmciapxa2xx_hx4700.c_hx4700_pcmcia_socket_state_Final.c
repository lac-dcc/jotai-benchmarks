...
__attribute__((used)) static void hx4700_pcmcia_socket_state(struct soc_pcmcia_socket *skt,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_skt0; _i0++) {
            skt->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_state0 = 1;
          struct pcmcia_state * state = (struct pcmcia_state *) malloc(_len_state0*sizeof(struct pcmcia_state));
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state->vs_3v = ((-2 * (next_i()%2)) + 1) * next_i();
        state->vs_Xv = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          hx4700_pcmcia_socket_state(skt,state);
          free(skt);
          free(state);
