...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        p_tun->ip_geneve.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->l2_geneve.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->l2_geneve.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->ip_gre.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->ip_gre.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->l2_gre.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->l2_gre.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->vxlan.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_tun->vxlan.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_p_src0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_p_src0; _i0++) {
            p_src->ip_geneve.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->ip_geneve.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->l2_geneve.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->l2_geneve.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->ip_gre.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->ip_gre.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->l2_gre.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->l2_gre.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->vxlan.b_mode_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p_src->vxlan.b_update_mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
