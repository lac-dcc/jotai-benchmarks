...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dispc0; _i0++) {
            dispc->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cinfo0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_cinfo0; _i0++) {
            cinfo->lck_div = ((-2 * (next_i()%2)) + 1) * next_i();
        cinfo->pck_div = ((-2 * (next_i()%2)) + 1) * next_i();
        cinfo->lck = ((-2 * (next_i()%2)) + 1) * next_i();
        cinfo->pck = ((-2 * (next_i()%2)) + 1) * next_i();
          }
