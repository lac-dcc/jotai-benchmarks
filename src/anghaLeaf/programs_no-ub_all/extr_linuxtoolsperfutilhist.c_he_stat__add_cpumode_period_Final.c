...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_he_stat0; _i0++) {
            he_stat->period_guest_us = ((-2 * (next_i()%2)) + 1) * next_i();
        he_stat->period_guest_sys = ((-2 * (next_i()%2)) + 1) * next_i();
        he_stat->period_us = ((-2 * (next_i()%2)) + 1) * next_i();
        he_stat->period_sys = ((-2 * (next_i()%2)) + 1) * next_i();
          }
