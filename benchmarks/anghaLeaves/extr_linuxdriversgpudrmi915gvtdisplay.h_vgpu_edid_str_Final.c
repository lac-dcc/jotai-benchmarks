...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          enum intel_vgpu_edid id = 100;
        
          char * benchRet = vgpu_edid_str(id);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          ...
          enum intel_vgpu_edid id = ((-2 * (next_i()%2)) + 1) * next_i();
