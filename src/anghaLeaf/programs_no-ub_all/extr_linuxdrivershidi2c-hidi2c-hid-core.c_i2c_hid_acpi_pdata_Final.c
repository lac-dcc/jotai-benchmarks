...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pdata0 = 1;
          struct i2c_hid_platform_data * pdata = (struct i2c_hid_platform_data *) malloc(_len_pdata0*sizeof(struct i2c_hid_platform_data));
          for(int _i0 = 0; _i0 < _len_pdata0; _i0++) {
            pdata->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = i2c_hid_acpi_pdata(client,pdata);
          printf("%d\n", benchRet); 
          free(client);
          free(pdata);
