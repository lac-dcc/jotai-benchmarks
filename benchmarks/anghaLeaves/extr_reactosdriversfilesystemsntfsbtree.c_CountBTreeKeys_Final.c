...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * aux_FirstKey[10000];
          struct TYPE_3__ * FirstKey = _allocate_FirstKey(10000, aux_FirstKey);
        
          long benchRet = CountBTreeKeys(FirstKey);
          printf("%ld\n", benchRet); 
          _delete_FirstKey(aux_FirstKey, 10000);
