...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long sdei_err = 100;
        
          int benchRet = sdei_to_linux_errno(sdei_err);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long sdei_err = ((-2 * (next_i()%2)) + 1) * next_i();
