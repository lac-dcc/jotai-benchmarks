...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adjusted_mode0; _i0++) {
            adjusted_mode->crtc_hsync_end = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_hsync_start = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_hblank_end = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_hblank_start = ((-2 * (next_i()%2)) + 1) * next_i();
        adjusted_mode->crtc_hdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
          }
