...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_typelib0; _i0++) {
            typelib->typelib_header.magic1 = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.magic2 = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.posguid = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.lcid = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.lcid2 = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.varflags = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.helpstring = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.NameOffset = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.helpfile = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.CustomDataOffset = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.res44 = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.res48 = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.dispatchpos = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.nimpinfos = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.nametablechars = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.nametablecount = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.helpcontext = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.helpstringcontext = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.nrtypeinfos = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        typelib->typelib_header.version = ((-2 * (next_i()%2)) + 1) * next_i();
          }
