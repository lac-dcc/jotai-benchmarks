...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum kfd_queue_type type = 0;
          unsigned int queue_size = 100;
          int _len_kq0 = 1;
          struct kernel_queue * kq = (struct kernel_queue *) malloc(_len_kq0*sizeof(struct kernel_queue));
          for(int _i0 = 0; _i0 < _len_kq0; _i0++) {
            kq[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dev0 = 1;
          struct kfd_dev * dev = (struct kfd_dev *) malloc(_len_dev0*sizeof(struct kfd_dev));
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = initialize_cik(kq,dev,type,queue_size);
          printf("%d\n", benchRet); 
          free(kq);
          free(dev);
