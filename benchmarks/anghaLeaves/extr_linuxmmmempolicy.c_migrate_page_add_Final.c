...
__attribute__((used)) static void migrate_page_add(struct page *page, struct list_head *pagelist,
				unsigned long flags)
{
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct list_head * pagelist = (struct list_head *) malloc(_len_pagelist0*sizeof(struct list_head));
          for(int _i0 = 0; _i0 < _len_pagelist0; _i0++) {
            pagelist[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          migrate_page_add(page,pagelist,flags);
          free(page);
          free(pagelist);
