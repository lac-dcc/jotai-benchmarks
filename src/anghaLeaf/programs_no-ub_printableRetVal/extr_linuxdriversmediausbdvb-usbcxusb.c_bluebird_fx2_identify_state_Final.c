...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_udev0; _i0++) {
            udev->descriptor.bDeviceClass = ((-2 * (next_i()%2)) + 1) * next_i();
        udev->descriptor.bDeviceSubClass = ((-2 * (next_i()%2)) + 1) * next_i();
        udev->descriptor.bDeviceProtocol = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_props0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_props0; _i0++) {
            props->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_desc0 = 1;
