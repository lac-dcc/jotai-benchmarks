...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ea0; _i0++) {
            ea->EA_ResetInput = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_EndRegular = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_GetInput = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_View = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Move = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_DelayedJump = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Jump = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_SelectWeapon = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_MoveRight = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_MoveLeft = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_MoveBack = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_MoveForward = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_MoveDown = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_MoveUp = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Crouch = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Respawn = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Use = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Attack = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Talk = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Gesture = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Action = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_SayTeam = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Say = ((-2 * (next_i()%2)) + 1) * next_i();
        ea->EA_Command = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          Init_EA_Export(ea);
          free(ea);
