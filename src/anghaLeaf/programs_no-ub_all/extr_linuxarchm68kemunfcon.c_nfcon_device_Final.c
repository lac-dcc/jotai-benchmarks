...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_con0 = 1;
          struct console * con = (struct console *) malloc(_len_con0*sizeof(struct console));
          for(int _i0 = 0; _i0 < _len_con0; _i0++) {
            con->flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          struct tty_driver * benchRet = nfcon_device(con,index);
          printf("{{struct}} %p\n", &benchRet); 
          free(con);
          free(index);
