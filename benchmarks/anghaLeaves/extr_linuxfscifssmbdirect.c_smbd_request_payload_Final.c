...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_request0 = 1;
          struct smbd_request * request = (struct smbd_request *) malloc(_len_request0*sizeof(struct smbd_request));
          for(int _i0 = 0; _i0 < _len_request0; _i0++) {
            request[_i0].packet = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = smbd_request_payload(request);
          free(request);
