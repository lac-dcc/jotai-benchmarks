...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long con_flag = 100;
        
          int benchRet = con_flag_valid(con_flag);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long con_flag = ((-2 * (next_i()%2)) + 1) * next_i();
