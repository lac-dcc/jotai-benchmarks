...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        rect->left = ((-2 * (next_i()%2)) + 1) * next_i();
        rect->top = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_subrect0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_subrect0; _i0++) {
            subrect->width = ((-2 * (next_i()%2)) + 1) * next_i();
        subrect->height = ((-2 * (next_i()%2)) + 1) * next_i();
        subrect->left = ((-2 * (next_i()%2)) + 1) * next_i();
        subrect->top = ((-2 * (next_i()%2)) + 1) * next_i();
          }
