...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_feat0; _i0++) {
            feat->offload.tx = ((-2 * (next_i()%2)) + 1) * next_i();
        feat->offload.rx_supported = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_netdev0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_netdev0; _i0++) {
            netdev->features = ((-2 * (next_i()%2)) + 1) * next_i();
        netdev->hw_features = ((-2 * (next_i()%2)) + 1) * next_i();
        netdev->vlan_features = ((-2 * (next_i()%2)) + 1) * next_i();
          }
