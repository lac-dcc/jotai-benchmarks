...
__attribute__((used)) static enum speaker_layout pulseaudio_channels_to_obs_speakers(
...
int main(int argc, char *argv[]) {
    ...
    {
          int channels = 100;
          enum speaker_layout benchRet = pulseaudio_channels_to_obs_speakers(channels);
