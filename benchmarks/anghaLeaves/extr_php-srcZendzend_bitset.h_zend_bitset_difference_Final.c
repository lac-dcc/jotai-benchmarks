...
__attribute__((used)) static inline void zend_bitset_difference(zend_bitset set1, zend_bitset set2, uint32_t len)
{
	uint32_t i;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 4601
          // ------------------------------- 
          // static_instructions_O1 : 14
          // dynamic_instructions_O1 : 1538
          // ------------------------------- 
          // static_instructions_O2 : 79
          // dynamic_instructions_O2 : 363
          // ------------------------------- 
          // static_instructions_O3 : 79
          // dynamic_instructions_O3 : 363
          // ------------------------------- 
          // static_instructions_Ofast : 79
          // dynamic_instructions_Ofast : 363
          // ------------------------------- 
          ...
          zend_bitset_difference(set1,set2,len);
          free(set1);
          free(set2);
