...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long long orig_file_size = 100;
        
          int benchRet = kfs_bz_get_chunks_no(orig_file_size);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          long long orig_file_size = ((-2 * (next_i()%2)) + 1) * next_i();
