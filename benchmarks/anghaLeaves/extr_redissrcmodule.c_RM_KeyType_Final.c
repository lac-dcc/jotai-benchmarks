...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_key0 = 1;
          struct TYPE_5__ * key = (struct TYPE_5__ *) malloc(_len_key0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_key0; _i0++) {
              int _len_key__i0__value0 = 1;
          key[_i0].value = (struct TYPE_4__ *) malloc(_len_key__i0__value0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_key__i0__value0; _j0++) {
            key[_i0].value->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = RM_KeyType(key);
          printf("%d\n", benchRet); 
