...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_st0; _i0++) {
            st->lim_total_txpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_total_rxpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_conn_attempts = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_packet_loss_percent = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_total_retxpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_packet_ooo_percent = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_total_oopkts = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_conn_timeout_percent = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_conn_timeouts = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_dl_max_bandwidth = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_dl_detected = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_ul_max_bandwidth = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_rtt_min = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_ul_detected = ((-2 * (next_i()%2)) + 1) * next_i();
        st->lim_bk_txpkts = ((-2 * (next_i()%2)) + 1) * next_i();
          }
