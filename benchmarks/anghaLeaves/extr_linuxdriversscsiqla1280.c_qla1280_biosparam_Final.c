...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_geom0 = 65025;
          int * geom = (int *) malloc(_len_geom0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_geom0; _i0++) {
            geom[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = qla1280_biosparam(sdev,bdev,capacity,geom);
          printf("%d\n", benchRet); 
          free(sdev);
          free(bdev);
          free(geom);
