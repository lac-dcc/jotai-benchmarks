...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_task0; _i0++) {
            task->rusage_cpu_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        task->rusage_cpu_deadline = ((-2 * (next_i()%2)) + 1) * next_i();
        task->rusage_cpu_interval = ((-2 * (next_i()%2)) + 1) * next_i();
        task->rusage_cpu_percentage = ((-2 * (next_i()%2)) + 1) * next_i();
        task->rusage_cpu_perthr_interval = ((-2 * (next_i()%2)) + 1) * next_i();
        task->rusage_cpu_perthr_percentage = ((-2 * (next_i()%2)) + 1) * next_i();
          }
