...
__attribute__((used)) static void at91_dt_free_map(struct pinctrl_dev *pctldev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_map0 = 1;
          struct pinctrl_map * map = (struct pinctrl_map *) malloc(_len_map0*sizeof(struct pinctrl_map));
          for(int _i0 = 0; _i0 < _len_map0; _i0++) {
            map[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          at91_dt_free_map(pctldev,map,num_maps);
          free(pctldev);
          free(map);
