...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_op0; _i0++) {
            op->upcall.type = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.fsync.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.removexattr.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.listxattr.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.setxattr.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.getxattr.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.fs_umount.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.ra_cache_flush.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.truncate.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.statfs.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.rename.old_parent_refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.sym.parent_refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.setattr.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.readdir.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.mkdir.parent_refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.remove.parent_refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.getattr.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.create.parent_refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.lookup.parent_refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
        op->upcall.req.io.refn.fs_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
