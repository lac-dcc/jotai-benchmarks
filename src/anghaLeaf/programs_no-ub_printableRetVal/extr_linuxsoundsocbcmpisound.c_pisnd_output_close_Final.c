...
__attribute__((used)) static int pisnd_output_close(struct snd_rawmidi_substream *substream)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_substream0; _i0++) {
            substream->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = pisnd_output_close(substream);
          printf("%d\n", benchRet); 
          free(substream);
