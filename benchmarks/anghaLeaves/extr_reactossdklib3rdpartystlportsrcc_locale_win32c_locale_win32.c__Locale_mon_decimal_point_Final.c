...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_lmon0; _i0++) {
              int _len_lmon__i0__decimal_point0 = 1;
          lmon[_i0].decimal_point = (char *) malloc(_len_lmon__i0__decimal_point0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_lmon__i0__decimal_point0; _j0++) {
            lmon[_i0].decimal_point[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          char benchRet = _Locale_mon_decimal_point(lmon);
          printf("%c\n", (benchRet %26) + 'a'); 
          for(int _aux = 0; _aux < _len_lmon0; _aux++) {
          free(lmon[_aux].decimal_point);
          }
          free(lmon);
