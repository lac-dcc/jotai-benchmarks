...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_hwinfo0 = 1;
          int * hwinfo = (int *) malloc(_len_hwinfo0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_hwinfo0; _i0++) {
            hwinfo[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          Hal_EfuseParseAntennaDiversity_8723B(padapter,hwinfo,AutoLoadFail);
          free(padapter);
          free(hwinfo);
