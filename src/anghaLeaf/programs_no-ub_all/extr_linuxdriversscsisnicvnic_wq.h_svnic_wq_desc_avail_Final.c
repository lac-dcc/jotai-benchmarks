...
__attribute__((used)) static inline unsigned int svnic_wq_desc_avail(struct vnic_wq *wq)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_wq0; _i0++) {
            wq->ring.desc_avail = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned int benchRet = svnic_wq_desc_avail(wq);
          printf("%u\n", benchRet); 
          free(wq);
