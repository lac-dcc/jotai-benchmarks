...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter->recvpriv.rx_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->xmitpriv.tx_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->registrypriv.busy_thresh = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->mlmepriv.sitesurveyctrl.last_tx_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->mlmepriv.sitesurveyctrl.last_rx_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->mlmepriv.sitesurveyctrl.traffic_busy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
