...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_par0; _i0++) {
            par->mem_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        par->regs.bpp24_133 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->regs.bpp16_133 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->regs.bpp8_133 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->regs.bpp24_100 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->regs.bpp16_100 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->regs.bpp8_100 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
