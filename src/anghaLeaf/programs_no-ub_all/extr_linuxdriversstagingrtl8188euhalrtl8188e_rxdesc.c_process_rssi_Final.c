...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_padapter0; _i0++) {
            padapter->recvpriv.signal_strength_data.total_num = ((-2 * (next_i()%2)) + 1) * next_i();
        padapter->recvpriv.signal_strength_data.total_val = ((-2 * (next_i()%2)) + 1) * next_i();
        padapter->recvpriv.signal_strength_data.avg_val = ((-2 * (next_i()%2)) + 1) * next_i();
        padapter->recvpriv.signal_strength_data.update_req = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_prframe0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_prframe0; _i0++) {
            prframe->attrib.phy_info.SignalStrength = ((-2 * (next_i()%2)) + 1) * next_i();
          }
