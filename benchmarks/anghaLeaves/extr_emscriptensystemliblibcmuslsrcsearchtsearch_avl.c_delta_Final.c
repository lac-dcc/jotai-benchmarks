...
/* Type definitions */
struct node {TYPE_2__* right; TYPE_1__* left; } ;
struct TYPE_4__ {int height; } ;
struct TYPE_3__ {int height; } ;

/* Variables and functions */

__attribute__((used)) static int delta(struct node *n) {
