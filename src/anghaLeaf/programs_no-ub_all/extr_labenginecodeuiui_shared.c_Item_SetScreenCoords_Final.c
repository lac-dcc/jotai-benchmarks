...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_item0; _i0++) {
            item->textRect.h = ((-2 * (next_i()%2)) + 1) * next_i();
        item->textRect.w = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.border = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rectClient.h = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rectClient.w = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rectClient.y = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rectClient.x = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rect.h = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rect.w = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rect.y = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.rect.x = ((-2 * (next_i()%2)) + 1) * next_i();
        item->window.borderSize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
