...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev[_i0].functionality = ((-2 * (next_i()%2)) + 1) * next_i();
        dev[_i0].master_cfg = ((-2 * (next_i()%2)) + 1) * next_i();
        dev[_i0].mode = ((-2 * (next_i()%2)) + 1) * next_i();
        dev[_i0].timings.bus_freq_hz = ((-2 * (next_i()%2)) + 1) * next_i();
          }
