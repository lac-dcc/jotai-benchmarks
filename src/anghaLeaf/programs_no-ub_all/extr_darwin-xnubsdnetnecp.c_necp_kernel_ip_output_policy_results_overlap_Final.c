...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_upper_policy0; _i0++) {
            upper_policy->result = ((-2 * (next_i()%2)) + 1) * next_i();
        upper_policy->session_order = ((-2 * (next_i()%2)) + 1) * next_i();
        upper_policy->order = ((-2 * (next_i()%2)) + 1) * next_i();
        upper_policy->result_parameter.skip_policy_order = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_lower_policy0; _i0++) {
            lower_policy->result = ((-2 * (next_i()%2)) + 1) * next_i();
        lower_policy->session_order = ((-2 * (next_i()%2)) + 1) * next_i();
        lower_policy->order = ((-2 * (next_i()%2)) + 1) * next_i();
        lower_policy->result_parameter.skip_policy_order = ((-2 * (next_i()%2)) + 1) * next_i();
          }
