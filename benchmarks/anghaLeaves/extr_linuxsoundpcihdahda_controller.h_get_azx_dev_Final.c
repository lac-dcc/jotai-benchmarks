...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          substream[_i0].runtime->private_data = (struct azx_dev *) malloc(_len_substream__i0__runtime_private_data0*sizeof(struct azx_dev));
          ...
          struct azx_dev * benchRet = get_azx_dev(substream);
          printf("%d\n", (*benchRet).dummy);
