...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_antcomb0; _i0++) {
            antcomb->rssi_lna2 = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->rssi_lna1 = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->scan = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->rssi_add = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->rssi_sub = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_conf0 = 1;
        ...
        conf->lna1_lna2_switch_delta = ((-2 * (next_i()%2)) + 1) * next_i();
          }
