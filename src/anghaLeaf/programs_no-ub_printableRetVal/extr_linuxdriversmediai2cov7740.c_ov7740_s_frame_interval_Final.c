...
__attribute__((used)) static int ov7740_s_frame_interval(struct v4l2_subdev *sd,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ival0; _i0++) {
            ival->interval.numerator = ((-2 * (next_i()%2)) + 1) * next_i();
        ival->interval.denominator = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ov7740_s_frame_interval(sd,ival);
          printf("%d\n", benchRet); 
          free(sd);
          free(ival);
