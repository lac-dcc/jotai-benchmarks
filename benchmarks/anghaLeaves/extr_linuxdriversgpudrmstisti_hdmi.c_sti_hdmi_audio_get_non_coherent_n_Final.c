...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int audio_fs = 100;
        
          int benchRet = sti_hdmi_audio_get_non_coherent_n(audio_fs);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int audio_fs = ((-2 * (next_i()%2)) + 1) * next_i();
