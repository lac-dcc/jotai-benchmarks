...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->needFlush = ((-2 * (next_i()%2)) + 1) * next_i();
        p->needInitState = ((-2 * (next_i()%2)) + 1) * next_i();
        p->checkDicSize = ((-2 * (next_i()%2)) + 1) * next_i();
        p->processedPos = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tempBufSize = ((-2 * (next_i()%2)) + 1) * next_i();
        p->remainLen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
