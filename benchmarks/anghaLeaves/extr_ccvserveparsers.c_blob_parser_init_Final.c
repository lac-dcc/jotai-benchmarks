...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_parser0 = 1;
          struct TYPE_5__ * parser = (struct TYPE_5__ *) malloc(_len_parser0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_parser0; _i0++) {
            parser[_i0].data.data = ((-2 * (next_i()%2)) + 1) * next_i();
        parser[_i0].data.written = ((-2 * (next_i()%2)) + 1) * next_i();
        parser[_i0].data.len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          blob_parser_init(parser);
          free(parser);
