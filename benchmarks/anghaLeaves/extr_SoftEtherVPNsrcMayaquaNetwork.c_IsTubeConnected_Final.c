...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_t0; _i0++) {
              int _len_t__i0__TubePairData0 = 1;
          t[_i0].TubePairData = (struct TYPE_4__ *) malloc(_len_t__i0__TubePairData0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_t__i0__TubePairData0; _j0++) {
            t[_i0].TubePairData->IsDisconnected = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = IsTubeConnected(t);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_t0; _aux++) {
          free(t[_aux].TubePairData);
          }
          free(t);
