...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_led0; _i0++) {
            led[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_led_cfg0 = 1;
          struct aat1290_led_config_data * led_cfg = (struct aat1290_led_config_data *) malloc(_len_led_cfg0*sizeof(struct aat1290_led_config_data));
