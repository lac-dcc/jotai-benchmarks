...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_wtime0; _i0++) {
            wtime->tm_isdst = ((-2 * (next_i()%2)) + 1) * next_i();
        wtime->tm_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        wtime->tm_min = ((-2 * (next_i()%2)) + 1) * next_i();
        wtime->tm_hour = ((-2 * (next_i()%2)) + 1) * next_i();
        wtime->tm_mday = ((-2 * (next_i()%2)) + 1) * next_i();
        wtime->tm_mon = ((-2 * (next_i()%2)) + 1) * next_i();
        wtime->tm_year = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_eft0 = 1;
          struct TYPE_3__ * eft = (struct TYPE_3__ *) malloc(_len_eft0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_eft0; _i0++) {
            eft->timezone = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->daylight = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->nanosecond = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->second = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->minute = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->hour = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->day = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->month = ((-2 * (next_i()%2)) + 1) * next_i();
        eft->year = ((-2 * (next_i()%2)) + 1) * next_i();
          }
