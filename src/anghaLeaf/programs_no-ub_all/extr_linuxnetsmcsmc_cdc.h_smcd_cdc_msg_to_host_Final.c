...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_local0; _i0++) {
            local->conn_state_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        local->prod_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        local->cons.count = ((-2 * (next_i()%2)) + 1) * next_i();
        local->cons.wrap = ((-2 * (next_i()%2)) + 1) * next_i();
        local->prod.count = ((-2 * (next_i()%2)) + 1) * next_i();
        local->prod.wrap = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_peer0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_peer0; _i0++) {
            peer->conn_state_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->prod_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->cons_count = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->cons_wrap = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->prod_count = ((-2 * (next_i()%2)) + 1) * next_i();
        peer->prod_wrap = ((-2 * (next_i()%2)) + 1) * next_i();
          }
