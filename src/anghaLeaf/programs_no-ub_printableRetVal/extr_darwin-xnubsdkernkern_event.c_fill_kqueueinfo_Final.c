...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_kq0; _i0++) {
            kq->kq_state = ((-2 * (next_i()%2)) + 1) * next_i();
        kq->kq_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_kinfo0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_kinfo0; _i0++) {
            kinfo->kq_state = ((-2 * (next_i()%2)) + 1) * next_i();
        kinfo->kq_stat.vst_blksize = ((-2 * (next_i()%2)) + 1) * next_i();
        kinfo->kq_stat.vst_ino = ((-2 * (next_i()%2)) + 1) * next_i();
        kinfo->kq_stat.vst_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        kinfo->kq_stat.vst_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
