...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_XGI_Pr0; _i0++) {
            XGI_Pr->P3c4 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3d4 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3c0 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3ce = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3c2 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3cc = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3ca = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3c6 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3c7 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3c8 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3c9 = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->P3da = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->Part3Port = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->Part2Port = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->Part1Port = ((-2 * (next_i()%2)) + 1) * next_i();
        XGI_Pr->Part0Port = ((-2 * (next_i()%2)) + 1) * next_i();
          }
