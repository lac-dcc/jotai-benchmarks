...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ifp0; _i0++) {
            ifp->if_baudrate = ((-2 * (next_i()%2)) + 1) * next_i();
        ifp->if_input_bw.max_bw = ((-2 * (next_i()%2)) + 1) * next_i();
        ifp->if_input_bw.eff_bw = ((-2 * (next_i()%2)) + 1) * next_i();
        ifp->if_output_bw.max_bw = ((-2 * (next_i()%2)) + 1) * next_i();
        ifp->if_output_bw.eff_bw = ((-2 * (next_i()%2)) + 1) * next_i();
          }
