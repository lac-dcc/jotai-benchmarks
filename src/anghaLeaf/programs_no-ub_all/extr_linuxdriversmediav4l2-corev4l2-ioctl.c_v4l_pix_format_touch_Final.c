...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->xfer_func = ((-2 * (next_i()%2)) + 1) * next_i();
        p->quantization = ((-2 * (next_i()%2)) + 1) * next_i();
        p->ycbcr_enc = ((-2 * (next_i()%2)) + 1) * next_i();
        p->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        p->colorspace = ((-2 * (next_i()%2)) + 1) * next_i();
        p->field = ((-2 * (next_i()%2)) + 1) * next_i();
          }
