...
__attribute__((used)) static int iio_device_register_trigger_consumer(struct iio_dev *indio_dev)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = iio_device_register_trigger_consumer(indio_dev);
          printf("%d\n", benchRet); 
          free(indio_dev);
