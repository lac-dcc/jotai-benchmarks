...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ring0; _i0++) {
              ring[_i0].rx_fifo_errors = ((-2 * (next_i()%2)) + 1) * next_i();
          ring[_i0].rx_frame_errors = ((-2 * (next_i()%2)) + 1) * next_i();
          ring[_i0].rx_length_errors = ((-2 * (next_i()%2)) + 1) * next_i();
          ring[_i0].rx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
          ring[_i0].rx_crc_errors = ((-2 * (next_i()%2)) + 1) * next_i();
