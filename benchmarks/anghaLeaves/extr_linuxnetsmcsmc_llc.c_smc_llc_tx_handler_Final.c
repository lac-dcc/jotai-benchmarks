...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum ib_wc_status wc_status = 0;
          int _len_pend0 = 1;
          struct smc_wr_tx_pend_priv * pend = (struct smc_wr_tx_pend_priv *) malloc(_len_pend0*sizeof(struct smc_wr_tx_pend_priv));
          for(int _i0 = 0; _i0 < _len_pend0; _i0++) {
            pend[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_link0 = 1;
          ...
          smc_llc_tx_handler(pend,link,wc_status);
          free(pend);
          free(link);
