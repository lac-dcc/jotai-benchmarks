...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_regs0 = 1;
          struct kvm_regs * regs = (struct kvm_regs *) malloc(_len_regs0*sizeof(struct kvm_regs));
          for(int _i0 = 0; _i0 < _len_regs0; _i0++) {
            regs->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = kvm_arch_vcpu_ioctl_set_regs(vcpu,regs);
          printf("%d\n", benchRet); 
          free(vcpu);
          free(regs);
