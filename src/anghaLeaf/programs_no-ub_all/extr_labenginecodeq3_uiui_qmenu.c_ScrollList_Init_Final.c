...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_l0; _i0++) {
            l->columns = ((-2 * (next_i()%2)) + 1) * next_i();
        l->separation = ((-2 * (next_i()%2)) + 1) * next_i();
        l->width = ((-2 * (next_i()%2)) + 1) * next_i();
        l->height = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.left = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.x = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.right = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.y = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        l->generic.top = ((-2 * (next_i()%2)) + 1) * next_i();
        l->top = ((-2 * (next_i()%2)) + 1) * next_i();
        l->curvalue = ((-2 * (next_i()%2)) + 1) * next_i();
        l->oldvalue = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ScrollList_Init(l);
          free(l);
