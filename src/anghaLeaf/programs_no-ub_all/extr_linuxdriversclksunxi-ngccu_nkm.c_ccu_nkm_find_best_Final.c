...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nkm0; _i0++) {
            nkm->min_k = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->max_k = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->min_n = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->max_n = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->min_m = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->max_m = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->n = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->k = ((-2 * (next_i()%2)) + 1) * next_i();
        nkm->m = ((-2 * (next_i()%2)) + 1) * next_i();
          }
