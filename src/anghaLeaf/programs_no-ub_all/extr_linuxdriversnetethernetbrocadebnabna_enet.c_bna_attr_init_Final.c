...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ioceth0; _i0++) {
            ioceth->attr.fw_query_complete = ((-2 * (next_i()%2)) + 1) * next_i();
        ioceth->attr.max_rit_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ioceth->attr.num_mcmac = ((-2 * (next_i()%2)) + 1) * next_i();
        ioceth->attr.num_ucmac = ((-2 * (next_i()%2)) + 1) * next_i();
        ioceth->attr.num_rxp = ((-2 * (next_i()%2)) + 1) * next_i();
        ioceth->attr.num_txq = ((-2 * (next_i()%2)) + 1) * next_i();
          }
