...
int main(int argc, char *argv[]) {
    ...
    case 1:
    {
          ...
          int dc = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int stride = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int xblen = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int yblen = ((-2 * (next_i()%2)) + 1) * next_i();
