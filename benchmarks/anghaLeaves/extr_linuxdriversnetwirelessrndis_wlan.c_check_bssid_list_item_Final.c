...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int bssid_len = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int len = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int _len_bssid0 = 1;
          struct ndis_80211_bssid_ex * bssid = (struct ndis_80211_bssid_ex *) malloc(_len_bssid0*sizeof(struct ndis_80211_bssid_ex));
          for(int _i0 = 0; _i0 < _len_bssid0; _i0++) {
              bssid[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          void * buf;
        
          int benchRet = check_bssid_list_item(bssid,bssid_len,buf,len);
          printf("%d\n", benchRet); 
          free(bssid);
