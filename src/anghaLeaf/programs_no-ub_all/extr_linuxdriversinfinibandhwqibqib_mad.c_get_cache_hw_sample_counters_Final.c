...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ppd0; _i0++) {
            ppd->cong_stats.counter_cache.psxmitwait = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->cong_stats.counter_cache.psrcvpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->cong_stats.counter_cache.psxmitpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->cong_stats.counter_cache.psrcvdata = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->cong_stats.counter_cache.psxmitdata = ((-2 * (next_i()%2)) + 1) * next_i();
          }
