...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_chip0 = 1;
          struct snd_sh_dac * chip = (struct snd_sh_dac *) malloc(_len_chip0*sizeof(struct snd_sh_dac));
          for(int _i0 = 0; _i0 < _len_chip0; _i0++) {
            chip[_i0].wakeups_per_second = ((-2 * (next_i()%2)) + 1) * next_i();
        chip[_i0].rate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
