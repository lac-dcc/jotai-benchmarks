...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_jsdisp0 = 1;
          struct TYPE_3__ * jsdisp = (struct TYPE_3__ *) malloc(_len_jsdisp0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_jsdisp0; _i0++) {
            jsdisp[_i0].IDispatchEx_iface = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = to_disp(jsdisp);
          printf("%d\n", (*benchRet)); 
          free(jsdisp);
