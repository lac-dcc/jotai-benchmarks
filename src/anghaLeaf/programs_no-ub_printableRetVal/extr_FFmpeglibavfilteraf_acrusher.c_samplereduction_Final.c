...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s->round = ((-2 * (next_i()%2)) + 1) * next_i();
        s->samples = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_sr0 = 1;
          struct TYPE_5__ * sr = (struct TYPE_5__ *) malloc(_len_sr0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_sr0; _i0++) {
            sr->samples = ((-2 * (next_i()%2)) + 1) * next_i();
        sr->target = ((-2 * (next_i()%2)) + 1) * next_i();
        sr->real = ((-2 * (next_i()%2)) + 1) * next_i();
        sr->last = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
