...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct cpc925_dev_info * dev_info = (struct cpc925_dev_info *) malloc(_len_dev_info0*sizeof(struct cpc925_dev_info));
          for(int _i0 = 0; _i0 < _len_dev_info0; _i0++) {
            dev_info[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          cpc925_cpu_exit(dev_info);
          free(dev_info);
