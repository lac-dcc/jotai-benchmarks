...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_policy0; _i0++) {
            policy->priority = ((-2 * (next_i()%2)) + 1) * next_i();
        policy->mark.v = ((-2 * (next_i()%2)) + 1) * next_i();
        policy->mark.m = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pol0 = 1;
          struct xfrm_policy * pol = (struct xfrm_policy *) malloc(_len_pol0*sizeof(struct xfrm_policy));
          for(int _i0 = 0; _i0 < _len_pol0; _i0++) {
            pol->priority = ((-2 * (next_i()%2)) + 1) * next_i();
        pol->mark.v = ((-2 * (next_i()%2)) + 1) * next_i();
        pol->mark.m = ((-2 * (next_i()%2)) + 1) * next_i();
          }
