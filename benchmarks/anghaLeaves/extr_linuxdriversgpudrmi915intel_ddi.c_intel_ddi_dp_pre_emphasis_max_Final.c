...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = intel_ddi_dp_pre_emphasis_max(encoder,voltage_swing);
          printf("%d\n", benchRet); 
          free(encoder);
    ...
    case 3:
    {
          ...
          int voltage_swing = ((-2 * (next_i()%2)) + 1) * next_i();
