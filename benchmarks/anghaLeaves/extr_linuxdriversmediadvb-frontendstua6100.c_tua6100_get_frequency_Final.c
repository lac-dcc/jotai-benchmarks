...
struct tua6100_priv {int /*<<< orphan*/  frequency; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct tua6100_priv *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct tua6100_priv));
          ...
          int benchRet = tua6100_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
