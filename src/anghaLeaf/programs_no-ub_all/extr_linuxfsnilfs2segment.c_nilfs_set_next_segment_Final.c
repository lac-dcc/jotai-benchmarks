...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nilfs0; _i0++) {
            nilfs->ns_ctime = ((-2 * (next_i()%2)) + 1) * next_i();
        nilfs->ns_seg_seq = ((-2 * (next_i()%2)) + 1) * next_i();
        nilfs->ns_pseg_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        nilfs->ns_nextnum = ((-2 * (next_i()%2)) + 1) * next_i();
        nilfs->ns_segnum = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_segbuf0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_segbuf0; _i0++) {
            segbuf->sb_sum.ctime = ((-2 * (next_i()%2)) + 1) * next_i();
        segbuf->sb_sum.seg_seq = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        segbuf->sb_nextnum = ((-2 * (next_i()%2)) + 1) * next_i();
