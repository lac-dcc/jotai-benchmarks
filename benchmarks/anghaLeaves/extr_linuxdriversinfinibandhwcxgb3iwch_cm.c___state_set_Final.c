...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum iwch_ep_state new = 0;
          int _len_epc0 = 1;
          struct iwch_ep_common * epc = (struct iwch_ep_common *) malloc(_len_epc0*sizeof(struct iwch_ep_common));
          for(int _i0 = 0; _i0 < _len_epc0; _i0++) {
            epc[_i0].state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          __state_set(epc,new);
          free(epc);
