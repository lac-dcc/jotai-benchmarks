...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long last_success = 100;
        
          long last_used = 100;
        
          int benchRet = hidma_txn_is_success(cookie,last_success,last_used);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          long last_success = ((-2 * (next_i()%2)) + 1) * next_i();
        
          long last_used = ((-2 * (next_i()%2)) + 1) * next_i();
