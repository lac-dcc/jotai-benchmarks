...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_allocator0; _i0++) {
            allocator->gfree = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->gmallocarray = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->greallocarray = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->grealloc = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->gsubstrdup = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->gstrndup = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->gstrdup = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->gcalloc = ((-2 * (next_i()%2)) + 1) * next_i();
        allocator->gmalloc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
