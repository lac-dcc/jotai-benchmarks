...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bq0; _i0++) {
            bq->gain = ((-2 * (next_i()%2)) + 1) * next_i();
        bq->z1 = ((-2 * (next_i()%2)) + 1) * next_i();
        bq->a1 = ((-2 * (next_i()%2)) + 1) * next_i();
        bq->z2 = ((-2 * (next_i()%2)) + 1) * next_i();
        bq->a2 = ((-2 * (next_i()%2)) + 1) * next_i();
        bq->b1 = ((-2 * (next_i()%2)) + 1) * next_i();
        bq->b2 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
