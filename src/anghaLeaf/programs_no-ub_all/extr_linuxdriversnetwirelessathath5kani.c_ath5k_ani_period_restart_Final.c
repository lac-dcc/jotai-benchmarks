...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_as0; _i0++) {
            as->listen_time = ((-2 * (next_i()%2)) + 1) * next_i();
        as->cck_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        as->ofdm_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        as->last_listen = ((-2 * (next_i()%2)) + 1) * next_i();
        as->last_cck_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        as->last_ofdm_errors = ((-2 * (next_i()%2)) + 1) * next_i();
          }
