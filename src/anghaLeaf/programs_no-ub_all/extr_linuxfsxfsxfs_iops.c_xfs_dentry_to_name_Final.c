...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_namep0; _i0++) {
            namep->type = ((-2 * (next_i()%2)) + 1) * next_i();
        namep->len = ((-2 * (next_i()%2)) + 1) * next_i();
        namep->name = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dentry0 = 1;
          struct dentry * dentry = (struct dentry *) malloc(_len_dentry0*sizeof(struct dentry));
          for(int _i0 = 0; _i0 < _len_dentry0; _i0++) {
            dentry->d_name.len = ((-2 * (next_i()%2)) + 1) * next_i();
        dentry->d_name.name = ((-2 * (next_i()%2)) + 1) * next_i();
          }
