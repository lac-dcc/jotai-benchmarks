...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * op_array = (struct TYPE_3__ *) malloc(_len_op_array0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_op_array0; _i0++) {
            op_array[_i0].cache_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = alloc_cache_slots(op_array,num);
          printf("%d\n", benchRet); 
          free(op_array);
