...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int id2 = 100;
        
          unsigned int mask = 100;
        
          int benchRet = ac97_ids_match(id1,id2,mask);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          ...
          unsigned int id1 = 255;
        
          unsigned int id2 = 255;
    ...
    case 3:
    {
          ...
          unsigned int id1 = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int id2 = ((-2 * (next_i()%2)) + 1) * next_i();
