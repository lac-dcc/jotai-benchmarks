...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_TIM_OCInitStruct0; _i0++) {
            TIM_OCInitStruct->TIM_Pulse = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_OCInitStruct->TIM_OCNIdleState = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_OCInitStruct->TIM_OCIdleState = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_OCInitStruct->TIM_OutputNState = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_OCInitStruct->TIM_OutputState = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_OCInitStruct->TIM_OCMode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
