...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int swizzle = 100;
        
          const char * benchRet = swizzle_string(swizzle);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          ...
          unsigned int swizzle = ((-2 * (next_i()%2)) + 1) * next_i();
