...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int i = 255;
          int _len_v0 = 1;
          struct TYPE_4__ * v = (struct TYPE_4__ *) malloc(_len_v0*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_v0; _i0++) {
            v->next = ((-2 * (next_i()%2)) + 1) * next_i();
        v->ch = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct TYPE_4__ ** benchRet = get_not_null(v,i);
          printf("{{struct}} %p\n", &benchRet); 
          free(v);
