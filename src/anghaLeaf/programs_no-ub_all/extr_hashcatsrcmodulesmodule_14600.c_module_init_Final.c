...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_module_ctx0; _i0++) {
            module_ctx->module_tmp_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_potfile_disable = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_outfile_check_disable = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_opts_type = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_opti_type = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_kern_type_dynamic = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_hash_binary_parse = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_binary_count = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_esalt_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_benchmark_salt = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_benchmark_esalt = ((-2 * (next_i()%2)) + 1) * next_i();
