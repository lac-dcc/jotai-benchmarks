...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_low_key0; _i0++) {
            low_key->fmr_device = ((-2 * (next_i()%2)) + 1) * next_i();
        low_key->fmr_physical = ((-2 * (next_i()%2)) + 1) * next_i();
        low_key->fmr_owner = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_high_key0; _i0++) {
            high_key->fmr_device = ((-2 * (next_i()%2)) + 1) * next_i();
        high_key->fmr_physical = ((-2 * (next_i()%2)) + 1) * next_i();
        high_key->fmr_owner = ((-2 * (next_i()%2)) + 1) * next_i();
          }
