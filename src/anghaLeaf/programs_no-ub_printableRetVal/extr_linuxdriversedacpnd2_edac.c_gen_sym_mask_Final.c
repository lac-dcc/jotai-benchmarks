...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->sym_slice0_channel_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p->sym_slice1_channel_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p->enable_pmi_dual_data_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        p->ch_1_disabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p->slice_1_disabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p->slice_0_mem_disabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
