...
struct resource *_allocate_p(int length, struct resource *aux_p[]) {
...
void _delete_p(struct resource *aux_p[], int aux_p_size) {
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int sibling_only = 100;
        
          struct resource * aux_p[1];
          struct resource * p = _allocate_p(1, aux_p);
    ...
    case 1:
    {
          ...
          int sibling_only = ((-2 * (next_i()%2)) + 1) * next_i();
