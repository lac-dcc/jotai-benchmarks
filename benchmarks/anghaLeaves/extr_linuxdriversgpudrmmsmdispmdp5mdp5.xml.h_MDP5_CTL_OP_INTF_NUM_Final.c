...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          enum mdp5_intfnum val = 100;
        
          int benchRet = MDP5_CTL_OP_INTF_NUM(val);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          enum mdp5_intfnum val = ((-2 * (next_i()%2)) + 1) * next_i();
