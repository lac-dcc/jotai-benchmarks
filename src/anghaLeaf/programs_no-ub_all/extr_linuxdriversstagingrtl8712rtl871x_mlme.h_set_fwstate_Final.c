...
__attribute__((used)) static inline void set_fwstate(struct mlme_priv *pmlmepriv, sint state)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pmlmepriv0; _i0++) {
            pmlmepriv->fw_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          set_fwstate(pmlmepriv,state);
          free(pmlmepriv);
