...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_in0; _i0++) {
            in->si_band = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_value.sival_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_status = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_uid = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_pid = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_code = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_errno = ((-2 * (next_i()%2)) + 1) * next_i();
        in->si_signo = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_out0 = 1;
          struct TYPE_10__ * out = (struct TYPE_10__ *) malloc(_len_out0*sizeof(struct TYPE_10__));
          for(int _i0 = 0; _i0 < _len_out0; _i0++) {
            out->si_band = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_value.sival_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_status = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_uid = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_pid = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_code = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_errno = ((-2 * (next_i()%2)) + 1) * next_i();
        out->si_signo = ((-2 * (next_i()%2)) + 1) * next_i();
          }
