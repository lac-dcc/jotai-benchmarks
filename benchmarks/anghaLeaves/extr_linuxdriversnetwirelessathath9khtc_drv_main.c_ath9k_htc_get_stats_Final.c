...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          hw[_i0].priv = (struct ath9k_htc_priv *) malloc(_len_hw__i0__priv0*sizeof(struct ath9k_htc_priv));
          for(int _j0 = 0; _j0 < _len_hw__i0__priv0; _j0++) {
              int _len_hw__i0__priv_ah0 = 1;
          hw[_i0].priv->ah = (struct ath_hw *) malloc(_len_hw__i0__priv_ah0*sizeof(struct ath_hw));
          for(int _j0 = 0; _j0 < _len_hw__i0__priv_ah0; _j0++) {
            hw[_i0].priv->ah->ah_mibStats.rts_good = ((-2 * (next_i()%2)) + 1) * next_i();
        hw[_i0].priv->ah->ah_mibStats.fcs_bad = ((-2 * (next_i()%2)) + 1) * next_i();
        hw[_i0].priv->ah->ah_mibStats.rts_bad = ((-2 * (next_i()%2)) + 1) * next_i();
        hw[_i0].priv->ah->ah_mibStats.ackrcv_bad = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_stats0 = 1;
        ...
        stats[_i0].dot11ACKFailureCount = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = ath9k_htc_get_stats(hw,stats);
          printf("%d\n", benchRet); 
