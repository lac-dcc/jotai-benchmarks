...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ieee0; _i0++) {
            ieee->tkip_countermeasures = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->drop_unencrypted = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->open_wep = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->auth_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->wpa_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->ieee802_1x = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->privacy_invoked = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_info0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        data->value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
