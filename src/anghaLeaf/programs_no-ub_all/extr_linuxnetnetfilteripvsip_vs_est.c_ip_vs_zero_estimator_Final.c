...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stats0; _i0++) {
            stats->kstats.outpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->kstats.inpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->kstats.conns = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->kstats.outbytes = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->kstats.inbytes = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        stats->est.last_outpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->est.last_inpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->est.last_conns = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->est.last_outbytes = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->est.last_inbytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
