...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ws0; _i0++) {
            ws->gaps_inner = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->gaps_outer.left = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->gaps_outer.bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->gaps_outer.right = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->gaps_outer.top = ((-2 * (next_i()%2)) + 1) * next_i();
          }
