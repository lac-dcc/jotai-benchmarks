...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx->decoder = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->output_buffer = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->input_buffer = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->fout = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->fin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          init(ctx);
          free(ctx);
