...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phba0; _i0++) {
            phba->iocb_rsp_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pring0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_pring0; _i0++) {
            pring->sli.sli3.rspidx = ((-2 * (next_i()%2)) + 1) * next_i();
        pring->sli.sli3.rspringaddr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = lpfc_resp_iocb(phba,pring);
          printf("{{other_type}} %p\n", &benchRet); 
          free(phba);
          free(pring);
