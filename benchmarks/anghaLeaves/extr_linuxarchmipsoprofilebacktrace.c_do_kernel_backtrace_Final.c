...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long low_addr = 100;
          unsigned int depth = 100;
          int _len_frame0 = 1;
          struct stackframe * frame = (struct stackframe *) malloc(_len_frame0*sizeof(struct stackframe));
          for(int _i0 = 0; _i0 < _len_frame0; _i0++) {
            frame[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
