...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_chunk0 = 1;
          struct TYPE_3__ * chunk = (struct TYPE_3__ *) malloc(_len_chunk0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_chunk0; _i0++) {
            chunk[_i0].size = ((-2 * (next_i()%2)) + 1) * next_i();
        chunk[_i0].sndChunk = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_to0 = 1;
