...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_String0; _i0++) {
            String->Str.MaximumLength = ((-2 * (next_i()%2)) + 1) * next_i();
        String->Str.Length = ((-2 * (next_i()%2)) + 1) * next_i();
        String->Str.Buffer = ((-2 * (next_i()%2)) + 1) * next_i();
        String->FixedBuffer = ((-2 * (next_i()%2)) + 1) * next_i();
          }
