...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_ostr0 = 65025;
          char * ostr = (char *) malloc(_len_ostr0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_ostr0; _i0++) {
            ostr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = stb_from_utf8(buffer,ostr,n);
          printf("{{other_type}} %p\n", &benchRet); 
          free(buffer);
          free(ostr);
