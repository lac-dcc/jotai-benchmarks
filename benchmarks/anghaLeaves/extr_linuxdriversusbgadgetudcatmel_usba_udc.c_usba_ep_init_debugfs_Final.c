...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_udc0 = 1;
          struct usba_udc * udc = (struct usba_udc *) malloc(_len_udc0*sizeof(struct usba_udc));
          for(int _i0 = 0; _i0 < _len_udc0; _i0++) {
            udc[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ep0 = 1;
          struct usba_ep * ep = (struct usba_ep *) malloc(_len_ep0*sizeof(struct usba_ep));
          for(int _i0 = 0; _i0 < _len_ep0; _i0++) {
            ep[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          usba_ep_init_debugfs(udc,ep);
          free(udc);
          free(ep);
