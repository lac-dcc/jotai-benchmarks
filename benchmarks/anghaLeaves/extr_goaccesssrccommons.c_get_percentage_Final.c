...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long long hit = 100;
        
          float benchRet = get_percentage(total,hit);
          printf("%f\n", benchRet); 
    ...
    case 1:
    {
          ...
          unsigned long long total = 255;
        
          unsigned long long hit = 255;
    ...
    case 3:
    {
          ...
          unsigned long long total = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned long long hit = ((-2 * (next_i()%2)) + 1) * next_i();
