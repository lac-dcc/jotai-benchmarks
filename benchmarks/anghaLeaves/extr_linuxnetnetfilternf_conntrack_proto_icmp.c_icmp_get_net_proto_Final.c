...
__attribute__((used)) static struct nf_proto_net *icmp_get_net_proto(struct net *net)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_net0; _i0++) {
            net[_i0].ct.nf_ct_proto.icmp.pn.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct nf_proto_net * benchRet = icmp_get_net_proto(net);
          printf("%d\n", (*benchRet).dummy);
          free(net);
