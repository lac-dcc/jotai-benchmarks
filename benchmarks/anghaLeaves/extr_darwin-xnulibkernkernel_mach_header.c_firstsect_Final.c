...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_sgp0 = 65025;
          struct TYPE_3__ * sgp = (struct TYPE_3__ *) malloc(_len_sgp0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_sgp0; _i0++) {
              sgp[_i0].nsects = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int * benchRet = firstsect(sgp);
          printf("%d\n", (*benchRet)); 
          free(sgp);
