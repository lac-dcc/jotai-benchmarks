...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rq0; _i0++) {
            rq->dl.this_bw = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->dl.running_bw = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->dl.bw_ratio = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->dl.extra_bw = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dl_se0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_dl_se0; _i0++) {
            dl_se->dl_bw = ((-2 * (next_i()%2)) + 1) * next_i();
          }
