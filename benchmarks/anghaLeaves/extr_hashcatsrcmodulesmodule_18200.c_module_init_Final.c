...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // ------------------------------- 
          // static_instructions_O1 : 94
          // dynamic_instructions_O1 : 94
          // ------------------------------- 
          // static_instructions_O2 : 94
          // dynamic_instructions_O2 : 94
          // ------------------------------- 
          // static_instructions_O3 : 94
          // dynamic_instructions_O3 : 94
          // ------------------------------- 
          // static_instructions_Ofast : 94
          // dynamic_instructions_Ofast : 94
          // ------------------------------- 
          // static_instructions_Os : 94
          // dynamic_instructions_Os : 94
          // ------------------------------- 
          // static_instructions_Oz : 94
          ...
          module_ctx[_i0].module_pwdump_column = ((-2 * (next_i()%2)) + 1) * next_i();
