...
__attribute__((used)) static netdev_features_t nes_fix_features(struct net_device *netdev, netdev_features_t features)
{
	/*
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = nes_fix_features(netdev,features);
          printf("%d\n", benchRet); 
          free(netdev);
