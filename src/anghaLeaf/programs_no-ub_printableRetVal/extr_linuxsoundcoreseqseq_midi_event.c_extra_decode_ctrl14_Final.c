...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->lastcmd = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->nostat = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_buf0 = 65025;
          ...
          for(int _i0 = 0; _i0 < _len_ev0; _i0++) {
            ev->data.control.channel = ((-2 * (next_i()%2)) + 1) * next_i();
        ev->data.control.param = ((-2 * (next_i()%2)) + 1) * next_i();
        ev->data.control.value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = extra_decode_ctrl14(dev,buf,count,ev);
          printf("%d\n", benchRet); 
          free(dev);
          free(buf);
          free(ev);
