...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ca0; _i0++) {
            ca[_i0].maxreq_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        ca[_i0].maxresp_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        ca[_i0].maxops = ((-2 * (next_i()%2)) + 1) * next_i();
        ca[_i0].maxresp_cached = ((-2 * (next_i()%2)) + 1) * next_i();
        ca[_i0].headerpadsz = ((-2 * (next_i()%2)) + 1) * next_i();
          }
