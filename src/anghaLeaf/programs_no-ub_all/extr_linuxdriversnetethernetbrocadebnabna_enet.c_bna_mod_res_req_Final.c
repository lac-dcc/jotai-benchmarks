...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bna0; _i0++) {
            bna->ioceth.attr.num_txq = ((-2 * (next_i()%2)) + 1) * next_i();
        bna->ioceth.attr.num_rxp = ((-2 * (next_i()%2)) + 1) * next_i();
        bna->ioceth.attr.num_ucmac = ((-2 * (next_i()%2)) + 1) * next_i();
        bna->ioceth.attr.num_mcmac = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_res_info0; _i0++) {
            res_info->res_u.mem_info.num = ((-2 * (next_i()%2)) + 1) * next_i();
        res_info->res_u.mem_info.len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
