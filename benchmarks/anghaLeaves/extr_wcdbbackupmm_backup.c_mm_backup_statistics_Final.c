...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
              ctx[_i0].stmt_count = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int _len_stmt_count0 = 65025;
          unsigned int * stmt_count = (unsigned int *) malloc(_len_stmt_count0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_stmt_count0; _i0++) {
            stmt_count[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
