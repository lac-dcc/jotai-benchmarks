...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ext_attr0; _i0++) {
              ext_attr[_i0].qam_pga_cfg = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_pga_cfg = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_pre_saw_cfg.reference = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_pre_saw_cfg.use_pre_saw = ((-2 * (next_i()%2)) + 1) * next_i();
        
          ext_attr[_i0].vsb_rf_agc_cfg.max_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_rf_agc_cfg.speed = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_rf_agc_cfg.top = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_rf_agc_cfg.cut_off_current = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_rf_agc_cfg.min_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
        
          ext_attr[_i0].qam_pre_saw_cfg.reference = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_pre_saw_cfg.use_pre_saw = ((-2 * (next_i()%2)) + 1) * next_i();
        
          ext_attr[_i0].qam_rf_agc_cfg.max_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_rf_agc_cfg.speed = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_rf_agc_cfg.top = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_rf_agc_cfg.cut_off_current = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_rf_agc_cfg.min_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
        
          ext_attr[_i0].vsb_if_agc_cfg.max_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_if_agc_cfg.speed = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_if_agc_cfg.top = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].vsb_if_agc_cfg.min_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
        
          ext_attr[_i0].qam_if_agc_cfg.max_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_if_agc_cfg.speed = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_if_agc_cfg.top = ((-2 * (next_i()%2)) + 1) * next_i();
          ext_attr[_i0].qam_if_agc_cfg.min_output_level = ((-2 * (next_i()%2)) + 1) * next_i();
        
          ext_attr[_i0].has_lna = ((-2 * (next_i()%2)) + 1) * next_i();
