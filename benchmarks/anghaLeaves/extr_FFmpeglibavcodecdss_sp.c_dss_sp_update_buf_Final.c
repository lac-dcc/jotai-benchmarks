...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 2616
          // ------------------------------- 
          // static_instructions_O1 : 19
          // dynamic_instructions_O1 : 1165
          // ------------------------------- 
          ...
          // dynamic_instructions_Os : 1164
          // ------------------------------- 
          // static_instructions_Oz : 19
          // dynamic_instructions_Oz : 1198
          // ------------------------------- 

          int _len_hist0 = 65025;
          int * hist = (int *) malloc(_len_hist0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_hist0; _i0++) {
            hist[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int _len_vector0 = 65025;
          int * vector = (int *) malloc(_len_vector0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_vector0; _i0++) {
            vector[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          dss_sp_update_buf(hist,vector);
          free(hist);
          free(vector);
