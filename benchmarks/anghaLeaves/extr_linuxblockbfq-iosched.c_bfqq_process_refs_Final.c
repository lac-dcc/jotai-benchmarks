...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bfqq0; _i0++) {
            bfqq[_i0].ref = ((-2 * (next_i()%2)) + 1) * next_i();
        bfqq[_i0].allocated = ((-2 * (next_i()%2)) + 1) * next_i();
        bfqq[_i0].entity.on_st = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = bfqq_process_refs(bfqq);
          printf("%d\n", benchRet); 
          free(bfqq);
