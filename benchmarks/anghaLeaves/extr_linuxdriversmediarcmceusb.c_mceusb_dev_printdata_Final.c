...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int out = 100;
          int _len_ir0 = 1;
          struct mceusb_dev * ir = (struct mceusb_dev *) malloc(_len_ir0*sizeof(struct mceusb_dev));
          for(int _i0 = 0; _i0 < _len_ir0; _i0++) {
            ir[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_buf0 = 1;
          ...
          mceusb_dev_printdata(ir,buf,buf_len,offset,len,out);
          free(ir);
          free(buf);
