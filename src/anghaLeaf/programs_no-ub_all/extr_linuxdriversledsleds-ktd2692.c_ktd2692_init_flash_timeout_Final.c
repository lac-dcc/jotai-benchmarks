...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fled_cdev0; _i0++) {
            fled_cdev->timeout.max = ((-2 * (next_i()%2)) + 1) * next_i();
        fled_cdev->timeout.step = ((-2 * (next_i()%2)) + 1) * next_i();
        fled_cdev->timeout.val = ((-2 * (next_i()%2)) + 1) * next_i();
        fled_cdev->timeout.min = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cfg0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_cfg0; _i0++) {
            cfg->flash_max_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
          }
