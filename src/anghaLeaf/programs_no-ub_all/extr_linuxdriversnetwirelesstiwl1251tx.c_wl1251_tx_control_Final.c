...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tx_hdr0; _i0++) {
            tx_hdr->control.rate_policy = ((-2 * (next_i()%2)) + 1) * next_i();
        tx_hdr->control.ack_policy = ((-2 * (next_i()%2)) + 1) * next_i();
        tx_hdr->control.tx_complete = ((-2 * (next_i()%2)) + 1) * next_i();
        tx_hdr->control.qos = ((-2 * (next_i()%2)) + 1) * next_i();
        tx_hdr->control.packet_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_control0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_control0; _i0++) {
            control->flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
