...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_patch0; _i0++) {
            patch->is_rename = ((-2 * (next_i()%2)) + 1) * next_i();
        patch->is_copy = ((-2 * (next_i()%2)) + 1) * next_i();
        patch->is_new = ((-2 * (next_i()%2)) + 1) * next_i();
        patch->old_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        patch->new_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        patch->is_delete = ((-2 * (next_i()%2)) + 1) * next_i();
          }
