...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_GPIO_InitStruct0; _i0++) {
            GPIO_InitStruct->GPIO_PuPd = ((-2 * (next_i()%2)) + 1) * next_i();
        GPIO_InitStruct->GPIO_OType = ((-2 * (next_i()%2)) + 1) * next_i();
        GPIO_InitStruct->GPIO_Speed = ((-2 * (next_i()%2)) + 1) * next_i();
        GPIO_InitStruct->GPIO_Mode = ((-2 * (next_i()%2)) + 1) * next_i();
        GPIO_InitStruct->GPIO_Pin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
