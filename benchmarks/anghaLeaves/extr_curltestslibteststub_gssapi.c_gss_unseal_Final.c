...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = gss_unseal(min,context_handle,input_message_buffer,output_message_buffer,conf_state,qop_state);
          printf("%d\n", benchRet); 
          free(min);
          free(conf_state);
          free(qop_state);
    ...
    case 3:
    {
          ...
          int input_message_buffer = ((-2 * (next_i()%2)) + 1) * next_i();
