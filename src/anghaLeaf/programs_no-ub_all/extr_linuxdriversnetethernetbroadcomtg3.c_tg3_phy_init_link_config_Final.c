...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tp0; _i0++) {
            tp->phy_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        tp->old_link = ((-2 * (next_i()%2)) + 1) * next_i();
        tp->link_config.advertising = ((-2 * (next_i()%2)) + 1) * next_i();
        tp->link_config.autoneg = ((-2 * (next_i()%2)) + 1) * next_i();
          }
