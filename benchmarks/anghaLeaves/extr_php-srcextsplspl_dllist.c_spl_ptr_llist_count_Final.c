...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_llist0 = 1;
          struct TYPE_3__ * llist = (struct TYPE_3__ *) malloc(_len_llist0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_llist0; _i0++) {
            llist[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = spl_ptr_llist_count(llist);
          printf("%d\n", benchRet); 
          free(llist);
