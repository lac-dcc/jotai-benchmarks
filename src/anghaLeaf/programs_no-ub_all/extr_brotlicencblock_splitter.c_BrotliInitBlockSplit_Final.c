...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
            self->lengths_alloc_size = ((-2 * (next_i()%2)) + 1) * next_i();
        self->types_alloc_size = ((-2 * (next_i()%2)) + 1) * next_i();
        self->lengths = ((-2 * (next_i()%2)) + 1) * next_i();
        self->types = ((-2 * (next_i()%2)) + 1) * next_i();
        self->num_blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        self->num_types = ((-2 * (next_i()%2)) + 1) * next_i();
          }
