...
/* Variables and functions */
 int EINVAL ; 
 int /*<<< orphan*/  OV9740_MAX_HEIGHT ; 
 int /*<<< orphan*/  OV9740_MAX_WIDTH ; 
#define  V4L2_SEL_TGT_CROP 130 
#define  V4L2_SEL_TGT_CROP_BOUNDS 129 
#define  V4L2_SEL_TGT_CROP_DEFAULT 128 
 scalar_t__ V4L2_SUBDEV_FORMAT_ACTIVE ; 

__attribute__((used)) static int ov9740_get_selection(struct v4l2_subdev *sd,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        sel[_i0].r.left = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = ov9740_get_selection(sd,cfg,sel);
          printf("%d\n", benchRet); 
          free(sd);
          free(cfg);
          free(sel);
