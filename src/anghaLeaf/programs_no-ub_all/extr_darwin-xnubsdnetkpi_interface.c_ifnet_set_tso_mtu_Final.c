...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_interface0; _i0++) {
            interface->if_mtu = ((-2 * (next_i()%2)) + 1) * next_i();
        interface->if_hwassist = ((-2 * (next_i()%2)) + 1) * next_i();
        interface->if_tso_v6_mtu = ((-2 * (next_i()%2)) + 1) * next_i();
        interface->if_tso_v4_mtu = ((-2 * (next_i()%2)) + 1) * next_i();
          }
