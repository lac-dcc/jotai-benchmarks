...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 1474
          // ------------------------------- 
          // static_instructions_O1 : 30
          // dynamic_instructions_O1 : 1024
          // ------------------------------- 
          // static_instructions_O2 : 67
          // dynamic_instructions_O2 : 452
          // ------------------------------- 
          // static_instructions_O3 : 67
          // dynamic_instructions_O3 : 452
          // ------------------------------- 
          // static_instructions_Ofast : 67
          // dynamic_instructions_Ofast : 452
          // ------------------------------- 
          // static_instructions_Os : 27
          // dynamic_instructions_Os : 1007
          // ------------------------------- 
          ...
          spatial_compensation_4(src,dst,stride);
          free(src);
          free(dst);
