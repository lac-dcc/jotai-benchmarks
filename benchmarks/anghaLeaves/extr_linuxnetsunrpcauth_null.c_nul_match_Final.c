...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int taskflags = 100;
          int _len_acred0 = 1;
          struct auth_cred * acred = (struct auth_cred *) malloc(_len_acred0*sizeof(struct auth_cred));
          for(int _i0 = 0; _i0 < _len_acred0; _i0++) {
            acred[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cred0 = 1;
          ...
          int benchRet = nul_match(acred,cred,taskflags);
          printf("%d\n", benchRet); 
          free(acred);
          free(cred);
