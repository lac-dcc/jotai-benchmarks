...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_acl0; _i0++) {
            acl->node_attrib.default_erl = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.random_r2t_offsets = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.random_datain_seq_offsets = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.random_datain_pdu_offsets = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.nopin_response_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.nopin_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.dataout_timeout_retries = ((-2 * (next_i()%2)) + 1) * next_i();
        acl->node_attrib.dataout_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_tpg0 = 1;
