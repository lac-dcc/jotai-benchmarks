...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
            hw->adminq.rq.head_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.len_ena_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.len_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.bal = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.bah = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.len = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.tail = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.rq.head = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.head_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.len_ena_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.len_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.bal = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.bah = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.len = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.tail = ((-2 * (next_i()%2)) + 1) * next_i();
        hw->adminq.sq.head = ((-2 * (next_i()%2)) + 1) * next_i();
          }
