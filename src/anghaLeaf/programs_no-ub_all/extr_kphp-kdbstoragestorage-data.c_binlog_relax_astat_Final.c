...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_B0; _i0++) {
            B->st_read.fails = ((-2 * (next_i()%2)) + 1) * next_i();
        B->as_read.counter = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        B->as_read.old_value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
