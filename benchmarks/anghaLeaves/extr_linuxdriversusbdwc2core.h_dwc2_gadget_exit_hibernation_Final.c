...
__attribute__((used)) static inline int dwc2_gadget_exit_hibernation(struct dwc2_hsotg *hsotg,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = dwc2_gadget_exit_hibernation(hsotg,rem_wakeup,reset);
          printf("%d\n", benchRet); 
          free(hsotg);
