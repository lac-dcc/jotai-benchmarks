...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_wil0; _i0++) {
            wil->txrx_ops.rx_fini = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.is_rx_idle = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.rx_error_check = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.rx_crypto_check = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.get_netif_rx_params = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.get_reorder_params = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.wmi_addba_rx_resp = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.rx_init = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.tx_fini = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.tx_init = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.ring_init_bcast = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.ring_fini_tx = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.ring_init_tx = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.tx_ring_tso = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.tx_desc_unmap = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.tx_desc_map = ((-2 * (next_i()%2)) + 1) * next_i();
        wil->txrx_ops.configure_interrupt_moderation = ((-2 * (next_i()%2)) + 1) * next_i();
          }
