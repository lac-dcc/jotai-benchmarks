...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rx_status0; _i0++) {
            rx_status->signal = ((-2 * (next_i()%2)) + 1) * next_i();
        rx_status->enc_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_phy_stats0; _i0++) {
            phy_stats->cck_agc_rpt_ofdm_cfosho_a = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_stats->cck_sig_qual_ofdm_pwdb_all = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_stats->sgi_en = ((-2 * (next_i()%2)) + 1) * next_i();
          }
