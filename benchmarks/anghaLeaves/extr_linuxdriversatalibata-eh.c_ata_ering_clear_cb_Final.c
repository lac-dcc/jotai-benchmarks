...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_ent0 = 65025;
          struct ata_ering_entry * ent = (struct ata_ering_entry *) malloc(_len_ent0*sizeof(struct ata_ering_entry));
          for(int _i0 = 0; _i0 < _len_ent0; _i0++) {
              ent[_i0].eflags = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          void * void_arg;
        
          int benchRet = ata_ering_clear_cb(ent,void_arg);
          printf("%d\n", benchRet); 
          free(ent);
