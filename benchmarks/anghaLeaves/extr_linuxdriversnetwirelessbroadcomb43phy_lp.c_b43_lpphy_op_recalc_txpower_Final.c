...
__attribute__((used)) static enum b43_txpwr_result b43_lpphy_op_recalc_txpower(struct b43_wldev *dev,
							 bool ignore_tssi)
{
	//TODO
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          enum b43_txpwr_result benchRet = b43_lpphy_op_recalc_txpower(dev,ignore_tssi);
          free(dev);
