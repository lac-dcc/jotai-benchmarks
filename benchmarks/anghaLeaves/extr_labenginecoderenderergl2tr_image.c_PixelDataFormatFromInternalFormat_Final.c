...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int internalFormat = 100;
        
          int benchRet = PixelDataFormatFromInternalFormat(internalFormat);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int internalFormat = ((-2 * (next_i()%2)) + 1) * next_i();
