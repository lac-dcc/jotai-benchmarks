...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          node[_i0].sway_container = (struct TYPE_2__ *) malloc(_len_node__i0__sway_container0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_container0; _j0++) {
            node[_i0].sway_container->view = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = node_is_view(node);
          printf("%d\n", benchRet); 
