...
__attribute__((used)) static enum drm_mode_status vbox_mode_valid(struct drm_connector *connector,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          enum drm_mode_status benchRet = vbox_mode_valid(connector,mode);
          printf("{{other_type}} %p\n", &benchRet); 
          free(connector);
          free(mode);
