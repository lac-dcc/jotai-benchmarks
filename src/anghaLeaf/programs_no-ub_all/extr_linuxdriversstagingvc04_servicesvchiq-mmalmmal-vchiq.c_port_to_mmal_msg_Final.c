...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_port0; _i0++) {
            port->current_buffer.size = ((-2 * (next_i()%2)) + 1) * next_i();
        port->current_buffer.num = ((-2 * (next_i()%2)) + 1) * next_i();
        port->recommended_buffer.size = ((-2 * (next_i()%2)) + 1) * next_i();
        port->recommended_buffer.num = ((-2 * (next_i()%2)) + 1) * next_i();
        port->minimum_buffer.alignment = ((-2 * (next_i()%2)) + 1) * next_i();
        port->minimum_buffer.size = ((-2 * (next_i()%2)) + 1) * next_i();
        port->minimum_buffer.num = ((-2 * (next_i()%2)) + 1) * next_i();
        port->enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        port->type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->userdata = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_size = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_num = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_size_recommended = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_num_recommended = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_alignment_min = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_size_min = ((-2 * (next_i()%2)) + 1) * next_i();
        p->buffer_num_min = ((-2 * (next_i()%2)) + 1) * next_i();
        p->is_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        p->index_all = ((-2 * (next_i()%2)) + 1) * next_i();
        p->index = ((-2 * (next_i()%2)) + 1) * next_i();
        p->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
