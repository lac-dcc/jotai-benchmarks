...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cd0; _i0++) {
            cd->fcftr_value = ((-2 * (next_i()%2)) + 1) * next_i();
        cd->trscer_err_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        cd->eesr_err_check = ((-2 * (next_i()%2)) + 1) * next_i();
        cd->tx_check = ((-2 * (next_i()%2)) + 1) * next_i();
        cd->fdr_value = ((-2 * (next_i()%2)) + 1) * next_i();
        cd->ecsipr_value = ((-2 * (next_i()%2)) + 1) * next_i();
        cd->ecsr_value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
