...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_interface0; _i0++) {
            interface->glort = ((-2 * (next_i()%2)) + 1) * next_i();
        interface->glort_count = ((-2 * (next_i()%2)) + 1) * next_i();
        interface->hw.iov.total_vfs = ((-2 * (next_i()%2)) + 1) * next_i();
        interface->hw.mac.dglort_map = ((-2 * (next_i()%2)) + 1) * next_i();
          }
