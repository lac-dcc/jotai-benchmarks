...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s->ch_params.tx_delay = ((-2 * (next_i()%2)) + 1) * next_i();
        s->ch_params.ppersist = ((-2 * (next_i()%2)) + 1) * next_i();
        s->ch_params.slottime = ((-2 * (next_i()%2)) + 1) * next_i();
        s->ch_params.tx_tail = ((-2 * (next_i()%2)) + 1) * next_i();
        s->ch_params.fulldup = ((-2 * (next_i()%2)) + 1) * next_i();
          }
