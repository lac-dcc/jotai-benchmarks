...
__attribute__((used)) static inline int btrfs_init_acl(struct btrfs_trans_handle *trans,
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_trans0 = 1;
          struct btrfs_trans_handle * trans = (struct btrfs_trans_handle *) malloc(_len_trans0*sizeof(struct btrfs_trans_handle));
          ...
          int benchRet = btrfs_init_acl(trans,inode,dir);
          printf("%d\n", benchRet); 
          free(trans);
          free(inode);
          free(dir);
