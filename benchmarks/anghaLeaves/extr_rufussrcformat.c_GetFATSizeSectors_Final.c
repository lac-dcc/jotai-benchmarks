...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          ...
          int DskSize = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int ReservedSecCnt = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int SecPerClus = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int NumFATs = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int BytesPerSect = ((-2 * (next_i()%2)) + 1) * next_i();
