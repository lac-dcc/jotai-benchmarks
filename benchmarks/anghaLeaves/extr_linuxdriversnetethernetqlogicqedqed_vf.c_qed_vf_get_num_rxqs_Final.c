...
struct TYPE_4__ {int /*<<< orphan*/  num_rxqs; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_p_hwfn__i0__vf_iov_info0; _j0++) {
            p_hwfn[_i0].vf_iov_info->acquire_resp.resc.num_rxqs = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_num_rxqs0 = 1;
          int * num_rxqs = (int *) malloc(_len_num_rxqs0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_num_rxqs0; _i0++) {
            num_rxqs[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
