...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 6637
          // ------------------------------- 
          // static_instructions_O1 : 26
          // dynamic_instructions_O1 : 1291
          // ------------------------------- 
          // static_instructions_O2 : 126
          // dynamic_instructions_O2 : 215
          // ------------------------------- 
          // static_instructions_O3 : 126
          // dynamic_instructions_O3 : 215
          // ------------------------------- 
          // static_instructions_Ofast : 126
          // dynamic_instructions_Ofast : 215
          // ------------------------------- 
          // static_instructions_Os : 25
          // dynamic_instructions_Os : 1290
          // ------------------------------- 
          // static_instructions_Oz : 19
          // dynamic_instructions_Oz : 2301
          // ------------------------------- 
          ...
          nbt_get_string_data(data,buffer,bufsize);
          free(data);
          free(buffer);
