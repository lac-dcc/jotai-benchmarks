...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 1858
          // ------------------------------- 
          // static_instructions_O1 : 36
          // dynamic_instructions_O1 : 1184
          // ------------------------------- 
          // static_instructions_O2 : 91
          // dynamic_instructions_O2 : 616
          // ------------------------------- 
          // static_instructions_O3 : 91
          // dynamic_instructions_O3 : 616
          // ------------------------------- 
          // static_instructions_Ofast : 91
          // dynamic_instructions_Ofast : 616
          // ------------------------------- 
          // static_instructions_Os : 33
          // dynamic_instructions_Os : 1167
          // ------------------------------- 
          // static_instructions_Oz : 41
          // dynamic_instructions_Oz : 1263
          // ------------------------------- 
          ...
          spatial_compensation_11(src,dst,stride);
          free(src);
          free(dst);
