...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_CAN_InitStruct0; _i0++) {
            CAN_InitStruct->CAN_Prescaler = ((-2 * (next_i()%2)) + 1) * next_i();
        CAN_InitStruct->CAN_BS2 = ((-2 * (next_i()%2)) + 1) * next_i();
        CAN_InitStruct->CAN_BS1 = ((-2 * (next_i()%2)) + 1) * next_i();
        CAN_InitStruct->CAN_SJW = ((-2 * (next_i()%2)) + 1) * next_i();
        CAN_InitStruct->CAN_Mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
