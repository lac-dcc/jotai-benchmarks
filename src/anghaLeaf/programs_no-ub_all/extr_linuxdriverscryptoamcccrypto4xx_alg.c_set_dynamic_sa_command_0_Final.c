...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sa0; _i0++) {
            sa->sa_command_0.bf.save_hash_state = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.save_iv = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.load_hash_state = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.load_iv = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.hdr_proc = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.hash_alg = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.cipher_alg = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.pad_type = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.extend_pad = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.op_group = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.opcode = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.bf.dir = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_0.w = ((-2 * (next_i()%2)) + 1) * next_i();
          }
