...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_card0 = 1;
          struct rsxx_cardinfo * card = (struct rsxx_cardinfo *) malloc(_len_card0*sizeof(struct rsxx_cardinfo));
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
            card[_i0].ier_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        card[_i0].isr_mask = ((-2 * (next_i()%2)) + 1) * next_i();
          }
