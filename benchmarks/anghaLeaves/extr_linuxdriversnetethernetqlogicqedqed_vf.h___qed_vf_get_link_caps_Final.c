...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_link_caps0 = 1;
          struct qed_mcp_link_capabilities * p_link_caps = (struct qed_mcp_link_capabilities *) malloc(_len_p_link_caps0*sizeof(struct qed_mcp_link_capabilities));
          for(int _i0 = 0; _i0 < _len_p_link_caps0; _i0++) {
            p_link_caps[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          __qed_vf_get_link_caps(p_hwfn,p_link_caps,p_bulletin);
          free(p_hwfn);
          free(p_link_caps);
          free(p_bulletin);
