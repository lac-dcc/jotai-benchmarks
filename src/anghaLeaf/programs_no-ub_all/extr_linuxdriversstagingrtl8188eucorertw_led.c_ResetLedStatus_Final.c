...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pLed0; _i0++) {
            pLed->bLedOn = ((-2 * (next_i()%2)) + 1) * next_i();
        pLed->bLedBlinkInProgress = ((-2 * (next_i()%2)) + 1) * next_i();
        pLed->bLedWPSBlinkInProgress = ((-2 * (next_i()%2)) + 1) * next_i();
        pLed->bLedNoLinkBlinkInProgress = ((-2 * (next_i()%2)) + 1) * next_i();
        pLed->bLedLinkBlinkInProgress = ((-2 * (next_i()%2)) + 1) * next_i();
        pLed->bLedScanBlinkInProgress = ((-2 * (next_i()%2)) + 1) * next_i();
