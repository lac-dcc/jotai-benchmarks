...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int dwDeleteFlag = 100;
        
          int dwVersionNum = 100;
          ...
          int _len_pDriverName0 = 1;
          int * pDriverName = (int *) malloc(_len_pDriverName0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pDriverName0; _i0++) {
            pDriverName[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = _RpcDeletePrinterDriverEx(pName,pEnvironment,pDriverName,dwDeleteFlag,dwVersionNum);
          printf("%d\n", benchRet); 
          free(pEnvironment);
          free(pDriverName);
    ...
    case 1:
    {
          ...
          int dwDeleteFlag = 255;
        
          int dwVersionNum = 255;
    ...
    case 3:
    {
          ...
          int dwDeleteFlag = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int dwVersionNum = ((-2 * (next_i()%2)) + 1) * next_i();
