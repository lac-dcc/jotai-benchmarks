...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_c0 = 1;
          struct snd_card * c = (struct snd_card *) malloc(_len_c0*sizeof(struct snd_card));
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c->private_data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct soundscape * benchRet = get_card_soundscape(c);
          printf("{{struct}} %p\n", &benchRet); 
          free(c);
