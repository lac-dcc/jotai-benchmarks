...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_packet0; _i0++) {
            packet->status = ((-2 * (next_i()%2)) + 1) * next_i();
        packet->latent = ((-2 * (next_i()%2)) + 1) * next_i();
        packet->front = ((-2 * (next_i()%2)) + 1) * next_i();
        packet->size = ((-2 * (next_i()%2)) + 1) * next_i();
        packet->cts = ((-2 * (next_i()%2)) + 1) * next_i();
        packet->dts = ((-2 * (next_i()%2)) + 1) * next_i();
          }
