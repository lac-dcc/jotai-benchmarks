...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int fw_fec = 100;
        
          unsigned int benchRet = fwcap_to_eth_fec(fw_fec);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int fw_fec = ((-2 * (next_i()%2)) + 1) * next_i();
