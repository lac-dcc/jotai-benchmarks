...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum genwqe_requ_state new_state = 0;
          int _len_req0 = 1;
          struct ddcb_requ * req = (struct ddcb_requ *) malloc(_len_req0*sizeof(struct ddcb_requ));
          for(int _i0 = 0; _i0 < _len_req0; _i0++) {
            req[_i0].req_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ddcb_requ_set_state(req,new_state);
          free(req);
