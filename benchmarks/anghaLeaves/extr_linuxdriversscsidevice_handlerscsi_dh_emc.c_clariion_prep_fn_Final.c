...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          sdev[_i0].handler_data = (struct clariion_dh_data *) malloc(_len_sdev__i0__handler_data0*sizeof(struct clariion_dh_data));
          for(int _j0 = 0; _j0 < _len_sdev__i0__handler_data0; _j0++) {
            sdev[_i0].handler_data->lun_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_req0 = 1;
          ...
          int benchRet = clariion_prep_fn(sdev,req);
          printf("%d\n", benchRet); 
