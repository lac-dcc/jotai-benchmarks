...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c[_i0].found_mdat = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pb0 = 1;
          int * pb = (int *) malloc(_len_pb0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pb0; _i0++) {
            pb[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct TYPE_6__ atom;
        atom.size = ((-2 * (next_i()%2)) + 1) * next_i();
          int benchRet = mov_read_mdat(c,pb,atom);
          printf("%d\n", benchRet); 
          free(c);
          free(pb);
