...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_usb_phy0; _i0++) {
            usb_phy->chg_type = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.sdp_min = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.sdp_max = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.dcp_min = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.dcp_max = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.cdp_min = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.cdp_max = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.aca_min = ((-2 * (next_i()%2)) + 1) * next_i();
        usb_phy->chg_cur.aca_max = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_min0 = 65025;
