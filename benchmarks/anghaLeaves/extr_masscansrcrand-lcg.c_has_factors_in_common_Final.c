...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_factors0 = 1;
          int * factors = (int *) malloc(_len_factors0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_factors0; _i0++) {
            factors[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = has_factors_in_common(c,factors);
          printf("%d\n", benchRet); 
          free(factors);
