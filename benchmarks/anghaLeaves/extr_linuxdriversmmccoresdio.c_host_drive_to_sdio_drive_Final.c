...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int host_strength = 100;
        
          unsigned char benchRet = host_drive_to_sdio_drive(host_strength);
          printf("%c\n", (benchRet %26) + 'a'); 
    ...
    case 3:
    {
          ...
          int host_strength = ((-2 * (next_i()%2)) + 1) * next_i();
