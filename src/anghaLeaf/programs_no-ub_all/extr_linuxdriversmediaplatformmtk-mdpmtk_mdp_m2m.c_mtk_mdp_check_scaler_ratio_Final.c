...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_var0; _i0++) {
            var->h_scale_down_max = ((-2 * (next_i()%2)) + 1) * next_i();
        var->v_scale_down_max = ((-2 * (next_i()%2)) + 1) * next_i();
        var->h_scale_up_max = ((-2 * (next_i()%2)) + 1) * next_i();
        var->v_scale_up_max = ((-2 * (next_i()%2)) + 1) * next_i();
          }
