...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_stats0 = 1;
          struct qed_mcp_iscsi_stats * stats = (struct qed_mcp_iscsi_stats *) malloc(_len_stats0*sizeof(struct qed_mcp_iscsi_stats));
          for(int _i0 = 0; _i0 < _len_stats0; _i0++) {
            stats[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          qed_get_protocol_stats_iscsi(cdev,stats);
          free(cdev);
          free(stats);
