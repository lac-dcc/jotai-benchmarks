...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 555
          // ------------------------------- 
          // static_instructions_O1 : 25
          // dynamic_instructions_O1 : 349
          // ------------------------------- 
