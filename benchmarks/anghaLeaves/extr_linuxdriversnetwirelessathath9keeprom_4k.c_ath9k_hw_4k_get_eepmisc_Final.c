...
__attribute__((used)) static u8 ath9k_hw_4k_get_eepmisc(struct ath_hw *ah)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ah0; _i0++) {
            ah[_i0].eeprom.map4k.baseEepHeader.eepMisc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ath9k_hw_4k_get_eepmisc(ah);
          printf("%d\n", benchRet); 
          free(ah);
