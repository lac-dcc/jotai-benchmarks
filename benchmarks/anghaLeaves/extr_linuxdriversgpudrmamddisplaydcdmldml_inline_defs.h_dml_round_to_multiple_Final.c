...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int multiple = 100;
        
          int up = 100;
        
          unsigned int benchRet = dml_round_to_multiple(num,multiple,up);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int multiple = ((-2 * (next_i()%2)) + 1) * next_i();
