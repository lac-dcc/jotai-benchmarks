...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_data0 = 1;
          struct wined3d_bo_address * data = (struct wined3d_bo_address *) malloc(_len_data0*sizeof(struct wined3d_bo_address));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct wined3d_const_bo_address * benchRet = wined3d_const_bo_address(data);
          printf("{{struct}} %p\n", &benchRet); 
          free(data);
