...
__attribute__((used)) static void gfx_v8_0_scratch_init(struct amdgpu_device *adev)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adev0; _i0++) {
            adev[_i0].gfx.scratch.num_reg = ((-2 * (next_i()%2)) + 1) * next_i();
        adev[_i0].gfx.scratch.free_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        adev[_i0].gfx.scratch.reg_base = ((-2 * (next_i()%2)) + 1) * next_i();
          }
