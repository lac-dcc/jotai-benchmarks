...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct drbd_connection * connection = (struct drbd_connection *) malloc(_len_connection0*sizeof(struct drbd_connection));
          for(int _i0 = 0; _i0 < _len_connection0; _i0++) {
            connection[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pi0 = 1;
          struct packet_info * pi = (struct packet_info *) malloc(_len_pi0*sizeof(struct packet_info));
          for(int _i0 = 0; _i0 < _len_pi0; _i0++) {
            pi[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = got_skip(connection,pi);
          printf("%d\n", benchRet); 
          free(connection);
          free(pi);
