...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_in10 = 65025;
          unsigned char * in1 = (unsigned char *) malloc(_len_in10*sizeof(unsigned char));
          for(int _i0 = 0; _i0 < _len_in10; _i0++) {
            in1[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int _len_in20 = 65025;
          unsigned char * in2 = (unsigned char *) malloc(_len_in20*sizeof(unsigned char));
