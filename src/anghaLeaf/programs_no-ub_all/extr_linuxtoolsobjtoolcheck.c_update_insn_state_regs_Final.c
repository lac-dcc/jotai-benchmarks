...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_insn0; _i0++) {
            insn->stack_op.src.type = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->stack_op.src.reg = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->stack_op.src.offset = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->stack_op.dest.type = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->stack_op.dest.reg = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_state0 = 1;
          struct insn_state * state = (struct insn_state *) malloc(_len_state0*sizeof(struct insn_state));
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state->cfa.base = ((-2 * (next_i()%2)) + 1) * next_i();
        state->cfa.offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
