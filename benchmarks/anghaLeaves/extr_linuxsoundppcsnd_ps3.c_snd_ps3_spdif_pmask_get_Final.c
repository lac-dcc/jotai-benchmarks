...
__attribute__((used)) static int snd_ps3_spdif_pmask_get(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ucontrol0; _i0++) {
            ucontrol[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = snd_ps3_spdif_pmask_get(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(ucontrol);
