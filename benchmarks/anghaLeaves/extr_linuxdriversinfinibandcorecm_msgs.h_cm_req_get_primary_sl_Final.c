...
__attribute__((used)) static inline u8 cm_req_get_primary_sl(struct cm_req_msg *req_msg)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_req_msg0; _i0++) {
            req_msg[_i0].primary_offset94 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = cm_req_get_primary_sl(req_msg);
          printf("%d\n", benchRet); 
          free(req_msg);
