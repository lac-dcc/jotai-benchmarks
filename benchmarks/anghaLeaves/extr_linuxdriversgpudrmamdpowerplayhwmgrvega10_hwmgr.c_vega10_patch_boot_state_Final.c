...
__attribute__((used)) static int vega10_patch_boot_state(struct pp_hwmgr *hwmgr,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw_ps0; _i0++) {
            hw_ps[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = vega10_patch_boot_state(hwmgr,hw_ps);
          printf("%d\n", benchRet); 
          free(hwmgr);
          free(hw_ps);
