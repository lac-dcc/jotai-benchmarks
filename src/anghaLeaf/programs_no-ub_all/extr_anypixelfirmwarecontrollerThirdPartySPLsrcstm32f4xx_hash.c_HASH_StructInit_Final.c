...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_HASH_InitStruct0; _i0++) {
            HASH_InitStruct->HASH_HMACKeyType = ((-2 * (next_i()%2)) + 1) * next_i();
        HASH_InitStruct->HASH_DataType = ((-2 * (next_i()%2)) + 1) * next_i();
        HASH_InitStruct->HASH_AlgoMode = ((-2 * (next_i()%2)) + 1) * next_i();
        HASH_InitStruct->HASH_AlgoSelection = ((-2 * (next_i()%2)) + 1) * next_i();
          }
