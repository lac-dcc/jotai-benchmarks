...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vc0; _i0++) {
            vc->tb_offset_applied = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->conferring_threads = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->napping_threads = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->in_guest = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->entry_exit_map = ((-2 * (next_i()%2)) + 1) * next_i();
          }
