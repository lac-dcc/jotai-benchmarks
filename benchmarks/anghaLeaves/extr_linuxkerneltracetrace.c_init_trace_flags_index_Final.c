...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tr0; _i0++) {
              int _len_tr__i0__trace_flags_index0 = 1;
          tr[_i0].trace_flags_index = (int *) malloc(_len_tr__i0__trace_flags_index0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_tr__i0__trace_flags_index0; _j0++) {
            tr[_i0].trace_flags_index[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          init_trace_flags_index(tr);
          for(int _aux = 0; _aux < _len_tr0; _aux++) {
          free(tr[_aux].trace_flags_index);
          }
          free(tr);
