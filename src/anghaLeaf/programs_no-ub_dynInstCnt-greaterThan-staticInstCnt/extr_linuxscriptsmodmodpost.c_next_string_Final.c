...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_secsize0 = 65025;
          unsigned long * secsize = (unsigned long *) malloc(_len_secsize0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_secsize0; _i0++) {
            secsize[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          char * benchRet = next_string(string,secsize);
          printf("{{other_type}} %p\n", &benchRet); 
          free(string);
          free(secsize);
