...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hdw0; _i0++) {
            hdw->pathway_state = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_encoder_runok = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_decoder_run = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_pathway_ok = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_encoder_ok = ((-2 * (next_i()%2)) + 1) * next_i();
          }
