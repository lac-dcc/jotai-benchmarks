...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rt2x00dev0; _i0++) {
            rt2x00dev->link.qual.tx_failed = ((-2 * (next_i()%2)) + 1) * next_i();
        rt2x00dev->link.qual.tx_success = ((-2 * (next_i()%2)) + 1) * next_i();
        rt2x00dev->link.qual.rx_failed = ((-2 * (next_i()%2)) + 1) * next_i();
        rt2x00dev->link.qual.rx_success = ((-2 * (next_i()%2)) + 1) * next_i();
          }
