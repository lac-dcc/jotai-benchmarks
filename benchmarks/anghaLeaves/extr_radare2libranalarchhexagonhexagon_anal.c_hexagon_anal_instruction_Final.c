...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_hi0 = 1;
          struct TYPE_10__ * hi = (struct TYPE_10__ *) malloc(_len_hi0*sizeof(struct TYPE_10__));
          for(int _i0 = 0; _i0 < _len_hi0; _i0++) {
            hi[_i0].instruction = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_hi__i0__ops0 = 1;
          hi[_i0].ops = (struct TYPE_8__ *) malloc(_len_hi__i0__ops0*sizeof(struct TYPE_8__));
          for(int _j0 = 0; _j0 < _len_hi__i0__ops0; _j0++) {
            hi[_i0].ops->op.imm = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_op0 = 1;
          struct TYPE_9__ * op = (struct TYPE_9__ *) malloc(_len_op0*sizeof(struct TYPE_9__));
          for(int _i0 = 0; _i0 < _len_op0; _i0++) {
            op[_i0].jump = ((-2 * (next_i()%2)) + 1) * next_i();
        op[_i0].addr = ((-2 * (next_i()%2)) + 1) * next_i();
        op[_i0].fail = ((-2 * (next_i()%2)) + 1) * next_i();
        op[_i0].size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = hexagon_anal_instruction(hi,op);
          printf("%d\n", benchRet); 
