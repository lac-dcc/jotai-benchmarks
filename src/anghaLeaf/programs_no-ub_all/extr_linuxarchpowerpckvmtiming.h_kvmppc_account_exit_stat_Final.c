...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vcpu0; _i0++) {
            vcpu->stat.gdbell_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.dbell_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.signal_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.itlb_virt_miss_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.itlb_real_miss_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.mmio_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.dtlb_virt_miss_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.dtlb_real_miss_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.syscall_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.isi_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.dsi_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.emulated_inst_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.dec_exits = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu->stat.ext_intr_exits = ((-2 * (next_i()%2)) + 1) * next_i();
          }
