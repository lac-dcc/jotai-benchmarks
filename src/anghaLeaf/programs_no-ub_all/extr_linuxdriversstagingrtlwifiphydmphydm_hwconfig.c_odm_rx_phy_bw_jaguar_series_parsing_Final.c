...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phy_info0; _i0++) {
            phy_info->band_width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pktinfo0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_pktinfo0; _i0++) {
            pktinfo->data_rate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_phy_sta_rpt0; _i0++) {
            phy_sta_rpt->r_RFMOD = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_sta_rpt->sub_chnl = ((-2 * (next_i()%2)) + 1) * next_i();
          }
