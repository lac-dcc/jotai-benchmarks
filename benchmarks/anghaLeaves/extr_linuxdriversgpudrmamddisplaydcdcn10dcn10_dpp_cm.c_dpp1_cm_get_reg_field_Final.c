...
struct TYPE_8__ {int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_START_SEGMENT_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_START_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_LINEAR_SLOPE_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_END_BASE_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_END_SLOPE_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_END_B; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION1_NUM_SEGMENTS; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION1_LUT_OFFSET; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION0_NUM_SEGMENTS; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION0_LUT_OFFSET; } ;
struct TYPE_6__ {int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_START_SEGMENT_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_START_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_LINEAR_SLOPE_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_END_BASE_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_END_SLOPE_B; int /*<<< orphan*/  CM_RGAM_RAMB_EXP_REGION_END_B; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION1_NUM_SEGMENTS; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION1_LUT_OFFSET; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION0_NUM_SEGMENTS; int /*<<< orphan*/  CM_RGAM_RAMA_EXP_REGION0_LUT_OFFSET; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dpp__i0__tf_mask0; _j0++) {
            dpp[_i0].tf_mask->CM_RGAM_RAMB_EXP_REGION_START_SEGMENT_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMB_EXP_REGION_START_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMB_EXP_REGION_LINEAR_SLOPE_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMB_EXP_REGION_END_BASE_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMB_EXP_REGION_END_SLOPE_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMB_EXP_REGION_END_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMA_EXP_REGION1_NUM_SEGMENTS = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMA_EXP_REGION1_LUT_OFFSET = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMA_EXP_REGION0_NUM_SEGMENTS = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_mask->CM_RGAM_RAMA_EXP_REGION0_LUT_OFFSET = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _j0 = 0; _j0 < _len_dpp__i0__tf_shift0; _j0++) {
            dpp[_i0].tf_shift->CM_RGAM_RAMB_EXP_REGION_START_SEGMENT_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMB_EXP_REGION_START_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMB_EXP_REGION_LINEAR_SLOPE_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMB_EXP_REGION_END_BASE_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMB_EXP_REGION_END_SLOPE_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMB_EXP_REGION_END_B = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMA_EXP_REGION1_NUM_SEGMENTS = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMA_EXP_REGION1_LUT_OFFSET = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMA_EXP_REGION0_NUM_SEGMENTS = ((-2 * (next_i()%2)) + 1) * next_i();
        dpp[_i0].tf_shift->CM_RGAM_RAMA_EXP_REGION0_LUT_OFFSET = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_reg0 = 1;
