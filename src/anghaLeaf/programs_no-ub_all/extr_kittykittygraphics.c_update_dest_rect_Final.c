...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        ref->cell_x_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->src_height = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->cell_y_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->effective_num_rows = ((-2 * (next_i()%2)) + 1) * next_i();
        ref->effective_num_cols = ((-2 * (next_i()%2)) + 1) * next_i();
          }
