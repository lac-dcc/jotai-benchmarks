...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_txq0 = 65025;
          struct qede_tx_queue * txq = (struct qede_tx_queue *) malloc(_len_txq0*sizeof(struct qede_tx_queue));
          for(int _i0 = 0; _i0 < _len_txq0; _i0++) {
              txq[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          qede_get_ethtool_stats_txq(txq,buf);
          free(txq);
