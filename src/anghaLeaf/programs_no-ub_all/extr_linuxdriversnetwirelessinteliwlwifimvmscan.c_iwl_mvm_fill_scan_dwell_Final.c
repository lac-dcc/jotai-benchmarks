...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dwell0; _i0++) {
            dwell->extended = ((-2 * (next_i()%2)) + 1) * next_i();
        dwell->fragmented = ((-2 * (next_i()%2)) + 1) * next_i();
        dwell->passive = ((-2 * (next_i()%2)) + 1) * next_i();
        dwell->active = ((-2 * (next_i()%2)) + 1) * next_i();
          }
