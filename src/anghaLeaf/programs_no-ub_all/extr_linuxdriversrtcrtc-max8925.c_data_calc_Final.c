...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tm0; _i0++) {
            tm->tm_year = ((-2 * (next_i()%2)) + 1) * next_i();
        tm->tm_mon = ((-2 * (next_i()%2)) + 1) * next_i();
        tm->tm_mday = ((-2 * (next_i()%2)) + 1) * next_i();
        tm->tm_wday = ((-2 * (next_i()%2)) + 1) * next_i();
        tm->tm_hour = ((-2 * (next_i()%2)) + 1) * next_i();
        tm->tm_min = ((-2 * (next_i()%2)) + 1) * next_i();
        tm->tm_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
