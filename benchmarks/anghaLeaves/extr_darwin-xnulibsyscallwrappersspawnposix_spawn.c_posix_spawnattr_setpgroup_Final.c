...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_attr0; _i0++) {
            int _len_attr1 = 1;
            attr[_i0] = (int *) malloc(_len_attr1*sizeof(int));
            for(int _i1 = 0; _i1 < _len_attr1; _i1++) {
              attr[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
        
          int benchRet = posix_spawnattr_setpgroup(attr,pgroup);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int pgroup = ((-2 * (next_i()%2)) + 1) * next_i();
