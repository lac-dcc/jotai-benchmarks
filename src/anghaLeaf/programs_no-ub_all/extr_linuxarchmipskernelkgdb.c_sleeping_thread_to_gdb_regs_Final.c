...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->thread.reg31 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.cp0_status = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg30 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg29 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg23 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg22 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg21 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg20 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg19 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg18 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg17 = ((-2 * (next_i()%2)) + 1) * next_i();
        p->thread.reg16 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
