...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_z0 = 65025;
          struct thermal_zone_device * z = (struct thermal_zone_device *) malloc(_len_z0*sizeof(struct thermal_zone_device));
          for(int _i0 = 0; _i0 < _len_z0; _i0++) {
              int _len_z__i0__devdata0 = 1;
          z[_i0].devdata = (struct da9062_thermal *) malloc(_len_z__i0__devdata0*sizeof(struct da9062_thermal));
          for(int _j0 = 0; _j0 < _len_z__i0__devdata0; _j0++) {
              z[_i0].devdata->mode = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = da9062_thermal_get_mode(z,mode);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_z0; _aux++) {
          free(z[_aux].devdata);
          }
          free(z);
          free(mode);
