...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pHeader0; _i0++) {
            pHeader->m_type = ((-2 * (next_i()%2)) + 1) * next_i();
        pHeader->m_packetLen.m_iLen = ((-2 * (next_i()%2)) + 1) * next_i();
        pHeader->m_flag = ((-2 * (next_i()%2)) + 1) * next_i();
        pHeader->m_versionB1 = ((-2 * (next_i()%2)) + 1) * next_i();
        pHeader->m_versionB0 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
