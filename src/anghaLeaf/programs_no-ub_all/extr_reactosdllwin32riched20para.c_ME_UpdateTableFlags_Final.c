...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_para0; _i0++) {
            para->member.para.nFlags = ((-2 * (next_i()%2)) + 1) * next_i();
        para->member.para.fmt.dwMask = ((-2 * (next_i()%2)) + 1) * next_i();
        para->member.para.fmt.wEffects = ((-2 * (next_i()%2)) + 1) * next_i();
        para->member.para.pCell = ((-2 * (next_i()%2)) + 1) * next_i();
          }
