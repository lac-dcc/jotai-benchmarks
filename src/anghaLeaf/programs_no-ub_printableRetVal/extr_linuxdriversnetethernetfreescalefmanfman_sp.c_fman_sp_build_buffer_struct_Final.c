...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_int_context_data_copy0; _i0++) {
            int_context_data_copy->ext_buf_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        int_context_data_copy->size = ((-2 * (next_i()%2)) + 1) * next_i();
        int_context_data_copy->int_context_offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_buffer_prefix_content0; _i0++) {
            buffer_prefix_content->priv_data_size = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_prefix_content->data_align = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_prefix_content->pass_prs_result = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_prefix_content->pass_hash_result = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_prefix_content->pass_time_stamp = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_buf_margins0; _i0++) {
            buf_margins->start_margins = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_buffer_offsets0; _i0++) {
            buffer_offsets->prs_result_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_offsets->time_stamp_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_offsets->hash_result_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer_offsets->data_offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
