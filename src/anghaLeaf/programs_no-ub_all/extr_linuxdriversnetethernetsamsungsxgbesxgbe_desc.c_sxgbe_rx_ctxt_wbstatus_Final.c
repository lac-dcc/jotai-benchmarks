...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->ptp_msgtype = ((-2 * (next_i()%2)) + 1) * next_i();
        p->tstamp_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_x0 = 1;
          struct sxgbe_extra_stats * x = (struct sxgbe_extra_stats *) malloc(_len_x0*sizeof(struct sxgbe_extra_stats));
          for(int _i0 = 0; _i0 < _len_x0; _i0++) {
            x->rx_ptp_resv_msg_type = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_signal = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_mgmt = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_announce = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_pdelay_follow_up = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_pdelay_resp = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_pdelay_req = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_delay_resp = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_delay_req = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_follow_up = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_ptp_type_sync = ((-2 * (next_i()%2)) + 1) * next_i();
        x->rx_msg_type_no_ptp = ((-2 * (next_i()%2)) + 1) * next_i();
        x->timestamp_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
          }
