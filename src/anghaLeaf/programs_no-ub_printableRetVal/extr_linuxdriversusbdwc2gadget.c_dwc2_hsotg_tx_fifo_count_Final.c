...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hsotg0; _i0++) {
            hsotg->hw_params.num_dev_in_eps = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->hw_params.num_dev_perio_in_ep = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->hw_params.en_multiple_tx_fifo = ((-2 * (next_i()%2)) + 1) * next_i();
          }
