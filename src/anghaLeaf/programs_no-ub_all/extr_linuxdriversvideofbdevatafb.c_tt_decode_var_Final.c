    ...
    case 0:
    {
        ...
        var->yoffset = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_par0; _i0++) {
            par->yres_virtual = ((-2 * (next_i()%2)) + 1) * next_i();
        par->next_line = ((-2 * (next_i()%2)) + 1) * next_i();
        par->screen_base = ((-2 * (next_i()%2)) + 1) * next_i();
        par->hw.tt.sync = ((-2 * (next_i()%2)) + 1) * next_i();
        par->hw.tt.mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
