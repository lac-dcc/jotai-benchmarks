...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sg_cpu0; _i0++) {
            sg_cpu->last_update = ((-2 * (next_i()%2)) + 1) * next_i();
        sg_cpu->iowait_boost_pending = ((-2 * (next_i()%2)) + 1) * next_i();
        sg_cpu->min = ((-2 * (next_i()%2)) + 1) * next_i();
        sg_cpu->iowait_boost = ((-2 * (next_i()%2)) + 1) * next_i();
          }
