...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state->mode = ((-2 * (next_i()%2)) + 1) * next_i();
        state->yoffset = ((-2 * (next_i()%2)) + 1) * next_i();
        state->xoffset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_par0 = 1;
          struct amifb_par * par = (struct amifb_par *) malloc(_len_par0*sizeof(struct amifb_par));
          for(int _i0 = 0; _i0 < _len_par0; _i0++) {
            par->crsr.crsr_y = ((-2 * (next_i()%2)) + 1) * next_i();
        par->crsr.crsr_x = ((-2 * (next_i()%2)) + 1) * next_i();
          }
