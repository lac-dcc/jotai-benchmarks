...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_fmt0 = 1;
          struct skl_module_fmt * fmt = (struct skl_module_fmt *) malloc(_len_fmt0*sizeof(struct skl_module_fmt));
          for(int _i0 = 0; _i0 < _len_fmt0; _i0++) {
              fmt[_i0].ch_map = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          skl_tplg_update_chmap(fmt,chs);
          free(fmt);
