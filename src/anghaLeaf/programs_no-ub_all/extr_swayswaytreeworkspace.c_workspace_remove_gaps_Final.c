...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ws0; _i0++) {
            ws->current_gaps.top = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->current_gaps.right = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->current_gaps.bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->current_gaps.left = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->y = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->x = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->height = ((-2 * (next_i()%2)) + 1) * next_i();
        ws->width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
