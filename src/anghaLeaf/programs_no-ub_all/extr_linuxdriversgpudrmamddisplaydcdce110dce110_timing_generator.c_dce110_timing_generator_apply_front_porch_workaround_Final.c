...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_tg0 = 1;
          struct timing_generator * tg = (struct timing_generator *) malloc(_len_tg0*sizeof(struct timing_generator));
          for(int _i0 = 0; _i0 < _len_tg0; _i0++) {
            tg->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_timing0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_timing0; _i0++) {
            timing->v_front_porch = ((-2 * (next_i()%2)) + 1) * next_i();
        timing->flags.INTERLACE = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          dce110_timing_generator_apply_front_porch_workaround(tg,timing);
          free(tg);
          free(timing);
