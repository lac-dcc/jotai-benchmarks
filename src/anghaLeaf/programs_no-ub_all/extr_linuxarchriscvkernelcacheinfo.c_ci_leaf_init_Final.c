...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_this_leaf0; _i0++) {
            this_leaf->level = ((-2 * (next_i()%2)) + 1) * next_i();
        this_leaf->type = ((-2 * (next_i()%2)) + 1) * next_i();
        this_leaf->physical_line_partition = ((-2 * (next_i()%2)) + 1) * next_i();
        this_leaf->attributes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_node0 = 1;
