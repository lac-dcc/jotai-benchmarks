...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx[_i0].instr = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctx__i0__code0 = 1;
          ctx[_i0].code = (struct TYPE_4__ *) malloc(_len_ctx__i0__code0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_ctx__i0__code0; _j0++) {
            ctx[_i0].code->instrs = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          instr_jmp(ctx,addr);
