...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          efx[_i0].filter_state = (struct efx_ef10_filter_table *) malloc(_len_efx__i0__filter_state0*sizeof(struct efx_ef10_filter_table));
          for(int _j0 = 0; _j0 < _len_efx__i0__filter_state0; _j0++) {
            efx[_i0].filter_state->rx_match_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = efx_ef10_filter_get_rx_id_limit(efx);
          printf("%d\n", benchRet); 
