...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_host0 = 1;
          struct mxcmci_host * host = (struct mxcmci_host *) malloc(_len_host0*sizeof(struct mxcmci_host));
          for(int _i0 = 0; _i0 < _len_host0; _i0++) {
            host[_i0].devtype = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_mpc512x_mmc(host);
          printf("%d\n", benchRet); 
          free(host);
