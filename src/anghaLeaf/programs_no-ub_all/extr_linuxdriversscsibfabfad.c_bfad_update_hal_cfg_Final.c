...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bfa_cfg0; _i0++) {
            bfa_cfg->drvcfg.num_reqq_elems = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->drvcfg.num_rspq_elems = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->drvcfg.num_sgpgs = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->fwcfg.num_rports = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->fwcfg.num_ioim_reqs = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->fwcfg.num_tskim_reqs = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->fwcfg.num_fcxp_reqs = ((-2 * (next_i()%2)) + 1) * next_i();
        bfa_cfg->fwcfg.num_uf_bufs = ((-2 * (next_i()%2)) + 1) * next_i();
          }
