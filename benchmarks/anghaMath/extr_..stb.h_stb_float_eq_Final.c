...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          float delta = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          int max_ulps = 100;
          int benchRet = stb_float_eq(x,y,delta,max_ulps);
          printf("%d\n", benchRet); 
