...
__attribute__((used)) static int dpu_dbg_debugfs_open(struct inode *inode, struct file *file)
{
	/* non-seekable */
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_inode0; _i0++) {
            inode->i_private = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_file0 = 1;
        ...
        file->private_data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
