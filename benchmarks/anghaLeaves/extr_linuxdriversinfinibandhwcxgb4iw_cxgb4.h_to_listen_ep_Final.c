...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          cm_id[_i0].provider_data = (struct c4iw_listen_ep *) malloc(_len_cm_id__i0__provider_data0*sizeof(struct c4iw_listen_ep));
          ...
          struct c4iw_listen_ep * benchRet = to_listen_ep(cm_id);
          printf("%d\n", (*benchRet).dummy);
