...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_dst0 = 1;
          struct axisang * dst = (struct axisang *) malloc(_len_dst0*sizeof(struct axisang));
          for(int _i0 = 0; _i0 < _len_dst0; _i0++) {
            dst->x = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        dst->y = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        dst->z = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        dst->w = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          axisang_set(dst,x,y,z,w);
          free(dst);
