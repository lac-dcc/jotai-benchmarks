...
/* Variables and functions */
 int /*<<< orphan*/  _STATIC_org_apache_harmony_luni_platform_IFileSystem_EXCLUSIVE_LOCK_TYPE ; 
...
int main(int argc, char *argv[]) {
    ...
    {
          int v = 100;
          org_apache_harmony_luni_platform_IFileSystem_PUT_EXCLUSIVE_LOCK_TYPE(v);
