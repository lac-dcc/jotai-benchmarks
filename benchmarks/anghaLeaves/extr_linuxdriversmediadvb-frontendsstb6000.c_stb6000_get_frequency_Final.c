...
struct stb6000_priv {int /*<<< orphan*/  frequency; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct stb6000_priv *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct stb6000_priv));
          ...
          int benchRet = stb6000_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
