...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct query_nodes_list * aux_p[10000];
          struct query_nodes_list * p = _allocate_p(10000, aux_p);
        
          struct query_nodes_list * aux_q[10000];
          struct query_nodes_list * q = _allocate_q(10000, aux_q);
