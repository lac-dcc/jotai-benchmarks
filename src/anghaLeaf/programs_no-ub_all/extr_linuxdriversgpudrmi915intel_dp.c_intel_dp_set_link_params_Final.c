...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_intel_dp0; _i0++) {
            intel_dp->link_trained = ((-2 * (next_i()%2)) + 1) * next_i();
        intel_dp->link_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        intel_dp->link_mst = ((-2 * (next_i()%2)) + 1) * next_i();
        intel_dp->lane_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
