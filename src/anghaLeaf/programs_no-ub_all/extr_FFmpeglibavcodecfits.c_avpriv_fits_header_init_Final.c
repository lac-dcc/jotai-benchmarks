...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_header0; _i0++) {
            header->gcount = ((-2 * (next_i()%2)) + 1) * next_i();
        header->bscale = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        header->data_max_found = ((-2 * (next_i()%2)) + 1) * next_i();
        header->data_min_found = ((-2 * (next_i()%2)) + 1) * next_i();
        header->bzero = ((-2 * (next_i()%2)) + 1) * next_i();
        header->image_extension = ((-2 * (next_i()%2)) + 1) * next_i();
        header->rgb = ((-2 * (next_i()%2)) + 1) * next_i();
        header->groups = ((-2 * (next_i()%2)) + 1) * next_i();
        header->pcount = ((-2 * (next_i()%2)) + 1) * next_i();
        header->blank_found = ((-2 * (next_i()%2)) + 1) * next_i();
        header->naxis_index = ((-2 * (next_i()%2)) + 1) * next_i();
        header->state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
