...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_can0; _i0++) {
            can->sx = ((-2 * (next_i()%2)) + 1) * next_i();
        can->sy = ((-2 * (next_i()%2)) + 1) * next_i();
        can->w = ((-2 * (next_i()%2)) + 1) * next_i();
        can->h = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_n0 = 1;
          struct TYPE_6__ * n = (struct TYPE_6__ *) malloc(_len_n0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_n0; _i0++) {
            n->x = ((-2 * (next_i()%2)) + 1) * next_i();
        n->y = ((-2 * (next_i()%2)) + 1) * next_i();
        n->w = ((-2 * (next_i()%2)) + 1) * next_i();
        n->h = ((-2 * (next_i()%2)) + 1) * next_i();
          }
