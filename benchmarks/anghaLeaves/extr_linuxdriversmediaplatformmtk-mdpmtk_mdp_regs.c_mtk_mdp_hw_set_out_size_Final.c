...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__vpu_vsi0; _j0++) {
            ctx[_i0].vpu.vsi->dst_config.h = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.w = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.y = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.x = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.crop_h = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.crop_w = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.crop_y = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].vpu.vsi->dst_config.crop_x = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ctx[_i0].d_frame.height = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].d_frame.width = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].d_frame.crop.height = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].d_frame.crop.width = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].d_frame.crop.top = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].d_frame.crop.left = ((-2 * (next_i()%2)) + 1) * next_i();
          }
