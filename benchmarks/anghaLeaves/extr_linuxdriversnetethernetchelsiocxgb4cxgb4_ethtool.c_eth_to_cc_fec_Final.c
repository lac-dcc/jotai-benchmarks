...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int eth_fec = 100;
        
          unsigned int benchRet = eth_to_cc_fec(eth_fec);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int eth_fec = ((-2 * (next_i()%2)) + 1) * next_i();
