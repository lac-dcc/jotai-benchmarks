...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_server0; _i0++) {
            server->credits = ((-2 * (next_i()%2)) + 1) * next_i();
        server->echo_credits = ((-2 * (next_i()%2)) + 1) * next_i();
        server->oplock_credits = ((-2 * (next_i()%2)) + 1) * next_i();
        server->echoes = ((-2 * (next_i()%2)) + 1) * next_i();
        server->oplocks = ((-2 * (next_i()%2)) + 1) * next_i();
          }
