...
/* Variables and functions */
 int /*<<< orphan*/  init_sdma_vm_hawaii ; 
 int /*<<< orphan*/  set_cache_memory_policy_cik ; 
 int /*<<< orphan*/  update_qpd_cik_hawaii ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_asic_ops0; _i0++) {
            asic_ops->init_sdma_vm = ((-2 * (next_i()%2)) + 1) * next_i();
        asic_ops->update_qpd = ((-2 * (next_i()%2)) + 1) * next_i();
        asic_ops->set_cache_memory_policy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
