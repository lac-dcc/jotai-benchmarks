...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->exist_sw_net_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->preamble_type = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->auto_fb_ctrl = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->bb_type = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->packet_type = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->op_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->long_retry_limit = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->short_retry_limit = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->num_rcb = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->num_tx_context = ((-2 * (next_i()%2)) + 1) * next_i();
          }
