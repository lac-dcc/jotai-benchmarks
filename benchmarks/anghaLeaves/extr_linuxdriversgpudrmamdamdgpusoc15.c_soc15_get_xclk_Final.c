...
__attribute__((used)) static u32 soc15_get_xclk(struct amdgpu_device *adev)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adev0; _i0++) {
              adev[_i0].clock.spll.reference_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        
        
        
          }
        
          int benchRet = soc15_get_xclk(adev);
          printf("%d\n", benchRet); 
          free(adev);
