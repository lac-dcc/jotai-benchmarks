...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          enum ata_lpm_policy policy = 0;
        
          unsigned int hints = 100;
          ...
          int benchRet = sata_pmp_set_lpm(link,policy,hints);
          printf("%d\n", benchRet); 
          free(link);
    ...
    case 3:
    {
          ...
          unsigned int hints = ((-2 * (next_i()%2)) + 1) * next_i();
