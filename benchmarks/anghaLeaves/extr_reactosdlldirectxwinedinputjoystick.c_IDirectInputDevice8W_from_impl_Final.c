...
__attribute__((used)) static inline IDirectInputDevice8W *IDirectInputDevice8W_from_impl(JoystickGenericImpl *This)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_This0; _i0++) {
            This[_i0].base.IDirectInputDevice8W_iface = ((-2 * (next_i()%2)) + 1) * next_i();
          }
