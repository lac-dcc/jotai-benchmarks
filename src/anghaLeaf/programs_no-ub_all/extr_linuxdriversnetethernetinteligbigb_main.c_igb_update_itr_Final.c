...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q_vector0; _i0++) {
            q_vector->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_ring_container0; _i0++) {
            ring_container->total_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        ring_container->total_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        ring_container->itr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
