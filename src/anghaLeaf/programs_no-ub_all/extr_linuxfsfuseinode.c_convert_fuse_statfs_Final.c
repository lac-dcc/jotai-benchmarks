...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stbuf0; _i0++) {
            stbuf->f_namelen = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_ffree = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_files = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_bavail = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_bfree = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_frsize = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_bsize = ((-2 * (next_i()%2)) + 1) * next_i();
        stbuf->f_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_attr0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_attr0; _i0++) {
            attr->namelen = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->ffree = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->files = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->bavail = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->bfree = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->frsize = ((-2 * (next_i()%2)) + 1) * next_i();
        attr->bsize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
