...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_row0; _i0++) {
            row->num_chars = ((-2 * (next_i()%2)) + 1) * next_i();
        row->x1 = ((-2 * (next_i()%2)) + 1) * next_i();
        row->baseline_y_delta = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        row->ymin = ((-2 * (next_i()%2)) + 1) * next_i();
        row->ymax = ((-2 * (next_i()%2)) + 1) * next_i();
        row->x0 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_str0 = 1;
          struct TYPE_6__ * str = (struct TYPE_6__ *) malloc(_len_str0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_str0; _i0++) {
            str->stringlen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
