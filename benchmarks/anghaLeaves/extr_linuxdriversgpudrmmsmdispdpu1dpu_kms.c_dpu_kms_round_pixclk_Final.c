...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_kms0 = 1;
          struct msm_kms * kms = (struct msm_kms *) malloc(_len_kms0*sizeof(struct msm_kms));
          for(int _i0 = 0; _i0 < _len_kms0; _i0++) {
            kms[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_encoder0 = 1;
          ...
          long benchRet = dpu_kms_round_pixclk(kms,rate,encoder);
          printf("%ld\n", benchRet); 
          free(kms);
          free(encoder);
