...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->progress.uploaded = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.downloaded = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.dlspeed = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.ulspeed = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.size_dl = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.size_ul = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.timespent = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.t_nslookup = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.t_connect = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.t_appconnect = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.t_pretransfer = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.t_starttransfer = ((-2 * (next_i()%2)) + 1) * next_i();
        data->progress.t_redirect = ((-2 * (next_i()%2)) + 1) * next_i();
        data->info.filetime = ((-2 * (next_i()%2)) + 1) * next_i();
          }
