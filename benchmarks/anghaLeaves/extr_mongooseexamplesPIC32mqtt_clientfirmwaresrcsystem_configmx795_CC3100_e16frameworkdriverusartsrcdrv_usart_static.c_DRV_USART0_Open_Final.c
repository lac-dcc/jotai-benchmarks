...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          const int ioIntent = 100;
        
          int benchRet = DRV_USART0_Open(index,ioIntent);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          const int index = ((-2 * (next_i()%2)) + 1) * next_i();
        
          const int ioIntent = ((-2 * (next_i()%2)) + 1) * next_i();
