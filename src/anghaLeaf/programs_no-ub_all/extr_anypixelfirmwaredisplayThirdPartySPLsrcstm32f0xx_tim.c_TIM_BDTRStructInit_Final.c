...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_TIM_BDTRInitStruct0; _i0++) {
            TIM_BDTRInitStruct->TIM_DeadTime = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_BDTRInitStruct->TIM_AutomaticOutput = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_BDTRInitStruct->TIM_BreakPolarity = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_BDTRInitStruct->TIM_Break = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_BDTRInitStruct->TIM_LOCKLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_BDTRInitStruct->TIM_OSSIState = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_BDTRInitStruct->TIM_OSSRState = ((-2 * (next_i()%2)) + 1) * next_i();
          }
