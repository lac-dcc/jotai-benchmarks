...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_addr0; _i0++) {
            addr->family = ((-2 * (next_i()%2)) + 1) * next_i();
        addr->addrtype = ((-2 * (next_i()%2)) + 1) * next_i();
        addr->addr.nameseq.lower = ((-2 * (next_i()%2)) + 1) * next_i();
        addr->addr.nameseq.upper = ((-2 * (next_i()%2)) + 1) * next_i();
          }
