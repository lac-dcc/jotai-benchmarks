...
struct iwl_traffic_load {scalar_t__ time_stamp; size_t head; scalar_t__ queue_count; scalar_t__* packet_count; int /*<<< orphan*/  total; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long curr_time = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int _len_tl0 = 1;
          struct iwl_traffic_load * tl = (struct iwl_traffic_load *) malloc(_len_tl0*sizeof(struct iwl_traffic_load));
