...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_irq_ptr0; _i0++) {
            irq_ptr->siga_flag.input = ((-2 * (next_i()%2)) + 1) * next_i();
        irq_ptr->siga_flag.output = ((-2 * (next_i()%2)) + 1) * next_i();
        irq_ptr->siga_flag.sync = ((-2 * (next_i()%2)) + 1) * next_i();
        irq_ptr->siga_flag.sync_after_ai = ((-2 * (next_i()%2)) + 1) * next_i();
        irq_ptr->siga_flag.sync_out_after_pci = ((-2 * (next_i()%2)) + 1) * next_i();
          }
