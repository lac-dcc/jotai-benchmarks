...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_z0 = 1;
          struct TYPE_4__ * z = (struct TYPE_4__ *) malloc(_len_z0*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_z0; _i0++) {
            z[_i0].elem_size = ((-2 * (next_i()%2)) + 1) * next_i();
        z[_i0].gzalloc_exempt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = gzalloc_tracked(z);
          printf("%d\n", benchRet); 
          free(z);
