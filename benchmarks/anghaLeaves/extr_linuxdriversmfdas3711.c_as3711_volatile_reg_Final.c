...
#define  AS3711_CHARGER_STATUS_1 134 
#define  AS3711_CHARGER_STATUS_2 133 
#define  AS3711_GPIO_SIGNAL_IN 132 
#define  AS3711_INTERRUPT_STATUS_1 131 
#define  AS3711_INTERRUPT_STATUS_2 130 
#define  AS3711_INTERRUPT_STATUS_3 129 
#define  AS3711_REG_STATUS 128 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = as3711_volatile_reg(dev,reg);
          printf("%d\n", benchRet); 
          free(dev);
