...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_comb0; _i0++) {
            comb->sadb_comb_soft_allocations = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_hard_allocations = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_hard_addtime = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_soft_addtime = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_soft_usetime = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_hard_usetime = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_hard_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        comb->sadb_comb_soft_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
