...
__attribute__((used)) static uint8_t intel_dp_autotest_phy_pattern(struct intel_dp *intel_dp)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_intel_dp0; _i0++) {
            intel_dp[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = intel_dp_autotest_phy_pattern(intel_dp);
          printf("%d\n", benchRet); 
          free(intel_dp);
