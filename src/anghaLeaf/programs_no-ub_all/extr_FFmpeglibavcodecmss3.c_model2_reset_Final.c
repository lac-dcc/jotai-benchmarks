...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_m0; _i0++) {
            m->zero_weight = ((-2 * (next_i()%2)) + 1) * next_i();
        m->total_weight = ((-2 * (next_i()%2)) + 1) * next_i();
        m->zero_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        m->total_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        m->upd_val = ((-2 * (next_i()%2)) + 1) * next_i();
        m->till_rescale = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          model2_reset(m);
          free(m);
