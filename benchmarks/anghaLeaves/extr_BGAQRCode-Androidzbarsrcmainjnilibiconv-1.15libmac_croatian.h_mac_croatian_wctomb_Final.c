...
/* Variables and functions */
 int RET_ILUNI ; 
 unsigned char* mac_croatian_page00 ; 
 unsigned char* mac_croatian_page02 ; 
 unsigned char* mac_croatian_page20 ; 
 unsigned char* mac_croatian_page21 ; 
 unsigned char* mac_croatian_page22 ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = mac_croatian_wctomb(conv,r,wc,n);
          printf("%d\n", benchRet); 
          free(r);
