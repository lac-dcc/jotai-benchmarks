...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sdata0; _i0++) {
            sdata->vif.bss_conf.use_cts_prot = ((-2 * (next_i()%2)) + 1) * next_i();
        sdata->vif.bss_conf.use_short_preamble = ((-2 * (next_i()%2)) + 1) * next_i();
        sdata->vif.bss_conf.use_short_slot = ((-2 * (next_i()%2)) + 1) * next_i();
          }
