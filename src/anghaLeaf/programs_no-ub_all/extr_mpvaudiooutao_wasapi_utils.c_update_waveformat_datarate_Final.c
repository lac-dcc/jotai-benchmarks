...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_wformat0; _i0++) {
            wformat->Format.nBlockAlign = ((-2 * (next_i()%2)) + 1) * next_i();
        wformat->Format.nChannels = ((-2 * (next_i()%2)) + 1) * next_i();
        wformat->Format.wBitsPerSample = ((-2 * (next_i()%2)) + 1) * next_i();
        wformat->Format.nAvgBytesPerSec = ((-2 * (next_i()%2)) + 1) * next_i();
        wformat->Format.nSamplesPerSec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
