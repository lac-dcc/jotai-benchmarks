...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = _HandlePortIsValid(pInputData,pOutputData,cbOutputData,pcbOutputNeeded);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int pOutputData = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int cbOutputData = ((-2 * (next_i()%2)) + 1) * next_i();
