...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_phy_info__i0__port_details0; _j0++) {
              int _len_phy_info__i0__port_details_starget0 = 1;
          phy_info[_i0].port_details->starget = (struct scsi_target *) malloc(_len_phy_info__i0__port_details_starget0*sizeof(struct scsi_target));
          for(int _j0 = 0; _j0 < _len_phy_info__i0__port_details_starget0; _j0++) {
            phy_info[_i0].port_details->starget->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct scsi_target * benchRet = mptsas_get_starget(phy_info);
          printf("%d\n", (*benchRet).dummy);
