...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_buffer0; _i0++) {
            buffer->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer->parent_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        buffer->parent = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_last_obj0; _i0++) {
            last_obj->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        last_obj->parent_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        last_obj->parent = ((-2 * (next_i()%2)) + 1) * next_i();
          }
