...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
              int _len_c__i0__mgr0 = 1;
          c[_i0].mgr = (struct TYPE_4__ *) malloc(_len_c__i0__mgr0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_c__i0__mgr0; _j0++) {
              c[_i0].mgr->user_data = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
          c[_i0].recv_mbuf.size = ((-2 * (next_i()%2)) + 1) * next_i();
