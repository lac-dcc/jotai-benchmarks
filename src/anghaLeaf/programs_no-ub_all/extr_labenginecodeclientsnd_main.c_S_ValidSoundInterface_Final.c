...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_si0; _i0++) {
            si->SoundList = ((-2 * (next_i()%2)) + 1) * next_i();
        si->SoundInfo = ((-2 * (next_i()%2)) + 1) * next_i();
        si->ClearSoundBuffer = ((-2 * (next_i()%2)) + 1) * next_i();
        si->RegisterSound = ((-2 * (next_i()%2)) + 1) * next_i();
        si->BeginRegistration = ((-2 * (next_i()%2)) + 1) * next_i();
        si->DisableSounds = ((-2 * (next_i()%2)) + 1) * next_i();
        si->Update = ((-2 * (next_i()%2)) + 1) * next_i();
        si->UpdateEntityPosition = ((-2 * (next_i()%2)) + 1) * next_i();
        si->Respatialize = ((-2 * (next_i()%2)) + 1) * next_i();
        si->StopLoopingSound = ((-2 * (next_i()%2)) + 1) * next_i();
        si->AddRealLoopingSound = ((-2 * (next_i()%2)) + 1) * next_i();
        si->AddLoopingSound = ((-2 * (next_i()%2)) + 1) * next_i();
        si->ClearLoopingSounds = ((-2 * (next_i()%2)) + 1) * next_i();
        si->StopAllSounds = ((-2 * (next_i()%2)) + 1) * next_i();
        si->RawSamples = ((-2 * (next_i()%2)) + 1) * next_i();
        si->StopBackgroundTrack = ((-2 * (next_i()%2)) + 1) * next_i();
        si->StartBackgroundTrack = ((-2 * (next_i()%2)) + 1) * next_i();
        si->StartLocalSound = ((-2 * (next_i()%2)) + 1) * next_i();
        si->StartSound = ((-2 * (next_i()%2)) + 1) * next_i();
        si->Shutdown = ((-2 * (next_i()%2)) + 1) * next_i();
          }
