...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_status_indication0 = 1;
          int * status_indication = (int *) malloc(_len_status_indication0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_status_indication0; _i0++) {
            status_indication[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          SlNdisStatusExProc(protocol_binding_context,status_indication);
          free(status_indication);
    ...
    case 1:
    {
          ...
          int _len_status_indication0 = 100;
          int * status_indication = (int *) malloc(_len_status_indication0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_status_indication0; _i0++) {
            status_indication[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
