...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_image0; _i0++) {
            image->palette_size = ((-2 * (next_i()%2)) + 1) * next_i();
        image->palette = ((-2 * (next_i()%2)) + 1) * next_i();
        image->rgb = ((-2 * (next_i()%2)) + 1) * next_i();
        image->buffer1 = ((-2 * (next_i()%2)) + 1) * next_i();
        image->blue_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        image->green_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        image->red_mask = ((-2 * (next_i()%2)) + 1) * next_i();
          }
