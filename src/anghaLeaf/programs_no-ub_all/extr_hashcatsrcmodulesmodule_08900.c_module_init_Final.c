...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        module_ctx->module_kernel_threads_min = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_kernel_threads_max = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_kernel_loops_min = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_kernel_loops_max = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_kernel_accel_min = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_kernel_accel_max = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_jit_cache_disable = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_jit_build_options = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_extra_tmp_size = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_extra_buffer_size = ((-2 * (next_i()%2)) + 1) * next_i();
