...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_gvt_dmabuf0; _i0++) {
            gvt_dmabuf->y_hot = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->x_hot = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->y_pos = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->x_pos = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->size = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->stride = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->height = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->width = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->drm_format_mod = ((-2 * (next_i()%2)) + 1) * next_i();
        gvt_dmabuf->drm_format = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_fb_info0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_fb_info0; _i0++) {
            fb_info->y_hot = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->x_hot = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->y_pos = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->x_pos = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->size = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->stride = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->height = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->width = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->drm_format_mod = ((-2 * (next_i()%2)) + 1) * next_i();
        fb_info->drm_format = ((-2 * (next_i()%2)) + 1) * next_i();
          }
