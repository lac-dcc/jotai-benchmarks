...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pts0 = 65025;
          int * pts = (int *) malloc(_len_pts0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pts0; _i0++) {
            pts[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          nvg__polyReverse(pts,npts);
          free(pts);
