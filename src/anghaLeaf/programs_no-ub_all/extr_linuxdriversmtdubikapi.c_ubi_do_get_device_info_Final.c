...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ubi0; _i0++) {
            ubi->cdev.dev = ((-2 * (next_i()%2)) + 1) * next_i();
        ubi->ro_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        ubi->max_write_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ubi->min_io_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ubi->leb_start = ((-2 * (next_i()%2)) + 1) * next_i();
        ubi->leb_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ubi->ubi_num = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_di0; _i0++) {
            di->cdev = ((-2 * (next_i()%2)) + 1) * next_i();
        di->ro_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        di->max_write_size = ((-2 * (next_i()%2)) + 1) * next_i();
        di->min_io_size = ((-2 * (next_i()%2)) + 1) * next_i();
        di->leb_start = ((-2 * (next_i()%2)) + 1) * next_i();
        di->leb_size = ((-2 * (next_i()%2)) + 1) * next_i();
        di->ubi_num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
