...
__attribute__((used)) static int snd_hdspm_info_system_sample_rate(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        uinfo->type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = snd_hdspm_info_system_sample_rate(kcontrol,uinfo);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(uinfo);
