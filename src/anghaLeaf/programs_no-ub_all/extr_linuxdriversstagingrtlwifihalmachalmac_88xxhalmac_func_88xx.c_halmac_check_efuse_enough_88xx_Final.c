...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_halmac_adapter0; _i0++) {
            halmac_adapter->efuse_end = ((-2 * (next_i()%2)) + 1) * next_i();
        halmac_adapter->hw_config_info.efuse_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_pg_efuse_info0; _i0++) {
            pg_efuse_info->efuse_map_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
