...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_mac_key0; _i0++) {
            mac_key[_i0].low.bits.mac_5 = ((-2 * (next_i()%2)) + 1) * next_i();
        mac_key[_i0].low.bits.mac_4 = ((-2 * (next_i()%2)) + 1) * next_i();
        mac_key[_i0].high.bits.mac_3 = ((-2 * (next_i()%2)) + 1) * next_i();
        mac_key[_i0].high.bits.mac_2 = ((-2 * (next_i()%2)) + 1) * next_i();
        mac_key[_i0].high.bits.mac_1 = ((-2 * (next_i()%2)) + 1) * next_i();
        mac_key[_i0].high.bits.mac_0 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
