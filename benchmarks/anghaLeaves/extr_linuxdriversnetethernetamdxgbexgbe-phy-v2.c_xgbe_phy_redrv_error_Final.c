...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phy_data0; _i0++) {
              phy_data[_i0].redrv_if = ((-2 * (next_i()%2)) + 1) * next_i();
          phy_data[_i0].redrv_model = ((-2 * (next_i()%2)) + 1) * next_i();
          phy_data[_i0].redrv_lane = ((-2 * (next_i()%2)) + 1) * next_i();
          phy_data[_i0].redrv = ((-2 * (next_i()%2)) + 1) * next_i();
