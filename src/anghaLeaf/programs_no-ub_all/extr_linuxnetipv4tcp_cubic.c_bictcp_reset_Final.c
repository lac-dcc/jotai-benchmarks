...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ca0; _i0++) {
            ca->found = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->tcp_cwnd = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->ack_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->epoch_start = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->delay_min = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->bic_K = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->bic_origin_point = ((-2 * (next_i()%2)) + 1) * next_i();
