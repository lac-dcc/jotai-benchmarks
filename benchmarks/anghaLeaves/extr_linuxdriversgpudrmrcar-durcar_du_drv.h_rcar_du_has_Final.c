...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_rcdu__i0__info0; _j0++) {
              rcdu[_i0].info->features = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          int benchRet = rcar_du_has(rcdu,feature);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int feature = ((-2 * (next_i()%2)) + 1) * next_i();
