...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_drbg0; _i0++) {
              drbg[_i0].reseed_interval = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = RAND_DRBG_set_reseed_interval(drbg,interval);
          printf("%d\n", benchRet); 
          free(drbg);
    ...
    case 3:
    {
          ...
          unsigned int interval = ((-2 * (next_i()%2)) + 1) * next_i();
