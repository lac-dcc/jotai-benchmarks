...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
              int _len_f__i0__f_op0 = 1;
          f[_i0].f_op = (int *) malloc(_len_f__i0__f_op0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_f__i0__f_op0; _j0++) {
            f[_i0].f_op[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = is_file_epoll(f);
          printf("%d\n", benchRet); 
