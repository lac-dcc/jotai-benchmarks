...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
              int _len_c__i0__box0 = 1;
          c[_i0].box = (int *) malloc(_len_c__i0__box0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_c__i0__box0; _j0++) {
            c[_i0].box[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = uiprivChildBox(c);
          printf("%d\n", (*benchRet)); 
