...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        ops->prepare_idle_pc = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->restore = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        ops->wait_for_vblank = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->wait_for_tx_complete = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->prepare_for_kickoff = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->wait_for_commit_done = ((-2 * (next_i()%2)) + 1) * next_i();
