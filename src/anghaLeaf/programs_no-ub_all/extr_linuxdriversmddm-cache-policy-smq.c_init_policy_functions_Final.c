...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_mq0; _i0++) {
            mq->policy.emit_config_values = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.set_config_value = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.allow_migrations = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.tick = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.residency = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.get_hint = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.invalidate_mapping = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.load_mapping = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.clear_dirty = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.set_dirty = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.complete_background_work = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.get_background_work = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.lookup_with_work = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.lookup = ((-2 * (next_i()%2)) + 1) * next_i();
        mq->policy.destroy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
