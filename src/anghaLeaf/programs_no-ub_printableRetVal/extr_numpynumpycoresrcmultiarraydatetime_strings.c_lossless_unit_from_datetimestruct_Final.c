...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dts0; _i0++) {
            dts->as = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->ps = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->us = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->sec = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->min = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->hour = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->day = ((-2 * (next_i()%2)) + 1) * next_i();
        dts->month = ((-2 * (next_i()%2)) + 1) * next_i();
          }
