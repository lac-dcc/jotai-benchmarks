...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_TIM_TimeBaseInitStruct0; _i0++) {
            TIM_TimeBaseInitStruct->TIM_Period = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_TimeBaseInitStruct->TIM_Prescaler = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_TimeBaseInitStruct->TIM_RepetitionCounter = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_TimeBaseInitStruct->TIM_CounterMode = ((-2 * (next_i()%2)) + 1) * next_i();
        TIM_TimeBaseInitStruct->TIM_ClockDivision = ((-2 * (next_i()%2)) + 1) * next_i();
          }
