...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_fid0 = 1;
          struct p9_fid * fid = (struct p9_fid *) malloc(_len_fid0*sizeof(struct p9_fid));
          for(int _i0 = 0; _i0 < _len_fid0; _i0++) {
            fid[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dacl0 = 1;
          struct posix_acl * dacl = (struct posix_acl *) malloc(_len_dacl0*sizeof(struct posix_acl));
          for(int _i0 = 0; _i0 < _len_dacl0; _i0++) {
            dacl[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_acl0 = 1;
          ...
          int benchRet = v9fs_set_create_acl(inode,fid,dacl,acl);
          printf("%d\n", benchRet); 
          free(inode);
          free(fid);
          free(dacl);
