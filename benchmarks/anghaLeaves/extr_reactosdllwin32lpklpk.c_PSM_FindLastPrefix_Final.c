...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 5349
          // ------------------------------- 
          // static_instructions_O1 : 20
          // dynamic_instructions_O1 : 1791
          // ------------------------------- 
          // static_instructions_O2 : 19
          // dynamic_instructions_O2 : 1537
          // ------------------------------- 
          // static_instructions_O3 : 19
          // dynamic_instructions_O3 : 1537
          // ------------------------------- 
          // static_instructions_Ofast : 19
          // dynamic_instructions_Ofast : 1537
          // ------------------------------- 
          // static_instructions_Os : 18
          // dynamic_instructions_Os : 1536
          // ------------------------------- 
          // static_instructions_Oz : 16
          // dynamic_instructions_Oz : 1789
          // ------------------------------- 

          int count = 255;
        
          int _len_str0 = 65025;
          long * str = (long *) malloc(_len_str0*sizeof(long));
          for(int _i0 = 0; _i0 < _len_str0; _i0++) {
            str[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = PSM_FindLastPrefix(str,count);
          printf("%d\n", benchRet); 
          free(str);
