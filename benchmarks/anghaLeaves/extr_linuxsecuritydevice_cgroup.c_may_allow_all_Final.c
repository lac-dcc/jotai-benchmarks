...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_parent0 = 1;
          struct dev_cgroup * parent = (struct dev_cgroup *) malloc(_len_parent0*sizeof(struct dev_cgroup));
          for(int _i0 = 0; _i0 < _len_parent0; _i0++) {
            parent[_i0].behavior = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = may_allow_all(parent);
          printf("%d\n", benchRet); 
          free(parent);
