...
__attribute__((used)) static __inline UINT64 unix_time_to_win(BTRFS_TIME* t) {
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_t0; _i0++) {
            t[_i0].seconds = ((-2 * (next_i()%2)) + 1) * next_i();
        t[_i0].nanoseconds = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = unix_time_to_win(t);
          printf("%d\n", benchRet); 
          free(t);
