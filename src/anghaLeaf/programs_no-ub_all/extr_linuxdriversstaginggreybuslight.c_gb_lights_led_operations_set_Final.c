...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_channel0; _i0++) {
            channel->flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cdev0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_cdev0; _i0++) {
            cdev->blink_set = ((-2 * (next_i()%2)) + 1) * next_i();
        cdev->brightness_set_blocking = ((-2 * (next_i()%2)) + 1) * next_i();
        cdev->brightness_get = ((-2 * (next_i()%2)) + 1) * next_i();
          }
