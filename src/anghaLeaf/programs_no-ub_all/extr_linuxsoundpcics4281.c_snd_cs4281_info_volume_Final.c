...
/* Variables and functions */
 int /*<<< orphan*/  CS_VOL_MASK ; 
 int /*<<< orphan*/  SNDRV_CTL_ELEM_TYPE_INTEGER ; 

__attribute__((used)) static int snd_cs4281_info_volume(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        uinfo->type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = snd_cs4281_info_volume(kcontrol,uinfo);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(uinfo);
