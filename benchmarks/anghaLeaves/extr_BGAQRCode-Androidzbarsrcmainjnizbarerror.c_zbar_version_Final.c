...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int * major = (unsigned int *) malloc(_len_major0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_major0; _i0++) {
            major[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int _len_minor0 = 65025;
          unsigned int * minor = (unsigned int *) malloc(_len_minor0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_minor0; _i0++) {
            minor[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = zbar_version(major,minor);
          printf("%d\n", benchRet); 
          free(major);
          free(minor);
