...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ifp0; _i0++) {
            ifp->if_interface_state.valid_bitmask = ((-2 * (next_i()%2)) + 1) * next_i();
        ifp->if_interface_state.lqm_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_delegated_ifp0; _i0++) {
            delegated_ifp->if_interface_state.valid_bitmask = ((-2 * (next_i()%2)) + 1) * next_i();
        delegated_ifp->if_interface_state.lqm_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
