...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_diffopt0 = 1;
          struct diff_options * diffopt = (struct diff_options *) malloc(_len_diffopt0*sizeof(struct diff_options));
          for(int _i0 = 0; _i0 < _len_diffopt0; _i0++) {
            diffopt[_i0].output_prefix = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          graph_setup_line_prefix(diffopt);
          free(diffopt);
