...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_soc0; _i0++) {
            int _len_soc1 = 1;
            soc[_i0] = (struct abx500_pinctrl_soc_data *) malloc(_len_soc1*sizeof(struct abx500_pinctrl_soc_data));
            for(int _i1 = 0; _i1 < _len_soc1; _i1++) {
              soc[_i0][_i1].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          abx500_pinctrl_ab8500_init(soc);
          for(int i1 = 0; i1 < _len_soc0; i1++) {
            int _len_soc1 = 1;
              free(soc[i1]);
          }
          free(soc);
