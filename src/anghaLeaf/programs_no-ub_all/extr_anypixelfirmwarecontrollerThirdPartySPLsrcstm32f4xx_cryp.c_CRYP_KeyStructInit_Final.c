...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_CRYP_KeyInitStruct0; _i0++) {
            CRYP_KeyInitStruct->CRYP_Key3Right = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key3Left = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key2Right = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key2Left = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key1Right = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key1Left = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key0Right = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_KeyInitStruct->CRYP_Key0Left = ((-2 * (next_i()%2)) + 1) * next_i();
          }
