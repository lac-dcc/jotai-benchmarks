...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ADC_InitStruct0; _i0++) {
            ADC_InitStruct->ADC_ScanDirection = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_InitStruct->ADC_DataAlign = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_InitStruct->ADC_ExternalTrigConv = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_InitStruct->ADC_ExternalTrigConvEdge = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_InitStruct->ADC_ContinuousConvMode = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_InitStruct->ADC_Resolution = ((-2 * (next_i()%2)) + 1) * next_i();
          }
