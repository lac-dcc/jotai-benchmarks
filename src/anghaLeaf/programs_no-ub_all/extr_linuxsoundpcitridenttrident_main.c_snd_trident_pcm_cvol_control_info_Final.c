...
__attribute__((used)) static int snd_trident_pcm_cvol_control_info(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        uinfo->type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = snd_trident_pcm_cvol_control_info(kcontrol,uinfo);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(uinfo);
