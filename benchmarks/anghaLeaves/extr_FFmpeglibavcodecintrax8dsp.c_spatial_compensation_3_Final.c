...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // ------------------------------- 
          // static_instructions_O3 : 320
          // dynamic_instructions_O3 : 320
          // ------------------------------- 
          // static_instructions_Ofast : 320
          // dynamic_instructions_Ofast : 320
          // ------------------------------- 
          // static_instructions_Os : 24
          // dynamic_instructions_Os : 584
          // ------------------------------- 
          // static_instructions_Oz : 26
          // dynamic_instructions_Oz : 674
          // ------------------------------- 
          ...
          spatial_compensation_3(src,dst,stride);
          free(src);
          free(dst);
