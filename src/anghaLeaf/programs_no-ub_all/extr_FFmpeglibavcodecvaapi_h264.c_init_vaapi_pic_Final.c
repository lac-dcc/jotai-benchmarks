...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_va_pic0; _i0++) {
            va_pic->BottomFieldOrderCnt = ((-2 * (next_i()%2)) + 1) * next_i();
        va_pic->TopFieldOrderCnt = ((-2 * (next_i()%2)) + 1) * next_i();
        va_pic->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        va_pic->picture_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
