...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ftl0; _i0++) {
            ftl->cache_data_invalid_bitmap = ((-2 * (next_i()%2)) + 1) * next_i();
        ftl->cache_clean = ((-2 * (next_i()%2)) + 1) * next_i();
        ftl->cache_zone = ((-2 * (next_i()%2)) + 1) * next_i();
        ftl->cache_block = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          sm_cache_init(ftl);
          free(ftl);
