...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data0; _j0++) {
            ctl[_i0].private_data->model.dac_volume_max = ((-2 * (next_i()%2)) + 1) * next_i();
        ctl[_i0].private_data->model.dac_volume_min = ((-2 * (next_i()%2)) + 1) * next_i();
        ctl[_i0].private_data->model.dac_channels_mixer = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_info0 = 1;
        ...
        info[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = dac_volume_info(ctl,info);
          printf("%d\n", benchRet); 
