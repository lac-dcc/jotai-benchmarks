...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_xdev0 = 1;
          struct xenbus_device * xdev = (struct xenbus_device *) malloc(_len_xdev0*sizeof(struct xenbus_device));
          for(int _i0 = 0; _i0 < _len_xdev0; _i0++) {
            xdev[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_env0 = 1;
          ...
          int benchRet = pvcalls_back_uevent(xdev,env);
          printf("%d\n", benchRet); 
          free(xdev);
          free(env);
