...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long expire = 100;
        
          unsigned long benchRet = timer_slot(wheel,expire);
          printf("%lu\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long expire = ((-2 * (next_i()%2)) + 1) * next_i();
