...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter->flags2 = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->hw.device_id = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->hw.phy.eee_speeds_advertised = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->hw.phy.eee_speeds_supported = ((-2 * (next_i()%2)) + 1) * next_i();
          }
