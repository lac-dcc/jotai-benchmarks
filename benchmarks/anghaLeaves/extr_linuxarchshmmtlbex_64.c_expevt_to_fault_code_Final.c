...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long expevt = 100;
        
          unsigned int benchRet = expevt_to_fault_code(expevt);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long expevt = ((-2 * (next_i()%2)) + 1) * next_i();
