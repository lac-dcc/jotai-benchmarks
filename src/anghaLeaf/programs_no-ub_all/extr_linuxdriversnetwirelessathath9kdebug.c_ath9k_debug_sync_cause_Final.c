...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sc0; _i0++) {
            sc->debug.stats.istats.mac_sleep_access = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.mac_asleep = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.mac_awake = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.pm_access = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.local_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.radm_cpl_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.radm_cpl_ecrc_err = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.radm_cpl_tlp_abort = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.radm_cpl_dllp_abort = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.radm_cpl_ep = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.trcv_fifo_perr = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.host1_perr = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.host1_fatal = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.pci_mode_conflict = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.apb_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.eeprom_illegal_access = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.sync_mac_irq = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.sync_rtc_irq = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->debug.stats.istats.sync_cause_all = ((-2 * (next_i()%2)) + 1) * next_i();
          }
