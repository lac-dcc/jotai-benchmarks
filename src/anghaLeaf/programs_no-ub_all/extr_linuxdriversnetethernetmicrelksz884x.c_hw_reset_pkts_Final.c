...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->next = ((-2 * (next_i()%2)) + 1) * next_i();
        info->last = ((-2 * (next_i()%2)) + 1) * next_i();
        info->alloc = ((-2 * (next_i()%2)) + 1) * next_i();
        info->avail = ((-2 * (next_i()%2)) + 1) * next_i();
        info->ring = ((-2 * (next_i()%2)) + 1) * next_i();
        info->cur = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          hw_reset_pkts(info);
          free(info);
