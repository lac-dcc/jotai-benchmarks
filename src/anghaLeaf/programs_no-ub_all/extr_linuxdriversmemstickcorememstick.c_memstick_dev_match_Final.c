...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
            card->id.type = ((-2 * (next_i()%2)) + 1) * next_i();
        card->id.category = ((-2 * (next_i()%2)) + 1) * next_i();
        card->id.class = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_id0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_id0; _i0++) {
            id->match_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        id->type = ((-2 * (next_i()%2)) + 1) * next_i();
        id->category = ((-2 * (next_i()%2)) + 1) * next_i();
        id->class = ((-2 * (next_i()%2)) + 1) * next_i();
          }
