...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw_stats0; _i0++) {
            hw_stats->mac_stats.mac_rx_oversize_pkt_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->mac_stats.mac_rx_undersize_pkt_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->mac_stats.mac_rx_fcs_err_pkt_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->mac_stats.mac_rx_multi_pkt_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->mac_stats.mac_tx_multi_pkt_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->all_32_bit_stats.igu_rx_no_sof_pkt = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->all_32_bit_stats.igu_rx_no_eof_pkt = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->all_32_bit_stats.ssu_key_drop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->all_32_bit_stats.ppp_key_drop_num = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_stats->all_32_bit_stats.ssu_full_drop_num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_net_stats0; _i0++) {
            net_stats->rx_over_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        net_stats->rx_length_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        net_stats->rx_crc_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        net_stats->multicast = ((-2 * (next_i()%2)) + 1) * next_i();
        net_stats->rx_errors = ((-2 * (next_i()%2)) + 1) * next_i();
        net_stats->rx_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
        net_stats->tx_dropped = ((-2 * (next_i()%2)) + 1) * next_i();
          }
