...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long bytes_per_frame = 100;
        
          int benchRet = check_bytes_per_frame(bytes_per_frame);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          long bytes_per_frame = ((-2 * (next_i()%2)) + 1) * next_i();
