...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dst_chan0; _i0++) {
            dst_chan->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_chan->center_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_chan->dfs_state = ((-2 * (next_i()%2)) + 1) * next_i();
        dst_chan->dfs_state_entered = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_src_chan0; _i0++) {
            src_chan->flags = ((-2 * (next_i()%2)) + 1) * next_i();
        src_chan->center_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        src_chan->dfs_state = ((-2 * (next_i()%2)) + 1) * next_i();
        src_chan->dfs_state_entered = ((-2 * (next_i()%2)) + 1) * next_i();
          }
