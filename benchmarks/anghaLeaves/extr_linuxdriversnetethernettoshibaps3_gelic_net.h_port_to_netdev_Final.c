...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              int _len_p__i0__netdev0 = 1;
          p[_i0].netdev = (struct net_device *) malloc(_len_p__i0__netdev0*sizeof(struct net_device));
          for(int _j0 = 0; _j0 < _len_p__i0__netdev0; _j0++) {
            p[_i0].netdev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct net_device * benchRet = port_to_netdev(p);
          printf("%d\n", (*benchRet).dummy);
