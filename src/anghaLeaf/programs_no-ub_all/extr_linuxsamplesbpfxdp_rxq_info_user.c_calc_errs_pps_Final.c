...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_r0; _i0++) {
            r->issue = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          int _len_p0 = 1;
          struct datarec * p = (struct datarec *) malloc(_len_p0*sizeof(struct datarec));
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->issue = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
