...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_code0 = 1;
          struct TYPE_4__ * code = (struct TYPE_4__ *) malloc(_len_code0*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_code0; _i0++) {
            code[_i0].ref = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct TYPE_4__ * benchRet = bytecode_addref(code);
          printf("%d\n", (*benchRet).ref);
          free(code);
