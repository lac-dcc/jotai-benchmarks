...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_reply0 = 1;
          struct i2c_reply_transaction_data * reply = (struct i2c_reply_transaction_data *) malloc(_len_reply0*sizeof(struct i2c_reply_transaction_data));
          for(int _i0 = 0; _i0 < _len_reply0; _i0++) {
            reply[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          dal_i2c_engine_process_channel_reply(engine,reply);
          free(engine);
          free(reply);
