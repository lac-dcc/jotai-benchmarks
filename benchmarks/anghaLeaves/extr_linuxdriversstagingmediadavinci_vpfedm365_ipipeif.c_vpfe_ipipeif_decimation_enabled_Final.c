...
/* Type definitions */
struct TYPE_2__ {int decimation; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vpfe_dev0; _i0++) {
              vpfe_dev[_i0].vpfe_ipipeif.config.decimation = ((-2 * (next_i()%2)) + 1) * next_i();
        
        
        
          }
        
          int benchRet = vpfe_ipipeif_decimation_enabled(vpfe_dev);
          printf("%d\n", benchRet); 
          free(vpfe_dev);
