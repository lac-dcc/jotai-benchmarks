...
int main(int argc, char *argv[]) {
    ...
    case 1:
    {
          struct halmac_adapter * aux_halmac_adapter[10000];
          struct halmac_adapter * halmac_adapter = _allocate_halmac_adapter(10000, aux_halmac_adapter);
          enum halmac_ret_status benchRet = halmac_adapter_validate(halmac_adapter);
          printf("{{other_type}} %p\n", &benchRet); 
          _delete_halmac_adapter(aux_halmac_adapter, 10000);
