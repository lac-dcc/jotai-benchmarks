...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_mixer0 = 1;
          struct ct_mixer * mixer = (struct ct_mixer *) malloc(_len_mixer0*sizeof(struct ct_mixer));
          for(int _i0 = 0; _i0 < _len_mixer0; _i0++) {
            mixer[_i0].switch_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned char benchRet = get_switch_state(mixer,type);
          printf("%c\n", (benchRet %26) + 'a'); 
          free(mixer);
