...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_prli0; _i0++) {
            prli[_i0].parampage.type = ((-2 * (next_i()%2)) + 1) * next_i();
        prli[_i0].parampage.servparams.initiator = ((-2 * (next_i()%2)) + 1) * next_i();
        prli[_i0].parampage.imagepair = ((-2 * (next_i()%2)) + 1) * next_i();
          }
