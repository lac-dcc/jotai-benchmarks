...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_entry0 = 1;
          struct TYPE_5__ * entry = (struct TYPE_5__ *) malloc(_len_entry0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_entry0; _i0++) {
            entry[_i0].children.num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = profiler_snapshot_num_children(entry);
          printf("%lu\n", benchRet); 
          free(entry);
