...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_m0; _i0++) {
            m->a.frame_pts = ((-2 * (next_i()%2)) + 1) * next_i();
        m->a.frame_ready = ((-2 * (next_i()%2)) + 1) * next_i();
        m->has_audio = ((-2 * (next_i()%2)) + 1) * next_i();
        m->v.frame_pts = ((-2 * (next_i()%2)) + 1) * next_i();
        m->v.frame_ready = ((-2 * (next_i()%2)) + 1) * next_i();
        m->has_video = ((-2 * (next_i()%2)) + 1) * next_i();
          }
