...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ah0; _i0++) {
              ah[_i0].ah_capabilities.cap_range.range_2ghz_min = ((-2 * (next_i()%2)) + 1) * next_i();
          ah[_i0].ah_capabilities.cap_range.range_2ghz_max = ((-2 * (next_i()%2)) + 1) * next_i();
          ah[_i0].ah_capabilities.cap_range.range_5ghz_min = ((-2 * (next_i()%2)) + 1) * next_i();
          ah[_i0].ah_capabilities.cap_range.range_5ghz_max = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          channel[_i0].band = ((-2 * (next_i()%2)) + 1) * next_i();
