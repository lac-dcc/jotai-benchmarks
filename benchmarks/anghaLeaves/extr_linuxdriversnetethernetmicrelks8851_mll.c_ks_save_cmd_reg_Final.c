...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ks0 = 1;
          struct ks_net * ks = (struct ks_net *) malloc(_len_ks0*sizeof(struct ks_net));
          for(int _i0 = 0; _i0 < _len_ks0; _i0++) {
            ks[_i0].cmd_reg_cache = ((-2 * (next_i()%2)) + 1) * next_i();
        ks[_i0].cmd_reg_cache_int = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ks_save_cmd_reg(ks);
          free(ks);
