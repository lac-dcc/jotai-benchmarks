...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bus0; _i0++) {
            bus->sprom.board_rev = ((-2 * (next_i()%2)) + 1) * next_i();
        bus->sprom.boardflags_lo = ((-2 * (next_i()%2)) + 1) * next_i();
        bus->boardinfo.vendor = ((-2 * (next_i()%2)) + 1) * next_i();
        bus->boardinfo.type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
