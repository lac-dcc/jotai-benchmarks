...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_task_params0; _i0++) {
            task_params->rx_io_size = ((-2 * (next_i()%2)) + 1) * next_i();
        task_params->tx_io_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_sgl_task_params0; _i0++) {
            sgl_task_params->total_buffer_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_dif_task_params0; _i0++) {
            dif_task_params->dif_on_network = ((-2 * (next_i()%2)) + 1) * next_i();
          }
