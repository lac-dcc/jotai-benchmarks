...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dma__i0__dmab0; _j0++) {
              int _len_dma__i0__dmab_area0 = 1;
          dma[_i0].dmab->area = (unsigned char *) malloc(_len_dma__i0__dmab_area0*sizeof(unsigned char));
          for(int _j0 = 0; _j0 < _len_dma__i0__dmab_area0; _j0++) {
            dma[_i0].dmab->area[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          unsigned char * benchRet = dma_get_buffer_addr(dma);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
