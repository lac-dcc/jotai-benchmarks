...
/* Variables and functions */
 int /*<<< orphan*/  mlx5_ib_rep_query_port ; 
 int /*<<< orphan*/  mlx5_port_rep_immutable ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->ib_dev.query_port = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->ib_dev.get_port_immutable = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = mlx5_ib_stage_rep_non_default_cb(dev);
          printf("%d\n", benchRet); 
          free(dev);
