...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_zip_ops0; _i0++) {
            zip_ops->speed = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->ccode = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->lzs_flag = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->begin_file = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->end_file = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->csum = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->compcode = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->history_len = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->format = ((-2 * (next_i()%2)) + 1) * next_i();
        zip_ops->flush = ((-2 * (next_i()%2)) + 1) * next_i();
          }
