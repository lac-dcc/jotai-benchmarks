...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cd0; _i0++) {
              int _len_cd__i0__dev0 = 1;
          cd[_i0].dev = (int *) malloc(_len_cd__i0__dev0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_cd__i0__dev0; _j0++) {
            cd[_i0].dev[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = genwqe_device_initialized(cd);
          printf("%d\n", benchRet); 
