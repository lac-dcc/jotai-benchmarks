...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stats0; _i0++) {
            stats->pkt_curr_buf_tc7_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc6_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc5_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc4_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc3_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc2_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc1_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_tc0_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->pkt_curr_buf_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
