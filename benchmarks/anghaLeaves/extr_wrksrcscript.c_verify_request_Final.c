...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_parser0; _i0++) {
              int _len_parser__i0__data0 = 1;
          parser[_i0].data = (unsigned long *) malloc(_len_parser__i0__data0*sizeof(unsigned long));
          for(int _j0 = 0; _j0 < _len_parser__i0__data0; _j0++) {
            parser[_i0].data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = verify_request(parser);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_parser0; _aux++) {
          free(parser[_aux].data);
          }
          free(parser);
