...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_identifier0 = 1;
          int * identifier = (int *) malloc(_len_identifier0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_identifier0; _i0++) {
            identifier[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = pqi_sas_get_enclosure_identifier(rphy,identifier);
          printf("%d\n", benchRet); 
          free(rphy);
          free(identifier);
