...
/* Type definitions */
struct TYPE_3__ {int efuse_cmd_construct_state; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_halmac_adapter0; _i0++) {
            halmac_adapter->halmac_state.efuse_state_set.efuse_cmd_construct_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          enum halmac_efuse_cmd_construct_state benchRet = halmac_query_efuse_curr_state_88xx(halmac_adapter);
          printf("{{struct}} %p\n", &benchRet); 
          free(halmac_adapter);
