...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ctx0 = 1;
          struct tee_context * ctx = (struct tee_context *) malloc(_len_ctx0*sizeof(struct tee_context));
          ...
          for(int _i0 = 0; _i0 < _len_shm0; _i0++) {
            shm[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = optee_shm_unregister_supp(ctx,shm);
          printf("%d\n", benchRet); 
          free(ctx);
          free(shm);
