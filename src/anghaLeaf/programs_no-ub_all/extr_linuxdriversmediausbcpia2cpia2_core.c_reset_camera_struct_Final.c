...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cam0; _i0++) {
            cam->params.roi.height = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.roi.width = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.version.sensor_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.vp_params.gpio_data = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.vp_params.gpio_direction = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.vp_params.lowlight_boost = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.pnp_id.device_type = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.vc_params.quality = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.compression.creep_period = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.compression.user_squeeze = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.compression.inhibit_htables = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.compression.jpeg_options = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->params.flicker_control.flicker_mode_req = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->height = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->width = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->video_size = ((-2 * (next_i()%2)) + 1) * next_i();
        cam->sensor_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
