...
__attribute__((used)) static unsigned int OnAction_wmm(struct adapter *padapter,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_padapter0; _i0++) {
            padapter->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_precv_frame0; _i0++) {
            precv_frame->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned int benchRet = OnAction_wmm(padapter,precv_frame);
          printf("%u\n", benchRet); 
          free(padapter);
          free(precv_frame);
