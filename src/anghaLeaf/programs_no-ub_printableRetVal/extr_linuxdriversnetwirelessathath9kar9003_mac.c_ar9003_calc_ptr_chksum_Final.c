...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ads0; _i0++) {
            ads->info = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->link = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->data0 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->ctl3 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->data1 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->ctl5 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->data2 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->ctl7 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->data3 = ((-2 * (next_i()%2)) + 1) * next_i();
        ads->ctl9 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
