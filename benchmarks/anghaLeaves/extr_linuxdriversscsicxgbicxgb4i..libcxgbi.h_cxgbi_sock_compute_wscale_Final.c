...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int win = 100;
        
          unsigned int benchRet = cxgbi_sock_compute_wscale(win);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int win = ((-2 * (next_i()%2)) + 1) * next_i();
