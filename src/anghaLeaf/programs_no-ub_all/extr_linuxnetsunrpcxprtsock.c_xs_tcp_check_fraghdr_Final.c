...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_transport0; _i0++) {
            transport->tcp_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        transport->tcp_reclen = ((-2 * (next_i()%2)) + 1) * next_i();
        transport->tcp_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        transport->tcp_copied = ((-2 * (next_i()%2)) + 1) * next_i();
          }
