...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_portal0 = 1;
          struct bm_portal * portal = (struct bm_portal *) malloc(_len_portal0*sizeof(struct bm_portal));
          for(int _i0 = 0; _i0 < _len_portal0; _i0++) {
            portal[_i0].rcr.available = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = bm_rcr_get_avail(portal);
          printf("%d\n", benchRet); 
          free(portal);
