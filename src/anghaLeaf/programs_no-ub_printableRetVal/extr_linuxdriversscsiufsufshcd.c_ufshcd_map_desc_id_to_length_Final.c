...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hba0; _i0++) {
            hba->desc_size.dev_desc = ((-2 * (next_i()%2)) + 1) * next_i();
        hba->desc_size.pwr_desc = ((-2 * (next_i()%2)) + 1) * next_i();
        hba->desc_size.geom_desc = ((-2 * (next_i()%2)) + 1) * next_i();
        hba->desc_size.conf_desc = ((-2 * (next_i()%2)) + 1) * next_i();
        hba->desc_size.unit_desc = ((-2 * (next_i()%2)) + 1) * next_i();
        hba->desc_size.interc_desc = ((-2 * (next_i()%2)) + 1) * next_i();
        hba->desc_size.hlth_desc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
