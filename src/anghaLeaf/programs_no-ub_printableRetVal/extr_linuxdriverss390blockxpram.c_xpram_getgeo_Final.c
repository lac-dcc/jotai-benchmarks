...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_bdev0; _i0++) {
            bdev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_geo0 = 1;
          struct hd_geometry * geo = (struct hd_geometry *) malloc(_len_geo0*sizeof(struct hd_geometry));
          for(int _i0 = 0; _i0 < _len_geo0; _i0++) {
            geo->cylinders = ((-2 * (next_i()%2)) + 1) * next_i();
        geo->heads = ((-2 * (next_i()%2)) + 1) * next_i();
        geo->sectors = ((-2 * (next_i()%2)) + 1) * next_i();
        geo->start = ((-2 * (next_i()%2)) + 1) * next_i();
          }
