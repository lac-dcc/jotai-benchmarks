...
__attribute__((used)) static int hvs_dgram_enqueue(struct vsock_sock *vsk,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vsk0; _i0++) {
            vsk->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_remote0 = 1;
          struct sockaddr_vm * remote = (struct sockaddr_vm *) malloc(_len_remote0*sizeof(struct sockaddr_vm));
          for(int _i0 = 0; _i0 < _len_remote0; _i0++) {
            remote->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_msg0 = 1;
          ...
          int benchRet = hvs_dgram_enqueue(vsk,remote,msg,dgram_len);
          printf("%d\n", benchRet); 
          free(vsk);
          free(remote);
          free(msg);
