...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_context0; _i0++) {
            context->direct_map = ((-2 * (next_i()%2)) + 1) * next_i();
        context->nx = ((-2 * (next_i()%2)) + 1) * next_i();
        context->shadow_root_level = ((-2 * (next_i()%2)) + 1) * next_i();
        context->root_level = ((-2 * (next_i()%2)) + 1) * next_i();
        context->update_pte = ((-2 * (next_i()%2)) + 1) * next_i();
        context->invlpg = ((-2 * (next_i()%2)) + 1) * next_i();
        context->sync_page = ((-2 * (next_i()%2)) + 1) * next_i();
        context->gva_to_gpa = ((-2 * (next_i()%2)) + 1) * next_i();
        context->page_fault = ((-2 * (next_i()%2)) + 1) * next_i();
          }
