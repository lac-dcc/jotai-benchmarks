...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_csa0; _i0++) {
            csa->priv1.mfc_sr1_RW = ((-2 * (next_i()%2)) + 1) * next_i();
        csa->priv1.int_mask_class0_RW = ((-2 * (next_i()%2)) + 1) * next_i();
        csa->priv1.int_mask_class1_RW = ((-2 * (next_i()%2)) + 1) * next_i();
        csa->priv1.int_mask_class2_RW = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          init_priv1(csa);
          free(csa);
