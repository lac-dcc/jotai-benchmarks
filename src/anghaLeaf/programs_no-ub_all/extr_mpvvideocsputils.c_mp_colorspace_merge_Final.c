...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_orig0; _i0++) {
            orig->light = ((-2 * (next_i()%2)) + 1) * next_i();
        orig->sig_peak = ((-2 * (next_i()%2)) + 1) * next_i();
        orig->gamma = ((-2 * (next_i()%2)) + 1) * next_i();
        orig->primaries = ((-2 * (next_i()%2)) + 1) * next_i();
        orig->levels = ((-2 * (next_i()%2)) + 1) * next_i();
        orig->space = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_new0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_new0; _i0++) {
            new->light = ((-2 * (next_i()%2)) + 1) * next_i();
        new->sig_peak = ((-2 * (next_i()%2)) + 1) * next_i();
        new->gamma = ((-2 * (next_i()%2)) + 1) * next_i();
        new->primaries = ((-2 * (next_i()%2)) + 1) * next_i();
        new->levels = ((-2 * (next_i()%2)) + 1) * next_i();
        new->space = ((-2 * (next_i()%2)) + 1) * next_i();
          }
