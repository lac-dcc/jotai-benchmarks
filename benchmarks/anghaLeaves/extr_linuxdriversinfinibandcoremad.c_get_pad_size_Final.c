...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long mad_size = 100;
        
          int benchRet = get_pad_size(hdr_len,data_len,mad_size);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long mad_size = ((-2 * (next_i()%2)) + 1) * next_i();
