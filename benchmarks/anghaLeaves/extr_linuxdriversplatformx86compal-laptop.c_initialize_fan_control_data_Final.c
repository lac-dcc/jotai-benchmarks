...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_data0 = 1;
          struct compal_data * data = (struct compal_data *) malloc(_len_data0*sizeof(struct compal_data));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data[_i0].pwm_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        data[_i0].curr_pwm = ((-2 * (next_i()%2)) + 1) * next_i();
          }
