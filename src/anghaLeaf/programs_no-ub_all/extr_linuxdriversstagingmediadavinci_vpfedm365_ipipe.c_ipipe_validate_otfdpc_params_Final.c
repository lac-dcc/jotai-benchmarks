...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dpc_param0; _i0++) {
            dpc_param->en = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.act_adj_shf = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.det_thr = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.det_slp = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.det_thr_min = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.det_thr_max = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.corr_thr = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.corr_slp = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.corr_thr_min = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_3_0.corr_thr_max = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.corr_thr.r = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.corr_thr.gr = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.corr_thr.gb = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.corr_thr.b = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.det_thr.r = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.det_thr.gr = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.det_thr.gb = ((-2 * (next_i()%2)) + 1) * next_i();
        dpc_param->alg_cfg.dpc_2_0.det_thr.b = ((-2 * (next_i()%2)) + 1) * next_i();
          }
