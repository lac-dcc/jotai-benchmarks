...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hdw0; _i0++) {
            hdw->state_pipeline_idle = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_pipeline_pause = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_decoder_quiescent = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_usbstream_run = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_decoder_run = ((-2 * (next_i()%2)) + 1) * next_i();
        hdw->state_encoder_run = ((-2 * (next_i()%2)) + 1) * next_i();
          }
