...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_section0 = 1;
          struct mem_section * section = (struct mem_section *) malloc(_len_section0*sizeof(struct mem_section));
          for(int _i0 = 0; _i0 < _len_section0; _i0++) {
            section[_i0].section_mem_map = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = sparse_early_nid(section);
          printf("%d\n", benchRet); 
          free(section);
