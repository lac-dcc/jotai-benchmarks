...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_param0; _i0++) {
            param->src_color = ((-2 * (next_i()%2)) + 1) * next_i();
        param->dst_fourcc = ((-2 * (next_i()%2)) + 1) * next_i();
        param->dma_mcu = ((-2 * (next_i()%2)) + 1) * next_i();
        param->dma_group = ((-2 * (next_i()%2)) + 1) * next_i();
        param->mcu_w = ((-2 * (next_i()%2)) + 1) * next_i();
        param->dma_last_mcu = ((-2 * (next_i()%2)) + 1) * next_i();
          }
