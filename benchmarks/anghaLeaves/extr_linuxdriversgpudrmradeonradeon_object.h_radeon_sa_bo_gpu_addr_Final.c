...
__attribute__((used)) static inline uint64_t radeon_sa_bo_gpu_addr(struct radeon_sa_bo *sa_bo)
{
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_sa_bo0 = 1;
          struct radeon_sa_bo * sa_bo = (struct radeon_sa_bo *) malloc(_len_sa_bo0*sizeof(struct radeon_sa_bo));
          ...
          long benchRet = radeon_sa_bo_gpu_addr(sa_bo);
          printf("%ld\n", benchRet); 
