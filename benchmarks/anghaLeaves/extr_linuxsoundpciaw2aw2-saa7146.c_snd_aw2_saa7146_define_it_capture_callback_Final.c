...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          snd_aw2_saa7146_define_it_capture_callback(stream_number,p_it_callback,p_callback_param);
    ...
    case 3:
    {
          ...
          unsigned int stream_number = ((-2 * (next_i()%2)) + 1) * next_i();
        
          long p_it_callback = ((-2 * (next_i()%2)) + 1) * next_i();
