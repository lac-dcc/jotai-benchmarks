...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int omap2xxx_pwrst = 100;
        
          int benchRet = omap2xxx_pwrst_to_common_pwrst(omap2xxx_pwrst);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int omap2xxx_pwrst = ((-2 * (next_i()%2)) + 1) * next_i();
