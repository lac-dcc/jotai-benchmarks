...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          long channel_layout = 100;
        
          int benchRet = ff_flac_is_native_layout(channel_layout);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          long channel_layout = ((-2 * (next_i()%2)) + 1) * next_i();
