...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_id0; _i0++) {
            id->route.addr.src_addr.ss_family = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dst0 = 1;
          struct rdma_conn_param * dst = (struct rdma_conn_param *) malloc(_len_dst0*sizeof(struct rdma_conn_param));
          for(int _i0 = 0; _i0 < _len_dst0; _i0++) {
            dst->qkey = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->qp_num = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->srq = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->rnr_retry_count = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->retry_count = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->flow_control = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->initiator_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->responder_resources = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->private_data_len = ((-2 * (next_i()%2)) + 1) * next_i();
        dst->private_data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_src0 = 1;
          struct rdma_ucm_conn_param * src = (struct rdma_ucm_conn_param *) malloc(_len_src0*sizeof(struct rdma_ucm_conn_param));
          for(int _i0 = 0; _i0 < _len_src0; _i0++) {
            src->qkey = ((-2 * (next_i()%2)) + 1) * next_i();
        src->qp_num = ((-2 * (next_i()%2)) + 1) * next_i();
        src->srq = ((-2 * (next_i()%2)) + 1) * next_i();
        src->rnr_retry_count = ((-2 * (next_i()%2)) + 1) * next_i();
        src->retry_count = ((-2 * (next_i()%2)) + 1) * next_i();
        src->flow_control = ((-2 * (next_i()%2)) + 1) * next_i();
        src->initiator_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        src->responder_resources = ((-2 * (next_i()%2)) + 1) * next_i();
        src->private_data_len = ((-2 * (next_i()%2)) + 1) * next_i();
        src->private_data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
