...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dma_page0; _i0++) {
            dma_page->uaddr = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_page->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_page->tail = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_page->first = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_page->last = ((-2 * (next_i()%2)) + 1) * next_i();
        dma_page->page_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
