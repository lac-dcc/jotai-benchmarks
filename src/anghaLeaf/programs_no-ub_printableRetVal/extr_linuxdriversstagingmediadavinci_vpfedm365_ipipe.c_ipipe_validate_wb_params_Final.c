...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_wbal0; _i0++) {
            wbal->ofst_r = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->ofst_gr = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->ofst_gb = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->ofst_b = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_b.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_b.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_gb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_gb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_gr.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_gr.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_r.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        wbal->gain_r.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
          }
