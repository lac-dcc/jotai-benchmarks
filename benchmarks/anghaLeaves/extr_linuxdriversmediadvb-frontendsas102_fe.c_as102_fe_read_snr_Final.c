...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].demodulator_priv = (struct as102_state *) malloc(_len_fe__i0__demodulator_priv0*sizeof(struct as102_state));
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
            fe[_i0].demodulator_priv->demod_stats.mer = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_snr0 = 1;
          ...
          int benchRet = as102_fe_read_snr(fe,snr);
          printf("%d\n", benchRet); 
