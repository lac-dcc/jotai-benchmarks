...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ca0; _i0++) {
            ca->sb.block_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->sb.bucket_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ca->sb.nr_in_set = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_c0 = 1;
          struct cache_set * c = (struct cache_set *) malloc(_len_c0*sizeof(struct cache_set));
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c->sb.block_size = ((-2 * (next_i()%2)) + 1) * next_i();
        c->sb.bucket_size = ((-2 * (next_i()%2)) + 1) * next_i();
        c->sb.nr_in_set = ((-2 * (next_i()%2)) + 1) * next_i();
          }
