...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int get_by_subject = 100;
        
          int _len_method0 = 1;
          struct TYPE_3__ * method = (struct TYPE_3__ *) malloc(_len_method0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_method0; _i0++) {
              method[_i0].get_by_subject = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = X509_LOOKUP_meth_set_get_by_subject(method,get_by_subject);
          printf("%d\n", benchRet); 
          free(method);
    ...
    case 3:
    {
          ...
          int get_by_subject = ((-2 * (next_i()%2)) + 1) * next_i();
