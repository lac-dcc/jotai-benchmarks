...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_im0; _i0++) {
            im[_i0].colorsTotal = ((-2 * (next_i()%2)) + 1) * next_i();
        im[_i0].transparent = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_im__i0__alpha0 = 1;
          im[_i0].alpha = (int *) malloc(_len_im__i0__alpha0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_im__i0__alpha0; _j0++) {
            im[_i0].alpha[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
