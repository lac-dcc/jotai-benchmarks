...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int compression_method = 100;
        
          const char * benchRet = list_get_compression_method_description(compression_method);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          ...
          int compression_method = ((-2 * (next_i()%2)) + 1) * next_i();
