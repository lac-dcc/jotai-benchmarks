...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int family = 100;
          int _len_pcb0 = 1;
          struct utun_pcb * pcb = (struct utun_pcb *) malloc(_len_pcb0*sizeof(struct utun_pcb));
          for(int _i0 = 0; _i0 < _len_pcb0; _i0++) {
            pcb[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pkt0 = 1;
          ...
          int benchRet = utun_pkt_dtls_input(pcb,pkt,family);
          printf("%d\n", benchRet); 
          free(pcb);
          free(pkt);
