...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long modulus = 100;
        
          unsigned int benchRet = modulo_min(a,b,modulus);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long modulus = ((-2 * (next_i()%2)) + 1) * next_i();
