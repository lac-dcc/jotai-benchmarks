...
#define  FSL_SAI_RCR1 144 
#define  FSL_SAI_RCR2 143 
#define  FSL_SAI_RCR3 142 
#define  FSL_SAI_RCR4 141 
#define  FSL_SAI_RCR5 140 
#define  FSL_SAI_RCSR 139 
#define  FSL_SAI_RDR 138 
#define  FSL_SAI_RFR 137 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = fsl_sai_readable_reg(dev,reg);
          printf("%d\n", benchRet); 
          free(dev);
