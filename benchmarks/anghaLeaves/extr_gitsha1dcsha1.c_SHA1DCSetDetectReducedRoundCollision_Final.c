...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          SHA1DCSetDetectReducedRoundCollision(ctx,reduced_round_coll);
          free(ctx);
    ...
    case 3:
    {
          int reduced_round_coll = ((-2 * (next_i()%2)) + 1) * next_i();
