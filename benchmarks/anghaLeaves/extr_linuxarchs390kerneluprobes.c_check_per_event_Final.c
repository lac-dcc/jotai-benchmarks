...
int main(int argc, char *argv[]) {
    ...
    case 1:
    {
          ...
          unsigned short cause = 255;
        
          unsigned long control = 255;
    ...
    case 3:
    {
          ...
          unsigned short cause = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned long control = ((-2 * (next_i()%2)) + 1) * next_i();
