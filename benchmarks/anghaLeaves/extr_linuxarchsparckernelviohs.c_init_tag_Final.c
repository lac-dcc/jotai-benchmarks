...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_tag0 = 1;
          struct vio_msg_tag * tag = (struct vio_msg_tag *) malloc(_len_tag0*sizeof(struct vio_msg_tag));
          for(int _i0 = 0; _i0 < _len_tag0; _i0++) {
              tag[_i0].stype_env = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          init_tag(tag,type,stype,stype_env);
          free(tag);
    ...
    case 3:
    {
          ...
          int stype_env = ((-2 * (next_i()%2)) + 1) * next_i();
