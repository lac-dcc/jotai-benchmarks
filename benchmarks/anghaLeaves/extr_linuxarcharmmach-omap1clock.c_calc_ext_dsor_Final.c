...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 1637
          // ------------------------------- 
          // static_instructions_O1 : 22
          // dynamic_instructions_O1 : 1032
          // ------------------------------- 
          // static_instructions_O2 : 24
          // dynamic_instructions_O2 : 540
          // ------------------------------- 
          // static_instructions_O3 : 24
          // dynamic_instructions_O3 : 540
          // ------------------------------- 
          // static_instructions_Ofast : 24
          // dynamic_instructions_Ofast : 540
          // ------------------------------- 
          // static_instructions_Os : 20
          // dynamic_instructions_Os : 988
          // ------------------------------- 
          // static_instructions_Oz : 20
          // dynamic_instructions_Oz : 1083
          // ------------------------------- 

          unsigned long rate = 100;
        
          unsigned int benchRet = calc_ext_dsor(rate);
          printf("%u\n", benchRet); 
