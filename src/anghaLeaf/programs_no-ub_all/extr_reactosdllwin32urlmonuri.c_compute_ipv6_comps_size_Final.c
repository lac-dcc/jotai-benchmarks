...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_address0; _i0++) {
            address->components_size = ((-2 * (next_i()%2)) + 1) * next_i();
        address->h16_count = ((-2 * (next_i()%2)) + 1) * next_i();
        address->elision_size = ((-2 * (next_i()%2)) + 1) * next_i();
        address->elision = ((-2 * (next_i()%2)) + 1) * next_i();
        address->ipv4 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
