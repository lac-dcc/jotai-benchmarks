...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_t0; _i0++) {
            t->Send.UnicastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        t->Send.BroadcastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        t->Recv.UnicastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        t->Recv.BroadcastBytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
