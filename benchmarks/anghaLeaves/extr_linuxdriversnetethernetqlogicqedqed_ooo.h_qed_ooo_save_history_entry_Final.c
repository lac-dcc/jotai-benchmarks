...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_cqe0 = 1;
          struct ooo_opaque * p_cqe = (struct ooo_opaque *) malloc(_len_p_cqe0*sizeof(struct ooo_opaque));
          for(int _i0 = 0; _i0 < _len_p_cqe0; _i0++) {
            p_cqe[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          qed_ooo_save_history_entry(p_hwfn,p_ooo_info,p_cqe);
          free(p_hwfn);
          free(p_ooo_info);
          free(p_cqe);
