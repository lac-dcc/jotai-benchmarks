...
struct TYPE_3__ *_allocate_tree(int length) {
...
void _delete_tree(struct TYPE_3__ * head) {
  if(head->cdr != NULL) _delete_tree(head->cdr);
  free(head);
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          struct TYPE_3__ * tree = _allocate_tree(1);
