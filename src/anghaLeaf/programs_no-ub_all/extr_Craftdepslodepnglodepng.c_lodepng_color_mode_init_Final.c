...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->bitdepth = ((-2 * (next_i()%2)) + 1) * next_i();
        info->palettesize = ((-2 * (next_i()%2)) + 1) * next_i();
        info->palette = ((-2 * (next_i()%2)) + 1) * next_i();
        info->colortype = ((-2 * (next_i()%2)) + 1) * next_i();
        info->key_b = ((-2 * (next_i()%2)) + 1) * next_i();
        info->key_g = ((-2 * (next_i()%2)) + 1) * next_i();
        info->key_r = ((-2 * (next_i()%2)) + 1) * next_i();
        info->key_defined = ((-2 * (next_i()%2)) + 1) * next_i();
          }
