...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_context0 = 1;
          struct skynet_context * context = (struct skynet_context *) malloc(_len_context0*sizeof(struct skynet_context));
          for(int _i0 = 0; _i0 < _len_context0; _i0++) {
              context[_i0].cb = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          void * ud;
        
          skynet_callback(context,ud,cb);
          free(context);
