...
__attribute__((used)) static int altera_ci_slot_shutdown(struct dvb_ca_en50221 *en50221, int slot)
{
	/* not implemented */
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_en502210; _i0++) {
            en50221[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = altera_ci_slot_shutdown(en50221,slot);
          printf("%d\n", benchRet); 
          free(en50221);
