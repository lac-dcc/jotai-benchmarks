...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
              table[_i0].code = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_table__i0__text0 = 1;
          table[_i0].text = (char *) malloc(_len_table__i0__text0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_table__i0__text0; _j0++) {
            table[_i0].text[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          }
        
          char * benchRet = twa_string_lookup(table,code);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_table0; _aux++) {
          free(table[_aux].text);
          }
          free(table);
