...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int cluster = 100;
        
          int benchRet = sunxi_mc_smp_cluster_is_down(cluster);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int cluster = ((-2 * (next_i()%2)) + 1) * next_i();
