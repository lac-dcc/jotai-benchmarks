...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rgb2yuv0; _i0++) {
            rgb2yuv->out_ofst_y = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->out_ofst_cb = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->out_ofst_cr = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_bcr.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_bcr.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_gcr.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_gcr.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_rcr.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_rcr.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_bcb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_bcb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_gcb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_gcb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_rcb.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_rcb.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_by.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_by.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_gy.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_gy.integer = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_ry.decimal = ((-2 * (next_i()%2)) + 1) * next_i();
        rgb2yuv->coef_ry.integer = ((-2 * (next_i()%2)) + 1) * next_i();
          }
