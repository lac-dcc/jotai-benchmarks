...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_RTC_AlarmStruct0; _i0++) {
            RTC_AlarmStruct->RTC_AlarmDateWeekDay = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_AlarmStruct->RTC_AlarmMask = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_AlarmStruct->RTC_AlarmDateWeekDaySel = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours = ((-2 * (next_i()%2)) + 1) * next_i();
        RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
