...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_module_ctx0; _i0++) {
            module_ctx->module_unstable_warning = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_build_plain_postprocess = ((-2 * (next_i()%2)) + 1) * next_i();
