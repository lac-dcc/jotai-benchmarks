...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_ranges0 = 1;
          struct htt_rx_indication_mpdu_range * ranges = (struct htt_rx_indication_mpdu_range *) malloc(_len_ranges0*sizeof(struct htt_rx_indication_mpdu_range));
          for(int _i0 = 0; _i0 < _len_ranges0; _i0++) {
            ranges[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ath10k_sta_update_rx_tid_stats_ampdu(ar,peer_id,tid,ranges,num_ranges);
          free(ar);
          free(ranges);
