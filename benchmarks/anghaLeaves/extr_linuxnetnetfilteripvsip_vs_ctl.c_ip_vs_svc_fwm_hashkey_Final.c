...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int benchRet = ip_vs_svc_fwm_hashkey(ipvs,fwmark);
          printf("%u\n", benchRet); 
          free(ipvs);
    ...
    case 3:
    {
          ...
          unsigned long fwmark = ((-2 * (next_i()%2)) + 1) * next_i();
