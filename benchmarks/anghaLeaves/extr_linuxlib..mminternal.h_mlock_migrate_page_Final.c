...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_new0 = 1;
          struct page * new = (struct page *) malloc(_len_new0*sizeof(struct page));
          for(int _i0 = 0; _i0 < _len_new0; _i0++) {
            new[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_old0 = 1;
          struct page * old = (struct page *) malloc(_len_old0*sizeof(struct page));
          for(int _i0 = 0; _i0 < _len_old0; _i0++) {
            old[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          mlock_migrate_page(new,old);
          free(new);
          free(old);
