...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_table0 = 1;
          struct iceland_mc_reg_table * table = (struct iceland_mc_reg_table *) malloc(_len_table0*sizeof(struct iceland_mc_reg_table));
        ...
        table[_i0].validflag = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = iceland_set_valid_flag(table);
          printf("%d\n", benchRet); 
