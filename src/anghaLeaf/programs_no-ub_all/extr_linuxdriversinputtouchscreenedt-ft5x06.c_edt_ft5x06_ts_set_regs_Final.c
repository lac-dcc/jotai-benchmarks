...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tsdata0; _i0++) {
            tsdata->version = ((-2 * (next_i()%2)) + 1) * next_i();
        tsdata->reg_addr.reg_num_y = ((-2 * (next_i()%2)) + 1) * next_i();
        tsdata->reg_addr.reg_num_x = ((-2 * (next_i()%2)) + 1) * next_i();
        tsdata->reg_addr.reg_report_rate = ((-2 * (next_i()%2)) + 1) * next_i();
          }
