...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
            stream->triggered_crtc_reset.delay = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->triggered_crtc_reset.event = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->triggered_crtc_reset.enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
