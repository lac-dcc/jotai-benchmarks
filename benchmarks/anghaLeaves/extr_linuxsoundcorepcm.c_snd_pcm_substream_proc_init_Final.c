...
__attribute__((used)) static inline int snd_pcm_substream_proc_init(struct snd_pcm_substream *substream) { return 0; }
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = snd_pcm_substream_proc_init(substream);
          printf("%d\n", benchRet); 
          free(substream);
