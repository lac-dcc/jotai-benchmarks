...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_Sector0; _i0++) {
            Sector->Signature1 = ((-2 * (next_i()%2)) + 1) * next_i();
        Sector->BytesPerSector = ((-2 * (next_i()%2)) + 1) * next_i();
        Sector->FATCount = ((-2 * (next_i()%2)) + 1) * next_i();
        Sector->Media = ((-2 * (next_i()%2)) + 1) * next_i();
        Sector->SectorsPerCluster = ((-2 * (next_i()%2)) + 1) * next_i();
          }
