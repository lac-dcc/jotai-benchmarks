...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fmt0; _i0++) {
            fmt->pixelformat = ((-2 * (next_i()%2)) + 1) * next_i();
        fmt->width = ((-2 * (next_i()%2)) + 1) * next_i();
        fmt->height = ((-2 * (next_i()%2)) + 1) * next_i();
        fmt->colorspace = ((-2 * (next_i()%2)) + 1) * next_i();
        fmt->quantization = ((-2 * (next_i()%2)) + 1) * next_i();
        fmt->ycbcr_enc = ((-2 * (next_i()%2)) + 1) * next_i();
        fmt->xfer_func = ((-2 * (next_i()%2)) + 1) * next_i();
          }
