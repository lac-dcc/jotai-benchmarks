...
__attribute__((used)) static BOOL arm64_fetch_minidump_module(struct dump_context* dc, unsigned index, unsigned flags)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dc0; _i0++) {
            dc->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = arm64_fetch_minidump_module(dc,index,flags);
          printf("%d\n", benchRet); 
          free(dc);
