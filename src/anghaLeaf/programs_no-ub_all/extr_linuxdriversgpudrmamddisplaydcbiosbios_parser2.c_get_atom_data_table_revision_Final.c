...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_atom_data_tbl0; _i0++) {
            atom_data_tbl->content_revision = ((-2 * (next_i()%2)) + 1) * next_i();
        atom_data_tbl->format_revision = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_tbl_revision0; _i0++) {
            tbl_revision->major = ((-2 * (next_i()%2)) + 1) * next_i();
        tbl_revision->minor = ((-2 * (next_i()%2)) + 1) * next_i();
          }
