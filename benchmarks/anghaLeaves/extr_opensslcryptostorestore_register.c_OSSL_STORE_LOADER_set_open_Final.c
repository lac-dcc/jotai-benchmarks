...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int open_function = 100;
        
          int _len_loader0 = 1;
          struct TYPE_3__ * loader = (struct TYPE_3__ *) malloc(_len_loader0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_loader0; _i0++) {
              loader[_i0].open = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = OSSL_STORE_LOADER_set_open(loader,open_function);
          printf("%d\n", benchRet); 
          free(loader);
    ...
    case 3:
    {
          int open_function = ((-2 * (next_i()%2)) + 1) * next_i();
