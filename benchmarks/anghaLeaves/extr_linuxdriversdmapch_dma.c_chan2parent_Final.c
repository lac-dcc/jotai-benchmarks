...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_chan__i0__dev0; _j0++) {
              int _len_chan__i0__dev_device_parent0 = 1;
          chan[_i0].dev->device.parent = (struct device *) malloc(_len_chan__i0__dev_device_parent0*sizeof(struct device));
          for(int _j0 = 0; _j0 < _len_chan__i0__dev_device_parent0; _j0++) {
            chan[_i0].dev->device.parent->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct device * benchRet = chan2parent(chan);
          printf("%d\n", (*benchRet).dummy);
