...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_aas0; _i0++) {
            aas->AAS_PredictClientMovement = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_Swimming = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_AlternativeRouteGoals = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_PredictRoute = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_EnableRoutingArea = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_AreaTravelTimeToGoalArea = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_AreaReachability = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_IntForBSPEpairKey = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_FloatForBSPEpairKey = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_VectorForBSPEpairKey = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_ValueForBSPEpairKey = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_NextBSPEntity = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_PointContents = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_AreaInfo = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_BBoxAreas = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_TraceAreas = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_PointReachabilityAreaIndex = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_PointAreaNum = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_Time = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_PresenceTypeBoundingBox = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_Initialized = ((-2 * (next_i()%2)) + 1) * next_i();
        aas->AAS_EntityInfo = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          Init_AAS_Export(aas);
          free(aas);
