...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_fw_hi0 = 65025;
          int * fw_hi = (int *) malloc(_len_fw_hi0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_fw_hi0; _i0++) {
            fw_hi[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int _len_fw_lo0 = 65025;
          int * fw_lo = (int *) malloc(_len_fw_lo0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_fw_lo0; _i0++) {
            fw_lo[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          bnx2x_get_fw_mac_addr(fw_hi,fw_mid,fw_lo,mac);
          free(fw_hi);
          free(fw_mid);
          free(fw_lo);
          free(mac);
