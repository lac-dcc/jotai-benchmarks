...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hisi_param0; _i0++) {
            hisi_param->desired_working_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->hs_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->tx_pwr_hs = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->rx_pwr_hs = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->tx_pwr_pwm = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->rx_pwr_pwm = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->pwm_tx_gear = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->pwm_rx_gear = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->hs_tx_gear = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->hs_rx_gear = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->tx_lanes = ((-2 * (next_i()%2)) + 1) * next_i();
        hisi_param->rx_lanes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
