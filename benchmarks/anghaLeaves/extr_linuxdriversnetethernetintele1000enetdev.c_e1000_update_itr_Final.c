...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int itr_setting = 100;
        
          int packets = 100;
        
          int bytes = 100;
        
          unsigned int benchRet = e1000_update_itr(itr_setting,packets,bytes);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int itr_setting = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int packets = ((-2 * (next_i()%2)) + 1) * next_i();
