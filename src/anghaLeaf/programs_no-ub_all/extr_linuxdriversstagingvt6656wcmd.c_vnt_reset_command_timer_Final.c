...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->cmd_running = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->command_state = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->cmd_enqueue_idx = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->cmd_dequeue_idx = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->free_cmd_queue = ((-2 * (next_i()%2)) + 1) * next_i();
          }
