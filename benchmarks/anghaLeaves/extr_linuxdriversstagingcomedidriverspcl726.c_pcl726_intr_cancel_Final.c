...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].private = (struct pcl726_private *) malloc(_len_dev__i0__private0*sizeof(struct pcl726_private));
          for(int _j0 = 0; _j0 < _len_dev__i0__private0; _j0++) {
              dev[_i0].private->cmd_running = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = pcl726_intr_cancel(dev,s);
          printf("%d\n", benchRet); 
