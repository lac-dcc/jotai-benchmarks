...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          addr1[_i0].rose_addr = (long *) malloc(_len_addr1__i0__rose_addr0*sizeof(long));
          ...
          addr2[_i0].rose_addr = (long *) malloc(_len_addr2__i0__rose_addr0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_addr2__i0__rose_addr0; _j0++) {
            addr2[_i0].rose_addr[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = rosecmp(addr1,addr2);
          printf("%d\n", benchRet); 
