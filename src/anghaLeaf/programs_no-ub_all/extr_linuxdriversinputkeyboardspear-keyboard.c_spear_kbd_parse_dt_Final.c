...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_kbd0 = 1;
          struct spear_kbd * kbd = (struct spear_kbd *) malloc(_len_kbd0*sizeof(struct spear_kbd));
          for(int _i0 = 0; _i0 < _len_kbd0; _i0++) {
            kbd->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = spear_kbd_parse_dt(pdev,kbd);
          printf("%d\n", benchRet); 
          free(pdev);
          free(kbd);
