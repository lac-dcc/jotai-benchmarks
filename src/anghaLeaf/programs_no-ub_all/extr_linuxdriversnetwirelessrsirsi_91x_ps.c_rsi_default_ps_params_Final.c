...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter->ps_info.enabled = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.deep_sleep_wakeup_period = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.num_dtims_per_sleep = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.dtim_interval_duration = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.num_bcns_per_lis_int = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.listen_interval = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.monitor_interval = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.rx_hysterisis = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.tx_hysterisis = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.rx_threshold = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.tx_threshold = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->ps_info.sleep_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
