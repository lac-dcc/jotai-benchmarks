...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_adjusted0 = 1;
          struct drm_display_mode * adjusted = (struct drm_display_mode *) malloc(_len_adjusted0*sizeof(struct drm_display_mode));
          for(int _i0 = 0; _i0 < _len_adjusted0; _i0++) {
            adjusted[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          rockchip_dp_drm_encoder_mode_set(encoder,mode,adjusted);
          free(encoder);
          free(mode);
          free(adjusted);
