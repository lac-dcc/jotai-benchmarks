...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q_vector0; _i0++) {
            q_vector->rx.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rc0 = 1;
          struct i40e_ring_container * rc = (struct i40e_ring_container *) malloc(_len_rc0*sizeof(struct i40e_ring_container));
          for(int _i0 = 0; _i0 < _len_rc0; _i0++) {
            rc->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = i40e_container_is_rx(q_vector,rc);
          printf("%d\n", benchRet); 
          free(q_vector);
          free(rc);
