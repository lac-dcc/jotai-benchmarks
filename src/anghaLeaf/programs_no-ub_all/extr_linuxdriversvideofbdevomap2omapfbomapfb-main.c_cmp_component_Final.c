...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f10; _i0++) {
            f1->length = ((-2 * (next_i()%2)) + 1) * next_i();
        f1->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        f1->msb_right = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_f20 = 1;
          struct fb_bitfield * f2 = (struct fb_bitfield *) malloc(_len_f20*sizeof(struct fb_bitfield));
          for(int _i0 = 0; _i0 < _len_f20; _i0++) {
            f2->length = ((-2 * (next_i()%2)) + 1) * next_i();
        f2->offset = ((-2 * (next_i()%2)) + 1) * next_i();
        f2->msb_right = ((-2 * (next_i()%2)) + 1) * next_i();
          }
