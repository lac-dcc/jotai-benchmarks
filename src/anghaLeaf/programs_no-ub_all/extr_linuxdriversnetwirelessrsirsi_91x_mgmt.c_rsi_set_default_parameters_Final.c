...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_common0; _i0++) {
            common->channel = ((-2 * (next_i()%2)) + 1) * next_i();
        common->min_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        common->iface_down = ((-2 * (next_i()%2)) + 1) * next_i();
        common->driver_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        common->ulp_ps_handshake_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        common->obm_ant_sel_val = ((-2 * (next_i()%2)) + 1) * next_i();
        common->dtim_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        common->beacon_interval = ((-2 * (next_i()%2)) + 1) * next_i();
        common->wlan_rf_power_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        common->rf_power_val = ((-2 * (next_i()%2)) + 1) * next_i();
        common->lp_ps_handshake_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        common->endpoint = ((-2 * (next_i()%2)) + 1) * next_i();
        common->fsm_state = ((-2 * (next_i()%2)) + 1) * next_i();
        common->rts_threshold = ((-2 * (next_i()%2)) + 1) * next_i();
        common->channel_width = ((-2 * (next_i()%2)) + 1) * next_i();
        common->band = ((-2 * (next_i()%2)) + 1) * next_i();
          }
