...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pxmitframe0; _i0++) {
            pxmitframe->attrib.encrypt = ((-2 * (next_i()%2)) + 1) * next_i();
        pxmitframe->attrib.icv_len = ((-2 * (next_i()%2)) + 1) * next_i();
        pxmitframe->attrib.bswenc = ((-2 * (next_i()%2)) + 1) * next_i();
        pxmitframe->attrib.pktlen = ((-2 * (next_i()%2)) + 1) * next_i();
        pxmitframe->attrib.iv_len = ((-2 * (next_i()%2)) + 1) * next_i();
        pxmitframe->attrib.hdrlen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
