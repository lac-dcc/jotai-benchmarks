...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_chan0; _i0++) {
            chan->scan_type.sign = ((-2 * (next_i()%2)) + 1) * next_i();
        chan->scan_type.realbits = ((-2 * (next_i()%2)) + 1) * next_i();
        chan->scan_type.storagebits = ((-2 * (next_i()%2)) + 1) * next_i();
        chan->scan_type.repeat = ((-2 * (next_i()%2)) + 1) * next_i();
          }
