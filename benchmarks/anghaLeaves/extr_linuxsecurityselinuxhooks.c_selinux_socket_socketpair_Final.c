...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          socka[_i0].sk->sk_security = (struct sk_security_struct *) malloc(_len_socka__i0__sk_sk_security0*sizeof(struct sk_security_struct));
          for(int _j0 = 0; _j0 < _len_socka__i0__sk_sk_security0; _j0++) {
            socka[_i0].sk->sk_security->sid = ((-2 * (next_i()%2)) + 1) * next_i();
        socka[_i0].sk->sk_security->peer_sid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_sockb0 = 1;
          ...
          sockb[_i0].sk->sk_security = (struct sk_security_struct *) malloc(_len_sockb__i0__sk_sk_security0*sizeof(struct sk_security_struct));
          for(int _j0 = 0; _j0 < _len_sockb__i0__sk_sk_security0; _j0++) {
            sockb[_i0].sk->sk_security->sid = ((-2 * (next_i()%2)) + 1) * next_i();
        sockb[_i0].sk->sk_security->peer_sid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = selinux_socket_socketpair(socka,sockb);
          printf("%d\n", benchRet); 
