...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int AddressingReset = 100;
        
          int benchRet = NeoNdisResetEx(MiniportAdapterContext,AddressingReset);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int AddressingReset = ((-2 * (next_i()%2)) + 1) * next_i();
