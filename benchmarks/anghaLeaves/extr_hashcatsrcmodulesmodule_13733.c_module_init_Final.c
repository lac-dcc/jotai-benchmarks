...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // ------------------------------- 
          // static_instructions_Os : 97
          // dynamic_instructions_Os : 97
          // ------------------------------- 
          // static_instructions_Oz : 97
