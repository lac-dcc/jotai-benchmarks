...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_marker0 = 1;
          struct bond_marker * marker = (struct bond_marker *) malloc(_len_marker0*sizeof(struct bond_marker));
          for(int _i0 = 0; _i0 < _len_marker0; _i0++) {
            marker[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_port0 = 1;
