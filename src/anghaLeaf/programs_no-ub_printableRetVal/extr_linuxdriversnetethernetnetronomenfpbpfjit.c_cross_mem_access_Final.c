...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_head_ld_meta0; _i0++) {
            head_ld_meta->ptr.type = ((-2 * (next_i()%2)) + 1) * next_i();
        head_ld_meta->ptr.id = ((-2 * (next_i()%2)) + 1) * next_i();
        head_ld_meta->ptr.off = ((-2 * (next_i()%2)) + 1) * next_i();
        head_ld_meta->insn.off = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_head_st_meta0; _i0++) {
            head_st_meta->ptr.type = ((-2 * (next_i()%2)) + 1) * next_i();
        head_st_meta->ptr.id = ((-2 * (next_i()%2)) + 1) * next_i();
        head_st_meta->ptr.off = ((-2 * (next_i()%2)) + 1) * next_i();
        head_st_meta->insn.off = ((-2 * (next_i()%2)) + 1) * next_i();
          }
