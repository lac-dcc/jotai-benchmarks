...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // ------------------------------- 
          // static_instructions_O1 : 128
          // dynamic_instructions_O1 : 128
          // ------------------------------- 
          // static_instructions_O2 : 125
          // dynamic_instructions_O2 : 125
          // ------------------------------- 
          // static_instructions_O3 : 125
          ...
          // ------------------------------- 
          // static_instructions_Oz : 125
          // dynamic_instructions_Oz : 125
          // ------------------------------- 
          ...
          int benchRet = hkscs2008_wctomb(conv,r,wc,n);
          printf("%d\n", benchRet); 
          free(r);
