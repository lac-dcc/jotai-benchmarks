...
#define  BFI_ASIC_GEN_CT2 128 
 int /*<<< orphan*/  bfi_image_cb_size ; 
 int /*<<< orphan*/  bfi_image_ct2_size ; 
 int /*<<< orphan*/  bfi_image_ct_size ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum bfi_asic_gen asic_gen = 0;
          int benchRet = bfa_cb_image_get_size(asic_gen);
          printf("%d\n", benchRet); 
