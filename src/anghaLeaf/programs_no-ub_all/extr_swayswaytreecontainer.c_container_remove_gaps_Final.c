...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c->current_gaps.top = ((-2 * (next_i()%2)) + 1) * next_i();
        c->current_gaps.right = ((-2 * (next_i()%2)) + 1) * next_i();
        c->current_gaps.bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        c->current_gaps.left = ((-2 * (next_i()%2)) + 1) * next_i();
        c->y = ((-2 * (next_i()%2)) + 1) * next_i();
        c->x = ((-2 * (next_i()%2)) + 1) * next_i();
