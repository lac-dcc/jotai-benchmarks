...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s->num_blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        s->fbw_channels = ((-2 * (next_i()%2)) + 1) * next_i();
        s->num_blks_code = ((-2 * (next_i()%2)) + 1) * next_i();
        s->channel_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        s->frame_bits_fixed = ((-2 * (next_i()%2)) + 1) * next_i();
        s->eac3 = ((-2 * (next_i()%2)) + 1) * next_i();
        s->lfe_on = ((-2 * (next_i()%2)) + 1) * next_i();
        s->use_frame_exp_strategy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
