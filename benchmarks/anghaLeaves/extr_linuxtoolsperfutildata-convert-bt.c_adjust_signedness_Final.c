...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long long value_int = 100;
        
          int size = 100;
        
          unsigned long long benchRet = adjust_signedness(value_int,size);
          printf("%llu\n", benchRet); 
    ...
    case 1:
    {
          ...
          unsigned long long value_int = 255;
    ...
    case 2:
    {
          ...
          unsigned long long value_int = 10;
    ...
    case 3:
    {
          ...
          unsigned long long value_int = ((-2 * (next_i()%2)) + 1) * next_i();
