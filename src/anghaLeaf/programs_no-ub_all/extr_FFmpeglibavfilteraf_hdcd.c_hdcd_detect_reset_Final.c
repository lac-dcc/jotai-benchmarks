...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_detect0; _i0++) {
            detect->max_gain_adjustment = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        detect->cdt_expirations = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->_active_count = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->uses_transient_filter = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->peak_extend = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->errors = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->total_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->packet_type = ((-2 * (next_i()%2)) + 1) * next_i();
        detect->hdcd_detected = ((-2 * (next_i()%2)) + 1) * next_i();
          }
