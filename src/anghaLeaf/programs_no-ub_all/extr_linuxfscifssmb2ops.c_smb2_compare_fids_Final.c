...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ob10; _i0++) {
            ob1->fid.persistent_fid = ((-2 * (next_i()%2)) + 1) * next_i();
        ob1->fid.volatile_fid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ob20 = 1;
          struct cifsFileInfo * ob2 = (struct cifsFileInfo *) malloc(_len_ob20*sizeof(struct cifsFileInfo));
          for(int _i0 = 0; _i0 < _len_ob20; _i0++) {
            ob2->fid.persistent_fid = ((-2 * (next_i()%2)) + 1) * next_i();
        ob2->fid.volatile_fid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
