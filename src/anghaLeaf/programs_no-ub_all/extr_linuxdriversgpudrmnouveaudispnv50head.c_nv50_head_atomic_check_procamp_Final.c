...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_armh0; _i0++) {
            armh->set.procamp = ((-2 * (next_i()%2)) + 1) * next_i();
        armh->procamp.sat.cos = ((-2 * (next_i()%2)) + 1) * next_i();
        armh->procamp.sat.sin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_asyh0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_asyh0; _i0++) {
            asyh->set.procamp = ((-2 * (next_i()%2)) + 1) * next_i();
        asyh->procamp.sat.cos = ((-2 * (next_i()%2)) + 1) * next_i();
        asyh->procamp.sat.sin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_asyc0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_asyc0; _i0++) {
            asyc->procamp.color_vibrance = ((-2 * (next_i()%2)) + 1) * next_i();
        asyc->procamp.vibrant_hue = ((-2 * (next_i()%2)) + 1) * next_i();
          }
