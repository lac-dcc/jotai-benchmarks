...
/* Variables and functions */
 int /*<<< orphan*/  _STATIC_org_apache_harmony_luni_platform_INetworkSystem_SOCKET_CONNECT_STEP_CHECK ; 
...
int main(int argc, char *argv[]) {
    ...
    {
          int v = 100;
          org_apache_harmony_luni_platform_INetworkSystem_PUT_SOCKET_CONNECT_STEP_CHECK(v);
