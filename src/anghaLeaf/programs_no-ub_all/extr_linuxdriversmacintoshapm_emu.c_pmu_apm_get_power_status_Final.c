...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->battery_life = ((-2 * (next_i()%2)) + 1) * next_i();
        info->time = ((-2 * (next_i()%2)) + 1) * next_i();
        info->battery_flag = ((-2 * (next_i()%2)) + 1) * next_i();
        info->battery_status = ((-2 * (next_i()%2)) + 1) * next_i();
        info->units = ((-2 * (next_i()%2)) + 1) * next_i();
          }
