...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_host0; _i0++) {
            host->sg_off = ((-2 * (next_i()%2)) + 1) * next_i();
        host->sg_orig = ((-2 * (next_i()%2)) + 1) * next_i();
        host->sg_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
        host->sg_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_data0 = 1;
          struct mmc_data * data = (struct mmc_data *) malloc(_len_data0*sizeof(struct mmc_data));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->sg = ((-2 * (next_i()%2)) + 1) * next_i();
        data->sg_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
