...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sa0; _i0++) {
            sa->sa_command_1.bf.crypto_mode31 = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.crypto_mode9_8 = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.feedback_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.sa_rev = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.hmac_muting = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.extended_seq_num = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.seq_num_mask = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.mutable_bit_proc = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.copy_pad = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.copy_payload = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.bf.copy_hdr = ((-2 * (next_i()%2)) + 1) * next_i();
        sa->sa_command_1.w = ((-2 * (next_i()%2)) + 1) * next_i();
          }
