...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nn0; _i0++) {
              nn[_i0].rx_coalesce_usecs = ((-2 * (next_i()%2)) + 1) * next_i();
          nn[_i0].rx_coalesce_max_frames = ((-2 * (next_i()%2)) + 1) * next_i();
          nn[_i0].tx_coalesce_usecs = ((-2 * (next_i()%2)) + 1) * next_i();
          nn[_i0].tx_coalesce_max_frames = ((-2 * (next_i()%2)) + 1) * next_i();
