...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->reply_agg_tx_stats.unknown = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.delay_tx = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.dump_tx = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.response = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.bad_crc32 = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.scd_query = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.last_sent_bt_kill = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.last_sent_try = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.last_sent_ttl = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.abort = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.few_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.bt_prio = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->reply_agg_tx_stats.underrun = ((-2 * (next_i()%2)) + 1) * next_i();
          }
