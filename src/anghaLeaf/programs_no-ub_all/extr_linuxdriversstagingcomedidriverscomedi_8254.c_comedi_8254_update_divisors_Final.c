...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_i82540; _i0++) {
            i8254->divisor = ((-2 * (next_i()%2)) + 1) * next_i();
        i8254->next_div = ((-2 * (next_i()%2)) + 1) * next_i();
        i8254->divisor1 = ((-2 * (next_i()%2)) + 1) * next_i();
        i8254->next_div1 = ((-2 * (next_i()%2)) + 1) * next_i();
        i8254->divisor2 = ((-2 * (next_i()%2)) + 1) * next_i();
        i8254->next_div2 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
