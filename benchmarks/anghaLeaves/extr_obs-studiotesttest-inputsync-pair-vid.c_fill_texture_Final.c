...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 12617
          // ------------------------------- 
          // static_instructions_O1 : 17
          // dynamic_instructions_O1 : 4326
          // ------------------------------- 
          ...
          // dynamic_instructions_Os : 1191
          // ------------------------------- 
          // static_instructions_Oz : 16
          // dynamic_instructions_Oz : 5383
          // ------------------------------- 

          int pixel = 255;
        
          int _len_pixels0 = 65025;
          int * pixels = (int *) malloc(_len_pixels0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pixels0; _i0++) {
            pixels[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          fill_texture(pixels,pixel);
          free(pixels);
