...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ds[_i0].priv = (struct mv88e6xxx_chip *) malloc(_len_ds__i0__priv0*sizeof(struct mv88e6xxx_chip));
          for(int _j0 = 0; _j0 < _len_ds__i0__priv0; _j0++) {
            ds[_i0].priv->eeprom_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = mv88e6xxx_get_eeprom_len(ds);
          printf("%d\n", benchRet); 
