...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long intparm = 100;
        
          int benchRet = qeth_intparm_is_iob(intparm);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned long intparm = ((-2 * (next_i()%2)) + 1) * next_i();
