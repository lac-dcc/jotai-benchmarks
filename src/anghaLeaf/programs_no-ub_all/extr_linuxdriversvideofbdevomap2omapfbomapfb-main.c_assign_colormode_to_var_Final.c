...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_var0; _i0++) {
            var->transp = ((-2 * (next_i()%2)) + 1) * next_i();
        var->blue = ((-2 * (next_i()%2)) + 1) * next_i();
        var->green = ((-2 * (next_i()%2)) + 1) * next_i();
        var->red = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        var->bits_per_pixel = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_color0; _i0++) {
            color->transp = ((-2 * (next_i()%2)) + 1) * next_i();
        color->blue = ((-2 * (next_i()%2)) + 1) * next_i();
        color->green = ((-2 * (next_i()%2)) + 1) * next_i();
        color->red = ((-2 * (next_i()%2)) + 1) * next_i();
        color->nonstd = ((-2 * (next_i()%2)) + 1) * next_i();
        color->bits_per_pixel = ((-2 * (next_i()%2)) + 1) * next_i();
          }
