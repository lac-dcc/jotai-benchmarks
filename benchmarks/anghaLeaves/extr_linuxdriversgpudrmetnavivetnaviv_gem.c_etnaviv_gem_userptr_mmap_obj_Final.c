...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_etnaviv_obj0 = 65025;
          struct etnaviv_gem_object * etnaviv_obj = (struct etnaviv_gem_object *) malloc(_len_etnaviv_obj0*sizeof(struct etnaviv_gem_object));
          for(int _i0 = 0; _i0 < _len_etnaviv_obj0; _i0++) {
              etnaviv_obj[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = etnaviv_gem_userptr_mmap_obj(etnaviv_obj,vma);
          printf("%d\n", benchRet); 
          free(etnaviv_obj);
          free(vma);
