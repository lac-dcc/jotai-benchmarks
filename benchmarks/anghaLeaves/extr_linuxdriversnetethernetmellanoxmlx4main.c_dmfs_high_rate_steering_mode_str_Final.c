...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int dmfs_high_steer_mode = 100;
        
          const char * benchRet = dmfs_high_rate_steering_mode_str(dmfs_high_steer_mode);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
    ...
    case 3:
    {
          ...
          int dmfs_high_steer_mode = ((-2 * (next_i()%2)) + 1) * next_i();
