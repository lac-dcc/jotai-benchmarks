...
__attribute__((used)) static inline u8 dwc2_hcd_is_pipe_isoc(struct dwc2_hcd_pipe_info *pipe)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pipe0; _i0++) {
            pipe[_i0].pipe_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = dwc2_hcd_is_pipe_isoc(pipe);
          printf("%d\n", benchRet); 
          free(pipe);
