...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_vrf_dev0 = 1;
          struct net_device * vrf_dev = (struct net_device *) malloc(_len_vrf_dev0*sizeof(struct net_device));
          for(int _i0 = 0; _i0 < _len_vrf_dev0; _i0++) {
            vrf_dev[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_sk0 = 1;
          ...
          struct sk_buff * benchRet = vrf_ip6_out(vrf_dev,sk,skb);
          printf("%d\n", (*benchRet).dummy);
          free(vrf_dev);
          free(sk);
          free(skb);
