...
__attribute__((used)) static int dib3000mc_fe_get_tune_settings(struct dvb_frontend* fe, struct dvb_frontend_tune_settings *tune)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tune0; _i0++) {
            tune->min_delay_ms = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = dib3000mc_fe_get_tune_settings(fe,tune);
          printf("%d\n", benchRet); 
          free(fe);
          free(tune);
