...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->generic.strdup_strings = ((-2 * (next_i()%2)) + 1) * next_i();
        data->r_branch.strdup_strings = ((-2 * (next_i()%2)) + 1) * next_i();
        data->tag.strdup_strings = ((-2 * (next_i()%2)) + 1) * next_i();
        data->branch.strdup_strings = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          init_src_data(data);
          free(data);
