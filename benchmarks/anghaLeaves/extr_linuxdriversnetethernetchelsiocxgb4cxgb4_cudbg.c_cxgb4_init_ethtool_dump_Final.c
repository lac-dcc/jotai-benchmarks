...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter[_i0].eth_dump.len = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter[_i0].eth_dump.version = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter[_i0].eth_dump.flag = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter[_i0].params.fw_vers = ((-2 * (next_i()%2)) + 1) * next_i();
          }
