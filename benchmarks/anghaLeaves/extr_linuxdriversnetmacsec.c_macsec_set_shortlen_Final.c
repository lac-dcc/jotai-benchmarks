...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_h0 = 1;
          struct macsec_eth_header * h = (struct macsec_eth_header *) malloc(_len_h0*sizeof(struct macsec_eth_header));
          for(int _i0 = 0; _i0 < _len_h0; _i0++) {
              h[_i0].short_length = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          macsec_set_shortlen(h,data_len);
          free(h);
    ...
    case 3:
    {
          ...
          unsigned long data_len = ((-2 * (next_i()%2)) + 1) * next_i();
