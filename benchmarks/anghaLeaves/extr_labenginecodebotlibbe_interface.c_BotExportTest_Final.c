...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int parm3 = 100;
          int _len_parm10 = 1;
          char * parm1 = (char *) malloc(_len_parm10*sizeof(char));
          for(int _i0 = 0; _i0 < _len_parm10; _i0++) {
            parm1[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = BotExportTest(parm0,parm1,parm2,parm3);
          printf("%d\n", benchRet); 
          free(parm1);
