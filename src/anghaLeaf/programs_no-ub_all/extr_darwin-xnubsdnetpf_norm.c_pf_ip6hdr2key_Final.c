...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_key0; _i0++) {
            key->fr_dstx.v6addr = ((-2 * (next_i()%2)) + 1) * next_i();
        key->fr_srcx.v6addr = ((-2 * (next_i()%2)) + 1) * next_i();
        key->fr_af = ((-2 * (next_i()%2)) + 1) * next_i();
        key->fr_id6 = ((-2 * (next_i()%2)) + 1) * next_i();
        key->fr_p = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_ip60; _i0++) {
            ip6->ip6_dst = ((-2 * (next_i()%2)) + 1) * next_i();
        ip6->ip6_src = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_fh0 = 1;
          struct ip6_frag * fh = (struct ip6_frag *) malloc(_len_fh0*sizeof(struct ip6_frag));
          for(int _i0 = 0; _i0 < _len_fh0; _i0++) {
            fh->ip6f_ident = ((-2 * (next_i()%2)) + 1) * next_i();
        fh->ip6f_nxt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
