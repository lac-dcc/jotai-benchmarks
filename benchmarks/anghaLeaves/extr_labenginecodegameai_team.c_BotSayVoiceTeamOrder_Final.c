...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_voicechat0 = 1;
          char * voicechat = (char *) malloc(_len_voicechat0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_voicechat0; _i0++) {
            voicechat[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          BotSayVoiceTeamOrder(bs,toclient,voicechat);
          free(bs);
          free(voicechat);
