...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->max_eq = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->base_eqid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_conf0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_conf0; _i0++) {
            conf->fn_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        conf->max_eq = ((-2 * (next_i()%2)) + 1) * next_i();
        conf->base_eqid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
