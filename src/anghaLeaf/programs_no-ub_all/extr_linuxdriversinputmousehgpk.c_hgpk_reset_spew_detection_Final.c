...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->spew_flag = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->y_tally = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->x_tally = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->dupe_count = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->spew_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
