...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_evsel0; _i0++) {
            evsel->attr.exclude_idle = ((-2 * (next_i()%2)) + 1) * next_i();
        evsel->attr.exclude_host = ((-2 * (next_i()%2)) + 1) * next_i();
        evsel->attr.exclude_hv = ((-2 * (next_i()%2)) + 1) * next_i();
        evsel->attr.exclude_user = ((-2 * (next_i()%2)) + 1) * next_i();
        evsel->attr.exclude_kernel = ((-2 * (next_i()%2)) + 1) * next_i();
          }
