...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tmr0; _i0++) {
            tmr->tick.fraction = ((-2 * (next_i()%2)) + 1) * next_i();
        tmr->tick.cur_tick = ((-2 * (next_i()%2)) + 1) * next_i();
        tmr->cur_time.tv_nsec = ((-2 * (next_i()%2)) + 1) * next_i();
        tmr->cur_time.tv_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          seq_timer_reset(tmr);
          free(tmr);
