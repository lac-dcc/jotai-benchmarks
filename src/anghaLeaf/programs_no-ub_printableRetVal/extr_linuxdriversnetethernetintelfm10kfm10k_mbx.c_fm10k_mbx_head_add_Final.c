...
__attribute__((used)) static u16 fm10k_mbx_head_add(struct fm10k_mbx_info *mbx, u16 offset)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_mbx0; _i0++) {
            mbx->head = ((-2 * (next_i()%2)) + 1) * next_i();
        mbx->mbmem_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = fm10k_mbx_head_add(mbx,offset);
          printf("%d\n", benchRet); 
          free(mbx);
