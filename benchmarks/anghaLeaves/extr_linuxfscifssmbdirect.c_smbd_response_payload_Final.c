...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct smbd_response * response = (struct smbd_response *) malloc(_len_response0*sizeof(struct smbd_response));
          for(int _i0 = 0; _i0 < _len_response0; _i0++) {
            response[_i0].packet = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = smbd_response_payload(response);
          free(response);
