...
/* Type definitions */
struct TYPE_3__ {int is_dirty; scalar_t__ history_line_added_count; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
            self[_i0].is_dirty = ((-2 * (next_i()%2)) + 1) * next_i();
        self[_i0].history_line_added_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
