...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_header0; _i0++) {
            header->Layer_nb = ((-2 * (next_i()%2)) + 1) * next_i();
        header->Msg_length = ((-2 * (next_i()%2)) + 1) * next_i();
        header->Msg_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        header->CSn_Id = ((-2 * (next_i()%2)) + 1) * next_i();
        header->Class_Id = ((-2 * (next_i()%2)) + 1) * next_i();
        header->last_byte = ((-2 * (next_i()%2)) + 1) * next_i();
        header->Id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
