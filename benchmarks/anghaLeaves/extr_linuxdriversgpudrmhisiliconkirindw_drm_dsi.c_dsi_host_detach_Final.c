...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_mdsi0 = 1;
          struct mipi_dsi_device * mdsi = (struct mipi_dsi_device *) malloc(_len_mdsi0*sizeof(struct mipi_dsi_device));
          for(int _i0 = 0; _i0 < _len_mdsi0; _i0++) {
            mdsi[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = dsi_host_detach(host,mdsi);
          printf("%d\n", benchRet); 
          free(host);
          free(mdsi);
