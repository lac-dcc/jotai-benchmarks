...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ifs0; _i0++) {
            ifs->srtt = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->rttupdated = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->rttvar = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->connreset = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->sack_recovery_episodes = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->dsack_recvd = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->dsack_sent = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->pawsdrop = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->reordered_pkts = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->rcvoopack = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->rxmitpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->rxpackets = ((-2 * (next_i()%2)) + 1) * next_i();
        ifs->txpackets = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_stat0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_stat0; _i0++) {
            stat->rtt_avg = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->rtt_var = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->rst_drop = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->sack_episodes = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->total_reorderpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->total_oopkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->total_rxmitpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->total_rxpkts = ((-2 * (next_i()%2)) + 1) * next_i();
        stat->total_txpkts = ((-2 * (next_i()%2)) + 1) * next_i();
          }
