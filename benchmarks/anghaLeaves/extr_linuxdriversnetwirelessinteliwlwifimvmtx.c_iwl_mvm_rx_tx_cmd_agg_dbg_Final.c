...
__attribute__((used)) static void iwl_mvm_rx_tx_cmd_agg_dbg(struct iwl_mvm *mvm,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pkt0 = 1;
          struct iwl_rx_packet * pkt = (struct iwl_rx_packet *) malloc(_len_pkt0*sizeof(struct iwl_rx_packet));
