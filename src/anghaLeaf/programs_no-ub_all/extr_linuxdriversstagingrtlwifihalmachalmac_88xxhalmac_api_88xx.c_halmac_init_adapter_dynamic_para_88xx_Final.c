...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_halmac_adapter0; _i0++) {
            halmac_adapter->gen_info_valid = ((-2 * (next_i()%2)) + 1) * next_i();
        halmac_adapter->h2c_buf_free_space = ((-2 * (next_i()%2)) + 1) * next_i();
        halmac_adapter->h2c_packet_seq = ((-2 * (next_i()%2)) + 1) * next_i();
          }
