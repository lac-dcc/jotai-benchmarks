...
__attribute__((used)) static BOOL glsl_fragment_pipe_alloc_context_data(struct wined3d_context *context)
{
    return TRUE;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = glsl_fragment_pipe_alloc_context_data(context);
          printf("%d\n", benchRet); 
          free(context);
