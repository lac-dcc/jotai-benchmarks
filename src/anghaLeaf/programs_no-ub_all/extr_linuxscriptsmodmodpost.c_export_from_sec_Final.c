...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_elf0; _i0++) {
            elf->export_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf->export_unused_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf->export_gpl_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf->export_unused_gpl_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        elf->export_gpl_future_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
