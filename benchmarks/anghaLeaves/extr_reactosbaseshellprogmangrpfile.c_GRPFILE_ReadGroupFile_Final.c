...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int bIsCommonGroup = 100;
        
          int benchRet = GRPFILE_ReadGroupFile(lpszPath,bIsCommonGroup);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int lpszPath = ((-2 * (next_i()%2)) + 1) * next_i();
        
          int bIsCommonGroup = ((-2 * (next_i()%2)) + 1) * next_i();
