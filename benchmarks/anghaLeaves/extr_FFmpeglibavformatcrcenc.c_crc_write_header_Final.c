...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_s0 = 1;
          struct AVFormatContext * s = (struct AVFormatContext *) malloc(_len_s0*sizeof(struct AVFormatContext));
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
              int _len_s__i0__priv_data0 = 1;
          s[_i0].priv_data = (struct TYPE_2__ *) malloc(_len_s__i0__priv_data0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_s__i0__priv_data0; _j0++) {
            s[_i0].priv_data->crcval = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = crc_write_header(s);
          printf("%d\n", benchRet); 
