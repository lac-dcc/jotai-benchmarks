...
__attribute__((used)) static inline void reset_switch_active(struct spu_state *csa, struct spu *spu)
{
	/* Restore, Step 74:
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_csa0; _i0++) {
            csa[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_spu0 = 1;
