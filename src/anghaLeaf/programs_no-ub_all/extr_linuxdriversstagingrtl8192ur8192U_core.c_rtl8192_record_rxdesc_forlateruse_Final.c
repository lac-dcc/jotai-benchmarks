...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_psrc_stats0; _i0++) {
            psrc_stats->Seq_Num = ((-2 * (next_i()%2)) + 1) * next_i();
        psrc_stats->bFirstMPDU = ((-2 * (next_i()%2)) + 1) * next_i();
        psrc_stats->bIsAMPDU = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_ptarget_stats0; _i0++) {
            ptarget_stats->Seq_Num = ((-2 * (next_i()%2)) + 1) * next_i();
        ptarget_stats->bFirstMPDU = ((-2 * (next_i()%2)) + 1) * next_i();
        ptarget_stats->bIsAMPDU = ((-2 * (next_i()%2)) + 1) * next_i();
          }
