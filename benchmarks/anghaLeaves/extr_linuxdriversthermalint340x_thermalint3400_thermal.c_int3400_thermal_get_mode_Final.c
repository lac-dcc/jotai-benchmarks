...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          thermal[_i0].devdata = (struct int3400_thermal_priv *) malloc(_len_thermal__i0__devdata0*sizeof(struct int3400_thermal_priv));
          for(int _j0 = 0; _j0 < _len_thermal__i0__devdata0; _j0++) {
              thermal[_i0].devdata->mode = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = int3400_thermal_get_mode(thermal,mode);
          printf("%d\n", benchRet); 
