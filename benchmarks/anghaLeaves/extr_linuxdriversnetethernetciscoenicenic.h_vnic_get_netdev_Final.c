...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vdev[_i0].priv = (struct enic *) malloc(_len_vdev__i0__priv0*sizeof(struct enic));
          for(int _j0 = 0; _j0 < _len_vdev__i0__priv0; _j0++) {
              int _len_vdev__i0__priv_netdev0 = 1;
          vdev[_i0].priv->netdev = (struct net_device *) malloc(_len_vdev__i0__priv_netdev0*sizeof(struct net_device));
          for(int _j0 = 0; _j0 < _len_vdev__i0__priv_netdev0; _j0++) {
            vdev[_i0].priv->netdev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct net_device * benchRet = vnic_get_netdev(vdev);
          printf("%d\n", (*benchRet).dummy);
