...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params->is_64bit = ((-2 * (next_i()%2)) + 1) * next_i();
        params->CRn = ((-2 * (next_i()%2)) + 1) * next_i();
        params->CRm = ((-2 * (next_i()%2)) + 1) * next_i();
        params->Op1 = ((-2 * (next_i()%2)) + 1) * next_i();
        params->Op2 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
