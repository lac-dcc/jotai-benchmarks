...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dp0; _i0++) {
            dp->context_bi = ((-2 * (next_i()%2)) + 1) * next_i();
        dp->context_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
        dp->next_page = ((-2 * (next_i()%2)) + 1) * next_i();
        dp->get_page = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_bio0 = 1;
        ...
        bio->bi_io_vec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          bio_dp_init(dp,bio);
          free(dp);
          free(bio);
