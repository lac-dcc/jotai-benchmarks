...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pll0 = 1;
          struct intel_shared_dpll * pll = (struct intel_shared_dpll *) malloc(_len_pll0*sizeof(struct intel_shared_dpll));
          for(int _i0 = 0; _i0 < _len_pll0; _i0++) {
            pll[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_hw_state0 = 1;
          struct intel_dpll_hw_state * hw_state = (struct intel_dpll_hw_state *) malloc(_len_hw_state0*sizeof(struct intel_dpll_hw_state));
          for(int _i0 = 0; _i0 < _len_hw_state0; _i0++) {
            hw_state[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = hsw_ddi_lcpll_get_hw_state(dev_priv,pll,hw_state);
          printf("%d\n", benchRet); 
          free(dev_priv);
          free(pll);
          free(hw_state);
