...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->hbm_f_pg_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_dc_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_ie_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_dot_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_ev_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_fa_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_os_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->hbm_f_dr_supported = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->version.major_version = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->version.minor_version = ((-2 * (next_i()%2)) + 1) * next_i();
          }
