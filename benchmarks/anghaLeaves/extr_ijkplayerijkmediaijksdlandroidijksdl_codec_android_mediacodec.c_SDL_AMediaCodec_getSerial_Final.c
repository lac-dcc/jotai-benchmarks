...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_acodec0 = 1;
          struct TYPE_3__ * acodec = (struct TYPE_3__ *) malloc(_len_acodec0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_acodec0; _i0++) {
            acodec[_i0].object_serial = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = SDL_AMediaCodec_getSerial(acodec);
          printf("%d\n", benchRet); 
          free(acodec);
