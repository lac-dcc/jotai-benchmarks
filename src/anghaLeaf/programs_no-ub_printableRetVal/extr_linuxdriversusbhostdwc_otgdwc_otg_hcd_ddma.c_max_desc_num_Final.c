...
struct TYPE_3__ {scalar_t__ ep_type; scalar_t__ dev_speed; } ;
...
__attribute__((used)) static inline uint16_t max_desc_num(dwc_otg_qh_t * qh)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_qh0; _i0++) {
            qh->ep_type = ((-2 * (next_i()%2)) + 1) * next_i();
        qh->dev_speed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
