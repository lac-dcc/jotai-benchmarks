...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_kn0; _i0++) {
            kn->kn_sfflags = ((-2 * (next_i()%2)) + 1) * next_i();
        kn->kn_hookid = ((-2 * (next_i()%2)) + 1) * next_i();
        kn->kn_sdata = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_kev0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_kev0; _i0++) {
            kev->fflags = ((-2 * (next_i()%2)) + 1) * next_i();
        kev->data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
