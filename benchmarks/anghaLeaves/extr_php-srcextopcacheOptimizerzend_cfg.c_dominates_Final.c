...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * blocks = (struct TYPE_3__ *) malloc(_len_blocks0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_blocks0; _i0++) {
              blocks[_i0].level = ((-2 * (next_i()%2)) + 1) * next_i();
          blocks[_i0].idom = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = dominates(blocks,a,b);
          printf("%d\n", benchRet); 
          free(blocks);
