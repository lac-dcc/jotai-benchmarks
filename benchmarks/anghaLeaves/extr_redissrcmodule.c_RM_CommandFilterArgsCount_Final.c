...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_fctx0 = 1;
          struct TYPE_3__ * fctx = (struct TYPE_3__ *) malloc(_len_fctx0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_fctx0; _i0++) {
            fctx[_i0].argc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = RM_CommandFilterArgsCount(fctx);
          printf("%d\n", benchRet); 
          free(fctx);
