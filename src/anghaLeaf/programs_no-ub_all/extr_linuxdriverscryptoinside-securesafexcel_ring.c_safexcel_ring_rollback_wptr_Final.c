...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ring0; _i0++) {
            ring->write = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->read = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->base = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->base_end = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
