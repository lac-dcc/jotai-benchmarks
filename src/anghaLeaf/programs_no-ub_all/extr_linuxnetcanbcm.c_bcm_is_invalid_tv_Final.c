...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_msg_head0; _i0++) {
            msg_head->ival2.tv_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        msg_head->ival2.tv_usec = ((-2 * (next_i()%2)) + 1) * next_i();
        msg_head->ival1.tv_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        msg_head->ival1.tv_usec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
