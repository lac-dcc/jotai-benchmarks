...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_port0; _i0++) {
            port->disc_addr.tsas.rdma.cms = ((-2 * (next_i()%2)) + 1) * next_i();
        port->disc_addr.tsas.rdma.prtype = ((-2 * (next_i()%2)) + 1) * next_i();
        port->disc_addr.tsas.rdma.qptype = ((-2 * (next_i()%2)) + 1) * next_i();
          }
