...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_DCMI_InitStruct0; _i0++) {
            DCMI_InitStruct->DCMI_ExtendedDataMode = ((-2 * (next_i()%2)) + 1) * next_i();
        DCMI_InitStruct->DCMI_CaptureRate = ((-2 * (next_i()%2)) + 1) * next_i();
        DCMI_InitStruct->DCMI_HSPolarity = ((-2 * (next_i()%2)) + 1) * next_i();
        DCMI_InitStruct->DCMI_VSPolarity = ((-2 * (next_i()%2)) + 1) * next_i();
        DCMI_InitStruct->DCMI_PCKPolarity = ((-2 * (next_i()%2)) + 1) * next_i();
        DCMI_InitStruct->DCMI_SynchroMode = ((-2 * (next_i()%2)) + 1) * next_i();
        DCMI_InitStruct->DCMI_CaptureMode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
