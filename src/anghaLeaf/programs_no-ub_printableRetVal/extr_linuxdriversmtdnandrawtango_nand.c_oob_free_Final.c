...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_res0 = 1;
          struct mtd_oob_region * res = (struct mtd_oob_region *) malloc(_len_res0*sizeof(struct mtd_oob_region));
          for(int _i0 = 0; _i0 < _len_res0; _i0++) {
            res->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = oob_free(mtd,idx,res);
          printf("%d\n", benchRet); 
          free(mtd);
          free(res);
