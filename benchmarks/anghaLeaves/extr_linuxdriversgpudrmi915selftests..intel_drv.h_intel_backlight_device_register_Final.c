...
__attribute__((used)) static inline int intel_backlight_device_register(struct intel_connector *connector)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = intel_backlight_device_register(connector);
          printf("%d\n", benchRet); 
          free(connector);
