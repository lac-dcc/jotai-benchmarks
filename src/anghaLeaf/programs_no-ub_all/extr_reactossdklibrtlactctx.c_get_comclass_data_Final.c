...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_actctx0 = 1;
          struct TYPE_3__ * actctx = (struct TYPE_3__ *) malloc(_len_actctx0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_actctx0; _i0++) {
            actctx->comserver_section = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_index0 = 1;
          struct guid_index * index = (struct guid_index *) malloc(_len_index0*sizeof(struct guid_index));
          for(int _i0 = 0; _i0 < _len_index0; _i0++) {
            index->data_offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct comclassredirect_data * benchRet = get_comclass_data(actctx,index);
          printf("{{struct}} %p\n", &benchRet); 
          free(actctx);
          free(index);
