...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params->disable_literal_context_modeling = ((-2 * (next_i()%2)) + 1) * next_i();
        params->size_hint = ((-2 * (next_i()%2)) + 1) * next_i();
        params->lgblock = ((-2 * (next_i()%2)) + 1) * next_i();
        params->lgwin = ((-2 * (next_i()%2)) + 1) * next_i();
        params->quality = ((-2 * (next_i()%2)) + 1) * next_i();
        params->mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
