...
__attribute__((used)) static void fixed_400mhz_get_cdclk(struct drm_i915_private *dev_priv,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev_priv0; _i0++) {
            dev_priv->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_cdclk_state0; _i0++) {
            cdclk_state->cdclk = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          fixed_400mhz_get_cdclk(dev_priv,cdclk_state);
          free(dev_priv);
          free(cdclk_state);
