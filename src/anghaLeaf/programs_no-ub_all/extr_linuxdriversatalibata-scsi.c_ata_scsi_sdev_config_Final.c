...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sdev0; _i0++) {
            sdev->use_10_for_rw = ((-2 * (next_i()%2)) + 1) * next_i();
        sdev->use_10_for_ms = ((-2 * (next_i()%2)) + 1) * next_i();
        sdev->no_write_same = ((-2 * (next_i()%2)) + 1) * next_i();
        sdev->max_device_blocked = ((-2 * (next_i()%2)) + 1) * next_i();
          }
