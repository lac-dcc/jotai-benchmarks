...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_server0; _i0++) {
            server->negflavor = ((-2 * (next_i()%2)) + 1) * next_i();
        server->sec_mskerberos = ((-2 * (next_i()%2)) + 1) * next_i();
        server->sec_kerberos = ((-2 * (next_i()%2)) + 1) * next_i();
        server->sec_ntlmssp = ((-2 * (next_i()%2)) + 1) * next_i();
          }
