...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_real_rate0 = 1;
          unsigned int * real_rate = (unsigned int *) malloc(_len_real_rate0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_real_rate0; _i0++) {
            real_rate[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          unsigned int benchRet = snd_cs4281_rate(rate,real_rate);
          printf("%u\n", benchRet); 
          free(real_rate);
