...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          double * array = (double *) malloc(_len_array0*sizeof(double));
          for(int _i0 = 0; _i0 < _len_array0; _i0++) {
            array[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
