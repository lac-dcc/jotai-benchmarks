...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int reg_idx = 100;
        
          unsigned int benchRet = get_offset_reg(table,reg_idx);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int table = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int reg_idx = ((-2 * (next_i()%2)) + 1) * next_i();
