...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx->a = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->b = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->c = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->d = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->e = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->bytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ngx_sha1_init(ctx);
          free(ctx);
