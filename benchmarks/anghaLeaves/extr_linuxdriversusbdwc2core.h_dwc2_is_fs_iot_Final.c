...
__attribute__((used)) static inline bool dwc2_is_fs_iot(struct dwc2_hsotg *hsotg)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hsotg0; _i0++) {
            hsotg[_i0].hw_params.snpsid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = dwc2_is_fs_iot(hsotg);
          printf("%d\n", benchRet); 
          free(hsotg);
