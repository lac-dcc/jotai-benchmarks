...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_link0; _i0++) {
            link->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_source_fmt0; _i0++) {
            source_fmt->format.width = ((-2 * (next_i()%2)) + 1) * next_i();
        source_fmt->format.height = ((-2 * (next_i()%2)) + 1) * next_i();
        source_fmt->format.code = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_sink_fmt0; _i0++) {
            sink_fmt->format.width = ((-2 * (next_i()%2)) + 1) * next_i();
        sink_fmt->format.height = ((-2 * (next_i()%2)) + 1) * next_i();
        sink_fmt->format.code = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = resizer_link_validate(sd,link,source_fmt,sink_fmt);
          printf("%d\n", benchRet); 
          free(sd);
          free(link);
          free(source_fmt);
