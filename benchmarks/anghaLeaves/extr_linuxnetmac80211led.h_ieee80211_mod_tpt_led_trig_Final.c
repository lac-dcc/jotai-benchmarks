...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned int types_on = 100;
          unsigned int types_off = 100;
          int _len_local0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_local0; _i0++) {
            local[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ieee80211_mod_tpt_led_trig(local,types_on,types_off);
          free(local);
    ...
    case 1:
    {
          unsigned int types_on = 10;
          unsigned int types_off = 10;
          int _len_local0 = 100;
          struct ieee80211_local * local = (struct ieee80211_local *) malloc(_len_local0*sizeof(struct ieee80211_local));
          for(int _i0 = 0; _i0 < _len_local0; _i0++) {
            local[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
