...
__attribute__((used)) int static inline ubi_fastmap_init_checkmap(struct ubi_volume *vol, int leb_count) { return 0; }
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = ubi_fastmap_init_checkmap(vol,leb_count);
          printf("%d\n", benchRet); 
          free(vol);
