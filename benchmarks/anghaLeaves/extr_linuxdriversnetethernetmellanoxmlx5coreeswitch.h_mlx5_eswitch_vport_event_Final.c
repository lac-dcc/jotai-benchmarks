...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_esw0; _i0++) {
            esw[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_eqe0 = 1;
          struct mlx5_eqe * eqe = (struct mlx5_eqe *) malloc(_len_eqe0*sizeof(struct mlx5_eqe));
          for(int _i0 = 0; _i0 < _len_eqe0; _i0++) {
            eqe[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          mlx5_eswitch_vport_event(esw,eqe);
          free(esw);
          free(eqe);
