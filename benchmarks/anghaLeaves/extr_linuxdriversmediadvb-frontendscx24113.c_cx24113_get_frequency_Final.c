...
struct cx24113_state {int /*<<< orphan*/  frequency; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct cx24113_state *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct cx24113_state));
          ...
          int benchRet = cx24113_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
