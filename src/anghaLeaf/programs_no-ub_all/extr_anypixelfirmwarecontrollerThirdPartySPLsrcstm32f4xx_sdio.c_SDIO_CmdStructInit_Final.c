...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_SDIO_CmdInitStruct0; _i0++) {
            SDIO_CmdInitStruct->SDIO_Argument = ((-2 * (next_i()%2)) + 1) * next_i();
        SDIO_CmdInitStruct->SDIO_CmdIndex = ((-2 * (next_i()%2)) + 1) * next_i();
        SDIO_CmdInitStruct->SDIO_CPSM = ((-2 * (next_i()%2)) + 1) * next_i();
        SDIO_CmdInitStruct->SDIO_Wait = ((-2 * (next_i()%2)) + 1) * next_i();
        SDIO_CmdInitStruct->SDIO_Response = ((-2 * (next_i()%2)) + 1) * next_i();
          }
