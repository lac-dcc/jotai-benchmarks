...
/* Type definitions */
struct panel_drv_data {unsigned int cabc_mode; } ;

/* Variables and functions */

__attribute__((used)) static unsigned int get_cabc_mode(struct panel_drv_data *ddata)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ddata0; _i0++) {
            ddata->cabc_mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
