...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tp0; _i0++) {
            tp[_i0].undo_retrans = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].sacked_out = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].undo_marker = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].lost_out = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].retrans_out = ((-2 * (next_i()%2)) + 1) * next_i();
          }
