...
__attribute__((used)) static inline void *____cache_alloc_node(struct kmem_cache *cachep,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          void * benchRet = ____cache_alloc_node(cachep,flags,nodeid);
          free(cachep);
