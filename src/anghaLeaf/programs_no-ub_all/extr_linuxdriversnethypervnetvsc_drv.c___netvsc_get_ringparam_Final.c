...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nvdev0; _i0++) {
            nvdev->nvsp_version = ((-2 * (next_i()%2)) + 1) * next_i();
        nvdev->recv_section_size = ((-2 * (next_i()%2)) + 1) * next_i();
        nvdev->send_section_size = ((-2 * (next_i()%2)) + 1) * next_i();
        nvdev->send_section_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
        nvdev->recv_section_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ring0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_ring0; _i0++) {
            ring->rx_max_pending = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->tx_max_pending = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->tx_pending = ((-2 * (next_i()%2)) + 1) * next_i();
        ring->rx_pending = ((-2 * (next_i()%2)) + 1) * next_i();
          }
