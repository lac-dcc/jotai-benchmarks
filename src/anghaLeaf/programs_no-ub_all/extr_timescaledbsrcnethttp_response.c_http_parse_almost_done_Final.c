...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state->state = ((-2 * (next_i()%2)) + 1) * next_i();
        state->content_length = ((-2 * (next_i()%2)) + 1) * next_i();
        state->parse_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        state->raw_buffer = ((-2 * (next_i()%2)) + 1) * next_i();
        state->body_start = ((-2 * (next_i()%2)) + 1) * next_i();
          }
