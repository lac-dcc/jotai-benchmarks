...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          wl[_i0].if_priv = (struct spi_device *) malloc(_len_wl__i0__if_priv0*sizeof(struct spi_device));
          for(int _j0 = 0; _j0 < _len_wl__i0__if_priv0; _j0++) {
              wl[_i0].if_priv->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          }
        
          struct spi_device * benchRet = wl_to_spi(wl);
          printf("%d\n", (*benchRet).dummy);
