...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ieee0; _i0++) {
            ieee->iw_mode = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->bTxUseDriverAssingedRate = ((-2 * (next_i()%2)) + 1) * next_i();
        ieee->bTxDisableRateFallBack = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_tcb_desc0; _i0++) {
            tcb_desc->bTxDisableRateFallBack = ((-2 * (next_i()%2)) + 1) * next_i();
        tcb_desc->bTxUseDriverAssingedRate = ((-2 * (next_i()%2)) + 1) * next_i();
        tcb_desc->RATRIndex = ((-2 * (next_i()%2)) + 1) * next_i();
          }
