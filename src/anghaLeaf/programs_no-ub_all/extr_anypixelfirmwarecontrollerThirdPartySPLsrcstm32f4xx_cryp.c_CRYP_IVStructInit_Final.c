...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_CRYP_IVInitStruct0; _i0++) {
            CRYP_IVInitStruct->CRYP_IV1Right = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_IVInitStruct->CRYP_IV1Left = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_IVInitStruct->CRYP_IV0Right = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_IVInitStruct->CRYP_IV0Left = ((-2 * (next_i()%2)) + 1) * next_i();
          }
