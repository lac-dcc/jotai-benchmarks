...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_params0 = 1;
          struct bnx2x_config_rss_params * params = (struct bnx2x_config_rss_params *) malloc(_len_params0*sizeof(struct bnx2x_config_rss_params));
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = bnx2x_vfpf_config_rss(bp,params);
          printf("%d\n", benchRet); 
          free(bp);
          free(params);
