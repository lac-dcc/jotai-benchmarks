...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_source0 = 1;
          struct TYPE_5__ * source = (struct TYPE_5__ *) malloc(_len_source0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_source0; _i0++) {
            source->info.output_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = source_has_audio(source);
          printf("%d\n", benchRet); 
          free(source);
