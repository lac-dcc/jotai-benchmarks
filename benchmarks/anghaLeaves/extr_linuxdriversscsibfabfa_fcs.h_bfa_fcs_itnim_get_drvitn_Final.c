...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_itnim0; _i0++) {
              int _len_itnim__i0__itnim_drv0 = 1;
          itnim[_i0].itnim_drv = (struct bfad_itnim_s *) malloc(_len_itnim__i0__itnim_drv0*sizeof(struct bfad_itnim_s));
          for(int _j0 = 0; _j0 < _len_itnim__i0__itnim_drv0; _j0++) {
            itnim[_i0].itnim_drv->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct bfad_itnim_s * benchRet = bfa_fcs_itnim_get_drvitn(itnim);
          printf("%d\n", (*benchRet).dummy);
          for(int _aux = 0; _aux < _len_itnim0; _aux++) {
          free(itnim[_aux].itnim_drv);
          }
          free(itnim);
