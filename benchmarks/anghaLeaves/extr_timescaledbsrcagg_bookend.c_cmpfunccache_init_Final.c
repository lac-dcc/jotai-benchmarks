...
/* Type definitions */
struct TYPE_3__ {int /*<<< orphan*/  cmp_type; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * cache = (struct TYPE_3__ *) malloc(_len_cache0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_cache0; _i0++) {
              cache[_i0].cmp_type = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          cmpfunccache_init(cache);
          free(cache);
