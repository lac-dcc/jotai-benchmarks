...
/* Variables and functions */
 int /*<<< orphan*/  NGX_OK ; 
 int /*<<< orphan*/  ngx_http_lua_capture_body_filter ; 
 int /*<<< orphan*/  ngx_http_lua_capture_header_filter ; 
 int /*<<< orphan*/  ngx_http_lua_next_body_filter ; 
 int /*<<< orphan*/  ngx_http_lua_next_header_filter ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = ngx_http_lua_capture_filter_init(cf);
          printf("%d\n", benchRet); 
          free(cf);
