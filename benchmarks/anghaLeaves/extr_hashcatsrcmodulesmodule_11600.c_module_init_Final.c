...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        module_ctx[_i0].module_hook_size = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx[_i0].module_hook_salt_size = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx[_i0].module_hook23 = ((-2 * (next_i()%2)) + 1) * next_i();
