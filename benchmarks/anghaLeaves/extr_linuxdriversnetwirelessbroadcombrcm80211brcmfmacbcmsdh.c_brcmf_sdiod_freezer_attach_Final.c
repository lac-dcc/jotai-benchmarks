...
__attribute__((used)) static int brcmf_sdiod_freezer_attach(struct brcmf_sdio_dev *sdiodev)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = brcmf_sdiod_freezer_attach(sdiodev);
          printf("%d\n", benchRet); 
          free(sdiodev);
