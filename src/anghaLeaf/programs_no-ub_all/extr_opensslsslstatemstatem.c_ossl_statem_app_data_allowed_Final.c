...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        s->s3.total_renegotiations = ((-2 * (next_i()%2)) + 1) * next_i();
        s->s3.in_read_app_data = ((-2 * (next_i()%2)) + 1) * next_i();
        s->statem.state = ((-2 * (next_i()%2)) + 1) * next_i();
        s->statem.hand_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
