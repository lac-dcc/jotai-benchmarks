...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_entry0; _i0++) {
            entry->cfentry_family = ((-2 * (next_i()%2)) + 1) * next_i();
        entry->cfentry_faddr.addr6 = ((-2 * (next_i()%2)) + 1) * next_i();
        entry->cfentry_faddr.addr46.ia46_addr4.s_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        entry->cfentry_fport = ((-2 * (next_i()%2)) + 1) * next_i();
        entry->cfentry_laddr.addr6 = ((-2 * (next_i()%2)) + 1) * next_i();
        entry->cfentry_laddr.addr46.ia46_addr4.s_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        entry->cfentry_lport = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_inp0 = 1;
        ...
        inp->in6p_faddr = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_fport = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->in6p_laddr = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_lport = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_faddr.s_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        inp->inp_laddr.s_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
