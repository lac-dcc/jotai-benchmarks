...
__attribute__((used)) static void fsp_packet_debug(struct psmouse *psmouse, unsigned char packet[])
{
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_packet0 = 1;
          unsigned char * packet = (unsigned char *) malloc(_len_packet0*sizeof(unsigned char));
