...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_dim0 = 1;
          struct TYPE_7__ * dim = (struct TYPE_7__ *) malloc(_len_dim0*sizeof(struct TYPE_7__));
          for(int _i0 = 0; _i0 < _len_dim0; _i0++) {
              dim[_i0].masks.num_masks = ((-2 * (next_i()%2)) + 1) * next_i();
          dim[_i0].masks.masks = ((-2 * (next_i()%2)) + 1) * next_i();
    ...
    case 3:
    {
          ...
          long end_point = ((-2 * (next_i()%2)) + 1) * next_i();
