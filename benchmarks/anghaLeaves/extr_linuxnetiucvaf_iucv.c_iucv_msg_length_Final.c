...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_msg0 = 1;
          struct iucv_message * msg = (struct iucv_message *) malloc(_len_msg0*sizeof(struct iucv_message));
          for(int _i0 = 0; _i0 < _len_msg0; _i0++) {
            msg[_i0].flags = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_msg__i0__rmmsg0 = 1;
          msg[_i0].rmmsg = (int *) malloc(_len_msg__i0__rmmsg0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_msg__i0__rmmsg0; _j0++) {
            msg[_i0].rmmsg[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        msg[_i0].length = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = iucv_msg_length(msg);
          printf("%lu\n", benchRet); 
