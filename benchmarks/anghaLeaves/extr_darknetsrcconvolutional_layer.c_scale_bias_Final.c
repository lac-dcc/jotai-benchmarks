...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_scales0 = 1;
          float * scales = (float *) malloc(_len_scales0*sizeof(float));
          for(int _i0 = 0; _i0 < _len_scales0; _i0++) {
            scales[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
        
          scale_bias(output,scales,batch,n,size);
          free(output);
          free(scales);
