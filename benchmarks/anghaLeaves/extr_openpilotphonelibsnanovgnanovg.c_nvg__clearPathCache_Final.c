...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ctx[_i0].cache = (struct TYPE_4__ *) malloc(_len_ctx__i0__cache0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_ctx__i0__cache0; _j0++) {
            ctx[_i0].cache->npaths = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].cache->npoints = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
