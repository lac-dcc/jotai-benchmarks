...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fsi0; _i0++) {
            fsi[_i0].base = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_fsi__i0__master0 = 1;
          fsi[_i0].master = (struct TYPE_2__ *) malloc(_len_fsi__i0__master0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_fsi__i0__master0; _j0++) {
            fsi[_i0].master->base = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = fsi_is_port_a(fsi);
          printf("%d\n", benchRet); 
