...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ppd0; _i0++) {
            ppd->neighbor_fm_security = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->neighbor_type = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->neighbor_port_number = ((-2 * (next_i()%2)) + 1) * next_i();
        ppd->neighbor_guid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
