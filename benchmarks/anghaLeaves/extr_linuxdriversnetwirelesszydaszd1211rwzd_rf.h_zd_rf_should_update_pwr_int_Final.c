...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_rf0 = 1;
          struct zd_rf * rf = (struct zd_rf *) malloc(_len_rf0*sizeof(struct zd_rf));
          for(int _i0 = 0; _i0 < _len_rf0; _i0++) {
            rf[_i0].update_channel_int = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = zd_rf_should_update_pwr_int(rf);
          printf("%d\n", benchRet); 
          free(rf);
