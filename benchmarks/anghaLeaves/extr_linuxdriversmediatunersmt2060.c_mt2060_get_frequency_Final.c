...
struct mt2060_priv {int /*<<< orphan*/  frequency; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct mt2060_priv *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct mt2060_priv));
          ...
          int benchRet = mt2060_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
