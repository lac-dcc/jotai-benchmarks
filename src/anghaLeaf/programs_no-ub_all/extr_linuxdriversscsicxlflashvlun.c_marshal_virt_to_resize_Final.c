...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_virt0; _i0++) {
            virt->last_lba = ((-2 * (next_i()%2)) + 1) * next_i();
        virt->lun_size = ((-2 * (next_i()%2)) + 1) * next_i();
        virt->rsrc_handle = ((-2 * (next_i()%2)) + 1) * next_i();
        virt->context_id = ((-2 * (next_i()%2)) + 1) * next_i();
        virt->hdr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_resize0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_resize0; _i0++) {
            resize->last_lba = ((-2 * (next_i()%2)) + 1) * next_i();
        resize->req_size = ((-2 * (next_i()%2)) + 1) * next_i();
