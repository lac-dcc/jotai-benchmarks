...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_Entry0; _i0++) {
            Entry->dmPelsWidth = ((-2 * (next_i()%2)) + 1) * next_i();
        Entry->dmPelsHeight = ((-2 * (next_i()%2)) + 1) * next_i();
        Entry->dmBitsPerPel = ((-2 * (next_i()%2)) + 1) * next_i();
        Entry->dmDisplayFrequency = ((-2 * (next_i()%2)) + 1) * next_i();
          }
