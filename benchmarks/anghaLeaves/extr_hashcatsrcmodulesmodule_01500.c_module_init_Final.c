...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // ------------------------------- 
          // static_instructions_Os : 95
          // dynamic_instructions_Os : 95
          // ------------------------------- 
          // static_instructions_Oz : 95
          // dynamic_instructions_Oz : 95
          // ------------------------------- 
          ...
          module_ctx[_i0].module_build_plain_postprocess = ((-2 * (next_i()%2)) + 1) * next_i();
