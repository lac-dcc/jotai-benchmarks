...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_cregion0 = 1;
          struct mlxsw_sp_acl_ctcam_region * cregion = (struct mlxsw_sp_acl_ctcam_region *) malloc(_len_cregion0*sizeof(struct mlxsw_sp_acl_ctcam_region));
          for(int _i0 = 0; _i0 < _len_cregion0; _i0++) {
            cregion[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_centry0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_centry0; _i0++) {
            centry[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          mlxsw_sp1_acl_ctcam_region_entry_remove(cregion,centry);
          free(cregion);
          free(centry);
