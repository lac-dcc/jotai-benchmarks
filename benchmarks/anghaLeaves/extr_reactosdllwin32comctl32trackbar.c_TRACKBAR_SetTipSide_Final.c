...
/* Type definitions */
struct TYPE_3__ {int /*<<< orphan*/  fLocation; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_infoPtr0; _i0++) {
              infoPtr[_i0].fLocation = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = TRACKBAR_SetTipSide(infoPtr,fLocation);
          printf("%d\n", benchRet); 
          free(infoPtr);
    ...
    case 3:
    {
          ...
          int fLocation = ((-2 * (next_i()%2)) + 1) * next_i();
