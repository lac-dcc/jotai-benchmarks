...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vf0; _i0++) {
            vf->sb_count = ((-2 * (next_i()%2)) + 1) * next_i();
        vf->alloc_resc.num_sbs = ((-2 * (next_i()%2)) + 1) * next_i();
        vf->alloc_resc.num_mc_filters = ((-2 * (next_i()%2)) + 1) * next_i();
        vf->alloc_resc.num_vlan_filters = ((-2 * (next_i()%2)) + 1) * next_i();
        vf->alloc_resc.num_mac_filters = ((-2 * (next_i()%2)) + 1) * next_i();
        vf->alloc_resc.num_txqs = ((-2 * (next_i()%2)) + 1) * next_i();
        vf->alloc_resc.num_rxqs = ((-2 * (next_i()%2)) + 1) * next_i();
          }
