...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_icom_port0; _i0++) {
            icom_port->port = ((-2 * (next_i()%2)) + 1) * next_i();
        icom_port->int_reg = ((-2 * (next_i()%2)) + 1) * next_i();
        icom_port->global_reg = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_icom_adapter0; _i0++) {
            icom_adapter->version = ((-2 * (next_i()%2)) + 1) * next_i();
        icom_adapter->base_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
