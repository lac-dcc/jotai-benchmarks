...
struct list_head *_allocate_list(int length) {
...
void _delete_list(struct list_head * head) {
  if(head->prev != NULL) _delete_list(head->prev);
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          struct list_head * list = _allocate_list(1);
