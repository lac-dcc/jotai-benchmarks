...
__attribute__((used)) static inline void rt2x00crypto_create_tx_descriptor(struct rt2x00_dev *rt2x00dev,
						     struct sk_buff *skb,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_txdesc0 = 1;
          struct txentry_desc * txdesc = (struct txentry_desc *) malloc(_len_txdesc0*sizeof(struct txentry_desc));
          for(int _i0 = 0; _i0 < _len_txdesc0; _i0++) {
            txdesc[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
