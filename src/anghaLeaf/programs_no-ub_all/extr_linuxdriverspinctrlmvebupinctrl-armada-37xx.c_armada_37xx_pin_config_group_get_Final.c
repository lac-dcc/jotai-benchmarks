...
__attribute__((used)) static int armada_37xx_pin_config_group_get(struct pinctrl_dev *pctldev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = armada_37xx_pin_config_group_get(pctldev,selector,config);
          printf("%d\n", benchRet); 
          free(pctldev);
          free(config);
