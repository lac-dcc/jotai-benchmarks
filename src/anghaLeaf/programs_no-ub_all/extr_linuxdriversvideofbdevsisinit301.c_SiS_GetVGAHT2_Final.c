...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_SiS_Pr0; _i0++) {
            SiS_Pr->SiS_VGAVT = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_VGAVDE = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_RVBHCMAX = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_VT = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_VDE = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_RVBHCFACT = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr->SiS_HT = ((-2 * (next_i()%2)) + 1) * next_i();
          }
