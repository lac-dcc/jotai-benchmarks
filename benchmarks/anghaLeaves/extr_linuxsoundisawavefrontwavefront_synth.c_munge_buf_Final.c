...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 3444
          // ------------------------------- 
          // static_instructions_O1 : 23
          // dynamic_instructions_O1 : 1283
          // ------------------------------- 
          // static_instructions_O2 : 39
          // dynamic_instructions_O2 : 1031
          // ------------------------------- 
          // static_instructions_O3 : 39
          // dynamic_instructions_O3 : 1031
          // ------------------------------- 
          // static_instructions_Ofast : 39
          // dynamic_instructions_Ofast : 1031
          // ------------------------------- 
          // static_instructions_Os : 21
          // dynamic_instructions_Os : 1281
          // ------------------------------- 
          // static_instructions_Oz : 18
          // dynamic_instructions_Oz : 1406
          // ------------------------------- 
          ...
          unsigned char * benchRet = munge_buf(src,dst,dst_size);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(src);
          free(dst);
