...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum target_signal oursig = 0;
          int _len_oursig_ok0 = 1;
          int * oursig_ok = (int *) malloc(_len_oursig_ok0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_oursig_ok0; _i0++) {
            oursig_ok[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = do_target_signal_to_host(oursig,oursig_ok);
          printf("%d\n", benchRet); 
          free(oursig_ok);
