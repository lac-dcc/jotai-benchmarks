...
__attribute__((used)) static __inline void register_task_alive(struct pwrctrl_priv *pwrctrl, u32 tag)
{
	pwrctrl->alives |= tag;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pwrctrl0; _i0++) {
            pwrctrl->alives = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          register_task_alive(pwrctrl,tag);
          free(pwrctrl);
