...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_cp00 = 65025;
          char * cp0 = (char *) malloc(_len_cp00*sizeof(char));
          for(int _i0 = 0; _i0 < _len_cp00; _i0++) {
            cp0[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = skpc(mask0,size,cp0);
          printf("%d\n", benchRet); 
          free(cp0);
