...
/* Variables and functions */
 int RET_ILUNI ; 
 unsigned char* koi8_r_page00 ; 
 unsigned char* koi8_r_page04 ; 
 unsigned char* koi8_r_page22 ; 
 unsigned char* koi8_r_page23 ; 
 unsigned char* koi8_r_page25 ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = koi8_r_wctomb(conv,r,wc,n);
          printf("%d\n", benchRet); 
          free(r);
