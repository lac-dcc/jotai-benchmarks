...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data->bme680.par_gh3 = ((-2 * (next_i()%2)) + 1) * next_i();
        data->bme680.par_gh1 = ((-2 * (next_i()%2)) + 1) * next_i();
        data->bme680.par_gh2 = ((-2 * (next_i()%2)) + 1) * next_i();
        data->bme680.res_heat_range = ((-2 * (next_i()%2)) + 1) * next_i();
        data->bme680.res_heat_val = ((-2 * (next_i()%2)) + 1) * next_i();
          }
