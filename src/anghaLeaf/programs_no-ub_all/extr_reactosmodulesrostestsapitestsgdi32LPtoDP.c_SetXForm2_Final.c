...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pxform0; _i0++) {
            pxform->eM11 = ((-2 * (next_i()%2)) + 1) * next_i();
        pxform->eM22 = ((-2 * (next_i()%2)) + 1) * next_i();
        pxform->eDy = ((-2 * (next_i()%2)) + 1) * next_i();
        pxform->eDx = ((-2 * (next_i()%2)) + 1) * next_i();
        pxform->eM21 = ((-2 * (next_i()%2)) + 1) * next_i();
        pxform->eM12 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          SetXForm2(pxform);
          free(pxform);
