...
/* Variables and functions */
 int A4XX_GRAS_SU_MODE_CONTROL_LINEHALFWIDTH__MASK ; 
 int A4XX_GRAS_SU_MODE_CONTROL_LINEHALFWIDTH__SHIFT ; 

__attribute__((used)) static inline uint32_t A4XX_GRAS_SU_MODE_CONTROL_LINEHALFWIDTH(float val)
{
