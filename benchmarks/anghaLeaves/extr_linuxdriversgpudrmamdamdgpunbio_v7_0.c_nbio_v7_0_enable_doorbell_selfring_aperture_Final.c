...
__attribute__((used)) static void nbio_v7_0_enable_doorbell_selfring_aperture(struct amdgpu_device *adev,
							bool enable)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          nbio_v7_0_enable_doorbell_selfring_aperture(adev,enable);
          free(adev);
