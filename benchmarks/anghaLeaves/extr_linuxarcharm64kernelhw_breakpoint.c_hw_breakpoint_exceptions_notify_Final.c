...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_unused0 = 1;
          struct notifier_block * unused = (struct notifier_block *) malloc(_len_unused0*sizeof(struct notifier_block));
          ...
          int benchRet = hw_breakpoint_exceptions_notify(unused,val,data);
          printf("%d\n", benchRet); 
          free(unused);
