...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_USART_ClockInitStruct0; _i0++) {
            USART_ClockInitStruct->USART_LastBit = ((-2 * (next_i()%2)) + 1) * next_i();
        USART_ClockInitStruct->USART_CPHA = ((-2 * (next_i()%2)) + 1) * next_i();
        USART_ClockInitStruct->USART_CPOL = ((-2 * (next_i()%2)) + 1) * next_i();
        USART_ClockInitStruct->USART_Clock = ((-2 * (next_i()%2)) + 1) * next_i();
          }
