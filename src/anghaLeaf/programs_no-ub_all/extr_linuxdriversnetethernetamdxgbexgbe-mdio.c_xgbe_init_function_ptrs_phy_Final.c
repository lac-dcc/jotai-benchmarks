...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phy_if0; _i0++) {
            phy_if->module_eeprom = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->module_info = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->an_isr = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_valid_speed = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_config_aneg = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_status = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_stop = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_start = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_reset = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_exit = ((-2 * (next_i()%2)) + 1) * next_i();
        phy_if->phy_init = ((-2 * (next_i()%2)) + 1) * next_i();
          }
