...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sub0; _i0++) {
            sub->start = ((-2 * (next_i()%2)) + 1) * next_i();
        sub->end = ((-2 * (next_i()%2)) + 1) * next_i();
        sub->codec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_p0 = 1;
          struct demux_packet * p = (struct demux_packet *) malloc(_len_p0*sizeof(struct demux_packet));
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p->start = ((-2 * (next_i()%2)) + 1) * next_i();
        p->end = ((-2 * (next_i()%2)) + 1) * next_i();
        p->codec = ((-2 * (next_i()%2)) + 1) * next_i();
        p->segmented = ((-2 * (next_i()%2)) + 1) * next_i();
          }
