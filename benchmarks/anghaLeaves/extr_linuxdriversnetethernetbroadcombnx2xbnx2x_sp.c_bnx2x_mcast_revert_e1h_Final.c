...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int old_num_bins = 100;
          enum bnx2x_mcast_cmd cmd = 0;
          int _len_bp0 = 1;
          ...
          int _len_p0 = 1;
          struct bnx2x_mcast_ramrod_params * p = (struct bnx2x_mcast_ramrod_params *) malloc(_len_p0*sizeof(struct bnx2x_mcast_ramrod_params));
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          bnx2x_mcast_revert_e1h(bp,p,old_num_bins,cmd);
          free(bp);
          free(p);
