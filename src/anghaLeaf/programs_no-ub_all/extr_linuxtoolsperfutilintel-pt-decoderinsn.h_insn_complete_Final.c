...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_insn0; _i0++) {
            insn->immediate.got = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->displacement.got = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->sib.got = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->modrm.got = ((-2 * (next_i()%2)) + 1) * next_i();
        insn->opcode.got = ((-2 * (next_i()%2)) + 1) * next_i();
          }
