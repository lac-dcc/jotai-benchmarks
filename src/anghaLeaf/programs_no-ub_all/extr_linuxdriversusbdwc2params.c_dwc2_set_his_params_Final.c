...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        hsotg->params.host_channels = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->params.phy_utmi_width = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->params.i2c_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->params.reload_ctl = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->params.ahbcfg = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->params.change_speed_quirk = ((-2 * (next_i()%2)) + 1) * next_i();
        hsotg->params.power_down = ((-2 * (next_i()%2)) + 1) * next_i();
