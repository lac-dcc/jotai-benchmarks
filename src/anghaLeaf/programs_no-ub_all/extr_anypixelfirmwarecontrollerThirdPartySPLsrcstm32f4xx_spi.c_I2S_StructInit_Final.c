...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_I2S_InitStruct0; _i0++) {
            I2S_InitStruct->I2S_CPOL = ((-2 * (next_i()%2)) + 1) * next_i();
        I2S_InitStruct->I2S_AudioFreq = ((-2 * (next_i()%2)) + 1) * next_i();
        I2S_InitStruct->I2S_MCLKOutput = ((-2 * (next_i()%2)) + 1) * next_i();
        I2S_InitStruct->I2S_DataFormat = ((-2 * (next_i()%2)) + 1) * next_i();
        I2S_InitStruct->I2S_Standard = ((-2 * (next_i()%2)) + 1) * next_i();
        I2S_InitStruct->I2S_Mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
