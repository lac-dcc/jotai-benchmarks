...
struct itd1000_state {int /*<<< orphan*/  frequency; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].tuner_priv = (struct itd1000_state *) malloc(_len_fe__i0__tuner_priv0*sizeof(struct itd1000_state));
          ...
          int benchRet = itd1000_get_frequency(fe,frequency);
          printf("%d\n", benchRet); 
