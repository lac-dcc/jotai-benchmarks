...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sconfig0; _i0++) {
            sconfig->src_maxburst = ((-2 * (next_i()%2)) + 1) * next_i();
        sconfig->dst_maxburst = ((-2 * (next_i()%2)) + 1) * next_i();
        sconfig->src_addr_width = ((-2 * (next_i()%2)) + 1) * next_i();
        sconfig->dst_addr_width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
