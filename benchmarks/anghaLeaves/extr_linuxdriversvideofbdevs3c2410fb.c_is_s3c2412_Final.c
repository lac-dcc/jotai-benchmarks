...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_fbi0 = 1;
          struct s3c2410fb_info * fbi = (struct s3c2410fb_info *) malloc(_len_fbi0*sizeof(struct s3c2410fb_info));
          for(int _i0 = 0; _i0 < _len_fbi0; _i0++) {
            fbi[_i0].drv_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_s3c2412(fbi);
          printf("%d\n", benchRet); 
          free(fbi);
