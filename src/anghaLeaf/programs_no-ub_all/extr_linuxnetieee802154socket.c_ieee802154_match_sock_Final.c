...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ro0; _i0++) {
            ro->src_addr.mode = ((-2 * (next_i()%2)) + 1) * next_i();
        ro->src_addr.extended_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ro->src_addr.pan_id = ((-2 * (next_i()%2)) + 1) * next_i();
        ro->src_addr.short_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ro->bound = ((-2 * (next_i()%2)) + 1) * next_i();
          }
