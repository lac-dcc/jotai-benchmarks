...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sq0; _i0++) {
            sq->bufSize = ((-2 * (next_i()%2)) + 1) * next_i();
        sq->numBufs = ((-2 * (next_i()%2)) + 1) * next_i();
        sq->user_frags = ((-2 * (next_i()%2)) + 1) * next_i();
        sq->max_active = ((-2 * (next_i()%2)) + 1) * next_i();
        sq->user_frag_size = ((-2 * (next_i()%2)) + 1) * next_i();
        sq->locked = ((-2 * (next_i()%2)) + 1) * next_i();
          }
