...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
            f->blocksize_1 = ((-2 * (next_i()%2)) + 1) * next_i();
        f->temp_memory_required = ((-2 * (next_i()%2)) + 1) * next_i();
        f->setup_temp_memory_required = ((-2 * (next_i()%2)) + 1) * next_i();
        f->setup_memory_required = ((-2 * (next_i()%2)) + 1) * next_i();
        f->sample_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        f->channels = ((-2 * (next_i()%2)) + 1) * next_i();
          }
