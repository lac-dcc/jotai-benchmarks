...
__attribute__((used)) static void target_core_stat_rmdir(
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_group0 = 1;
          struct config_group * group = (struct config_group *) malloc(_len_group0*sizeof(struct config_group));
          ...
          target_core_stat_rmdir(group,item);
          free(group);
          free(item);
