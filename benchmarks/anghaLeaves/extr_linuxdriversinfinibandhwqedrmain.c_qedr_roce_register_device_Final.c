...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_dev0 = 1;
          struct qedr_dev * dev = (struct qedr_dev *) malloc(_len_dev0*sizeof(struct qedr_dev));
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev[_i0].ibdev.get_port_immutable = ((-2 * (next_i()%2)) + 1) * next_i();
        dev[_i0].ibdev.node_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
