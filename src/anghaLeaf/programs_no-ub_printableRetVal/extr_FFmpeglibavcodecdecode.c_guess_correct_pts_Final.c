...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx->pts_correction_num_faulty_dts = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->pts_correction_last_dts = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->pts_correction_num_faulty_pts = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->pts_correction_last_pts = ((-2 * (next_i()%2)) + 1) * next_i();
          }
