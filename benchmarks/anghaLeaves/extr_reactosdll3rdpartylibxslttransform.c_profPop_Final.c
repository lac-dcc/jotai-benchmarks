...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctxt0; _i0++) {
            ctxt[_i0].profNr = ((-2 * (next_i()%2)) + 1) * next_i();
        ctxt[_i0].prof = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctxt__i0__profTab0 = 1;
          ctxt[_i0].profTab = (long *) malloc(_len_ctxt__i0__profTab0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_ctxt__i0__profTab0; _j0++) {
            ctxt[_i0].profTab[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          long benchRet = profPop(ctxt);
          printf("%ld\n", benchRet); 
          for(int _aux = 0; _aux < _len_ctxt0; _aux++) {
          free(ctxt[_aux].profTab);
          }
          free(ctxt);
