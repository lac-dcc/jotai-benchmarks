...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int * benchRet = serialize_list2a_raw(ptr,list,num);
          printf("%d\n", (*benchRet)); 
          free(ptr);
          free(list);
