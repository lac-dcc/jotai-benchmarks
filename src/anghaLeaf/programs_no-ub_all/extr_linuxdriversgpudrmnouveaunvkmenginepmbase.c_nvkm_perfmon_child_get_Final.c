...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_object0; _i0++) {
            object->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_oclass0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_oclass0; _i0++) {
            oclass->ctor = ((-2 * (next_i()%2)) + 1) * next_i();
        oclass->base.maxver = ((-2 * (next_i()%2)) + 1) * next_i();
        oclass->base.minver = ((-2 * (next_i()%2)) + 1) * next_i();
        oclass->base.oclass = ((-2 * (next_i()%2)) + 1) * next_i();
          }
