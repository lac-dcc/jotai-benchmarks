...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q0; _i0++) {
            q[_i0].un.iq.genbit = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ftr0 = 1;
          struct csio_iqwr_footer * ftr = (struct csio_iqwr_footer *) malloc(_len_ftr0*sizeof(struct csio_iqwr_footer));
          for(int _i0 = 0; _i0 < _len_ftr0; _i0++) {
            ftr[_i0].u.type_gen = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = csio_is_new_iqwr(q,ftr);
          printf("%d\n", benchRet); 
          free(q);
          free(ftr);
