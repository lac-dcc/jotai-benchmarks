...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          ...
          unsigned int vco_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int target_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int pd_min = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned int pd_even = ((-2 * (next_i()%2)) + 1) * next_i();
