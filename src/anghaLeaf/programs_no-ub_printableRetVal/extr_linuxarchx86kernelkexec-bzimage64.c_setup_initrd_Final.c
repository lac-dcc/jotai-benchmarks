...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params->ext_ramdisk_image = ((-2 * (next_i()%2)) + 1) * next_i();
        params->ext_ramdisk_size = ((-2 * (next_i()%2)) + 1) * next_i();
        params->hdr.ramdisk_image = ((-2 * (next_i()%2)) + 1) * next_i();
        params->hdr.ramdisk_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
