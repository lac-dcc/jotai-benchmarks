...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hw_node0; _i0++) {
            hw_node->generic.dstride = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_node->generic.sstride = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_node->saddr = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_node->control = ((-2 * (next_i()%2)) + 1) * next_i();
        hw_node->daddr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_fchan0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_fchan0; _i0++) {
            fchan->cfg.dev_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
