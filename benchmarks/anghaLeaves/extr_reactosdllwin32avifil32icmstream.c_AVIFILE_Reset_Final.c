...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_This0; _i0++) {
            This[_i0].lCurrent = ((-2 * (next_i()%2)) + 1) * next_i();
        This[_i0].dwUnusedBytes = ((-2 * (next_i()%2)) + 1) * next_i();
        This[_i0].dwLastQuality = ((-2 * (next_i()%2)) + 1) * next_i();
        This[_i0].lLastKey = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          AVIFILE_Reset(This);
          free(This);
