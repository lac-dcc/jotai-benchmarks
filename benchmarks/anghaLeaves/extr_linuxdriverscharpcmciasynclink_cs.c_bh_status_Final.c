...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info[_i0].cts_chkcount = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].dcd_chkcount = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].dsr_chkcount = ((-2 * (next_i()%2)) + 1) * next_i();
        info[_i0].ri_chkcount = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          bh_status(info);
          free(info);
