...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        module_ctx->module_pw_min = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_pw_max = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_potfile_custom_check = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_hash_init_selftest = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_encode = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_encode_potfile = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_encode_status = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_decode = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_decode_potfile = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_hash_binary_save = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        module_ctx->module_deep_comp_kernel = ((-2 * (next_i()%2)) + 1) * next_i();
        module_ctx->module_benchmark_mask = ((-2 * (next_i()%2)) + 1) * next_i();
