...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // ------------------------------- 
          // static_instructions_O1 : 103
          // dynamic_instructions_O1 : 103
          // ------------------------------- 
          // static_instructions_O2 : 103
          // dynamic_instructions_O2 : 103
          // ------------------------------- 
          ...
          // ------------------------------- 
          // static_instructions_Os : 103
          // dynamic_instructions_Os : 103
          // ------------------------------- 
          // static_instructions_Oz : 103
          ...
          module_ctx[_i0].module_pw_min = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_pw_max = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_potfile_custom_check = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          module_ctx[_i0].module_hash_init_selftest = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_encode = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_encode_potfile = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_encode_status = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_decode = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_decode_potfile = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_hash_binary_save = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          module_ctx[_i0].module_deep_comp_kernel = ((-2 * (next_i()%2)) + 1) * next_i();
          module_ctx[_i0].module_benchmark_mask = ((-2 * (next_i()%2)) + 1) * next_i();
