...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_SDp__i0__hostdata0; _j0++) {
              int _len_SDp__i0__hostdata_cmnd0 = 1;
          SDp[_i0].hostdata->cmnd = (char *) malloc(_len_SDp__i0__hostdata_cmnd0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_SDp__i0__hostdata_cmnd0; _j0++) {
            SDp[_i0].hostdata->cmnd[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          char * benchRet = NCR_700_get_sense_cmnd(SDp);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
