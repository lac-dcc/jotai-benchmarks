...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rq0; _i0++) {
            rq->flush.saved_end_io = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->end_io = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->rq_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->biotail = ((-2 * (next_i()%2)) + 1) * next_i();
        rq->bio = ((-2 * (next_i()%2)) + 1) * next_i();
          }
