...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_l0 = 1;
          struct ilist * l = (struct ilist *) malloc(_len_l0*sizeof(struct ilist));
          for(int _i0 = 0; _i0 < _len_l0; _i0++) {
            l[_i0].tail = ((-2 * (next_i()%2)) + 1) * next_i();
        l[_i0].head = ((-2 * (next_i()%2)) + 1) * next_i();
        l[_i0].nr_elts = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          l_init(l);
          free(l);
