...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].demodulator_priv = (struct af9013_state *) malloc(_len_fe__i0__demodulator_priv0*sizeof(struct af9013_state));
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
            fe[_i0].demodulator_priv->dvbv3_snr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_snr0 = 1;
          ...
          int benchRet = af9013_read_snr(fe,snr);
          printf("%d\n", benchRet); 
