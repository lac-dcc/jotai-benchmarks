...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_smi_info0; _i0++) {
            smi_info->irq_enable_broken = ((-2 * (next_i()%2)) + 1) * next_i();
        smi_info->interrupt_disabled = ((-2 * (next_i()%2)) + 1) * next_i();
        smi_info->io.irq = ((-2 * (next_i()%2)) + 1) * next_i();
        smi_info->supports_event_msg_buff = ((-2 * (next_i()%2)) + 1) * next_i();
        smi_info->cannot_disable_irq = ((-2 * (next_i()%2)) + 1) * next_i();
          }
