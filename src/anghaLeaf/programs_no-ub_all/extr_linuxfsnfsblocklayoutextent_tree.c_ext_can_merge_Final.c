...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_be10; _i0++) {
            be1->be_state = ((-2 * (next_i()%2)) + 1) * next_i();
        be1->be_device = ((-2 * (next_i()%2)) + 1) * next_i();
        be1->be_f_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        be1->be_length = ((-2 * (next_i()%2)) + 1) * next_i();
        be1->be_v_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        be1->be_tag = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_be20 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_be20; _i0++) {
            be2->be_state = ((-2 * (next_i()%2)) + 1) * next_i();
        be2->be_device = ((-2 * (next_i()%2)) + 1) * next_i();
        be2->be_f_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        be2->be_length = ((-2 * (next_i()%2)) + 1) * next_i();
        be2->be_v_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        be2->be_tag = ((-2 * (next_i()%2)) + 1) * next_i();
          }
