...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pool0; _i0++) {
            pool->size = ((-2 * (next_i()%2)) + 1) * next_i();
        pool->index = ((-2 * (next_i()%2)) + 1) * next_i();
        pool->buff_size = ((-2 * (next_i()%2)) + 1) * next_i();
        pool->threshold = ((-2 * (next_i()%2)) + 1) * next_i();
        pool->active = ((-2 * (next_i()%2)) + 1) * next_i();
          }
