...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_context0; _i0++) {
              int _len_context__i0__pColl0 = 1;
          context[_i0].pColl = (int *) malloc(_len_context__i0__pColl0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_context__i0__pColl0; _j0++) {
            context[_i0].pColl[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = sqlite3GetFuncCollSeq(context);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_context0; _aux++) {
          free(context[_aux].pColl);
          }
          free(context);
