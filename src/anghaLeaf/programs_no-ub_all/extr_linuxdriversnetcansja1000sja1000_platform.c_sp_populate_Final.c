...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->write_reg = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->read_reg = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->cdr = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->ocr = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->can.clock.freq = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pdata0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_pdata0; _i0++) {
            pdata->osc_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        pdata->cdr = ((-2 * (next_i()%2)) + 1) * next_i();
        pdata->ocr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
