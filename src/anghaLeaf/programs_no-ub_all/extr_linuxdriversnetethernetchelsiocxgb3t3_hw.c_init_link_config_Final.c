...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_lc0; _i0++) {
            lc->supported = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->requested_fc = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->fc = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->advertising = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->autoneg = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->duplex = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->requested_duplex = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->speed = ((-2 * (next_i()%2)) + 1) * next_i();
        lc->requested_speed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
