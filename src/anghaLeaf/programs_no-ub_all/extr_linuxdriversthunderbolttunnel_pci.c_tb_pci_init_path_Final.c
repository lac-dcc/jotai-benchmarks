...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_path0; _i0++) {
            path->egress_fc_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        path->priority = ((-2 * (next_i()%2)) + 1) * next_i();
        path->weight = ((-2 * (next_i()%2)) + 1) * next_i();
        path->nfc_credits = ((-2 * (next_i()%2)) + 1) * next_i();
        path->drop_packages = ((-2 * (next_i()%2)) + 1) * next_i();
        path->ingress_fc_enable = ((-2 * (next_i()%2)) + 1) * next_i();
          }
