...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_antcomb0; _i0++) {
            antcomb->rssi_second = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->rssi_third = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->first_quick_scan_conf = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->second_quick_scan_conf = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->main_conf = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->second_ratio = ((-2 * (next_i()%2)) + 1) * next_i();
        antcomb->first_ratio = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_conf0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_conf0; _i0++) {
            conf->main_lna_conf = ((-2 * (next_i()%2)) + 1) * next_i();
        conf->alt_lna_conf = ((-2 * (next_i()%2)) + 1) * next_i();
          }
