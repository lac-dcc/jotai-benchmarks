...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cc0; _i0++) {
            cc[_i0].dmreq_start = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dmreq0 = 1;
          struct dm_crypt_request * dmreq = (struct dm_crypt_request *) malloc(_len_dmreq0*sizeof(struct dm_crypt_request));
          for(int _i0 = 0; _i0 < _len_dmreq0; _i0++) {
            dmreq[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = req_of_dmreq(cc,dmreq);
          printf("{{other_type}} %p\n", &benchRet); 
          free(cc);
          free(dmreq);
