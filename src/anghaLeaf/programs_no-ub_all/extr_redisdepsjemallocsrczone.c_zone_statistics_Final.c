...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stats0; _i0++) {
            stats->size_allocated = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->max_size_in_use = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->size_in_use = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->blocks_in_use = ((-2 * (next_i()%2)) + 1) * next_i();
          }
