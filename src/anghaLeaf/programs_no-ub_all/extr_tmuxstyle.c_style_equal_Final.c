...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sy10; _i0++) {
            sy1->align = ((-2 * (next_i()%2)) + 1) * next_i();
        sy1->gc.fg = ((-2 * (next_i()%2)) + 1) * next_i();
        sy1->gc.bg = ((-2 * (next_i()%2)) + 1) * next_i();
        sy1->gc.attr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_sy20 = 1;
          struct style * sy2 = (struct style *) malloc(_len_sy20*sizeof(struct style));
          for(int _i0 = 0; _i0 < _len_sy20; _i0++) {
            sy2->align = ((-2 * (next_i()%2)) + 1) * next_i();
        sy2->gc.fg = ((-2 * (next_i()%2)) + 1) * next_i();
        sy2->gc.bg = ((-2 * (next_i()%2)) + 1) * next_i();
        sy2->gc.attr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
