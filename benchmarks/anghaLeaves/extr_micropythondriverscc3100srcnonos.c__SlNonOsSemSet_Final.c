...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pSemObj0 = 1;
          int * pSemObj = (int *) malloc(_len_pSemObj0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pSemObj0; _i0++) {
            pSemObj[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = _SlNonOsSemSet(pSemObj,Value);
          printf("%d\n", benchRet); 
          free(pSemObj);
