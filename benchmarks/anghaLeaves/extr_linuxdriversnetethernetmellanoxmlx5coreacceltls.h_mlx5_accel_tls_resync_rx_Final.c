...
__attribute__((used)) static inline int mlx5_accel_tls_resync_rx(struct mlx5_core_dev *mdev, u32 handle,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = mlx5_accel_tls_resync_rx(mdev,handle,seq,rcd_sn);
          printf("%d\n", benchRet); 
          free(mdev);
