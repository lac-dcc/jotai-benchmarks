...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        p[_i0].cyclicBufferSize = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].cyclicBufferPos = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].streamPos = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].keepSizeAfter = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].matchMaxLen = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].posLimit = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].lenLimit = ((-2 * (next_i()%2)) + 1) * next_i();
          }
