...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_renderer0; _i0++) {
            renderer->gravity = ((-2 * (next_i()%2)) + 1) * next_i();
        renderer->vertices_changed = ((-2 * (next_i()%2)) + 1) * next_i();
        renderer->layer_width = ((-2 * (next_i()%2)) + 1) * next_i();
        renderer->layer_height = ((-2 * (next_i()%2)) + 1) * next_i();
          }
