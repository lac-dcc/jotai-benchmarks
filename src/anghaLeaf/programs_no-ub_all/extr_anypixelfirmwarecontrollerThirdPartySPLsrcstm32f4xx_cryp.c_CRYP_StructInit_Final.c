...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_CRYP_InitStruct0; _i0++) {
            CRYP_InitStruct->CRYP_KeySize = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_InitStruct->CRYP_DataType = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_InitStruct->CRYP_AlgoMode = ((-2 * (next_i()%2)) + 1) * next_i();
        CRYP_InitStruct->CRYP_AlgoDir = ((-2 * (next_i()%2)) + 1) * next_i();
          }
