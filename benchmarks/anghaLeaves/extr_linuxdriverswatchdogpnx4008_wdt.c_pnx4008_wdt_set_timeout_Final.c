...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = pnx4008_wdt_set_timeout(wdd,new_timeout);
          printf("%d\n", benchRet); 
          free(wdd);
    ...
    case 3:
    {
          ...
          unsigned int new_timeout = ((-2 * (next_i()%2)) + 1) * next_i();
