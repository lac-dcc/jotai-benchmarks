...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_r0; _i0++) {
            r[_i0].match_tag = ((-2 * (next_i()%2)) + 1) * next_i();
        r[_i0].match_tag_not = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pf_mtag0 = 1;
          struct pf_mtag * pf_mtag = (struct pf_mtag *) malloc(_len_pf_mtag0*sizeof(struct pf_mtag));
          for(int _i0 = 0; _i0 < _len_pf_mtag0; _i0++) {
            pf_mtag[_i0].pftag_tag = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_tag0 = 1;
