...
__attribute__((used)) static inline void cc_set_ree_fips_status(struct cc_drvdata *drvdata,
					  bool ok) {}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_drvdata0; _i0++) {
            drvdata[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          cc_set_ree_fips_status(drvdata,ok);
          free(drvdata);
