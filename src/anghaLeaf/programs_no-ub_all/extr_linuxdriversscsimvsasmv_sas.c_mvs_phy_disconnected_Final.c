...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_phy0 = 1;
          struct mvs_phy * phy = (struct mvs_phy *) malloc(_len_phy0*sizeof(struct mvs_phy));
          for(int _i0 = 0; _i0 < _len_phy0; _i0++) {
            phy->att_dev_sas_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        phy->att_dev_info = ((-2 * (next_i()%2)) + 1) * next_i();
        phy->phy_attached = ((-2 * (next_i()%2)) + 1) * next_i();
          }
