...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_DeviceExt0; _i0++) {
              DeviceExt[_i0].FatInfo.dataStart = ((-2 * (next_i()%2)) + 1) * next_i();
          DeviceExt[_i0].FatInfo.SectorsPerCluster = ((-2 * (next_i()%2)) + 1) * next_i();
        
        
          }
        
          int benchRet = ClusterToSector(DeviceExt,Cluster);
          printf("%d\n", benchRet); 
          free(DeviceExt);
    ...
    case 3:
    {
          ...
          int Cluster = ((-2 * (next_i()%2)) + 1) * next_i();
