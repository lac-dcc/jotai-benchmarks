...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_temperature0 = 65025;
          int * temperature = (int *) malloc(_len_temperature0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_temperature0; _i0++) {
            temperature[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        
          int benchRet = acerhdf_get_crit_temp(thermal,temperature);
          printf("%d\n", benchRet); 
          free(thermal);
          free(temperature);
