...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_avctx0 = 1;
          struct TYPE_4__ * avctx = (struct TYPE_4__ *) malloc(_len_avctx0*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_avctx0; _i0++) {
              int _len_avctx__i0__priv_data0 = 1;
          avctx[_i0].priv_data = (struct TYPE_5__ *) malloc(_len_avctx__i0__priv_data0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_avctx__i0__priv_data0; _j0++) {
            avctx[_i0].priv_data->has_status = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          adpcm_flush(avctx);
