...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int _len__client0 = 65025;
          int * _client = (int *) malloc(_len__client0*sizeof(int));
          for(int _i0 = 0; _i0 < _len__client0; _i0++) {
            _client[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = do_get_socket(_client);
          printf("{{other_type}} %p\n", &benchRet); 
          free(_client);
