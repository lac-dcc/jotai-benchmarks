...
__attribute__((used)) static void __update_queue(struct intel_engine_cs *engine, int prio)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_engine0; _i0++) {
              engine[_i0].execlists.queue_priority = ((-2 * (next_i()%2)) + 1) * next_i();
