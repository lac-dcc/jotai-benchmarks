...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rc10; _i0++) {
            rc1->x0 = ((-2 * (next_i()%2)) + 1) * next_i();
        rc1->y0 = ((-2 * (next_i()%2)) + 1) * next_i();
        rc1->x1 = ((-2 * (next_i()%2)) + 1) * next_i();
        rc1->y1 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_rc20 = 1;
          struct mp_rect * rc2 = (struct mp_rect *) malloc(_len_rc20*sizeof(struct mp_rect));
          for(int _i0 = 0; _i0 < _len_rc20; _i0++) {
            rc2->x0 = ((-2 * (next_i()%2)) + 1) * next_i();
        rc2->y0 = ((-2 * (next_i()%2)) + 1) * next_i();
        rc2->x1 = ((-2 * (next_i()%2)) + 1) * next_i();
        rc2->y1 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
