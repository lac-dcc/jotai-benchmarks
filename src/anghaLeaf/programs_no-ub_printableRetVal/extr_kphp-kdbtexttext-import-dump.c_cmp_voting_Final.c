...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_x0; _i0++) {
            x->owner_id = ((-2 * (next_i()%2)) + 1) * next_i();
        x->topic_id = ((-2 * (next_i()%2)) + 1) * next_i();
        x->voting_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_y0 = 1;
          struct TYPE_4__ * y = (struct TYPE_4__ *) malloc(_len_y0*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_y0; _i0++) {
            y->owner_id = ((-2 * (next_i()%2)) + 1) * next_i();
        y->topic_id = ((-2 * (next_i()%2)) + 1) * next_i();
        y->voting_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
