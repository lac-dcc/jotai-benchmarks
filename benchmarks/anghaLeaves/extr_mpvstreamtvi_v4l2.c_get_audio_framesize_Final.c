...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_priv0 = 1;
          struct TYPE_5__ * priv = (struct TYPE_5__ *) malloc(_len_priv0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv[_i0].audio_in.blocksize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = get_audio_framesize(priv);
          printf("%d\n", benchRet); 
          free(priv);
