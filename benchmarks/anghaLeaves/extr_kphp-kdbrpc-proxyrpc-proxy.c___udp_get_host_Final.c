...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_B0; _i0++) {
              int _len_B__i0__S0 = 1;
          B[_i0].S = (struct TYPE_2__ *) malloc(_len_B__i0__S0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_B__i0__S0; _j0++) {
            B[_i0].S->ip = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned int benchRet = __udp_get_host(B);
          printf("%u\n", benchRet); 
