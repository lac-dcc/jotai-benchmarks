...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p_ramrod0; _i0++) {
            p_ramrod->common.update_tpa_param_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->common.update_tpa_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_min_size_to_cont = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_min_size_to_start = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_max_size = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_max_aggs_num = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_gro_consistent_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_hdr_data_split_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_pkt_split_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.max_buff_num = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_ipv6_tunn_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_ipv4_tunn_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_ipv6_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_ramrod->tpa_param.tpa_ipv4_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_p_params0; _i0++) {
            p_params->tpa_min_size_to_cont = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_min_size_to_start = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_max_size = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_max_aggs_num = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_gro_consistent_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_hdr_data_split_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_pkt_split_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->max_buffers_per_cqe = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->update_tpa_param_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_ipv6_tunn_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_ipv4_tunn_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_ipv6_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->tpa_ipv4_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
        p_params->update_tpa_en_flg = ((-2 * (next_i()%2)) + 1) * next_i();
          }
