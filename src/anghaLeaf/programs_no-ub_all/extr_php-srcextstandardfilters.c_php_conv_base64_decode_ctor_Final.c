...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_inst0; _i0++) {
            inst->eos = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->ustat = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->urem_nbits = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->urem = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->_super.dtor = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->_super.convert_op = ((-2 * (next_i()%2)) + 1) * next_i();
          }
