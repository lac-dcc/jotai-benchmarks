...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int tls_session_secret_cb = 100;
        
          int _len_s0 = 1;
          struct TYPE_5__ * s = (struct TYPE_5__ *) malloc(_len_s0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
              s[_i0].ext.session_secret_cb = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = SSL_set_session_secret_cb(s,tls_session_secret_cb,arg);
          printf("%d\n", benchRet); 
          free(s);
    ...
    case 3:
    {
          ...
          int tls_session_secret_cb = ((-2 * (next_i()%2)) + 1) * next_i();
