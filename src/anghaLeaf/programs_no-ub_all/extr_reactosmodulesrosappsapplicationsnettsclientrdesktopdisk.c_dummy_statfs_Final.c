...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_buf0; _i0++) {
            buf->f_blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        buf->f_bfree = ((-2 * (next_i()%2)) + 1) * next_i();
        buf->f_bsize = ((-2 * (next_i()%2)) + 1) * next_i();
        buf->f_namelen = ((-2 * (next_i()%2)) + 1) * next_i();
        buf->f_namemax = ((-2 * (next_i()%2)) + 1) * next_i();
          }
