...
/* Type definitions */
typedef  int /*<<< orphan*/  PNET_DEVICE_PNP_EVENT ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int NetDevicePnPEvent = 100;
          NeoNdisDevicePnPEventNotify(MiniportAdapterContext,NetDevicePnPEvent);
