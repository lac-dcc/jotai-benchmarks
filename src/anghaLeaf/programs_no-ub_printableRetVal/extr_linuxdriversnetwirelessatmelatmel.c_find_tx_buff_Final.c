...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv->tx_buff_tail = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->tx_desc_free = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->tx_free_mem = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->host_info.tx_buff_size = ((-2 * (next_i()%2)) + 1) * next_i();
        priv->host_info.tx_buff_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
