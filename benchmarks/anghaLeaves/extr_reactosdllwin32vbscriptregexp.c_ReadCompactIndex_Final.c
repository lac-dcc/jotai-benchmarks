...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_pc0 = 65025;
          int * pc = (int *) malloc(_len_pc0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_pc0; _i0++) {
            pc[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_result0 = 65025;
          unsigned long * result = (unsigned long *) malloc(_len_result0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_result0; _i0++) {
            result[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = ReadCompactIndex(pc,result);
          printf("%d\n", (*benchRet)); 
          free(pc);
          free(result);
