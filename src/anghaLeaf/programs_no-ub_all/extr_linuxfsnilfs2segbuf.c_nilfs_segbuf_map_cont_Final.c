...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_segbuf0; _i0++) {
            segbuf->sb_pseg_start = ((-2 * (next_i()%2)) + 1) * next_i();
        segbuf->sb_fseg_end = ((-2 * (next_i()%2)) + 1) * next_i();
        segbuf->sb_rest_blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        segbuf->sb_sum.nblocks = ((-2 * (next_i()%2)) + 1) * next_i();
        segbuf->sb_fseg_start = ((-2 * (next_i()%2)) + 1) * next_i();
        segbuf->sb_segnum = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_prev0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_prev0; _i0++) {
            prev->sb_pseg_start = ((-2 * (next_i()%2)) + 1) * next_i();
        prev->sb_fseg_end = ((-2 * (next_i()%2)) + 1) * next_i();
        prev->sb_rest_blocks = ((-2 * (next_i()%2)) + 1) * next_i();
        prev->sb_sum.nblocks = ((-2 * (next_i()%2)) + 1) * next_i();
        prev->sb_fseg_start = ((-2 * (next_i()%2)) + 1) * next_i();
        prev->sb_segnum = ((-2 * (next_i()%2)) + 1) * next_i();
          }
