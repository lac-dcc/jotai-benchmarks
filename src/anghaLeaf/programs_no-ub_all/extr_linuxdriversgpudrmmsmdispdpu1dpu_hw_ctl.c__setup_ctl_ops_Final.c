...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ops0; _i0++) {
            ops->get_bitmask_cdm = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->get_bitmask_intf = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->get_bitmask_mixer = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->get_bitmask_sspp = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->setup_blendstage = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->clear_all_blendstages = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->wait_reset_status = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->reset = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->setup_intf_cfg = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->trigger_pending = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->trigger_start = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->get_flush_register = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->trigger_flush = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->get_pending_flush = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->update_pending_flush = ((-2 * (next_i()%2)) + 1) * next_i();
        ops->clear_pending_flush = ((-2 * (next_i()%2)) + 1) * next_i();
          }
