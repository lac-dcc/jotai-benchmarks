...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ADC_CommonInitStruct0; _i0++) {
            ADC_CommonInitStruct->ADC_TwoSamplingDelay = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_CommonInitStruct->ADC_DMAAccessMode = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_CommonInitStruct->ADC_Prescaler = ((-2 * (next_i()%2)) + 1) * next_i();
        ADC_CommonInitStruct->ADC_Mode = ((-2 * (next_i()%2)) + 1) * next_i();
          }
