...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pDM_Odm0; _i0++) {
            pDM_Odm->bUseRAMask = ((-2 * (next_i()%2)) + 1) * next_i();
        pDM_Odm->RateAdaptive.Type = ((-2 * (next_i()%2)) + 1) * next_i();
        pDM_Odm->RateAdaptive.LdpcThres = ((-2 * (next_i()%2)) + 1) * next_i();
        pDM_Odm->RateAdaptive.bUseLdpc = ((-2 * (next_i()%2)) + 1) * next_i();
        pDM_Odm->RateAdaptive.HighRSSIThresh = ((-2 * (next_i()%2)) + 1) * next_i();
        pDM_Odm->RateAdaptive.LowRSSIThresh = ((-2 * (next_i()%2)) + 1) * next_i();
        pDM_Odm->RateAdaptive.RATRState = ((-2 * (next_i()%2)) + 1) * next_i();
          }
