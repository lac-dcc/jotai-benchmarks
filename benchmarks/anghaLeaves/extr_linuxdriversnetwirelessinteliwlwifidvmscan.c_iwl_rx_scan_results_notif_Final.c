...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_rxb0 = 1;
          struct iwl_rx_cmd_buffer * rxb = (struct iwl_rx_cmd_buffer *) malloc(_len_rxb0*sizeof(struct iwl_rx_cmd_buffer));
          for(int _i0 = 0; _i0 < _len_rxb0; _i0++) {
            rxb[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          iwl_rx_scan_results_notif(priv,rxb);
          free(priv);
          free(rxb);
