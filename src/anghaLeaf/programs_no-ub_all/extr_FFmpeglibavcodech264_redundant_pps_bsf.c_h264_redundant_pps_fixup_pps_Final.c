...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx->global_pic_init_qp = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx->current_pic_init_qp = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pps0 = 1;
          struct TYPE_6__ * pps = (struct TYPE_6__ *) malloc(_len_pps0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_pps0; _i0++) {
            pps->weighted_pred_flag = ((-2 * (next_i()%2)) + 1) * next_i();
        pps->pic_init_qp_minus26 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
