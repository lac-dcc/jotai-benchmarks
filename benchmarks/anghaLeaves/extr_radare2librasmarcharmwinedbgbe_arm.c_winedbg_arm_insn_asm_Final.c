...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_arminsn0; _i0++) {
              int _len_arminsn__i0__str_asm0 = 1;
          arminsn[_i0].str_asm = (char *) malloc(_len_arminsn__i0__str_asm0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_arminsn__i0__str_asm0; _j0++) {
            arminsn[_i0].str_asm[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          char * benchRet = winedbg_arm_insn_asm(arminsn);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_arminsn0; _aux++) {
          free(arminsn[_aux].str_asm);
          }
          free(arminsn);
