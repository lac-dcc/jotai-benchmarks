...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int byte_num = 100;
        
          unsigned int bit = 100;
        
          unsigned long benchRet = amb_num_from_reg(byte_num,bit);
          printf("%lu\n", benchRet); 
    ...
    case 3:
    {
          ...
          unsigned int byte_num = ((-2 * (next_i()%2)) + 1) * next_i();
