...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ivideo0; _i0++) {
            ivideo->video_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->hwcursor_size = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->cmdQueueSize = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->UMAsize = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->sisfb_parm_mem = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->video_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->sisfb_mem = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->heapstart = ((-2 * (next_i()%2)) + 1) * next_i();
        ivideo->LFBsize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
