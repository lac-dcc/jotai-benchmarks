...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dbg0; _i0++) {
            dbg->stats.tfe0 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tfe1 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rff0 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rff1 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rls = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tls = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rfs = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tfs = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tue0 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tue1 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.roe0 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.roe1 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tde0 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tde1 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rdr0 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rdr1 = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rxt = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.cmddu = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.cmdau = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.tfrc = ((-2 * (next_i()%2)) + 1) * next_i();
        dbg->stats.rfrc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
