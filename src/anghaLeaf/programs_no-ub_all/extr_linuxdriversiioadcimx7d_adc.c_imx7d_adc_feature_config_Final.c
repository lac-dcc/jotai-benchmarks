...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info->adc_feature.core_time_unit = ((-2 * (next_i()%2)) + 1) * next_i();
        info->adc_feature.average_en = ((-2 * (next_i()%2)) + 1) * next_i();
        info->adc_feature.avg_num = ((-2 * (next_i()%2)) + 1) * next_i();
        info->adc_feature.clk_pre_div = ((-2 * (next_i()%2)) + 1) * next_i();
          }
