...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          // dynamic_instructions_O0 : 9727
          // ------------------------------- 
          // static_instructions_O1 : 19
          // dynamic_instructions_O1 : 2813
          // ------------------------------- 
          // static_instructions_O2 : 50
          // dynamic_instructions_O2 : 2444
          // ------------------------------- 
          // static_instructions_O3 : 50
          // dynamic_instructions_O3 : 2444
          // ------------------------------- 
          // static_instructions_Ofast : 50
          // dynamic_instructions_Ofast : 2444
          // ------------------------------- 
          // static_instructions_Os : 18
          // dynamic_instructions_Os : 2812
          // ------------------------------- 
          ...
          long benchRet = mpihelp_add_n(res_ptr,s1_ptr,s2_ptr,size);
          printf("%ld\n", benchRet); 
          free(res_ptr);
          free(s1_ptr);
          free(s2_ptr);
    ...
    case 1:
    {
          ...
          // dynamic_instructions_O3 : 114
          // ------------------------------- 
          // static_instructions_Ofast : 38
          // dynamic_instructions_Ofast : 114
          // ------------------------------- 
          // static_instructions_Os : 18
          // dynamic_instructions_Os : 117
          // ------------------------------- 
          // static_instructions_Oz : 18
