...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cell0; _i0++) {
            cell->event.flags = ((-2 * (next_i()%2)) + 1) * next_i();
        cell->event.time.time.tv_nsec = ((-2 * (next_i()%2)) + 1) * next_i();
        cell->event.time.time.tv_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        cell->event.time.tick = ((-2 * (next_i()%2)) + 1) * next_i();
        cell->event.dest.client = ((-2 * (next_i()%2)) + 1) * next_i();
        cell->event.source.client = ((-2 * (next_i()%2)) + 1) * next_i();
          }
