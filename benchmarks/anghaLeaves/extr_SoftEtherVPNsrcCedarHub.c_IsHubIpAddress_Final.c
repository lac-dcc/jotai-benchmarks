...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ip0; _i0++) {
              int _len_ip__i0__addr0 = 1;
          ip[_i0].addr = (int *) malloc(_len_ip__i0__addr0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ip__i0__addr0; _j0++) {
            ip[_i0].addr[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = IsHubIpAddress(ip);
          printf("%d\n", benchRet); 
