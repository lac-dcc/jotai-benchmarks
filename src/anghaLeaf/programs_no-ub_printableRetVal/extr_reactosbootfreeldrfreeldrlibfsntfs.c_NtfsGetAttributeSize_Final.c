...
__attribute__((used)) static ULONGLONG NtfsGetAttributeSize(PNTFS_ATTR_RECORD AttrRecord)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_AttrRecord0; _i0++) {
            AttrRecord->Resident.ValueLength = ((-2 * (next_i()%2)) + 1) * next_i();
        AttrRecord->NonResident.DataSize = ((-2 * (next_i()%2)) + 1) * next_i();
        AttrRecord->IsNonResident = ((-2 * (next_i()%2)) + 1) * next_i();
          }
