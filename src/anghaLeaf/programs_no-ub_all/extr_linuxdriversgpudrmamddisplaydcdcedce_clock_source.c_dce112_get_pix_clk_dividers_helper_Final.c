...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_clk_src0; _i0++) {
            clk_src->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_pll_settings0; _i0++) {
            pll_settings->actual_pix_clk = ((-2 * (next_i()%2)) + 1) * next_i();
        pll_settings->adjusted_pix_clk = ((-2 * (next_i()%2)) + 1) * next_i();
        pll_settings->calculated_pix_clk = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _i0 = 0; _i0 < _len_pix_clk_params0; _i0++) {
            pix_clk_params->requested_pix_clk = ((-2 * (next_i()%2)) + 1) * next_i();
        pix_clk_params->signal_type = ((-2 * (next_i()%2)) + 1) * next_i();
        pix_clk_params->color_depth = ((-2 * (next_i()%2)) + 1) * next_i();
          }
