...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
              int _len_self__i0__dict0 = 1;
          self[_i0].dict = (struct TYPE_6__ *) malloc(_len_self__i0__dict0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_self__i0__dict0; _j0++) {
            self[_i0].dict->dv_hashtab.ht_used = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = DictionaryLength(self);
          printf("%d\n", benchRet); 
