...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p_hwfn0; _i0++) {
            p_hwfn->qm_info.first_rl_pq = ((-2 * (next_i()%2)) + 1) * next_i();
        p_hwfn->qm_info.first_mcos_pq = ((-2 * (next_i()%2)) + 1) * next_i();
        p_hwfn->qm_info.first_vf_pq = ((-2 * (next_i()%2)) + 1) * next_i();
        p_hwfn->qm_info.num_vf_pqs = ((-2 * (next_i()%2)) + 1) * next_i();
        p_hwfn->qm_info.num_pf_rls = ((-2 * (next_i()%2)) + 1) * next_i();
        p_hwfn->qm_info.num_vports = ((-2 * (next_i()%2)) + 1) * next_i();
        p_hwfn->qm_info.num_pqs = ((-2 * (next_i()%2)) + 1) * next_i();
          }
