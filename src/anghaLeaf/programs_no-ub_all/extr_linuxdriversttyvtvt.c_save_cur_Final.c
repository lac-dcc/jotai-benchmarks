...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vc0; _i0++) {
            vc->vc_G1_charset = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_saved_G1 = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_G0_charset = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_saved_G0 = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_color = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_color = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_charset = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_charset = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_reverse = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_reverse = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_blink = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_blink = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_underline = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_underline = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_italic = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_italic = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_intensity = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_s_intensity = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_y = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_saved_y = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_x = ((-2 * (next_i()%2)) + 1) * next_i();
        vc->vc_saved_x = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          save_cur(vc);
          free(vc);
