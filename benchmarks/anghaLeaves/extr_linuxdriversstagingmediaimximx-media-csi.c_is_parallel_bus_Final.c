...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ep0 = 1;
          struct v4l2_fwnode_endpoint * ep = (struct v4l2_fwnode_endpoint *) malloc(_len_ep0*sizeof(struct v4l2_fwnode_endpoint));
          for(int _i0 = 0; _i0 < _len_ep0; _i0++) {
            ep[_i0].bus_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_parallel_bus(ep);
          printf("%d\n", benchRet); 
          free(ep);
