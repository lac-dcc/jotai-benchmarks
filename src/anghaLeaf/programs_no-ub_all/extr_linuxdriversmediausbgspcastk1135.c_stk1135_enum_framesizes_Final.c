...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fsize0; _i0++) {
            fsize->index = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->pixel_format = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->stepwise.min_width = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->stepwise.min_height = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->stepwise.max_width = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->stepwise.max_height = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->stepwise.step_width = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->stepwise.step_height = ((-2 * (next_i()%2)) + 1) * next_i();
        fsize->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
