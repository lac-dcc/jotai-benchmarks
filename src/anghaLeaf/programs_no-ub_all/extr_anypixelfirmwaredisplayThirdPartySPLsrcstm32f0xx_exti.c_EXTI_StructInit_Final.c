...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_EXTI_InitStruct0; _i0++) {
            EXTI_InitStruct->EXTI_LineCmd = ((-2 * (next_i()%2)) + 1) * next_i();
        EXTI_InitStruct->EXTI_Trigger = ((-2 * (next_i()%2)) + 1) * next_i();
        EXTI_InitStruct->EXTI_Mode = ((-2 * (next_i()%2)) + 1) * next_i();
        EXTI_InitStruct->EXTI_Line = ((-2 * (next_i()%2)) + 1) * next_i();
          }
