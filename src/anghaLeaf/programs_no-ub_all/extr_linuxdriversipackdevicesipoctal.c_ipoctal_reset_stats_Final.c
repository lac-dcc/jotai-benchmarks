...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stats0; _i0++) {
            stats->parity_err = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->overrun_err = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->framing_err = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->rcv_break = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->rx = ((-2 * (next_i()%2)) + 1) * next_i();
        stats->tx = ((-2 * (next_i()%2)) + 1) * next_i();
          }
