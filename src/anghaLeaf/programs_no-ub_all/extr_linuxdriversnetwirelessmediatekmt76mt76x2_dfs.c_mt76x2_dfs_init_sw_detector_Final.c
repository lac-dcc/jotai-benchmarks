...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
            dev->dfs_pd.region = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->dfs_pd.sw_dpd_params.pri_margin = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->dfs_pd.sw_dpd_params.min_pri = ((-2 * (next_i()%2)) + 1) * next_i();
        dev->dfs_pd.sw_dpd_params.max_pri = ((-2 * (next_i()%2)) + 1) * next_i();
          }
