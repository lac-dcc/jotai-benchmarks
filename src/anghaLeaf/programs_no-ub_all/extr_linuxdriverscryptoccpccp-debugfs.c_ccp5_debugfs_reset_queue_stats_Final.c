...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cmd_q0; _i0++) {
            cmd_q->total_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_aes_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_xts_aes_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_3des_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_sha_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_rsa_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_pt_ops = ((-2 * (next_i()%2)) + 1) * next_i();
        cmd_q->total_ecc_ops = ((-2 * (next_i()%2)) + 1) * next_i();
          }
