...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_v10; _i0++) {
            v1->varno = ((-2 * (next_i()%2)) + 1) * next_i();
        v1->varattno = ((-2 * (next_i()%2)) + 1) * next_i();
        v1->vartype = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_v20 = 1;
          struct TYPE_4__ * v2 = (struct TYPE_4__ *) malloc(_len_v20*sizeof(struct TYPE_4__));
          for(int _i0 = 0; _i0 < _len_v20; _i0++) {
            v2->varno = ((-2 * (next_i()%2)) + 1) * next_i();
        v2->varattno = ((-2 * (next_i()%2)) + 1) * next_i();
        v2->vartype = ((-2 * (next_i()%2)) + 1) * next_i();
          }
