...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fusb302_tcpc_dev0; _i0++) {
            fusb302_tcpc_dev->pd_transmit = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->start_drp_toggling = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->set_roles = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->set_pd_rx = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->set_vbus = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->set_vconn = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->set_polarity = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->get_cc = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->set_cc = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->get_current_limit = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->get_vbus = ((-2 * (next_i()%2)) + 1) * next_i();
        fusb302_tcpc_dev->init = ((-2 * (next_i()%2)) + 1) * next_i();
          }
