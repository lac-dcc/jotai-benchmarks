...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dispc[_i0].feat = (struct TYPE_3__ *) malloc(_len_dispc__i0__feat0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_dispc__i0__feat0; _j0++) {
            dispc[_i0].feat->no_framedone_tv = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = dispc_mgr_get_framedone_irq(dispc,channel);
          printf("%d\n", benchRet); 
