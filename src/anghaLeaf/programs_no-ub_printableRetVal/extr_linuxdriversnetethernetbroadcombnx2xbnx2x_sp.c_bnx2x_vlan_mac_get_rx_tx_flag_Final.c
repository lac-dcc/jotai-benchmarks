...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_o0 = 1;
          struct bnx2x_vlan_mac_obj * o = (struct bnx2x_vlan_mac_obj *) malloc(_len_o0*sizeof(struct bnx2x_vlan_mac_obj));
          for(int _i0 = 0; _i0 < _len_o0; _i0++) {
            o->raw.obj_type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = bnx2x_vlan_mac_get_rx_tx_flag(o);
          printf("%d\n", benchRet); 
          free(o);
