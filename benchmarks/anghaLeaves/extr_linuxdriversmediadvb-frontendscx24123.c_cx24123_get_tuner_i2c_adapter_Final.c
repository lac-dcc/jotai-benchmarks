...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].demodulator_priv = (struct cx24123_state *) malloc(_len_fe__i0__demodulator_priv0*sizeof(struct cx24123_state));
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
            fe[_i0].demodulator_priv->tuner_i2c_adapter.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct i2c_adapter * benchRet = cx24123_get_tuner_i2c_adapter(fe);
          printf("%d\n", (*benchRet).dummy);
