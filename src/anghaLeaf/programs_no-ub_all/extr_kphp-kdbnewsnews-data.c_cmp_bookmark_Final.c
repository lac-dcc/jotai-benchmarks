...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_x0; _i0++) {
            x->next = ((-2 * (next_i()%2)) + 1) * next_i();
        x->value = ((-2 * (next_i()%2)) + 1) * next_i();
        x->y = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_y0 = 1;
          struct bookmark * y = (struct bookmark *) malloc(_len_y0*sizeof(struct bookmark));
          for(int _i0 = 0; _i0 < _len_y0; _i0++) {
            y->next = ((-2 * (next_i()%2)) + 1) * next_i();
        y->value = ((-2 * (next_i()%2)) + 1) * next_i();
        y->y = ((-2 * (next_i()%2)) + 1) * next_i();
          }
