...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          float * pack = (float *) malloc(_len_pack0*sizeof(float));
          for(int _i0 = 0; _i0 < _len_pack0; _i0++) {
            pack[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          R_VaoUnpackTangent(v,pack);
          free(v);
          free(pack);
