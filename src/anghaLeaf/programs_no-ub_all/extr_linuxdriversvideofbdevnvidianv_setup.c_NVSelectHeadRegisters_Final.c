...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_par0; _i0++) {
            par->PDIO0 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PDIO = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PRAMDAC0 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PRAMDAC = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PCRTC0 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PCRTC = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PCIO0 = ((-2 * (next_i()%2)) + 1) * next_i();
        par->PCIO = ((-2 * (next_i()%2)) + 1) * next_i();
          }
