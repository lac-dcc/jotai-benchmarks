...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ioaddr0; _i0++) {
            ioaddr->cmd_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->command_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->status_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->device_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->lbah_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->lbam_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->lbal_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->nsect_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->feature_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->error_addr = ((-2 * (next_i()%2)) + 1) * next_i();
        ioaddr->data_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
