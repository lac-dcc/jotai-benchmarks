...
struct TYPE_4__ *_allocate_list(int length) {
...
void _delete_list(struct TYPE_4__ * head) {
...
int main(int argc, char *argv[]) {
    ...
    {
          int mtlIdParent = 255;
          struct TYPE_4__ * list = _allocate_list(1);
          struct TYPE_4__ * benchRet = _ase_get_material(list,mtlIdParent);
          printf("{{struct}} %p\n", &benchRet); 
          _delete_list(list);
