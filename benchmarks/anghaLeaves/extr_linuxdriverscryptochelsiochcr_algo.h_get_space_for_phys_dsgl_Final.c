...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned int sgl_entr = 100;
        
          unsigned int benchRet = get_space_for_phys_dsgl(sgl_entr);
          printf("%u\n", benchRet); 
    ...
    case 3:
    {
          unsigned int sgl_entr = ((-2 * (next_i()%2)) + 1) * next_i();
