...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_l0 = 1;
          struct ceph_file_layout * l = (struct ceph_file_layout *) malloc(_len_l0*sizeof(struct ceph_file_layout));
          for(int _i0 = 0; _i0 < _len_l0; _i0++) {
            l[_i0].stripe_unit = ((-2 * (next_i()%2)) + 1) * next_i();
        l[_i0].object_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = rbd_layout_is_fancy(l);
          printf("%d\n", benchRet); 
          free(l);
