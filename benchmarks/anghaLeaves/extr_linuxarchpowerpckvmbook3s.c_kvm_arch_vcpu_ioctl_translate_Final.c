...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_tr0 = 1;
          struct kvm_translation * tr = (struct kvm_translation *) malloc(_len_tr0*sizeof(struct kvm_translation));
          for(int _i0 = 0; _i0 < _len_tr0; _i0++) {
            tr[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = kvm_arch_vcpu_ioctl_translate(vcpu,tr);
          printf("%d\n", benchRet); 
          free(vcpu);
          free(tr);
