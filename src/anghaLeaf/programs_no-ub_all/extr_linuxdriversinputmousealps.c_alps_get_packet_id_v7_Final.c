...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int _len_byte0 = 65025;
          char * byte = (char *) malloc(_len_byte0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_byte0; _i0++) {
            byte[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned char benchRet = alps_get_packet_id_v7(byte);
          printf("%c\n", (benchRet%26)+'a'); 
          free(byte);
