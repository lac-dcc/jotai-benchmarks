...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_region0 = 1;
          struct mlxsw_sp_acl_tcam_region * region = (struct mlxsw_sp_acl_tcam_region *) malloc(_len_region0*sizeof(struct mlxsw_sp_acl_tcam_region));
          for(int _i0 = 0; _i0 < _len_region0; _i0++) {
            region[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = mlxsw_sp1_acl_tcam_region_associate(mlxsw_sp,region);
          printf("%d\n", benchRet); 
          free(mlxsw_sp);
          free(region);
