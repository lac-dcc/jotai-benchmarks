...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * points = (struct TYPE_3__ *) malloc(_len_points0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_points0; _i0++) {
              points[_i0].x = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          points[_i0].y = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        
          }
        
          stbtt__add_point(points,n,x,y);
          free(points);
