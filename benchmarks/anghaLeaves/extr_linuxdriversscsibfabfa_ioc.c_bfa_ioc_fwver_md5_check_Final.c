...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct bfi_ioc_image_hdr_s * fwhdr_1 = (struct bfi_ioc_image_hdr_s *) malloc(_len_fwhdr_10*sizeof(struct bfi_ioc_image_hdr_s));
          ...
          struct bfi_ioc_image_hdr_s * fwhdr_2 = (struct bfi_ioc_image_hdr_s *) malloc(_len_fwhdr_20*sizeof(struct bfi_ioc_image_hdr_s));
