...
struct pending_operation *_allocate_P(int length) {
  struct pending_operation *head = (struct pending_operation *)malloc(sizeof(struct pending_operation));

  head->next = NULL;

  struct pending_operation *walker = head;
...
void _delete_P(struct pending_operation * head) {
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          struct pending_operation * P = _allocate_P(1);
