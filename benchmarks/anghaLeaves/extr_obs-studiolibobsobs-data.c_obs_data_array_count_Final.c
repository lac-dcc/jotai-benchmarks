...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_array0 = 1;
          struct TYPE_5__ * array = (struct TYPE_5__ *) malloc(_len_array0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_array0; _i0++) {
            array[_i0].objects.num = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = obs_data_array_count(array);
          printf("%lu\n", benchRet); 
          free(array);
