...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sc0; _i0++) {
            sc->params.enable_blend = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->params.blend_src_rgb = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->params.blend_dst_rgb = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->params.blend_src_alpha = ((-2 * (next_i()%2)) + 1) * next_i();
        sc->params.blend_dst_alpha = ((-2 * (next_i()%2)) + 1) * next_i();
          }
