...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
            stream->request.str_type.codec_type = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->request.str_type.str_type = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->request.str_type.operation = ((-2 * (next_i()%2)) + 1) * next_i();
        stream->request.str_type.time_slots = ((-2 * (next_i()%2)) + 1) * next_i();
          }
