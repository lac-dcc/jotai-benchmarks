...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long small = 100;
        
          int benchRet = tfrc_binsearch(fval,small);
          printf("%d\n", benchRet); 
    ...
    case 3:
    {
          ...
          int fval = ((-2 * (next_i()%2)) + 1) * next_i();
        
          unsigned long small = ((-2 * (next_i()%2)) + 1) * next_i();
