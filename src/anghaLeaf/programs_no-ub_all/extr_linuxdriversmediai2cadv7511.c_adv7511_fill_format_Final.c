...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state->dv_timings.bt.height = ((-2 * (next_i()%2)) + 1) * next_i();
        state->dv_timings.bt.width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_format0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_format0; _i0++) {
            format->field = ((-2 * (next_i()%2)) + 1) * next_i();
        format->height = ((-2 * (next_i()%2)) + 1) * next_i();
        format->width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
