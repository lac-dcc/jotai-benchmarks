...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pstat0 = 1;
          struct sta_info * pstat = (struct sta_info *) malloc(_len_pstat0*sizeof(struct sta_info));
          for(int _i0 = 0; _i0 < _len_pstat0; _i0++) {
            pstat[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          issue_asocrsp(padapter,status,pstat,pkt_type);
          free(padapter);
          free(pstat);
