...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_policy0; _i0++) {
            policy->policy_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        policy->fault_time = ((-2 * (next_i()%2)) + 1) * next_i();
        policy->preemption_time = ((-2 * (next_i()%2)) + 1) * next_i();
        policy->execution_quantum = ((-2 * (next_i()%2)) + 1) * next_i();
          }
