...
__attribute__((used)) static int team_notify_peers_count_get(struct team *team,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_team0; _i0++) {
            team[_i0].notify_peers.count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ctx0 = 1;
          ...
          int benchRet = team_notify_peers_count_get(team,ctx);
          printf("%d\n", benchRet); 
          free(team);
          free(ctx);
