...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int section_type = 100;
        
          int _len_ctx0 = 1;
          struct TYPE_3__ * ctx = (struct TYPE_3__ *) malloc(_len_ctx0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
              ctx[_i0].texture = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = check_texture(ctx,section_type);
          printf("%d\n", benchRet); 
          free(ctx);
    ...
    case 3:
    {
          ...
          int section_type = ((-2 * (next_i()%2)) + 1) * next_i();
