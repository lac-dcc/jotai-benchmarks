...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_act0 = 1;
          struct irqaction * act = (struct irqaction *) malloc(_len_act0*sizeof(struct irqaction));
          for(int _i0 = 0; _i0 < _len_act0; _i0++) {
            act[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          irq_setup_timings(desc,act);
          free(desc);
          free(act);
