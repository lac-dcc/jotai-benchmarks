...
struct TYPE_4__ {int /*<<< orphan*/  dev_nperio_tx_fifo_size; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_core_if__i0__core_params0; _j0++) {
            core_if[_i0].core_params->dev_nperio_tx_fifo_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = dwc_otg_get_param_dev_nperio_tx_fifo_size(core_if);
          printf("%d\n", benchRet); 
