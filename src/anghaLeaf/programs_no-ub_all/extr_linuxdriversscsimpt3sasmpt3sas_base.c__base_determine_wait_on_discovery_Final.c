...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ioc0; _i0++) {
            ioc->bios_pg2.CurrentBootDeviceForm = ((-2 * (next_i()%2)) + 1) * next_i();
        ioc->bios_pg2.ReqBootDeviceForm = ((-2 * (next_i()%2)) + 1) * next_i();
        ioc->bios_pg2.ReqAltBootDeviceForm = ((-2 * (next_i()%2)) + 1) * next_i();
        ioc->bios_pg3.BiosVersion = ((-2 * (next_i()%2)) + 1) * next_i();
        ioc->ir_firmware = ((-2 * (next_i()%2)) + 1) * next_i();
          }
