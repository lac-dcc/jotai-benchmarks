...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ref0 = 1;
          struct jffs2_xattr_ref * ref = (struct jffs2_xattr_ref *) malloc(_len_ref0*sizeof(struct jffs2_xattr_ref));
          for(int _i0 = 0; _i0 < _len_ref0; _i0++) {
            ref[_i0].xseqno = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_xattr_ref_dead(ref);
          printf("%d\n", benchRet); 
          free(ref);
