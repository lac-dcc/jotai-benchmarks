...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_inst0; _i0++) {
            inst->settings.pack_data = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.read_setup_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.read_hold_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.read_pace_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.read_strobe_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.write_setup_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.write_hold_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.write_pace_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.write_strobe_time = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.dma_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.dma_passthrough_enable = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.dma_read_thresh = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.dma_write_thresh = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.dma_panic_read_thresh = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.dma_panic_write_thresh = ((-2 * (next_i()%2)) + 1) * next_i();
        inst->settings.data_width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
