...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pVBInfo0; _i0++) {
            pVBInfo->VGAVT = ((-2 * (next_i()%2)) + 1) * next_i();
        pVBInfo->VGAVDE = ((-2 * (next_i()%2)) + 1) * next_i();
        pVBInfo->RVBHCMAX = ((-2 * (next_i()%2)) + 1) * next_i();
        pVBInfo->VT = ((-2 * (next_i()%2)) + 1) * next_i();
        pVBInfo->VDE = ((-2 * (next_i()%2)) + 1) * next_i();
        pVBInfo->RVBHCFACT = ((-2 * (next_i()%2)) + 1) * next_i();
        pVBInfo->HT = ((-2 * (next_i()%2)) + 1) * next_i();
          }
