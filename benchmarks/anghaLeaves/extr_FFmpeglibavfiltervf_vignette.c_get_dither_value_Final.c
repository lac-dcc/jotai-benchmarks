...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s[_i0].dither = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        s[_i0].do_dither = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          double benchRet = get_dither_value(s);
          printf("%lf\n", benchRet); 
          free(s);
