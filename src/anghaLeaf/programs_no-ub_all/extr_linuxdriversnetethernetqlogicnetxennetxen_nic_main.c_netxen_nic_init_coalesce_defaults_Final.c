...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adapter0; _i0++) {
            adapter->coal.normal.data.tx_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->coal.normal.data.tx_time_us = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->coal.normal.data.rx_packets = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->coal.normal.data.rx_time_us = ((-2 * (next_i()%2)) + 1) * next_i();
        adapter->coal.flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
