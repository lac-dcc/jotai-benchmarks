...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_line0; _i0++) {
              line[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int _len_end0 = 65025;
          struct line * end = (struct line *) malloc(_len_end0*sizeof(struct line));
          for(int _i0 = 0; _i0 < _len_end0; _i0++) {
              end[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
        
          }
        
          int benchRet = stage_diff_done(line,end);
          printf("%d\n", benchRet); 
          free(line);
          free(end);
