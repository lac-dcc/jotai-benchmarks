...
/* Type definitions */
struct TYPE_4__ {int eight_bit_controls; } ;
struct TYPE_5__ {TYPE_1__ modes; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
              self[_i0].modes.eight_bit_controls = ((-2 * (next_i()%2)) + 1) * next_i();
        
        
          }
        
          screen_set_8bit_controls(self,yes);
          free(self);
