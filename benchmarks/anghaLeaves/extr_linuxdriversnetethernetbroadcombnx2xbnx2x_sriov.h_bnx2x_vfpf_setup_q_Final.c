...
__attribute__((used)) static inline int bnx2x_vfpf_setup_q(struct bnx2x *bp, struct bnx2x_fastpath *fp, bool is_leading) {return 0; }
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = bnx2x_vfpf_setup_q(bp,fp,is_leading);
          printf("%d\n", benchRet); 
          free(bp);
          free(fp);
