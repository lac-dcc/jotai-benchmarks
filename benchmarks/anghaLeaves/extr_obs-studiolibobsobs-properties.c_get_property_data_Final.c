...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_prop0 = 1;
          struct obs_property * prop = (struct obs_property *) malloc(_len_prop0*sizeof(struct obs_property));
          for(int _i0 = 0; _i0 < _len_prop0; _i0++) {
            prop[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = get_property_data(prop);
          printf("{{other_type}} %p\n", &benchRet); 
          free(prop);
