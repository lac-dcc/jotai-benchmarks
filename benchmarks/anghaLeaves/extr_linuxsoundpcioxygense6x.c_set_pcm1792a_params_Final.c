...
__attribute__((used)) static void set_pcm1792a_params(struct oxygen *chip,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_params0 = 1;
          struct snd_pcm_hw_params * params = (struct snd_pcm_hw_params *) malloc(_len_params0*sizeof(struct snd_pcm_hw_params));
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
            params[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          set_pcm1792a_params(chip,params);
          free(chip);
          free(params);
